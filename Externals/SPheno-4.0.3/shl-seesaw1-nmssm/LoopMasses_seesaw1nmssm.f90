...
! ------------------------------------------------------------------------------  
! File created at 18:21 on 2.10.2017   
! ----------------------------------------------------------------------  
 
 
Module LoopMasses_seesaw1nmssm 
...
Use Tadpoles_seesaw1nmssm 
 Use EffectivePotential_seesaw1nmssm 
 Use Pole2L_seesaw1nmssm 
...
& cplAhAhUSvImUSvIm(3,3,6,6),cplAhAhUSvReUSvRe(3,3,6,6),cplAhAhVZVZ(3,3),cplAhcUHpmVWm(3,2),& 
& cplAhhhVZ(3,3),cplAhHpmcUHpm(3,2,2),cplAhHpmcVWm(3,2),cplAhSdcUSd(3,6,6),              & 
& cplAhSecUSe(3,6,6),cplAhSucUSu(3,6,6),cplAhSvImUSvRe(3,6,6),cplAhUhhhh(3,3,3),         & 
& cplAhUhhVZ(3,3),cplAhUSvImSvIm(3,6,6),cplAhUSvImSvRe(3,6,6),cplAhUSvReSvRe(3,6,6),     & 
...
& cplcChaUFvSeL(2,6,6),cplcChaUFvSeR(2,6,6),cplcFdFdUAhL(3,3,3),cplcFdFdUAhR(3,3,3),     & 
...
& cplcFdGluSdR(3,6),cplcFdUChiSdL(3,5,6),cplcFdUChiSdR(3,5,6),cplcFeChaUSvImL(3,2,6),    & 
& cplcFeChaUSvImR(3,2,6),cplcFeChaUSvReL(3,2,6),cplcFeChaUSvReR(3,2,6),cplcFeFeUAhL(3,3,3),& 
...
& cplcFeUChiSeR(3,5,6),cplcFeUFvHpmL(3,6,2),cplcFeUFvHpmR(3,6,2),cplcFeUFvVWmL(3,6),     & 
& cplcFeUFvVWmR(3,6),cplcFuFdcUHpmL(3,3,2),cplcFuFdcUHpmR(3,3,2),cplcFuFdcVWmL(3,3),     & 
...
& cplChiFucUSuR(5,3,6),cplChiFvUSvImL(5,6,6),cplChiFvUSvImR(5,6,6),cplChiFvUSvReL(5,6,6),& 
& cplChiFvUSvReR(5,6,6),cplChiUFvSvImL(5,6,6),cplChiUFvSvImR(5,6,6),cplChiUFvSvReL(5,6,6),& 
& cplChiUFvSvReR(5,6,6),cplcHpmVPVWm(2),cplcHpmVWmVZ(2),cplcUChacFuSdL(2,3,6),           & 
& cplcUChacFuSdR(2,3,6),cplcUChaChaAhL(2,2,3),cplcUChaChaAhR(2,2,3),cplcUChaChahhL(2,2,3),& 
...
& cplcUChaChiVWmR(2,5),cplcUChaFdcSuL(2,3,6),cplcUChaFdcSuR(2,3,6),cplcUChaFeSvImL(2,3,6)

Complex(dp) :: cplcUChaFeSvImR(2,3,6),cplcUChaFeSvReL(2,3,6),cplcUChaFeSvReR(2,3,6),cplcUChaFvSeL(2,6,6),& 
& cplcUChaFvSeR(2,6,6),cplcUFdChaSuL(3,2,6),cplcUFdChaSuR(3,2,6),cplcUFdChiSdL(3,5,6),   & 
& cplcUFdChiSdR(3,5,6),cplcUFdFdAhL(3,3,3),cplcUFdFdAhR(3,3,3),cplcUFdFdhhL(3,3,3),      & 
...
& cplcUFdGluSdR(3,6),cplcUFeChaSvImL(3,2,6),cplcUFeChaSvImR(3,2,6),cplcUFeChaSvReL(3,2,6),& 
& cplcUFeChaSvReR(3,2,6),cplcUFeChiSeL(3,5,6),cplcUFeChiSeR(3,5,6),cplcUFeFeAhL(3,3,3),  & 
& cplcUFeFeAhR(3,3,3),cplcUFeFehhL(3,3,3),cplcUFeFehhR(3,3,3),cplcUFeFeVPL(3,3),         & 
& cplcUFeFeVPR(3,3),cplcUFeFeVZL(3,3),cplcUFeFeVZR(3,3),cplcUFeFvHpmL(3,6,2),            & 
& cplcUFeFvHpmR(3,6,2),cplcUFeFvVWmL(3,6),cplcUFeFvVWmR(3,6),cplcUFuChiSuL(3,5,6),       & 
& cplcUFuChiSuR(3,5,6),cplcUFuFdcHpmL(3,3,2),cplcUFuFdcHpmR(3,3,2),cplcUFuFdcVWmL(3,3),  & 
...
& cplcVWmVWmVZVZ1,cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,cplFvChacUSeL(6,2,6),cplFvChacUSeR(6,2,6),& 
& cplFvFecUHpmL(6,3,2),cplFvFecUHpmR(6,3,2),cplFvFecVWmL(6,3),cplFvFecVWmR(6,3),         & 
& cplFvFvUAhL(6,6,3),cplFvFvUAhR(6,6,3),cplFvFvUhhL(6,6,3),cplFvFvUhhR(6,6,3),           & 
& cplFvFvVZL(6,6),cplFvFvVZR(6,6),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),cplGluFdcUSdL(3,6),& 
& cplGluFdcUSdR(3,6),cplGluFucSuL(3,6),cplGluFucSuR(3,6),cplGluFucUSuL(3,6),             & 
& cplGluFucUSuR(3,6),cplGluGluVGL,cplGluGluVGR,cplhhcUHpmVWm(3,2),cplhhcVWmVWm(3),       & 
& cplhhhhcVWmVWm(3,3),cplhhhhUHpmcUHpm(3,3,2,2),cplhhhhUSdcUSd(3,3,6,6),cplhhhhUSecUSe(3,3,6,6),& 
& cplhhhhUSucUSu(3,3,6,6),cplhhhhUSvImUSvIm(3,3,6,6),cplhhhhUSvReUSvRe(3,3,6,6),         & 
& cplhhhhVZVZ(3,3),cplhhHpmcUHpm(3,2,2),cplhhHpmcVWm(3,2),cplhhSdcUSd(3,6,6),            & 
& cplhhSecUSe(3,6,6),cplhhSucUSu(3,6,6),cplhhSvImUSvRe(3,6,6),cplhhUSvImSvIm(3,6,6),     & 
& cplhhUSvImSvRe(3,6,6),cplhhUSvReSvRe(3,6,6),cplhhVZVZ(3),cplHpmcHpmcVWmVWm(2,2),       & 
...
& cplHpmcVWmVZ(2),cplHpmSucUSd(2,6,6),cplHpmSvImcUSe(2,6,6),cplHpmSvRecUSe(2,6,6),       & 
& cplHpmUSdcHpmcUSd(2,6,2,6),cplHpmUSecHpmcUSe(2,6,2,6),cplHpmUSucHpmcUSu(2,6,2,6),      & 
& cplHpmUSvImcSe(2,6,6),cplHpmUSvImUSvImcHpm(2,6,6,2),cplHpmUSvRecSe(2,6,6),             & 
& cplHpmUSvReUSvRecHpm(2,6,6,2),cplSdcHpmcUSu(6,2,6),cplSdcSdcVWmVWm(6,6),               & 
...
& cplSecSeVZ(6,6),cplSecSeVZVZ(6,6),cplSecUSeVP(6,6),cplSecUSeVZ(6,6),cplSeSvImcUHpm(6,6,2),& 
& cplSeSvImcVWm(6,6),cplSeSvRecUHpm(6,6,2),cplSeSvRecVWm(6,6),cplSeUSucSecUSu(6,6,6,6),  & 
& cplSeUSvImcVWm(6,6),cplSeUSvImUSvImcSe(6,6,6,6),cplSeUSvRecVWm(6,6),cplSeUSvReUSvRecSe(6,6,6,6),& 
...
& cplSucUSuVP(6,6),cplSucUSuVZ(6,6),cplSuUSvImUSvImcSu(6,6,6,6),cplSuUSvReUSvRecSu(6,6,6,6),& 
& cplSvImcUSeVWm(6,6),cplSvImSvImcVWmVWm(6,6),cplSvImSvImUSvReUSvRe(6,6,6,6),            & 
& cplSvImSvImVZVZ(6,6),cplSvImSvReVZ(6,6),cplSvImUSvReVZ(6,6),cplSvRecUSeVWm(6,6),       & 
& cplSvReSvRecVWmVWm(6,6),cplSvReSvReVZVZ(6,6),cplUAhAhAh(3,3,3),cplUAhAhhh(3,3,3),      & 
& cplUAhhhhh(3,3,3),cplUAhhhVZ(3,3),cplUAhHpmcHpm(3,2,2),cplUAhHpmcVWm(3,2),             & 
& cplUAhSdcSd(3,6,6),cplUAhSecSe(3,6,6),cplUAhSucSu(3,6,6),cplUAhSvImSvIm(3,6,6),        & 
& cplUAhSvImSvRe(3,6,6),cplUAhSvReSvRe(3,6,6),cplUAhUAhAhAh(3,3,3,3),cplUAhUAhcVWmVWm(3,3),& 
& cplUAhUAhhhhh(3,3,3,3),cplUAhUAhHpmcHpm(3,3,2,2),cplUAhUAhSdcSd(3,3,6,6),              & 
& cplUAhUAhSecSe(3,3,6,6),cplUAhUAhSucSu(3,3,6,6),cplUAhUAhSvImSvIm(3,3,6,6),            & 
& cplUAhUAhSvReSvRe(3,3,6,6),cplUAhUAhVZVZ(3,3),cplUChiChacHpmL(5,2,2),cplUChiChacHpmR(5,2,2),& 
...
& cplUChiFucSuL(5,3,6),cplUChiFucSuR(5,3,6),cplUChiFvSvImL(5,6,6),cplUChiFvSvImR(5,6,6), & 
& cplUChiFvSvReL(5,6,6),cplUChiFvSvReR(5,6,6),cplUFvChacSeL(6,2,6),cplUFvChacSeR(6,2,6), & 
...
& cplUFvFvVZL(6,6),cplUFvFvVZR(6,6),cplUhhcVWmVWm(3),cplUhhhhhh(3,3,3),cplUhhHpmcHpm(3,2,2),& 
& cplUhhHpmcVWm(3,2),cplUhhSdcSd(3,6,6),cplUhhSecSe(3,6,6),cplUhhSucSu(3,6,6),           & 
& cplUhhSvImSvIm(3,6,6),cplUhhSvImSvRe(3,6,6),cplUhhSvReSvRe(3,6,6),cplUhhUhhcVWmVWm(3,3),& 
& cplUhhUhhhhhh(3,3,3,3),cplUhhUhhHpmcHpm(3,3,2,2),cplUhhUhhSdcSd(3,3,6,6),              & 
& cplUhhUhhSecSe(3,3,6,6),cplUhhUhhSucSu(3,3,6,6),cplUhhUhhSvImSvIm(3,3,6,6),            & 
& cplUhhUhhSvReSvRe(3,3,6,6),cplUhhUhhVZVZ(3,3),cplUhhVZVZ(3),cplUHpmcUHpmcVWmVWm(2,2),  & 
...
& cplUSdSecUSdcSe(6,6,6,6),cplUSdSucUSdcSu(6,6,6,6),cplUSdSvImSvImcUSd(6,6,6,6),         & 
& cplUSdSvReSvRecUSd(6,6,6,6),cplUSecUSecVWmVWm(6,6),cplUSecUSeVPVP(6,6),cplUSecUSeVZVZ(6,6)

Complex(dp) :: cplUSeSecUSecSe(6,6,6,6),cplUSeSucUSecSu(6,6,6,6),cplUSeSvImSvImcUSe(6,6,6,6),         & 
& cplUSeSvReSvRecUSe(6,6,6,6),cplUSucUSucVWmVWm(6,6),cplUSucUSuVGVG(6,6),cplUSucUSuVPVP(6,6),& 
& cplUSucUSuVZVZ(6,6),cplUSuSucUSucSu(6,6,6,6),cplUSuSvImSvImcUSu(6,6,6,6),              & 
& cplUSuSvReSvRecUSu(6,6,6,6),cplUSvImSvReVZ(6,6),cplUSvImUSvImcVWmVWm(6,6),             & 
& cplUSvImUSvImSvImSvIm(6,6,6,6),cplUSvImUSvImSvReSvRe(6,6,6,6),cplUSvImUSvImVZVZ(6,6),  & 
& cplUSvReUSvRecVWmVWm(6,6),cplUSvReUSvReSvReSvRe(6,6,6,6),cplUSvReUSvReVZVZ(6,6),       & 
...
& ZN,ZDL,ZDR,g3,pG,vd,ZH,Tu,ZU,ZP,TW,Ye,ZE,ZVI,ZVR,kap,lamN,TLN,Yv,Tv,ZEL,               & 
& ZER,UV,Te,Tlam,Tk,cplAhSdcUSd,cplChaFucUSdL,cplChaFucUSdR,cplChiFdcUSdL,               & 
...
CASE ( 1 , 2 ) 
  ! Make sure that there are no exactly degenerated masses! 
   ...
   TLN_saveEP =TLN
   where (aint(Abs(TLN)).eq.TLN) TLN=TLN*(1 + 8*1.0E-12_dp)
   Tu_saveEP =Tu
   where (aint(Abs(Tu)).eq.Tu) Tu=Tu*(1 + 9*1.0E-12_dp)
   Tv_saveEP =Tv
...
& Td,Te,Tlam,Tk,TLN,Tu,Tv,mq2,ml2,mHd2,mHu2,md2,mu2,me2,mv2,ms2,M1,M2,M3,kont,           & 
& ti_ep2L,Pi2S_EffPot,PiP2S_EffPot)

Else 
Call CalculatePi2S(0._dp,vd,vu,vS,g1,g2,g3,Yd,Ye,lam,kap,lamN,Yu,Yv,Td,               & 
& Te,Tlam,Tk,TLN,Tu,Tv,mq2,ml2,mHd2,mHu2,md2,mu2,me2,mv2,ms2,M1,M2,M3,kont,              & 
& ti_ep2L,Pi2S_EffPot,PiP2S_EffPot)
...
End if 
Call SolveTadpoleEquations(g1,g2,g3,Yd,Ye,lam,kap,lamN,Yu,Yv,Td,Te,Tlam,              & 
& Tk,TLN,Tu,Tv,mq2,ml2,mHd2,mHu2,md2,mu2,me2,mv2,ms2,M1,M2,M3,vd,vu,vS,Tad1Loop)
...
Call OneLoopSvIm(g1,g2,lam,kap,lamN,TLN,Yv,Tv,ml2,mv2,vd,vu,vS,MSvIm,MSvIm2,          & 
& MAh,MAh2,MSvRe,MSvRe2,MFe,MFe2,MCha,MCha2,MFv,MFv2,MChi,MChi2,Mhh,Mhh2,MSe,            & 
& MSe2,MHpm,MHpm2,MVWm,MVWm2,MVZ,MVZ2,MSd,MSd2,MSu,MSu2,cplAhUSvImSvIm,cplAhUSvImSvRe,   & 
& cplcFeChaUSvImL,cplcFeChaUSvImR,cplChiFvUSvImL,cplChiFvUSvImR,cplhhUSvImSvIm,          & 
& cplhhUSvImSvRe,cplHpmUSvImcSe,cplSeUSvImcVWm,cplUSvImSvReVZ,cplAhAhUSvImUSvIm,         & 
& cplhhhhUSvImUSvIm,cplHpmUSvImUSvImcHpm,cplSdUSvImUSvImcSd,cplSeUSvImUSvImcSe,          & 
& cplSuUSvImUSvImcSu,cplUSvImUSvImSvImSvIm,cplUSvImUSvImSvReSvRe,cplUSvImUSvImcVWmVWm,   & 
& cplUSvImUSvImVZVZ,0.1_dp*delta_mass,MSvIm_1L,MSvIm2_1L,ZVI_1L,kont)

Call OneLoopSvRe(g1,g2,lam,kap,lamN,TLN,Yv,Tv,ml2,mv2,vd,vu,vS,MSvIm,MSvIm2,          & 
& MAh,MAh2,MSvRe,MSvRe2,MFe,MFe2,MCha,MCha2,MFv,MFv2,MChi,MChi2,Mhh,Mhh2,MSe,            & 
& MSe2,MHpm,MHpm2,MVWm,MVWm2,MVZ,MVZ2,MSd,MSd2,MSu,MSu2,cplAhSvImUSvRe,cplAhUSvReSvRe,   & 
& cplcFeChaUSvReL,cplcFeChaUSvReR,cplChiFvUSvReL,cplChiFvUSvReR,cplhhSvImUSvRe,          & 
& cplhhUSvReSvRe,cplHpmUSvRecSe,cplSeUSvRecVWm,cplSvImUSvReVZ,cplAhAhUSvReUSvRe,         & 
& cplhhhhUSvReUSvRe,cplHpmUSvReUSvRecHpm,cplSdUSvReUSvRecSd,cplSeUSvReUSvRecSe,          & 
& cplSuUSvReUSvRecSu,cplSvImSvImUSvReUSvRe,cplUSvReUSvReSvReSvRe,cplUSvReUSvRecVWmVWm,   & 
& cplUSvReUSvReVZVZ,0.1_dp*delta_mass,MSvRe_1L,MSvRe2_1L,ZVR_1L,kont)
...
Call OneLoopFv(lamN,Yv,vu,vS,MFv,MFv2,MAh,MAh2,MSe,MSe2,MCha,MCha2,MSvIm,             & 
...
& cplFvFvUhhR(6,6,3),cplcgWmgWmUhh(3),cplcgWpCgWpCUhh(3),cplcgZgZUhh(3),cplUhhhhhh(3,3,3),& 
& cplUhhHpmcHpm(3,2,2),cplUhhSdcSd(3,6,6),cplUhhSecSe(3,6,6),cplUhhSucSu(3,6,6),         & 
& cplUhhSvImSvIm(3,6,6),cplUhhSvReSvRe(3,6,6),cplUhhcVWmVWm(3),cplUhhVZVZ(3)
...
& MVZ,MVZ2,MVWm,MVWm2,MSe(6),MSe2(6),MSvIm(6),MSvIm2(6),MSvRe(6),MSvRe2(6)
...
If ((Include_in_loopSd).and.(Include_in_loopAh)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 3
...
If ((Include_in_loopFu).and.(Include_in_loopCha)) Then 
    Do i1 = 1, 3
       Do i2 = 1, 2
...
If ((Include_in_loopFd).and.(Include_in_loopChi)) Then 
    Do i1 = 1, 3
       Do i2 = 1, 5
...
If ((Include_in_loopGlu).and.(Include_in_loopFd)) Then 
      Do i2 = 1, 3
...
If ((Include_in_loopSd).and.(Include_in_loophh)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 3
...
If ((Include_in_loopSu).and.(Include_in_loopHpm)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 2
...
If ((Include_in_loopVG).and.(Include_in_loopSd)) Then 
      Do i2 = 1, 6
...
If ((Include_in_loopVP).and.(Include_in_loopSd)) Then 
      Do i2 = 1, 6
 F0m2 = FloopRXi(p2,MSd2(i2),0._dp) 
Do gO1 = 1, 6
  Do gO2 = gO1, 6
...
If ((Include_in_loopVZ).and.(Include_in_loopSd)) Then 
      Do i2 = 1, 6
...
If ((Include_in_loopVWm).and.(Include_in_loopSu)) Then 
      Do i2 = 1, 6
...
Subroutine OneLoopSvIm(g1,g2,lam,kap,lamN,TLN,Yv,Tv,ml2,mv2,vd,vu,vS,MSvIm,           & 
& MSvIm2,MAh,MAh2,MSvRe,MSvRe2,MFe,MFe2,MCha,MCha2,MFv,MFv2,MChi,MChi2,Mhh,              & 
& Mhh2,MSe,MSe2,MHpm,MHpm2,MVWm,MVWm2,MVZ,MVZ2,MSd,MSd2,MSu,MSu2,cplAhUSvImSvIm,         & 
& cplAhUSvImSvRe,cplcFeChaUSvImL,cplcFeChaUSvImR,cplChiFvUSvImL,cplChiFvUSvImR,          & 
& cplhhUSvImSvIm,cplhhUSvImSvRe,cplHpmUSvImcSe,cplSeUSvImcVWm,cplUSvImSvReVZ,            & 
& cplAhAhUSvImUSvIm,cplhhhhUSvImUSvIm,cplHpmUSvImUSvImcHpm,cplSdUSvImUSvImcSd,           & 
& cplSeUSvImUSvImcSe,cplSuUSvImUSvImcSu,cplUSvImUSvImSvImSvIm,cplUSvImUSvImSvReSvRe,     & 
& cplUSvImUSvImcVWmVWm,cplUSvImUSvImVZVZ,delta,mass,mass2,RS,kont)

Implicit None 
Real(dp), Intent(in) :: MSvIm(6),MSvIm2(6),MAh(3),MAh2(3),MSvRe(6),MSvRe2(6),MFe(3),MFe2(3),MCha(2),          & 
& MCha2(2),MFv(6),MFv2(6),MChi(5),MChi2(5),Mhh(3),Mhh2(3),MSe(6),MSe2(6),MHpm(2),        & 
...
Complex(dp), Intent(in) :: cplAhUSvImSvIm(3,6,6),cplAhUSvImSvRe(3,6,6),cplcFeChaUSvImL(3,2,6),cplcFeChaUSvImR(3,2,6),& 
& cplChiFvUSvImL(5,6,6),cplChiFvUSvImR(5,6,6),cplhhUSvImSvIm(3,6,6),cplhhUSvImSvRe(3,6,6),& 
& cplHpmUSvImcSe(2,6,6),cplSeUSvImcVWm(6,6),cplUSvImSvReVZ(6,6),cplAhAhUSvImUSvIm(3,3,6,6),& 
& cplhhhhUSvImUSvIm(3,3,6,6),cplHpmUSvImUSvImcHpm(2,6,6,2),cplSdUSvImUSvImcSd(6,6,6,6),  & 
& cplSeUSvImUSvImcSe(6,6,6,6),cplSuUSvImUSvImcSu(6,6,6,6),cplUSvImUSvImSvImSvIm(6,6,6,6),& 
& cplUSvImUSvImSvReSvRe(6,6,6,6),cplUSvImUSvImcVWmVWm(6,6),cplUSvImUSvImVZVZ(6,6)
...
Do j1 = 1,3
mat2a(1,4) = mat2a(1,4)-(vS*vu*Conjg(lamN(1,j1))*Yv(j1,1))/4._dp
End Do 
Do j1 = 1,3
mat2a(1,4) = mat2a(1,4)-(vS*vu*Conjg(lamN(j1,1))*Yv(j1,1))/4._dp
End Do 
Do j1 = 1,3
mat2a(1,4) = mat2a(1,4)-(vS*vu*Conjg(Yv(j1,1))*lamN(1,j1))/4._dp
End Do 
Do j1 = 1,3
mat2a(1,4) = mat2a(1,4)-(vS*vu*Conjg(Yv(j1,1))*lamN(j1,1))/4._dp
End Do 
...
Do j1 = 1,3
mat2a(1,5) = mat2a(1,5)-(vS*vu*Conjg(lamN(2,j1))*Yv(j1,1))/4._dp
End Do 
Do j1 = 1,3
mat2a(1,5) = mat2a(1,5)-(vS*vu*Conjg(lamN(j1,2))*Yv(j1,1))/4._dp
End Do 
Do j1 = 1,3
mat2a(1,5) = mat2a(1,5)-(vS*vu*Conjg(Yv(j1,1))*lamN(2,j1))/4._dp
End Do 
Do j1 = 1,3
mat2a(1,5) = mat2a(1,5)-(vS*vu*Conjg(Yv(j1,1))*lamN(j1,2))/4._dp
End Do 
...
Do j1 = 1,3
mat2a(1,6) = mat2a(1,6)-(vS*vu*Conjg(lamN(3,j1))*Yv(j1,1))/4._dp
End Do 
Do j1 = 1,3
mat2a(1,6) = mat2a(1,6)-(vS*vu*Conjg(lamN(j1,3))*Yv(j1,1))/4._dp
End Do 
Do j1 = 1,3
mat2a(1,6) = mat2a(1,6)-(vS*vu*Conjg(Yv(j1,1))*lamN(3,j1))/4._dp
End Do 
Do j1 = 1,3
mat2a(1,6) = mat2a(1,6)-(vS*vu*Conjg(Yv(j1,1))*lamN(j1,3))/4._dp
End Do 
...
Do j1 = 1,3
mat2a(2,4) = mat2a(2,4)-(vS*vu*Conjg(lamN(1,j1))*Yv(j1,2))/4._dp
End Do 
Do j1 = 1,3
mat2a(2,4) = mat2a(2,4)-(vS*vu*Conjg(lamN(j1,1))*Yv(j1,2))/4._dp
End Do 
Do j1 = 1,3
mat2a(2,4) = mat2a(2,4)-(vS*vu*Conjg(Yv(j1,2))*lamN(1,j1))/4._dp
End Do 
Do j1 = 1,3
mat2a(2,4) = mat2a(2,4)-(vS*vu*Conjg(Yv(j1,2))*lamN(j1,1))/4._dp
End Do 
...
Do j1 = 1,3
mat2a(2,5) = mat2a(2,5)-(vS*vu*Conjg(lamN(2,j1))*Yv(j1,2))/4._dp
End Do 
Do j1 = 1,3
mat2a(2,5) = mat2a(2,5)-(vS*vu*Conjg(lamN(j1,2))*Yv(j1,2))/4._dp
End Do 
Do j1 = 1,3
mat2a(2,5) = mat2a(2,5)-(vS*vu*Conjg(Yv(j1,2))*lamN(2,j1))/4._dp
End Do 
Do j1 = 1,3
mat2a(2,5) = mat2a(2,5)-(vS*vu*Conjg(Yv(j1,2))*lamN(j1,2))/4._dp
End Do 
...
Do j1 = 1,3
mat2a(2,6) = mat2a(2,6)-(vS*vu*Conjg(lamN(3,j1))*Yv(j1,2))/4._dp
End Do 
Do j1 = 1,3
mat2a(2,6) = mat2a(2,6)-(vS*vu*Conjg(lamN(j1,3))*Yv(j1,2))/4._dp
End Do 
Do j1 = 1,3
mat2a(2,6) = mat2a(2,6)-(vS*vu*Conjg(Yv(j1,2))*lamN(3,j1))/4._dp
End Do 
Do j1 = 1,3
mat2a(2,6) = mat2a(2,6)-(vS*vu*Conjg(Yv(j1,2))*lamN(j1,3))/4._dp
End Do 
...
Do j1 = 1,3
mat2a(3,4) = mat2a(3,4)-(vS*vu*Conjg(lamN(1,j1))*Yv(j1,3))/4._dp
End Do 
Do j1 = 1,3
mat2a(3,4) = mat2a(3,4)-(vS*vu*Conjg(lamN(j1,1))*Yv(j1,3))/4._dp
End Do 
Do j1 = 1,3
mat2a(3,4) = mat2a(3,4)-(vS*vu*Conjg(Yv(j1,3))*lamN(1,j1))/4._dp
End Do 
Do j1 = 1,3
mat2a(3,4) = mat2a(3,4)-(vS*vu*Conjg(Yv(j1,3))*lamN(j1,1))/4._dp
End Do 
...
Do j1 = 1,3
mat2a(3,5) = mat2a(3,5)-(vS*vu*Conjg(lamN(2,j1))*Yv(j1,3))/4._dp
End Do 
Do j1 = 1,3
mat2a(3,5) = mat2a(3,5)-(vS*vu*Conjg(lamN(j1,2))*Yv(j1,3))/4._dp
End Do 
Do j1 = 1,3
mat2a(3,5) = mat2a(3,5)-(vS*vu*Conjg(Yv(j1,3))*lamN(2,j1))/4._dp
End Do 
Do j1 = 1,3
mat2a(3,5) = mat2a(3,5)-(vS*vu*Conjg(Yv(j1,3))*lamN(j1,2))/4._dp
End Do 
...
Do j1 = 1,3
mat2a(3,6) = mat2a(3,6)-(vS*vu*Conjg(lamN(3,j1))*Yv(j1,3))/4._dp
End Do 
Do j1 = 1,3
mat2a(3,6) = mat2a(3,6)-(vS*vu*Conjg(lamN(j1,3))*Yv(j1,3))/4._dp
End Do 
Do j1 = 1,3
mat2a(3,6) = mat2a(3,6)-(vS*vu*Conjg(Yv(j1,3))*lamN(3,j1))/4._dp
End Do 
Do j1 = 1,3
mat2a(3,6) = mat2a(3,6)-(vS*vu*Conjg(Yv(j1,3))*lamN(j1,3))/4._dp
End Do 
mat2a(3,6) = mat2a(3,6)-(vd*vS*Conjg(lam)*Yv(3,3))/4._dp
mat2a(3,6) = mat2a(3,6)+(vu*Tv(3,3))/(2._dp*sqrt(2._dp))
mat2a(4,4) = 0._dp 
mat2a(4,4) = mat2a(4,4)-(vS**2*kap*Conjg(lamN(1,1)))/2._dp
mat2a(4,4) = mat2a(4,4)+(vd*vu*lam*Conjg(lamN(1,1)))/2._dp
mat2a(4,4) = mat2a(4,4)-((vS*Conjg(TLN(1,1)))/sqrt(2._dp))
...
End Do 
Do j1 = 1,3
mat2a(4,4) = mat2a(4,4)+(vS**2*Conjg(lamN(j1,1))*lamN(1,j1))/2._dp
End Do 
Do j1 = 1,3
mat2a(4,4) = mat2a(4,4)+(vS**2*Conjg(lamN(1,j1))*lamN(j1,1))/2._dp
End Do 
Do j1 = 1,3
mat2a(4,4) = mat2a(4,4)+(vS**2*Conjg(lamN(j1,1))*lamN(j1,1))/2._dp
End Do 
mat2a(4,4) = mat2a(4,4)-(vS**2*Conjg(kap)*lamN(1,1))/2._dp
mat2a(4,4) = mat2a(4,4)+(vd*vu*Conjg(lam)*lamN(1,1))/2._dp
mat2a(4,4) = mat2a(4,4)-((vS*TLN(1,1))/sqrt(2._dp))
mat2a(4,5) = 0._dp 
mat2a(4,5) = mat2a(4,5)-(vS**2*kap*Conjg(lamN(1,2)))/4._dp
mat2a(4,5) = mat2a(4,5)+(vd*vu*lam*Conjg(lamN(1,2)))/4._dp
mat2a(4,5) = mat2a(4,5)-(vS**2*kap*Conjg(lamN(2,1)))/4._dp
mat2a(4,5) = mat2a(4,5)+(vd*vu*lam*Conjg(lamN(2,1)))/4._dp
mat2a(4,5) = mat2a(4,5)-(vS*Conjg(TLN(1,2)))/(2._dp*sqrt(2._dp))
mat2a(4,5) = mat2a(4,5)-(vS*Conjg(TLN(2,1)))/(2._dp*sqrt(2._dp))
...
End Do 
Do j1 = 1,3
mat2a(4,5) = mat2a(4,5)+(vS**2*Conjg(lamN(j1,2))*lamN(1,j1))/4._dp
End Do 
Do j1 = 1,3
mat2a(4,5) = mat2a(4,5)+(vS**2*Conjg(lamN(1,j1))*lamN(2,j1))/4._dp
End Do 
Do j1 = 1,3
mat2a(4,5) = mat2a(4,5)+(vS**2*Conjg(lamN(j1,1))*lamN(2,j1))/4._dp
End Do 
Do j1 = 1,3
mat2a(4,5) = mat2a(4,5)+(vS**2*Conjg(lamN(2,j1))*lamN(j1,1))/4._dp
End Do 
Do j1 = 1,3
mat2a(4,5) = mat2a(4,5)+(vS**2*Conjg(lamN(j1,2))*lamN(j1,1))/4._dp
End Do 
Do j1 = 1,3
mat2a(4,5) = mat2a(4,5)+(vS**2*Conjg(lamN(1,j1))*lamN(j1,2))/4._dp
End Do 
Do j1 = 1,3
mat2a(4,5) = mat2a(4,5)+(vS**2*Conjg(lamN(j1,1))*lamN(j1,2))/4._dp
End Do 
mat2a(4,5) = mat2a(4,5)-(vS**2*Conjg(kap)*lamN(1,2))/4._dp
mat2a(4,5) = mat2a(4,5)+(vd*vu*Conjg(lam)*lamN(1,2))/4._dp
mat2a(4,5) = mat2a(4,5)-(vS**2*Conjg(kap)*lamN(2,1))/4._dp
mat2a(4,5) = mat2a(4,5)+(vd*vu*Conjg(lam)*lamN(2,1))/4._dp
mat2a(4,5) = mat2a(4,5)-(vS*TLN(1,2))/(2._dp*sqrt(2._dp))
mat2a(4,5) = mat2a(4,5)-(vS*TLN(2,1))/(2._dp*sqrt(2._dp))
mat2a(4,6) = 0._dp 
mat2a(4,6) = mat2a(4,6)-(vS**2*kap*Conjg(lamN(1,3)))/4._dp
mat2a(4,6) = mat2a(4,6)+(vd*vu*lam*Conjg(lamN(1,3)))/4._dp
mat2a(4,6) = mat2a(4,6)-(vS**2*kap*Conjg(lamN(3,1)))/4._dp
mat2a(4,6) = mat2a(4,6)+(vd*vu*lam*Conjg(lamN(3,1)))/4._dp
mat2a(4,6) = mat2a(4,6)-(vS*Conjg(TLN(1,3)))/(2._dp*sqrt(2._dp))
mat2a(4,6) = mat2a(4,6)-(vS*Conjg(TLN(3,1)))/(2._dp*sqrt(2._dp))
...
End Do 
Do j1 = 1,3
mat2a(4,6) = mat2a(4,6)+(vS**2*Conjg(lamN(j1,3))*lamN(1,j1))/4._dp
End Do 
Do j1 = 1,3
mat2a(4,6) = mat2a(4,6)+(vS**2*Conjg(lamN(1,j1))*lamN(3,j1))/4._dp
End Do 
Do j1 = 1,3
mat2a(4,6) = mat2a(4,6)+(vS**2*Conjg(lamN(j1,1))*lamN(3,j1))/4._dp
End Do 
Do j1 = 1,3
mat2a(4,6) = mat2a(4,6)+(vS**2*Conjg(lamN(3,j1))*lamN(j1,1))/4._dp
End Do 
Do j1 = 1,3
mat2a(4,6) = mat2a(4,6)+(vS**2*Conjg(lamN(j1,3))*lamN(j1,1))/4._dp
End Do 
Do j1 = 1,3
mat2a(4,6) = mat2a(4,6)+(vS**2*Conjg(lamN(1,j1))*lamN(j1,3))/4._dp
End Do 
Do j1 = 1,3
mat2a(4,6) = mat2a(4,6)+(vS**2*Conjg(lamN(j1,1))*lamN(j1,3))/4._dp
End Do 
mat2a(4,6) = mat2a(4,6)-(vS**2*Conjg(kap)*lamN(1,3))/4._dp
mat2a(4,6) = mat2a(4,6)+(vd*vu*Conjg(lam)*lamN(1,3))/4._dp
mat2a(4,6) = mat2a(4,6)-(vS**2*Conjg(kap)*lamN(3,1))/4._dp
mat2a(4,6) = mat2a(4,6)+(vd*vu*Conjg(lam)*lamN(3,1))/4._dp
mat2a(4,6) = mat2a(4,6)-(vS*TLN(1,3))/(2._dp*sqrt(2._dp))
mat2a(4,6) = mat2a(4,6)-(vS*TLN(3,1))/(2._dp*sqrt(2._dp))
mat2a(5,5) = 0._dp 
mat2a(5,5) = mat2a(5,5)-(vS**2*kap*Conjg(lamN(2,2)))/2._dp
mat2a(5,5) = mat2a(5,5)+(vd*vu*lam*Conjg(lamN(2,2)))/2._dp
mat2a(5,5) = mat2a(5,5)-((vS*Conjg(TLN(2,2)))/sqrt(2._dp))
...
End Do 
Do j1 = 1,3
mat2a(5,5) = mat2a(5,5)+(vS**2*Conjg(lamN(j1,2))*lamN(2,j1))/2._dp
End Do 
Do j1 = 1,3
mat2a(5,5) = mat2a(5,5)+(vS**2*Conjg(lamN(2,j1))*lamN(j1,2))/2._dp
End Do 
Do j1 = 1,3
mat2a(5,5) = mat2a(5,5)+(vS**2*Conjg(lamN(j1,2))*lamN(j1,2))/2._dp
End Do 
mat2a(5,5) = mat2a(5,5)-(vS**2*Conjg(kap)*lamN(2,2))/2._dp
mat2a(5,5) = mat2a(5,5)+(vd*vu*Conjg(lam)*lamN(2,2))/2._dp
mat2a(5,5) = mat2a(5,5)-((vS*TLN(2,2))/sqrt(2._dp))
mat2a(5,6) = 0._dp 
mat2a(5,6) = mat2a(5,6)-(vS**2*kap*Conjg(lamN(2,3)))/4._dp
mat2a(5,6) = mat2a(5,6)+(vd*vu*lam*Conjg(lamN(2,3)))/4._dp
mat2a(5,6) = mat2a(5,6)-(vS**2*kap*Conjg(lamN(3,2)))/4._dp
mat2a(5,6) = mat2a(5,6)+(vd*vu*lam*Conjg(lamN(3,2)))/4._dp
mat2a(5,6) = mat2a(5,6)-(vS*Conjg(TLN(2,3)))/(2._dp*sqrt(2._dp))
mat2a(5,6) = mat2a(5,6)-(vS*Conjg(TLN(3,2)))/(2._dp*sqrt(2._dp))
...
End Do 
Do j1 = 1,3
mat2a(5,6) = mat2a(5,6)+(vS**2*Conjg(lamN(j1,3))*lamN(2,j1))/4._dp
End Do 
Do j1 = 1,3
mat2a(5,6) = mat2a(5,6)+(vS**2*Conjg(lamN(2,j1))*lamN(3,j1))/4._dp
End Do 
Do j1 = 1,3
mat2a(5,6) = mat2a(5,6)+(vS**2*Conjg(lamN(j1,2))*lamN(3,j1))/4._dp
End Do 
Do j1 = 1,3
mat2a(5,6) = mat2a(5,6)+(vS**2*Conjg(lamN(3,j1))*lamN(j1,2))/4._dp
End Do 
Do j1 = 1,3
mat2a(5,6) = mat2a(5,6)+(vS**2*Conjg(lamN(j1,3))*lamN(j1,2))/4._dp
End Do 
Do j1 = 1,3
mat2a(5,6) = mat2a(5,6)+(vS**2*Conjg(lamN(2,j1))*lamN(j1,3))/4._dp
End Do 
Do j1 = 1,3
mat2a(5,6) = mat2a(5,6)+(vS**2*Conjg(lamN(j1,2))*lamN(j1,3))/4._dp
End Do 
mat2a(5,6) = mat2a(5,6)-(vS**2*Conjg(kap)*lamN(2,3))/4._dp
mat2a(5,6) = mat2a(5,6)+(vd*vu*Conjg(lam)*lamN(2,3))/4._dp
mat2a(5,6) = mat2a(5,6)-(vS**2*Conjg(kap)*lamN(3,2))/4._dp
mat2a(5,6) = mat2a(5,6)+(vd*vu*Conjg(lam)*lamN(3,2))/4._dp
mat2a(5,6) = mat2a(5,6)-(vS*TLN(2,3))/(2._dp*sqrt(2._dp))
mat2a(5,6) = mat2a(5,6)-(vS*TLN(3,2))/(2._dp*sqrt(2._dp))
mat2a(6,6) = 0._dp 
mat2a(6,6) = mat2a(6,6)-(vS**2*kap*Conjg(lamN(3,3)))/2._dp
mat2a(6,6) = mat2a(6,6)+(vd*vu*lam*Conjg(lamN(3,3)))/2._dp
mat2a(6,6) = mat2a(6,6)-((vS*Conjg(TLN(3,3)))/sqrt(2._dp))
...
End Do 
Do j1 = 1,3
mat2a(6,6) = mat2a(6,6)+(vS**2*Conjg(lamN(j1,3))*lamN(3,j1))/2._dp
End Do 
Do j1 = 1,3
mat2a(6,6) = mat2a(6,6)+(vS**2*Conjg(lamN(3,j1))*lamN(j1,3))/2._dp
End Do 
Do j1 = 1,3
mat2a(6,6) = mat2a(6,6)+(vS**2*Conjg(lamN(j1,3))*lamN(j1,3))/2._dp
End Do 
mat2a(6,6) = mat2a(6,6)-(vS**2*Conjg(kap)*lamN(3,3))/2._dp
mat2a(6,6) = mat2a(6,6)+(vd*vu*Conjg(lam)*lamN(3,3))/2._dp
mat2a(6,6) = mat2a(6,6)-((vS*TLN(3,3))/sqrt(2._dp))
...
If ((Include_in_loopSvIm).and.(Include_in_loopAh)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 3
...
If ((Include_in_loopSvRe).and.(Include_in_loopAh)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 3
...
If ((Include_in_loopFe).and.(Include_in_loopCha)) Then 
    Do i1 = 1, 3
       Do i2 = 1, 2
...
If ((Include_in_loopFv).and.(Include_in_loopChi)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 5
...
If ((Include_in_loopSvIm).and.(Include_in_loophh)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 3
...
If ((Include_in_loopSvRe).and.(Include_in_loophh)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 3
...
If ((Include_in_loopVZ).and.(Include_in_loopSvRe)) Then 
      Do i2 = 1, 6
...
Subroutine OneLoopSvRe(g1,g2,lam,kap,lamN,TLN,Yv,Tv,ml2,mv2,vd,vu,vS,MSvIm,           & 
& MSvIm2,MAh,MAh2,MSvRe,MSvRe2,MFe,MFe2,MCha,MCha2,MFv,MFv2,MChi,MChi2,Mhh,              & 
& Mhh2,MSe,MSe2,MHpm,MHpm2,MVWm,MVWm2,MVZ,MVZ2,MSd,MSd2,MSu,MSu2,cplAhSvImUSvRe,         & 
& cplAhUSvReSvRe,cplcFeChaUSvReL,cplcFeChaUSvReR,cplChiFvUSvReL,cplChiFvUSvReR,          & 
& cplhhSvImUSvRe,cplhhUSvReSvRe,cplHpmUSvRecSe,cplSeUSvRecVWm,cplSvImUSvReVZ,            & 
...
& cplUSvReUSvRecVWmVWm,cplUSvReUSvReVZVZ,delta,mass,mass2,RS,kont)
...
Complex(dp), Intent(in) :: cplAhSvImUSvRe(3,6,6),cplAhUSvReSvRe(3,6,6),cplcFeChaUSvReL(3,2,6),cplcFeChaUSvReR(3,2,6),& 
...
If ((Include_in_loopVZ).and.(Include_in_loopSvIm)) Then 
      Do i2 = 1, 6
...
& MVWm,MVWm2,MVZ,MVZ2,MSe(6),MSe2(6),MSvIm(6),MSvIm2(6),MSvRe(6),MSvRe2(6)
...
& cplUSuSvImSvImcUSu(6,6,6,6),cplUSuSvReSvRecUSu(6,6,6,6),cplUSucUSuVGVG(6,6),           & 
...
If ((Include_in_loopSu).and.(Include_in_loopAh)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 3
...
If ((Include_in_loopFu).and.(Include_in_loopChi)) Then 
    Do i1 = 1, 3
       Do i2 = 1, 5
...
If ((Include_in_loopCha).and.(Include_in_loopFd)) Then 
    Do i1 = 1, 2
       Do i2 = 1, 3
...
If ((Include_in_loopGlu).and.(Include_in_loopFu)) Then 
      Do i2 = 1, 3
...
If ((Include_in_loopSu).and.(Include_in_loophh)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 3
...
If ((Include_in_loopVWm).and.(Include_in_loopSd)) Then 
      Do i2 = 1, 6
...
If ((Include_in_loopVG).and.(Include_in_loopSu)) Then 
      Do i2 = 1, 6
...
If ((Include_in_loopVP).and.(Include_in_loopSu)) Then 
      Do i2 = 1, 6
 F0m2 = FloopRXi(p2,MSu2(i2),0._dp) 
Do gO1 = 1, 6
  Do gO2 = gO1, 6
...
If ((Include_in_loopVZ).and.(Include_in_loopSu)) Then 
      Do i2 = 1, 6
...
Implicit None 
Real(dp), Intent(in) :: MSe(6),MSe2(6),MAh(3),MAh2(3),MFv(6),MFv2(6),MCha(2),MCha2(2),MFe(3),MFe2(3),         & 
& MChi(5),MChi2(5),Mhh(3),Mhh2(3),MSvIm(6),MSvIm2(6),MHpm(2),MHpm2(2),MSvRe(6),          & 
& MSvRe2(6),MVZ,MVZ2,MVWm,MVWm2,MSd(6),MSd2(6),MSu(6),MSu2(6)

Real(dp), Intent(in) :: g1,g2,vd,vu,vS

Complex(dp), Intent(in) :: Ye(3,3),Te(3,3),lam,ml2(3,3),me2(3,3)

Complex(dp), Intent(in) :: cplAhSecUSe(3,6,6),cplFvChacUSeL(6,2,6),cplFvChacUSeR(6,2,6),cplChiFecUSeL(5,3,6),    & 
& cplChiFecUSeR(5,3,6),cplhhSecUSe(3,6,6),cplHpmSvImcUSe(2,6,6),cplHpmSvRecUSe(2,6,6),   & 
& cplSecUSeVP(6,6),cplSecUSeVZ(6,6),cplSvImcUSeVWm(6,6),cplSvRecUSeVWm(6,6),             & 
...
If ((Include_in_loopSe).and.(Include_in_loopAh)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 3
...
If ((Include_in_loopFv).and.(Include_in_loopCha)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 2
...
If ((Include_in_loopFe).and.(Include_in_loopChi)) Then 
    Do i1 = 1, 3
       Do i2 = 1, 5
...
If ((Include_in_loopSe).and.(Include_in_loophh)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 3
...
If ((Include_in_loopVP).and.(Include_in_loopSe)) Then 
      Do i2 = 1, 6
...
If ((Include_in_loopVZ).and.(Include_in_loopSe)) Then 
      Do i2 = 1, 6
...
If ((Include_in_loopVWm).and.(Include_in_loopSvIm)) Then 
      Do i2 = 1, 6
...
If ((Include_in_loopVWm).and.(Include_in_loopSvRe)) Then 
      Do i2 = 1, 6
...
& MFd(3),MFd2(3),MFe(3),MFe2(3),MFu(3),MFu2(3),MFv(6),MFv2(6),MHpm(2),MHpm2(2),          & 
& MVWm,MVWm2,MSd(6),MSd2(6),MSe(6),MSe2(6),MSu(6),MSu2(6),MSvIm(6),MSvIm2(6),            & 
& MSvRe(6),MSvRe2(6)
...
If ((Include_in_loopCha).and.(Include_in_loopCha)) Then 
    Do i1 = 1, 2
       Do i2 = 1, 2
...
If ((Include_in_loopChi).and.(Include_in_loopChi)) Then 
    Do i1 = 1, 5
       Do i2 = 1, 5
...
If ((Include_in_loopgWm).and.(Include_in_loopgWm)) Then 
...
If ((Include_in_loopgWpC).and.(Include_in_loopgWpC)) Then 
F0m2 = -Real(SA_B0(p2,MVWm2*RXi,MVWm2*RXi),dp) 
 Do gO1 = 1, 3
  Do gO2 = gO1, 3
...
If ((Include_in_loopSvRe).and.(Include_in_loopSvIm)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 6
...
& MFd2(3),MFe(3),MFe2(3),MFu(3),MFu2(3),MFv(6),MFv2(6),MVZ,MVZ2,MHpm(2),MHpm2(2),        & 
& MVWm,MVWm2,MSd(6),MSd2(6),MSe(6),MSe2(6),MSu(6),MSu2(6),MSvIm(6),MSvIm2(6),            & 
& MSvRe(6),MSvRe2(6)
...
& cplFvFvUAhL(6,6,3),cplFvFvUAhR(6,6,3),cplcgWmgWmUAh(3),cplcgWpCgWpCUAh(3),             & 
& cplUAhhhhh(3,3,3),cplUAhhhVZ(3,3),cplUAhHpmcHpm(3,2,2),cplUAhHpmcVWm(3,2),             & 
& cplUAhSdcSd(3,6,6),cplUAhSecSe(3,6,6),cplUAhSucSu(3,6,6),cplUAhSvImSvIm(3,6,6),        & 
& cplUAhSvImSvRe(3,6,6),cplUAhSvReSvRe(3,6,6),cplUAhUAhAhAh(3,3,3,3),cplUAhUAhhhhh(3,3,3,3),& 
& cplUAhUAhHpmcHpm(3,3,2,2),cplUAhUAhSdcSd(3,3,6,6),cplUAhUAhSecSe(3,3,6,6),             & 
& cplUAhUAhSucSu(3,3,6,6),cplUAhUAhSvImSvIm(3,3,6,6),cplUAhUAhSvReSvRe(3,3,6,6),         & 
...
& MFu(3),MFu2(3),MFd(3),MFd2(3),MFv(6),MFv2(6),MFe(3),MFe2(3),Mhh(3),Mhh2(3),            & 
& MVZ,MVZ2,MSu(6),MSu2(6),MSd(6),MSd2(6),MSvIm(6),MSvIm2(6),MSe(6),MSe2(6),              & 
& MSvRe(6),MSvRe2(6)
...
& cplSdcUHpmcSu(6,2,6),cplSeSvImcUHpm(6,6,2),cplSeSvRecUHpm(6,6,2),cplcUHpmVPVWm(2),     & 
& cplcUHpmVWmVZ(2),cplAhAhUHpmcUHpm(3,3,2,2),cplhhhhUHpmcUHpm(3,3,2,2),cplUHpmHpmcUHpmcHpm(2,2,2,2),& 
& cplUHpmSdcUHpmcSd(2,6,2,6),cplUHpmSecUHpmcSe(2,6,2,6),cplUHpmSucUHpmcSu(2,6,2,6),      & 
& cplUHpmSvImSvImcUHpm(2,6,6,2),cplUHpmSvReSvRecUHpm(2,6,6,2),cplUHpmcUHpmVPVP(2,2),     & 
...
If ((Include_in_loopHpm).and.(Include_in_loopAh)) Then 
    Do i1 = 1, 2
       Do i2 = 1, 3
...
If ((Include_in_loopVWm).and.(Include_in_loopAh)) Then 
      Do i2 = 1, 3
...
If ((Include_in_loopChi).and.(Include_in_loopCha)) Then 
    Do i1 = 1, 5
       Do i2 = 1, 2
...
If ((Include_in_loopgZ).and.(Include_in_loopgWm)) Then 
...
If ((Include_in_loopgWpC).and.(Include_in_loopgZ)) Then 
...
If ((Include_in_loopHpm).and.(Include_in_loophh)) Then 
    Do i1 = 1, 2
       Do i2 = 1, 3
...
If ((Include_in_loopVWm).and.(Include_in_loophh)) Then 
      Do i2 = 1, 3
...
If ((Include_in_loopVWm).and.(Include_in_loopVP)) Then 
...
& MFe(3),MFe2(3),MSu(6),MSu2(6),MFu(3),MFu2(3),MSvIm(6),MSvIm2(6),MFv(6),MFv2(6),        & 
& MSvRe(6),MSvRe2(6)
...
& cplUChiFvSvImL(5,6,6),cplUChiFvSvImR(5,6,6),cplUChiFvSvReL(5,6,6),cplUChiFvSvReR(5,6,6),& 
...
! Chi, Ah 
!------------------------ 
If ((Include_in_loopChi).and.(Include_in_loopAh)) Then 
    Do i1 = 1, 5
       Do i2 = 1, 3
 SumSL = 0._dp 
SumSR = 0._dp 
...
! conj[Hpm], Cha 
!------------------------ 
If ((Include_in_loopHpm).and.(Include_in_loopCha)) Then 
    Do i1 = 1, 2
       Do i2 = 1, 2
 SumSL = 0._dp 
SumSR = 0._dp 
...
! conj[VWm], Cha 
!------------------------ 
If ((Include_in_loopVWm).and.(Include_in_loopCha)) Then 
      Do i2 = 1, 2
 SumSL = 0._dp 
SumSR = 0._dp 
sumR = 0._dp 
...
! hh, Chi 
!------------------------ 
If ((Include_in_loophh).and.(Include_in_loopChi)) Then 
    Do i1 = 1, 3
       Do i2 = 1, 5
 SumSL = 0._dp 
SumSR = 0._dp 
...
! VZ, Chi 
!------------------------ 
If ((Include_in_loopVZ).and.(Include_in_loopChi)) Then 
      Do i2 = 1, 5
 SumSL = 0._dp 
SumSR = 0._dp 
sumR = 0._dp 
...
! conj[Sd], Fd 
!------------------------ 
If ((Include_in_loopSd).and.(Include_in_loopFd)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 3
 SumSL = 0._dp 
SumSR = 0._dp 
...
! conj[Se], Fe 
!------------------------ 
If ((Include_in_loopSe).and.(Include_in_loopFe)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 3
 SumSL = 0._dp 
SumSR = 0._dp 
...
! conj[Su], Fu 
!------------------------ 
If ((Include_in_loopSu).and.(Include_in_loopFu)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 3
 SumSL = 0._dp 
SumSR = 0._dp 
...
! SvIm, Fv 
!------------------------ 
If ((Include_in_loopSvIm).and.(Include_in_loopFv)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 6
 SumSL = 0._dp 
SumSR = 0._dp 
...
! SvRe, Fv 
!------------------------ 
If ((Include_in_loopSvRe).and.(Include_in_loopFv)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 6
 SumSL = 0._dp 
SumSR = 0._dp 
...
! bar[Cha], Hpm 
!------------------------ 
If ((Include_in_loopCha).and.(Include_in_loopHpm)) Then 
    Do i1 = 1, 2
       Do i2 = 1, 2
 SumSL = 0._dp 
SumSR = 0._dp 
...
! bar[Fd], Sd 
!------------------------ 
If ((Include_in_loopFd).and.(Include_in_loopSd)) Then 
    Do i1 = 1, 3
       Do i2 = 1, 6
 SumSL = 0._dp 
SumSR = 0._dp 
...
! bar[Fe], Se 
!------------------------ 
If ((Include_in_loopFe).and.(Include_in_loopSe)) Then 
    Do i1 = 1, 3
       Do i2 = 1, 6
 SumSL = 0._dp 
SumSR = 0._dp 
...
! bar[Fu], Su 
!------------------------ 
If ((Include_in_loopFu).and.(Include_in_loopSu)) Then 
    Do i1 = 1, 3
       Do i2 = 1, 6
 SumSL = 0._dp 
SumSR = 0._dp 
...
! bar[Cha], VWm 
!------------------------ 
If ((Include_in_loopCha).and.(Include_in_loopVWm)) Then 
    Do i1 = 1, 2
 SumSL = 0._dp 
SumSR = 0._dp 
sumR = 0._dp 
...
Subroutine OneLoopFv(lamN,Yv,vu,vS,MFv,MFv2,MAh,MAh2,MSe,MSe2,MCha,MCha2,             & 
...
Implicit None 
Real(dp), Intent(in) :: MFv(6),MFv2(6),MAh(3),MAh2(3),MSe(6),MSe2(6),MCha(2),MCha2(2),MSvIm(6),               & 
& MSvIm2(6),MChi(5),MChi2(5),MSvRe(6),MSvRe2(6),MHpm(2),MHpm2(2),MFe(3),MFe2(3),         & 
...
Complex(dp), Intent(in) :: cplUFvFvAhL(6,6,3),cplUFvFvAhR(6,6,3),cplUFvChacSeL(6,2,6),cplUFvChacSeR(6,2,6),      & 
& cplChiUFvSvImL(5,6,6),cplChiUFvSvImR(5,6,6),cplChiUFvSvReL(5,6,6),cplChiUFvSvReR(5,6,6),& 
& cplUFvFecHpmL(6,3,2),cplUFvFecHpmR(6,3,2),cplUFvFecVWmL(6,3),cplUFvFecVWmR(6,3),       & 
& cplUFvFvhhL(6,6,3),cplUFvFvhhR(6,6,3),cplUFvFvVZL(6,6),cplUFvFvVZR(6,6),               & 
& cplcFeUFvHpmL(3,6,2),cplcFeUFvHpmR(3,6,2),cplcChaUFvSeL(2,6,6),cplcChaUFvSeR(2,6,6),   & 
& cplcFeUFvVWmL(3,6),cplcFeUFvVWmR(3,6)
...
mat1a(4,4) = 0._dp 
mat1a(4,4) = mat1a(4,4)+sqrt(2._dp)*vS*lamN(1,1)
mat1a(4,5) = 0._dp 
mat1a(4,5) = mat1a(4,5)+(vS*lamN(1,2))/sqrt(2._dp)
mat1a(4,5) = mat1a(4,5)+(vS*lamN(2,1))/sqrt(2._dp)
mat1a(4,6) = 0._dp 
mat1a(4,6) = mat1a(4,6)+(vS*lamN(1,3))/sqrt(2._dp)
mat1a(4,6) = mat1a(4,6)+(vS*lamN(3,1))/sqrt(2._dp)
mat1a(5,1) = 0._dp 
...
mat1a(5,4) = 0._dp 
mat1a(5,4) = mat1a(5,4)+(vS*lamN(1,2))/sqrt(2._dp)
mat1a(5,4) = mat1a(5,4)+(vS*lamN(2,1))/sqrt(2._dp)
mat1a(5,5) = 0._dp 
mat1a(5,5) = mat1a(5,5)+sqrt(2._dp)*vS*lamN(2,2)
mat1a(5,6) = 0._dp 
mat1a(5,6) = mat1a(5,6)+(vS*lamN(2,3))/sqrt(2._dp)
mat1a(5,6) = mat1a(5,6)+(vS*lamN(3,2))/sqrt(2._dp)
mat1a(6,1) = 0._dp 
...
mat1a(6,4) = 0._dp 
mat1a(6,4) = mat1a(6,4)+(vS*lamN(1,3))/sqrt(2._dp)
mat1a(6,4) = mat1a(6,4)+(vS*lamN(3,1))/sqrt(2._dp)
mat1a(6,5) = 0._dp 
mat1a(6,5) = mat1a(6,5)+(vS*lamN(2,3))/sqrt(2._dp)
mat1a(6,5) = mat1a(6,5)+(vS*lamN(3,2))/sqrt(2._dp)
mat1a(6,6) = 0._dp 
mat1a(6,6) = mat1a(6,6)+sqrt(2._dp)*vS*lamN(3,3)
...
! conj[Se], Cha 
!------------------------ 
If ((Include_in_loopSe).and.(Include_in_loopCha)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 2
 SumSL = 0._dp 
SumSR = 0._dp 
...
! SvIm, Chi 
!------------------------ 
If ((Include_in_loopSvIm).and.(Include_in_loopChi)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 5
 SumSL = 0._dp 
SumSR = 0._dp 
...
! SvRe, Chi 
!------------------------ 
If ((Include_in_loopSvRe).and.(Include_in_loopChi)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 5
 SumSL = 0._dp 
SumSR = 0._dp 
...
! conj[Hpm], Fe 
!------------------------ 
If ((Include_in_loopHpm).and.(Include_in_loopFe)) Then 
    Do i1 = 1, 2
       Do i2 = 1, 3
 SumSL = 0._dp 
SumSR = 0._dp 
...
! conj[VWm], Fe 
!------------------------ 
If ((Include_in_loopVWm).and.(Include_in_loopFe)) Then 
      Do i2 = 1, 3
 SumSL = 0._dp 
SumSR = 0._dp 
sumR = 0._dp 
...
! bar[Fe], Hpm 
!------------------------ 
If ((Include_in_loopFe).and.(Include_in_loopHpm)) Then 
    Do i1 = 1, 3
       Do i2 = 1, 2
 SumSL = 0._dp 
SumSR = 0._dp 
...
! bar[Cha], Se 
!------------------------ 
If ((Include_in_loopCha).and.(Include_in_loopSe)) Then 
    Do i1 = 1, 2
       Do i2 = 1, 6
 SumSL = 0._dp 
SumSR = 0._dp 
...
! bar[Fe], VWm 
!------------------------ 
If ((Include_in_loopFe).and.(Include_in_loopVWm)) Then 
    Do i1 = 1, 3
 SumSL = 0._dp 
SumSR = 0._dp 
sumR = 0._dp 
...
& MChi(5),MChi2(5),MVWm,MVWm2,MSu(6),MSu2(6),MFd(3),MFd2(3),MSvIm(6),MSvIm2(6),          & 
& MFe(3),MFe2(3),MSvRe(6),MSvRe2(6),MSe(6),MSe2(6),MFv(6),MFv2(6),MFu(3),MFu2(3),        & 
& MSd(6),MSd2(6)
...
& cplcUChaFdcSuL(2,3,6),cplcUChaFdcSuR(2,3,6),cplcUChaFeSvImL(2,3,6),cplcUChaFeSvImR(2,3,6),& 
& cplcUChaFeSvReL(2,3,6),cplcUChaFeSvReR(2,3,6),cplcUChaFvSeL(2,6,6),cplcUChaFvSeR(2,6,6),& 
...
! Cha, Ah 
!------------------------ 
If ((Include_in_loopCha).and.(Include_in_loopAh)) Then 
    Do i1 = 1, 2
       Do i2 = 1, 3
 SumSL = 0._dp 
SumSR = 0._dp 
...
! hh, Cha 
!------------------------ 
If ((Include_in_loophh).and.(Include_in_loopCha)) Then 
    Do i1 = 1, 3
       Do i2 = 1, 2
 SumSL = 0._dp 
SumSR = 0._dp 
...
! VP, Cha 
!------------------------ 
If ((Include_in_loopVP).and.(Include_in_loopCha)) Then 
      Do i2 = 1, 2
 SumSL = 0._dp 
SumSR = 0._dp 
sumR = 0._dp 
...
! VZ, Cha 
!------------------------ 
If ((Include_in_loopVZ).and.(Include_in_loopCha)) Then 
      Do i2 = 1, 2
 SumSL = 0._dp 
SumSR = 0._dp 
sumR = 0._dp 
...
! Hpm, Chi 
!------------------------ 
If ((Include_in_loopHpm).and.(Include_in_loopChi)) Then 
    Do i1 = 1, 2
       Do i2 = 1, 5
 SumSL = 0._dp 
SumSR = 0._dp 
...
! VWm, Chi 
!------------------------ 
If ((Include_in_loopVWm).and.(Include_in_loopChi)) Then 
      Do i2 = 1, 5
 SumSL = 0._dp 
SumSR = 0._dp 
sumR = 0._dp 
...
! conj[Su], Fd 
!------------------------ 
If ((Include_in_loopSu).and.(Include_in_loopFd)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 3
 SumSL = 0._dp 
SumSR = 0._dp 
...
! SvIm, Fe 
!------------------------ 
If ((Include_in_loopSvIm).and.(Include_in_loopFe)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 3
 SumSL = 0._dp 
SumSR = 0._dp 
...
! SvRe, Fe 
!------------------------ 
If ((Include_in_loopSvRe).and.(Include_in_loopFe)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 3
 SumSL = 0._dp 
SumSR = 0._dp 
...
! Se, Fv 
!------------------------ 
If ((Include_in_loopSe).and.(Include_in_loopFv)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 6
 SumSL = 0._dp 
SumSR = 0._dp 
...
! bar[Fu], Sd 
!------------------------ 
If ((Include_in_loopFu).and.(Include_in_loopSd)) Then 
    Do i1 = 1, 3
       Do i2 = 1, 6
 SumSL = 0._dp 
SumSR = 0._dp 
...
Implicit None 
Real(dp), Intent(in) :: MFe(3),MFe2(3),MAh(3),MAh2(3),MSvIm(6),MSvIm2(6),MCha(2),MCha2(2),MSvRe(6),           & 
& MSvRe2(6),MSe(6),MSe2(6),MChi(5),MChi2(5),Mhh(3),Mhh2(3),MVZ,MVZ2,MHpm(2),             & 
& MHpm2(2),MFv(6),MFv2(6),MVWm,MVWm2

Real(dp), Intent(in) :: vd

Complex(dp), Intent(in) :: Ye(3,3)

Complex(dp), Intent(in) :: cplcUFeFeAhL(3,3,3),cplcUFeFeAhR(3,3,3),cplcUFeChaSvImL(3,2,6),cplcUFeChaSvImR(3,2,6),& 
...
! SvIm, Cha 
!------------------------ 
If ((Include_in_loopSvIm).and.(Include_in_loopCha)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 2
 SumSL = 0._dp 
SumSR = 0._dp 
...
! SvRe, Cha 
!------------------------ 
If ((Include_in_loopSvRe).and.(Include_in_loopCha)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 2
 SumSL = 0._dp 
SumSR = 0._dp 
...
! Se, Chi 
!------------------------ 
If ((Include_in_loopSe).and.(Include_in_loopChi)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 5
 SumSL = 0._dp 
SumSR = 0._dp 
...
! Hpm, Fv 
!------------------------ 
If ((Include_in_loopHpm).and.(Include_in_loopFv)) Then 
    Do i1 = 1, 2
       Do i2 = 1, 6
 SumSL = 0._dp 
SumSR = 0._dp 
...
! VWm, Fv 
!------------------------ 
If ((Include_in_loopVWm).and.(Include_in_loopFv)) Then 
      Do i2 = 1, 6
 SumSL = 0._dp 
SumSR = 0._dp 
sumR = 0._dp 
...
! Su, Cha 
!------------------------ 
If ((Include_in_loopSu).and.(Include_in_loopCha)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 2
 SumSL = 0._dp 
SumSR = 0._dp 
...
! Sd, Chi 
!------------------------ 
If ((Include_in_loopSd).and.(Include_in_loopChi)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 5
 SumSL = 0._dp 
SumSR = 0._dp 
...
! Hpm, Fu 
!------------------------ 
If ((Include_in_loopHpm).and.(Include_in_loopFu)) Then 
    Do i1 = 1, 2
       Do i2 = 1, 3
 SumSL = 0._dp 
SumSR = 0._dp 
...
! VWm, Fu 
!------------------------ 
If ((Include_in_loopVWm).and.(Include_in_loopFu)) Then 
      Do i2 = 1, 3
 SumSL = 0._dp 
SumSR = 0._dp 
sumR = 0._dp 
...
! Sd, Glu 
!------------------------ 
If ((Include_in_loopSd).and.(Include_in_loopGlu)) Then 
    Do i1 = 1, 6
 SumSL = 0._dp 
SumSR = 0._dp 
sumR = 0._dp 
...
! Su, Chi 
!------------------------ 
If ((Include_in_loopSu).and.(Include_in_loopChi)) Then 
    Do i1 = 1, 6
       Do i2 = 1, 5
 SumSL = 0._dp 
SumSR = 0._dp 
...
! conj[Hpm], Fd 
!------------------------ 
If ((Include_in_loopHpm).and.(Include_in_loopFd)) Then 
    Do i1 = 1, 2
       Do i2 = 1, 3
 SumSL = 0._dp 
SumSR = 0._dp 
...
! conj[VWm], Fd 
!------------------------ 
If ((Include_in_loopVWm).and.(Include_in_loopFd)) Then 
      Do i2 = 1, 3
 SumSL = 0._dp 
SumSR = 0._dp 
sumR = 0._dp 
...
! Su, Glu 
!------------------------ 
If ((Include_in_loopSu).and.(Include_in_loopGlu)) Then 
    Do i1 = 1, 6
 SumSL = 0._dp 
SumSR = 0._dp 
sumR = 0._dp 
...
! bar[Cha], Sd 
!------------------------ 
If ((Include_in_loopCha).and.(Include_in_loopSd)) Then 
    Do i1 = 1, 2
       Do i2 = 1, 6
 SumSL = 0._dp 
SumSR = 0._dp 
...
! VG, Glu 
!------------------------ 
If ((Include_in_loopVG).and.(Include_in_loopGlu)) Then 
SumR = 0._dp 
SumL = 0._dp 
SumSL = 0._dp 
SumSR = 0._dp 
...
! Glu, Glu 
!------------------------ 
If ((Include_in_loopGlu).and.(Include_in_loopGlu)) Then 
sumI = 0._dp 
...
& MFd2(3),MFe(3),MFe2(3),MFu(3),MFu2(3),MFv(6),MFv2(6),MVZ,MVZ2,MHpm(2),MHpm2(2),        & 
& MVWm,MVWm2,MSd(6),MSd2(6),MSe(6),MSe2(6),MSu(6),MSu2(6),MSvRe(6),MSvRe2(6),            & 
& MSvIm(6),MSvIm2(6)
...
& cplSecSeVZ(6,6),cplSucSuVZ(6,6),cplSvImSvReVZ(6,6),cplcVWmVWmVZ,cplAhAhVZVZ(3,3),      & 
& cplhhhhVZVZ(3,3),cplHpmcHpmVZVZ(2,2),cplSdcSdVZVZ(6,6),cplSecSeVZVZ(6,6),              & 
& cplSucSuVZVZ(6,6),cplSvImSvImVZVZ(6,6),cplSvReSvReVZVZ(6,6),cplcVWmVWmVZVZ1,           & 
...
& MFu2(3),MFd(3),MFd2(3),MFv(6),MFv2(6),MFe(3),MFe2(3),Mhh(3),Mhh2(3),MVWm,              & 
& MVWm2,MVZ,MVZ2,MSu(6),MSu2(6),MSd(6),MSd2(6),MSvIm(6),MSvIm2(6),MSe(6),MSe2(6),        & 
& MSvRe(6),MSvRe2(6)
...
& cplHpmcVWmVZ(2),cplSdcSucVWm(6,6),cplSeSvImcVWm(6,6),cplSeSvRecVWm(6,6),               & 
...
& cplSvReSvRecVWmVWm(6,6),cplcVWmVPVPVWm3,cplcVWmVPVPVWm1,cplcVWmVPVPVWm2,               & 
...
! bar[gWmC], gP 
!------------------------ 
If ((Include_in_loopgWpC).and.(Include_in_loopgA)) Then 
sumI = 0._dp 
...
! bar[gP], gWm 
!------------------------ 
If ((Include_in_loopgA).and.(Include_in_loopgWm)) Then 
sumI = 0._dp 
...
& cplChiChiVZR(5,5),cplcHpmVWmVZ(2),cplcVWmVWmVZ,cplFvFvhhL(6,6,3),cplFvFvhhR(6,6,3),    & 
& cplFvFvVZL(6,6),cplFvFvVZR(6,6),cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),cplhhHpmcHpm(3,2,2), & 
& cplhhHpmcVWm(3,2),cplhhSdcSd(3,6,6),cplhhSecSe(3,6,6),cplhhSucSu(3,6,6),               & 
& cplhhSvImSvRe(3,6,6),cplHpmcHpmVZ(2,2),cplHpmcVWmVZ(2),cplSdcSdVZ(6,6),cplSecSeVZ(6,6),& 
& cplSucSuVZ(6,6),cplSvImSvReVZ(6,6)
...
& cplAhSdcSd(3,6,6),cplAhSecSe(3,6,6),cplAhSucSu(3,6,6),cplAhSvImSvRe(3,6,6),            & 
...
& cplFvFvAhL(6,6,3),cplFvFvAhR(6,6,3),cplFvFvVZL(6,6),cplFvFvVZR(6,6),cplhhVZVZ(3),      & 
...
& cplcHpmVPVWm(2),cplcHpmVWmVZ(2),cplcVWmVPVWm,cplcVWmVWmVZ,cplFvFecHpmL(6,3,2),         & 
& cplFvFecHpmR(6,3,2),cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),cplhhHpmcHpm(3,2,2),             & 
...
! bar[Cha], Chi 
!------------------------ 
If ((Include_in_loopCha).and.(Include_in_loopChi)) Then 
sumI = 0._dp 
...
! bar[gP], gWmC 
!------------------------ 
If ((Include_in_loopgA).and.(Include_in_loopgWpC)) Then 
sumI = 0._dp 
...
! bar[gZ], gWmC 
!------------------------ 
If ((Include_in_loopgZ).and.(Include_in_loopgWpC)) Then 
sumI = 0._dp 
...
! bar[gWm], gZ 
!------------------------ 
If ((Include_in_loopgWm).and.(Include_in_loopgZ)) Then 
sumI = 0._dp 
...
End Module LoopMasses_seesaw1nmssm 
