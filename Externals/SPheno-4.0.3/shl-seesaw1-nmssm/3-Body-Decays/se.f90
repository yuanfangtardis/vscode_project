...
& me2,mv2,ms2,M1,M2,M3,vd,vu,vS,gSeAhChaFv,gSeAhChiFe,gSeChaChacSe,gSeSvImChaChi,        & 
...
& gSeSeFdcFd,gSeSeFucFu,gSeSvImFdcFu,gSeSvReFdcFu,epsI,deltaM,CheckRealStates,           & 
& gT,gPartial,BR)
...
Real(dp),Intent(inout) :: gSeAhChaFv(6,3,2,6),gSeAhChiFe(6,3,5,3),gSeChaChacSe(6,2,2,6),gSeSvImChaChi(6,6,2,5), & 
& gSeSvReChaChi(6,6,2,5),gSeChaFecHpm(6,2,3,2),gSehhChaFv(6,3,2,6),gSeHpmChacFe(6,2,2,3),& 
& gSeSeChacCha(6,6,2,2),gSeSeChiChi(6,6,5,5),gSehhChiFe(6,3,5,3),gSeHpmChiFv(6,2,5,6),   & 
& gSeFeFdcSd(6,3,3,6),gSeFeFecSe(6,3,3,6),gSeFeFucSu(6,3,3,6),gSeSvImFeFv(6,6,3,6),      & 
& gSeSvReFeFv(6,6,3,6),gSeHpmFecCha(6,2,3,2),gSeFeSdcFd(6,3,6,3),gSeSeFecFe(6,6,3,3),    & 
& gSeFeSucFu(6,3,6,3),gSeFvFdcSu(6,6,3,6),gSeSeFvFv(6,6,6,6),gSeFvSdcFu(6,6,6,3),        & 
& gSeSeFdcFd(6,6,3,3),gSeSeFucFu(6,6,3,3),gSeSvImFdcFu(6,6,3,3),gSeSvReFdcFu(6,6,3,3)

Real(dp) :: gSeAhChaFvi(3,2,6),gSeAhChiFei(3,5,3),gSeChaChacSei(2,2,6),gSeSvImChaChii(6,2,5),     & 
& gSeSvReChaChii(6,2,5),gSeChaFecHpmi(2,3,2),gSehhChaFvi(3,2,6),gSeHpmChacFei(2,2,3),    & 
& gSeSeChacChai(6,2,2),gSeSeChiChii(6,5,5),gSehhChiFei(3,5,3),gSeHpmChiFvi(2,5,6),       & 
& gSeFeFdcSdi(3,3,6),gSeFeFecSei(3,3,6),gSeFeFucSui(3,3,6),gSeSvImFeFvi(6,3,6),          & 
& gSeSvReFeFvi(6,3,6),gSeHpmFecChai(2,3,2),gSeFeSdcFdi(3,6,3),gSeSeFecFei(6,3,3),        & 
& gSeFeSucFui(3,6,3),gSeFvFdcSui(6,3,6),gSeSeFvFvi(6,6,6),gSeFvSdcFui(6,6,3),            & 
& gSeSeFdcFdi(6,3,3),gSeSeFucFui(6,3,3),gSeSvImFdcFui(6,3,3),gSeSvReFdcFui(6,3,3)
...
& mHd2,mHu2,md2,mu2,me2,mv2,ms2,M1,M2,M3,vd,vu,vS,cplAhSecSe,cplcChacFuSdL,              & 
...
Real(dp),Intent(in) :: MAh(3),MCha(2),MFv(6),MSe(6)

Complex(dp),Intent(in) :: cplAhSecSe(3,6,6),cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),cplFvChacSeL(6,2,6),      & 
& cplFvChacSeR(6,2,6),cplFvFvAhL(6,6,3),cplFvFvAhR(6,6,3)
...
Real(dp),Intent(in) :: MCha(2),MSe(6),MFv(6)
...
Real(dp),Intent(in) :: MSvIm(6),MCha(2),MChi(5),MVWm,MHpm(2),MFe(3),MFv(6),MSe(6)
...
Real(dp),Intent(in) :: MSvRe(6),MCha(2),MChi(5),MVWm,MHpm(2),MFe(3),MFv(6),MSe(6)
...
Real(dp),Intent(in) :: MCha(2),MFe(3),MHpm(2),MFv(6),MChi(5),MSe(6)
...
Real(dp),Intent(in) :: Mhh(3),MCha(2),MFv(6),MSe(6)
...
Real(dp),Intent(in) :: MHpm(2),MCha(2),MFe(3),MSvIm(6),MSvRe(6),MFv(6),MSe(6)

Complex(dp),Intent(in) :: cplHpmSvImcSe(2,6,6),cplHpmSvRecSe(2,6,6),cplcFeChaSvImL(3,2,6),cplcFeChaSvImR(3,2,6),& 
& cplcFeChaSvReL(3,2,6),cplcFeChaSvReR(3,2,6),cplcFeFvHpmL(3,6,2),cplcFeFvHpmR(3,6,2),   & 
& cplFvChacSeL(6,2,6),cplFvChacSeR(6,2,6)
...
Real(dp),Intent(in) :: MSe(6),MCha(2),MVZ,MAh(3),Mhh(3),MFv(6)

Complex(dp),Intent(in) :: cplAhSecSe(3,6,6),cplhhSecSe(3,6,6),cplSecSeVZ(6,6),cplcChaChaAhL(2,2,3),             & 
& cplcChaChaAhR(2,2,3),cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),cplcChaChaVZL(2,2),     & 
& cplcChaChaVZR(2,2),cplcChaFvSeL(2,6,6),cplcChaFvSeR(2,6,6),cplFvChacSeL(6,2,6),        & 
& cplFvChacSeR(6,2,6)
...
Real(dp),Intent(in) :: MHpm(2),MChi(5),MFv(6),MSvIm(6),MSvRe(6),MFe(3),MCha(2),MSe(6)

Complex(dp),Intent(in) :: cplHpmSvImcSe(2,6,6),cplHpmSvRecSe(2,6,6),cplcChaChiHpmL(2,5,2),cplcChaChiHpmR(2,5,2),& 
& cplcFeFvHpmL(3,6,2),cplcFeFvHpmR(3,6,2),cplChiFecSeL(5,3,6),cplChiFecSeR(5,3,6),       & 
...
Isum = 289 
Allocate( gSum(2,5,6, Isum) ) 
Allocate( Contribution(2,5,6, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: MSvIm(6),MFe(3),MFv(6),MVWm,MHpm(2),MCha(2),MChi(5),MSe(6)
...
Real(dp),Intent(in) :: MSvRe(6),MFe(3),MFv(6),MVWm,MHpm(2),MCha(2),MChi(5),MSe(6)
...
Real(dp),Intent(in) :: MHpm(2),MFe(3),MCha(2),MSvIm(6),MSvRe(6),MChi(5),MSe(6)
...
Real(dp),Intent(in) :: MFv(6),MFd(3),MSu(6),MCha(2),MSe(6)
...
Real(dp),Intent(in) :: MSe(6),MFv(6),MVZ,MAh(3),Mhh(3),MCha(2)

Complex(dp),Intent(in) :: cplAhSecSe(3,6,6),cplhhSecSe(3,6,6),cplSecSeVZ(6,6),cplcChaFvSeL(2,6,6),              & 
& cplcChaFvSeR(2,6,6),cplFvChacSeL(6,2,6),cplFvChacSeR(6,2,6),cplFvFvAhL(6,6,3),         & 
& cplFvFvAhR(6,6,3),cplFvFvhhL(6,6,3),cplFvFvhhR(6,6,3),cplFvFvVZL(6,6),cplFvFvVZR(6,6)
...
Real(dp),Intent(in) :: MFv(6),MSd(6),MFu(3),MCha(2),MSe(6)

Complex(dp),Intent(in) :: cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),cplFvChacSeL(6,2,6),cplFvChacSeR(6,2,6)
...
Real(dp),Intent(in) :: MSvIm(6),MFd(3),MFu(3),MVWm,MHpm(2),MSe(6)

Complex(dp),Intent(in) :: cplHpmSvImcSe(2,6,6),cplSvImcSeVWm(6,6),cplcFuFdcHpmL(3,3,2),cplcFuFdcHpmR(3,3,2),    & 
...
Real(dp),Intent(in) :: MSvRe(6),MFd(3),MFu(3),MVWm,MHpm(2),MSe(6)

Complex(dp),Intent(in) :: cplHpmSvRecSe(2,6,6),cplSvRecSeVWm(6,6),cplcFuFdcHpmL(3,3,2),cplcFuFdcHpmR(3,3,2),    & 
& cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3)
...
End Module Se3Decays_seesaw1nmssm 
