...
Module Hpm3Decays_seesaw1nmssm 
...
& me2,mv2,ms2,M1,M2,M3,vd,vu,vS,gHpmAhChaChi,gHpmAhFdcFu,gHpmAhFeFv,gHpmChaChacHpm,      & 
...
& gHpmHpmFucFu,gHpmSdGlucFu,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
Real(dp),Intent(inout) :: gHpmAhChaChi(2,3,2,5),gHpmAhFdcFu(2,3,3,3),gHpmAhFeFv(2,3,3,6),gHpmChaChacHpm(2,2,2,2),& 
...
Real(dp) :: gHpmAhChaChii(3,2,5),gHpmAhFdcFui(3,3,3),gHpmAhFeFvi(3,3,6),gHpmChaChacHpmi(2,2,2),   & 
& gHpmhhChaChii(3,2,5),gHpmFdChacSdi(3,2,6),gHpmChaFecSei(2,3,6),gHpmcSuChaFui(6,2,3),   & 
& gHpmSvImChaFvi(6,2,6),gHpmSvReChaFvi(6,2,6),gHpmHpmChacChai(2,2,2),gHpmSdChacFdi(6,2,3),& 
& gHpmSeChacFei(6,2,3),gHpmcFuChaSui(3,2,6),gHpmHpmChiChii(2,5,5),gHpmcSuChiFdi(6,5,3),  & 
& gHpmSvImChiFei(6,5,3),gHpmSvReChiFei(6,5,3),gHpmSeChiFvi(6,5,6),gHpmSdChicFui(6,5,3),  & 
& gHpmcSuFdGlui(6,3,1),gHpmhhFdcFui(3,3,3),gHpmHpmFdcFdi(2,3,3),gHpmFeFecHpmi(3,3,2),    & 
& gHpmhhFeFvi(3,3,6),gHpmHpmFecFei(2,3,3),gHpmSeFecChai(6,3,2),gHpmHpmFvFvi(2,6,6),      & 
...
& mHd2,mHu2,md2,mu2,me2,mv2,ms2,M1,M2,M3,vd,vu,vS,cplAhcHpmVWm,cplAhHpmcHpm,             & 
...
Real(dp),Intent(in) :: MAh(3),MFe(3),MFv(6),MVWm,MHpm(2)
...
Real(dp),Intent(in) :: MCha(2),MFe(3),MSe(6),MChi(5),MFv(6),MHpm(2)
...
Real(dp),Intent(in) :: MSvIm(6),MCha(2),MFv(6),MSe(6),MFe(3),MChi(5),MHpm(2)
...
Real(dp),Intent(in) :: MSvRe(6),MCha(2),MFv(6),MSe(6),MFe(3),MChi(5),MHpm(2)
...
Real(dp),Intent(in) :: MSe(6),MCha(2),MFe(3),MSvIm(6),MSvRe(6),MChi(5),MHpm(2)

Complex(dp),Intent(in) :: cplSeSvImcHpm(6,6,2),cplSeSvRecHpm(6,6,2),cplcFeChaSvImL(3,2,6),cplcFeChaSvImR(3,2,6),& 
& cplcFeChaSvReL(3,2,6),cplcFeChaSvReR(3,2,6),cplcFeChiSeL(3,5,6),cplcFeChiSeR(3,5,6),   & 
...
Real(dp),Intent(in) :: MSvIm(6),MChi(5),MFe(3),MSe(6),MCha(2),MFv(6),MHpm(2)
...
Real(dp),Intent(in) :: MSvRe(6),MChi(5),MFe(3),MSe(6),MCha(2),MFv(6),MHpm(2)
...
Real(dp),Intent(in) :: MSe(6),MChi(5),MFv(6),MSvIm(6),MSvRe(6),MCha(2),MFe(3),MHpm(2)

Complex(dp),Intent(in) :: cplSeSvImcHpm(6,6,2),cplSeSvRecHpm(6,6,2),cplcChaFvSeL(2,6,6),cplcChaFvSeR(2,6,6),    & 
& cplcFeChiSeL(3,5,6),cplcFeChiSeR(3,5,6),cplChiChacHpmL(5,2,2),cplChiChacHpmR(5,2,2),   & 
& cplChiFvSvImL(5,6,6),cplChiFvSvImR(5,6,6),cplChiFvSvReL(5,6,6),cplChiFvSvReR(5,6,6),   & 
& cplFvFecHpmL(6,3,2),cplFvFecHpmR(6,3,2)
...
Real(dp),Intent(in) :: MFe(3),MHpm(2),MFv(6)
...
Real(dp),Intent(in) :: Mhh(3),MFe(3),MFv(6),MVWm,MHpm(2)
...
Real(dp),Intent(in) :: MHpm(2),MFe(3),MVZ,MAh(3),Mhh(3),MFv(6)
...
& cplcFeFeVZR(3,3),cplcFeFvHpmL(3,6,2),cplcFeFvHpmR(3,6,2),cplFvFecHpmL(6,3,2),          & 
& cplFvFecHpmR(6,3,2)
...
Real(dp),Intent(in) :: MSe(6),MFe(3),MCha(2),MSvIm(6),MSvRe(6),MFv(6),MHpm(2)

Complex(dp),Intent(in) :: cplSeSvImcHpm(6,6,2),cplSeSvRecHpm(6,6,2),cplcChaFeSvImL(2,3,6),cplcChaFeSvImR(2,3,6),& 
& cplcChaFeSvReL(2,3,6),cplcChaFeSvReR(2,3,6),cplcChaFvSeL(2,6,6),cplcChaFvSeR(2,6,6),   & 
& cplFvFecHpmL(6,3,2),cplFvFecHpmR(6,3,2)
...
Real(dp),Intent(in) :: MHpm(2),MFv(6),MVZ,MAh(3),Mhh(3),MFe(3)

Complex(dp),Intent(in) :: cplAhHpmcHpm(3,2,2),cplhhHpmcHpm(3,2,2),cplHpmcHpmVZ(2,2),cplcFeFvHpmL(3,6,2),        & 
& cplcFeFvHpmR(3,6,2),cplFvFecHpmL(6,3,2),cplFvFecHpmR(6,3,2),cplFvFvAhL(6,6,3),         & 
...
End Module Hpm3Decays_seesaw1nmssm 
