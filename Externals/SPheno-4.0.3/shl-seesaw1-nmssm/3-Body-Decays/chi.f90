...
Module Chi3Decays_seesaw1nmssm 
...
& gChiChicFuFu(5,5,3,3),gChiChiFvFv(5,5,6,6),gChiChacFdFu(5,2,3,3),gChiChacFeFv(5,2,3,6),& 
...
& gChiChicFuFui(5,3,3),gChiChiFvFvi(5,6,6),gChiChacFdFui(2,3,3),gChiChacFeFvi(2,3,6),    & 
...
Real(dp),Intent(in) :: MChi(5),MFv(6),MVZ,MAh(3),Mhh(3),MSvIm(6),MSvRe(6)
...
Isum = 361 
Allocate( gSum(5,6,6, Isum) ) 
Allocate( Contribution(5,6,6, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: MCha(2),MFe(3),MFv(6),MVWm,MHpm(2),MSe(6),MSvIm(6),MSvRe(6),MChi(5)
...
End Module Chi3Decays_seesaw1nmssm 
