...
Module Glu3Decays_seesaw1nmssm 
...
& me2,mv2,ms2,M1,M2,M3,vd,vu,vS,gTSd,gTSu,gGluFdcFdChi,gGluFdcFucCha,gGluFucFuChi,       & 
...
Real(dp),Intent(inout) :: gGluFdcFdChi(1,3,3,5),gGluFdcFucCha(1,3,3,2),gGluFucFuChi(1,3,3,5)

Real(dp),Intent(in) :: gTSd(6),gTSu(6)

Real(dp) :: gGluFdcFdChii(3,3,5),gGluFdcFucChai(3,3,2),gGluFucFuChii(3,3,5)
...
& md2,mu2,me2,mv2,ms2,M1,M2,M3,vd,vu,vS,cplcChacFuSdL,cplcChacFuSdR,cplcChaFdcSuL,       & 
...
Real(dp),Intent(in) :: MFd(3),MChi(5),MSd(6),MGlu
...
Real(dp),Intent(in) :: MFu(3),MChi(5),MSu(6),MGlu
...
End Module Glu3Decays_seesaw1nmssm 
