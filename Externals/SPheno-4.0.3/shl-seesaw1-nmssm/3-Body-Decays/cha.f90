...
Module Cha3Decays_seesaw1nmssm 
...
& me2,mv2,ms2,M1,M2,M3,vd,vu,vS,gTAh,gThh,gTHpm,gTSd,gTSe,gTSu,gTSvIm,gTSvRe,            & 
...
& gChaChacFuFu(2,2,3,3),gChaChaFvFv(2,2,6,6),gChaChicFuFd(2,5,3,3),gChaChiFvFe(2,5,6,3), & 
& gChaFdcFuGlu(2,3,3,1),gChaFecChaFe(2,3,2,3)

Real(dp),Intent(in) :: gTAh(3),gThh(3),gTHpm(2),gTSd(6),gTSe(6),gTSu(6),gTSvIm(6),gTSvRe(6),gTVWm,gTVZ

Real(dp) :: gChaChacChaChai(2,2,2),gChaChaChiChii(2,5,5),gChaChacFdFdi(2,3,3),gChaChacFeFei(2,3,3),& 
& gChaChacFuFui(2,3,3),gChaChaFvFvi(2,6,6),gChaChicFuFdi(5,3,3),gChaChiFvFei(5,6,3),     & 
& gChaFdcFuGlui(3,3,1),gChaFecChaFei(3,2,3)

Real(dp) :: gTAhtemp(3),gThhtemp(3),gTHpmtemp(2),gTSdtemp(6),gTSetemp(6),gTSutemp(6)              & 
& ,gTSvImtemp(6),gTSvRetemp(6),gTVWmtemp,gTVZtemp
...
& mHd2,mHu2,md2,mu2,me2,mv2,ms2,M1,M2,M3,vd,vu,vS,cplcChacFuSdL,cplcChacFuSdR,           & 
...
Real(dp),Intent(in) :: MCha(2),MFe(3),MVZ,MAh(3),Mhh(3),MSvIm(6),MSvRe(6)

Complex(dp),Intent(in) :: cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),  & 
& cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),cplcChaFeSvImL(2,3,6),cplcChaFeSvImR(2,3,6),     & 
& cplcChaFeSvReL(2,3,6),cplcChaFeSvReR(2,3,6),cplcFeChaSvImL(3,2,6),cplcFeChaSvImR(3,2,6),& 
...
Real(dp),Intent(inout) :: gTVZ,gTAh(3),gThh(3),gTSvIm(6),gTSvRe(6)
...
Real(dp),Intent(in) :: MCha(2),MFv(6),MVZ,MSe(6),MAh(3),Mhh(3)
...
Real(dp),Intent(in) :: MChi(5),MFv(6),MFe(3),MVWm,MHpm(2),MSe(6),MSvIm(6),MSvRe(6),MCha(2)
...
& cplcChaFvSeL(2,6,6),cplcChaFvSeR(2,6,6),cplChiFecSeL(5,3,6),cplChiFecSeR(5,3,6),       & 
...
Isum = 441 
Allocate( gSum(5,6,3, Isum) ) 
Allocate( Contribution(5,6,3, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
End Module Cha3Decays_seesaw1nmssm 
