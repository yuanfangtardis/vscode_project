...
Subroutine SolveTadpoleEquations(g1,g2,g3,Yd,Ye,lam,kap,lamN,Yu,Yv,Td,Te,             & 
& Tlam,Tk,TLN,Tu,Tv,mq2,ml2,mHd2,mHu2,md2,mu2,me2,mv2,ms2,M1,M2,M3,vd,vu,vS,Tad1Loop)
...
Complex(dp), Intent(in) :: Tad1Loop(9)
...
Subroutine CalculateTadpoles(g1,g2,g3,Yd,Ye,lam,kap,lamN,Yu,Yv,Td,Te,Tlam,            & 
...
End Module Tadpoles_seesaw1nmssm 
