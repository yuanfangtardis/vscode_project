...
! ------------------------------------------------------------------------------  
! File created at 18:40 on 2.10.2017   
! ----------------------------------------------------------------------  
 
 
Module OneLoopDecay_Sd_seesaw1nmssm
Use Control 
Use Settings 
Use LoopFunctions 
...
Subroutine Amplitude_Tree_seesaw1nmssm_SdToSdAh(cplAhSdcSd,MAh,MSd,MAh2,MSd2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_SdToSdAh


Subroutine Gamma_Real_seesaw1nmssm_SdToSdAh(MLambda,em,gs,cplAhSdcSd,MAh,             & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_SdToSdAh


Subroutine Amplitude_WAVE_seesaw1nmssm_SdToSdAh(cplAhSdcSd,ctcplAhSdcSd,              & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_SdToSdAh


Subroutine Amplitude_VERTEX_seesaw1nmssm_SdToSdAh(MAh,MCha,MChi,MFd,MFu,              & 
...
! {Ah, conj[Sd], conj[Sd]}
If ((Include_in_loopAh).and.(Include_in_loopSd).and.(Include_in_loopSd)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,6
ML1 = MAh(i1) 
...
! {Cha, bar[Fu], bar[Fu]}
If ((Include_in_loopCha).and.(Include_in_loopFu).and.(Include_in_loopFu)) Then 
Do i1=1,2
  Do i2=1,3
    Do i3=1,3
ML1 = MCha(i1) 
...
! {Chi, bar[Fd], bar[Fd]}
If ((Include_in_loopChi).and.(Include_in_loopFd).and.(Include_in_loopFd)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,3
ML1 = MChi(i1) 
...
! {Fd, Chi, Chi}
If ((Include_in_loopFd).and.(Include_in_loopChi).and.(Include_in_loopChi)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,5
ML1 = MFd(i1) 
...
! {Fu, bar[Cha], bar[Cha]}
If ((Include_in_loopFu).and.(Include_in_loopCha).and.(Include_in_loopCha)) Then 
Do i1=1,3
  Do i2=1,2
    Do i3=1,2
ML1 = MFu(i1) 
...
! {Glu, bar[Fd], bar[Fd]}
If ((Include_in_loopGlu).and.(Include_in_loopFd).and.(Include_in_loopFd)) Then 
  Do i2=1,3
    Do i3=1,3
ML1 = MGlu 
ML2 = MFd(i2) 
...
! {hh, conj[Sd], conj[Sd]}
If ((Include_in_loophh).and.(Include_in_loopSd).and.(Include_in_loopSd)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,6
ML1 = Mhh(i1) 
...
! {Hpm, conj[Su], conj[Su]}
If ((Include_in_loopHpm).and.(Include_in_loopSu).and.(Include_in_loopSu)) Then 
Do i1=1,2
  Do i2=1,6
    Do i3=1,6
ML1 = MHpm(i1) 
...
! {Sd, Ah, Ah}
If ((Include_in_loopSd).and.(Include_in_loopAh).and.(Include_in_loopAh)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,3
ML1 = MSd(i1) 
...
! {Sd, hh, Ah}
If ((Include_in_loopSd).and.(Include_in_loophh).and.(Include_in_loopAh)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,3
ML1 = MSd(i1) 
...
! {Sd, Ah, hh}
If ((Include_in_loopSd).and.(Include_in_loopAh).and.(Include_in_loophh)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,3
ML1 = MSd(i1) 
...
! {Sd, hh, hh}
If ((Include_in_loopSd).and.(Include_in_loophh).and.(Include_in_loophh)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,3
ML1 = MSd(i1) 
...
! {Sd, VZ, hh}
If ((Include_in_loopSd).and.(Include_in_loopVZ).and.(Include_in_loophh)) Then 
Do i1=1,6
    Do i3=1,3
ML1 = MSd(i1) 
ML2 = MVZ 
...
! {Sd, hh, VZ}
If ((Include_in_loopSd).and.(Include_in_loophh).and.(Include_in_loopVZ)) Then 
Do i1=1,6
  Do i2=1,3
ML1 = MSd(i1) 
ML2 = Mhh(i2) 
...
If ((Include_in_loopSu).and.(Include_in_loopHpm).and.(Include_in_loopHpm)) Then 
Do i1=1,6
  Do i2=1,2
    Do i3=1,2
ML1 = MSu(i1) 
...
If ((Include_in_loopSu).and.(Include_in_loopVWm).and.(Include_in_loopHpm)) Then 
Do i1=1,6
    Do i3=1,2
ML1 = MSu(i1) 
ML2 = MVWm 
...
If ((Include_in_loopSu).and.(Include_in_loopHpm).and.(Include_in_loopVWm)) Then 
Do i1=1,6
  Do i2=1,2
ML1 = MSu(i1) 
ML2 = MHpm(i2) 
...
! {VG, conj[Sd], conj[Sd]}
If ((Include_in_loopVG).and.(Include_in_loopSd).and.(Include_in_loopSd)) Then 
  Do i2=1,6
    Do i3=1,6
ML1 = MVG 
ML2 = MSd(i2) 
...
! {VP, conj[Sd], conj[Sd]}
If ((Include_in_loopVP).and.(Include_in_loopSd).and.(Include_in_loopSd)) Then 
  Do i2=1,6
    Do i3=1,6
ML1 = MVP 
ML2 = MSd(i2) 
...
! {VWm, conj[Su], conj[Su]}
If ((Include_in_loopVWm).and.(Include_in_loopSu).and.(Include_in_loopSu)) Then 
  Do i2=1,6
    Do i3=1,6
ML1 = MVWm 
ML2 = MSu(i2) 
...
! {VZ, conj[Sd], conj[Sd]}
If ((Include_in_loopVZ).and.(Include_in_loopSd).and.(Include_in_loopSd)) Then 
  Do i2=1,6
    Do i3=1,6
ML1 = MVZ 
ML2 = MSd(i2) 
...
End if 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_SdToSdAh


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SdToSdAh(MAh,MCha,MChi,MFd,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SdToSdAh


Subroutine Amplitude_Tree_seesaw1nmssm_SdToFuCha(cplChaFucSdL,cplChaFucSdR,           & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_SdToFuCha


Subroutine Gamma_Real_seesaw1nmssm_SdToFuCha(MLambda,em,gs,cplChaFucSdL,              & 
& cplChaFucSdR,MCha,MFu,MSd,GammarealPhoton,GammarealGluon)
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_SdToFuCha


Subroutine Amplitude_WAVE_seesaw1nmssm_SdToFuCha(cplChaFucSdL,cplChaFucSdR,           & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_SdToFuCha


Subroutine Amplitude_VERTEX_seesaw1nmssm_SdToFuCha(MAh,MCha,MChi,MFd,MFu,             & 
...
! {Ah, conj[Sd], bar[Fu]}
If ((Include_in_loopAh).and.(Include_in_loopSd).and.(Include_in_loopFu)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,3
ML1 = MAh(i1) 
...
! {Chi, bar[Fd], conj[Su]}
If ((Include_in_loopChi).and.(Include_in_loopFd).and.(Include_in_loopSu)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,6
ML1 = MChi(i1) 
...
! {Fd, Chi, Hpm}
If ((Include_in_loopFd).and.(Include_in_loopChi).and.(Include_in_loopHpm)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,2
ML1 = MFd(i1) 
...
! {Fd, Chi, VWm}
If ((Include_in_loopFd).and.(Include_in_loopChi).and.(Include_in_loopVWm)) Then 
Do i1=1,3
  Do i2=1,5
ML1 = MFd(i1) 
ML2 = MChi(i2) 
...
! {Fu, bar[Cha], Ah}
If ((Include_in_loopFu).and.(Include_in_loopCha).and.(Include_in_loopAh)) Then 
Do i1=1,3
  Do i2=1,2
    Do i3=1,3
ML1 = MFu(i1) 
...
! {Fu, bar[Cha], hh}
If ((Include_in_loopFu).and.(Include_in_loopCha).and.(Include_in_loophh)) Then 
Do i1=1,3
  Do i2=1,2
    Do i3=1,3
ML1 = MFu(i1) 
...
! {Fu, bar[Cha], VP}
If ((Include_in_loopFu).and.(Include_in_loopCha).and.(Include_in_loopVP)) Then 
Do i1=1,3
  Do i2=1,2
ML1 = MFu(i1) 
ML2 = MCha(i2) 
...
! {Fu, bar[Cha], VZ}
If ((Include_in_loopFu).and.(Include_in_loopCha).and.(Include_in_loopVZ)) Then 
Do i1=1,3
  Do i2=1,2
ML1 = MFu(i1) 
ML2 = MCha(i2) 
...
! {Glu, bar[Fd], conj[Su]}
If ((Include_in_loopGlu).and.(Include_in_loopFd).and.(Include_in_loopSu)) Then 
  Do i2=1,3
    Do i3=1,6
ML1 = MGlu 
ML2 = MFd(i2) 
...
! {hh, conj[Sd], bar[Fu]}
If ((Include_in_loophh).and.(Include_in_loopSd).and.(Include_in_loopFu)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,3
ML1 = Mhh(i1) 
...
! {Sd, Ah, Cha}
If ((Include_in_loopSd).and.(Include_in_loopAh).and.(Include_in_loopCha)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,2
ML1 = MSd(i1) 
...
! {Sd, hh, Cha}
If ((Include_in_loopSd).and.(Include_in_loophh).and.(Include_in_loopCha)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,2
ML1 = MSd(i1) 
...
! {Sd, VP, Cha}
If ((Include_in_loopSd).and.(Include_in_loopVP).and.(Include_in_loopCha)) Then 
Do i1=1,6
    Do i3=1,2
ML1 = MSd(i1) 
ML2 = MVP 
...
! {Sd, VZ, Cha}
If ((Include_in_loopSd).and.(Include_in_loopVZ).and.(Include_in_loopCha)) Then 
Do i1=1,6
    Do i3=1,2
ML1 = MSd(i1) 
ML2 = MVZ 
...
! {Su, conj[Hpm], Chi}
If ((Include_in_loopSu).and.(Include_in_loopHpm).and.(Include_in_loopChi)) Then 
Do i1=1,6
  Do i2=1,2
    Do i3=1,5
ML1 = MSu(i1) 
...
! {Su, conj[VWm], Chi}
If ((Include_in_loopSu).and.(Include_in_loopVWm).and.(Include_in_loopChi)) Then 
Do i1=1,6
    Do i3=1,5
ML1 = MSu(i1) 
ML2 = MVWm 
...
! {VG, conj[Sd], bar[Fu]}
If ((Include_in_loopVG).and.(Include_in_loopSd).and.(Include_in_loopFu)) Then 
  Do i2=1,6
    Do i3=1,3
ML1 = MVG 
ML2 = MSd(i2) 
...
! {VP, conj[Sd], bar[Fu]}
If ((Include_in_loopVP).and.(Include_in_loopSd).and.(Include_in_loopFu)) Then 
  Do i2=1,6
    Do i3=1,3
ML1 = MVP 
ML2 = MSd(i2) 
...
! {VZ, conj[Sd], bar[Fu]}
If ((Include_in_loopVZ).and.(Include_in_loopSd).and.(Include_in_loopFu)) Then 
  Do i2=1,6
    Do i3=1,3
ML1 = MVZ 
ML2 = MSd(i2) 
...
End if 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_SdToFuCha


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SdToFuCha(MAh,MCha,MChi,MFd,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SdToFuCha


Subroutine Amplitude_Tree_seesaw1nmssm_SdToFdChi(cplChiFdcSdL,cplChiFdcSdR,           & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_SdToFdChi


Subroutine Gamma_Real_seesaw1nmssm_SdToFdChi(MLambda,em,gs,cplChiFdcSdL,              & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_SdToFdChi


Subroutine Amplitude_WAVE_seesaw1nmssm_SdToFdChi(cplChiFdcSdL,cplChiFdcSdR,           & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_SdToFdChi


Subroutine Amplitude_VERTEX_seesaw1nmssm_SdToFdChi(MAh,MCha,MChi,MFd,MFu,             & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
! {Ah, conj[Sd], bar[Fd]}
If ((Include_in_loopAh).and.(Include_in_loopSd).and.(Include_in_loopFd)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,3
ML1 = MAh(i1) 
...
! {Cha, bar[Fu], conj[Su]}
If ((Include_in_loopCha).and.(Include_in_loopFu).and.(Include_in_loopSu)) Then 
Do i1=1,2
  Do i2=1,3
    Do i3=1,6
ML1 = MCha(i1) 
...
! {Chi, bar[Fd], conj[Sd]}
If ((Include_in_loopChi).and.(Include_in_loopFd).and.(Include_in_loopSd)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,6
ML1 = MChi(i1) 
...
! {Fd, Chi, Ah}
If ((Include_in_loopFd).and.(Include_in_loopChi).and.(Include_in_loopAh)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,3
ML1 = MFd(i1) 
...
! {Fd, Chi, hh}
If ((Include_in_loopFd).and.(Include_in_loopChi).and.(Include_in_loophh)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,3
ML1 = MFd(i1) 
...
! {Fd, Chi, VZ}
If ((Include_in_loopFd).and.(Include_in_loopChi).and.(Include_in_loopVZ)) Then 
Do i1=1,3
  Do i2=1,5
ML1 = MFd(i1) 
ML2 = MChi(i2) 
...
! {Fu, bar[Cha], conj[Hpm]}
If ((Include_in_loopFu).and.(Include_in_loopCha).and.(Include_in_loopHpm)) Then 
Do i1=1,3
  Do i2=1,2
    Do i3=1,2
ML1 = MFu(i1) 
...
! {Fu, bar[Cha], conj[VWm]}
If ((Include_in_loopFu).and.(Include_in_loopCha).and.(Include_in_loopVWm)) Then 
Do i1=1,3
  Do i2=1,2
ML1 = MFu(i1) 
ML2 = MCha(i2) 
...
! {Glu, bar[Fd], conj[Sd]}
If ((Include_in_loopGlu).and.(Include_in_loopFd).and.(Include_in_loopSd)) Then 
  Do i2=1,3
    Do i3=1,6
ML1 = MGlu 
ML2 = MFd(i2) 
...
! {hh, conj[Sd], bar[Fd]}
If ((Include_in_loophh).and.(Include_in_loopSd).and.(Include_in_loopFd)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,3
ML1 = Mhh(i1) 
...
! {Hpm, conj[Su], bar[Fu]}
If ((Include_in_loopHpm).and.(Include_in_loopSu).and.(Include_in_loopFu)) Then 
Do i1=1,2
  Do i2=1,6
    Do i3=1,3
ML1 = MHpm(i1) 
...
! {Sd, Ah, Chi}
If ((Include_in_loopSd).and.(Include_in_loopAh).and.(Include_in_loopChi)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,5
ML1 = MSd(i1) 
...
! {Sd, hh, Chi}
If ((Include_in_loopSd).and.(Include_in_loophh).and.(Include_in_loopChi)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,5
ML1 = MSd(i1) 
...
! {Sd, VZ, Chi}
If ((Include_in_loopSd).and.(Include_in_loopVZ).and.(Include_in_loopChi)) Then 
Do i1=1,6
    Do i3=1,5
ML1 = MSd(i1) 
ML2 = MVZ 
...
! {Su, conj[Hpm], bar[Cha]}
If ((Include_in_loopSu).and.(Include_in_loopHpm).and.(Include_in_loopCha)) Then 
Do i1=1,6
  Do i2=1,2
    Do i3=1,2
ML1 = MSu(i1) 
...
! {Su, conj[VWm], bar[Cha]}
If ((Include_in_loopSu).and.(Include_in_loopVWm).and.(Include_in_loopCha)) Then 
Do i1=1,6
    Do i3=1,2
ML1 = MSu(i1) 
ML2 = MVWm 
...
! {VG, conj[Sd], bar[Fd]}
If ((Include_in_loopVG).and.(Include_in_loopSd).and.(Include_in_loopFd)) Then 
  Do i2=1,6
    Do i3=1,3
ML1 = MVG 
ML2 = MSd(i2) 
...
! {VP, conj[Sd], bar[Fd]}
If ((Include_in_loopVP).and.(Include_in_loopSd).and.(Include_in_loopFd)) Then 
  Do i2=1,6
    Do i3=1,3
ML1 = MVP 
ML2 = MSd(i2) 
...
! {VWm, conj[Su], bar[Fu]}
If ((Include_in_loopVWm).and.(Include_in_loopSu).and.(Include_in_loopFu)) Then 
  Do i2=1,6
    Do i3=1,3
ML1 = MVWm 
ML2 = MSu(i2) 
...
! {VZ, conj[Sd], bar[Fd]}
If ((Include_in_loopVZ).and.(Include_in_loopSd).and.(Include_in_loopFd)) Then 
  Do i2=1,6
    Do i3=1,3
ML1 = MVZ 
ML2 = MSd(i2) 
...
End if 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_SdToFdChi


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SdToFdChi(MAh,MCha,MChi,MFd,              & 
& MFu,MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,           & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,       & 
& cplcFdFdAhR,cplAhSdcSd,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,    & 
& cplChaFucSdL,cplChaFucSdR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SdToFdChi


Subroutine Amplitude_Tree_seesaw1nmssm_SdToGluFd(cplGluFdcSdL,cplGluFdcSdR,           & 
...
Amp(:,gt1, gt3) = AmpC 
    End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_SdToGluFd


Subroutine Gamma_Real_seesaw1nmssm_SdToGluFd(MLambda,em,gs,cplGluFdcSdL,              & 
...
End if 
    End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_SdToGluFd


Subroutine Amplitude_WAVE_seesaw1nmssm_SdToGluFd(cplGluFdcSdL,cplGluFdcSdR,           & 
...
Amp(:,gt1, gt3) = AmpC 
    End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_SdToGluFd


Subroutine Amplitude_VERTEX_seesaw1nmssm_SdToGluFd(MAh,MCha,MChi,MFd,MFu,             & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
! {Fd, Chi, Sd}
If ((Include_in_loopFd).and.(Include_in_loopChi).and.(Include_in_loopSd)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,6
ML1 = MFd(i1) 
...
! {Fd, Glu, Sd}
If ((Include_in_loopFd).and.(Include_in_loopGlu).and.(Include_in_loopSd)) Then 
Do i1=1,3
    Do i3=1,6
ML1 = MFd(i1) 
ML2 = MGlu 
...
! {Fu, bar[Cha], Su}
If ((Include_in_loopFu).and.(Include_in_loopCha).and.(Include_in_loopSu)) Then 
Do i1=1,3
  Do i2=1,2
    Do i3=1,6
ML1 = MFu(i1) 
...
! {Glu, bar[Fd], VG}
If ((Include_in_loopGlu).and.(Include_in_loopFd).and.(Include_in_loopVG)) Then 
  Do i2=1,3
ML1 = MGlu 
ML2 = MFd(i2) 
ML3 = MVG 
...
! {Sd, Ah, Fd}
If ((Include_in_loopSd).and.(Include_in_loopAh).and.(Include_in_loopFd)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,3
ML1 = MSd(i1) 
...
! {Sd, hh, Fd}
If ((Include_in_loopSd).and.(Include_in_loophh).and.(Include_in_loopFd)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,3
ML1 = MSd(i1) 
...
! {Sd, VG, Fd}
If ((Include_in_loopSd).and.(Include_in_loopVG).and.(Include_in_loopFd)) Then 
Do i1=1,6
    Do i3=1,3
ML1 = MSd(i1) 
ML2 = MVG 
...
! {Sd, VP, Fd}
If ((Include_in_loopSd).and.(Include_in_loopVP).and.(Include_in_loopFd)) Then 
Do i1=1,6
    Do i3=1,3
ML1 = MSd(i1) 
ML2 = MVP 
...
! {Sd, VZ, Fd}
If ((Include_in_loopSd).and.(Include_in_loopVZ).and.(Include_in_loopFd)) Then 
Do i1=1,6
    Do i3=1,3
ML1 = MSd(i1) 
ML2 = MVZ 
...
! {Su, conj[Hpm], Fu}
If ((Include_in_loopSu).and.(Include_in_loopHpm).and.(Include_in_loopFu)) Then 
Do i1=1,6
  Do i2=1,2
    Do i3=1,3
ML1 = MSu(i1) 
...
! {Su, conj[VWm], Fu}
If ((Include_in_loopSu).and.(Include_in_loopVWm).and.(Include_in_loopFu)) Then 
Do i1=1,6
    Do i3=1,3
ML1 = MSu(i1) 
ML2 = MVWm 
...
! {VG, conj[Sd], Glu}
If ((Include_in_loopVG).and.(Include_in_loopSd).and.(Include_in_loopGlu)) Then 
  Do i2=1,6
ML1 = MVG 
ML2 = MSd(i2) 
ML3 = MGlu 
...
End if 
    End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_SdToGluFd


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SdToGluFd(MAh,MCha,MChi,MFd,              & 
& MFu,MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,           & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,cplAhSdcSd,          & 
& cplChaFucSdL,cplChaFucSdR,cplChiFdcSdL,cplChiFdcSdR,cplGluFdcSdL,cplGluFdcSdR,         & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SdToGluFd


Subroutine Amplitude_Tree_seesaw1nmssm_SdToSdhh(cplhhSdcSd,Mhh,MSd,Mhh2,MSd2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_SdToSdhh


Subroutine Gamma_Real_seesaw1nmssm_SdToSdhh(MLambda,em,gs,cplhhSdcSd,Mhh,             & 
& MSd,GammarealPhoton,GammarealGluon)
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_SdToSdhh


Subroutine Amplitude_WAVE_seesaw1nmssm_SdToSdhh(cplhhSdcSd,ctcplhhSdcSd,              & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_SdToSdhh


Subroutine Amplitude_VERTEX_seesaw1nmssm_SdToSdhh(MAh,MCha,MChi,MFd,MFu,              & 
& MGlu,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,               & 
& MFd2,MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,               & 
...
! {Sd, VZ, Ah}
If ((Include_in_loopSd).and.(Include_in_loopVZ).and.(Include_in_loopAh)) Then 
Do i1=1,6
    Do i3=1,3
ML1 = MSd(i1) 
ML2 = MVZ 
...
! {Sd, Ah, VZ}
If ((Include_in_loopSd).and.(Include_in_loopAh).and.(Include_in_loopVZ)) Then 
Do i1=1,6
  Do i2=1,3
ML1 = MSd(i1) 
ML2 = MAh(i2) 
...
! {Sd, VZ, VZ}
If ((Include_in_loopSd).and.(Include_in_loopVZ).and.(Include_in_loopVZ)) Then 
Do i1=1,6
ML1 = MSd(i1) 
ML2 = MVZ 
ML3 = MVZ 
...
If ((Include_in_loopSu).and.(Include_in_loopVWm).and.(Include_in_loopVWm)) Then 
Do i1=1,6
ML1 = MSu(i1) 
ML2 = MVWm 
ML3 = MVWm 
...
End if 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_SdToSdhh


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SdToSdhh(MAh,MCha,MChi,MFd,               & 
& MFu,MGlu,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,           & 
& MFd2,MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,               & 
& MVZ2,cplAhAhhh,cplAhhhhh,cplAhhhVZ,cplAhSdcSd,cplChaFucSdL,cplChaFucSdR,               & 
& cplcChaChahhL,cplcChaChahhR,cplChiChihhL,cplChiChihhR,cplChiFdcSdL,cplChiFdcSdR,       & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SdToSdhh


Subroutine Amplitude_Tree_seesaw1nmssm_SdToSuHpm(cplHpmSucSd,MHpm,MSd,MSu,            & 
& MHpm2,MSd2,MSu2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_SdToSuHpm


Subroutine Gamma_Real_seesaw1nmssm_SdToSuHpm(MLambda,em,gs,cplHpmSucSd,               & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_SdToSuHpm


Subroutine Amplitude_WAVE_seesaw1nmssm_SdToSuHpm(cplHpmSucSd,ctcplHpmSucSd,           & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_SdToSuHpm


Subroutine Amplitude_VERTEX_seesaw1nmssm_SdToSuHpm(MAh,MCha,MChi,MFd,MFu,             & 
& MGlu,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,               & 
& MFd2,MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,               & 
...
& cplSeSuSvImcSdaa(6,6,6,6),cplSeSuSvRecSdaa(6,6,6,6),cplSucSdVPVWmaa(6,6),              & 
& cplSucSdVWmVZaa(6,6)
...
! {Ah, conj[Sd], conj[Su]}
If ((Include_in_loopAh).and.(Include_in_loopSd).and.(Include_in_loopSu)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,6
ML1 = MAh(i1) 
...
! {Chi, bar[Fd], bar[Fu]}
If ((Include_in_loopChi).and.(Include_in_loopFd).and.(Include_in_loopFu)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,3
ML1 = MChi(i1) 
...
! {Fd, Chi, Cha}
If ((Include_in_loopFd).and.(Include_in_loopChi).and.(Include_in_loopCha)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,2
ML1 = MFd(i1) 
...
! {Fu, bar[Cha], Chi}
If ((Include_in_loopFu).and.(Include_in_loopCha).and.(Include_in_loopChi)) Then 
Do i1=1,3
  Do i2=1,2
    Do i3=1,5
ML1 = MFu(i1) 
...
! {Glu, bar[Fd], bar[Fu]}
If ((Include_in_loopGlu).and.(Include_in_loopFd).and.(Include_in_loopFu)) Then 
  Do i2=1,3
    Do i3=1,3
ML1 = MGlu 
ML2 = MFd(i2) 
...
! {hh, conj[Sd], conj[Su]}
If ((Include_in_loophh).and.(Include_in_loopSd).and.(Include_in_loopSu)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,6
ML1 = Mhh(i1) 
...
! {Sd, Ah, Hpm}
If ((Include_in_loopSd).and.(Include_in_loopAh).and.(Include_in_loopHpm)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,2
ML1 = MSd(i1) 
...
! {Sd, hh, Hpm}
If ((Include_in_loopSd).and.(Include_in_loophh).and.(Include_in_loopHpm)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,2
ML1 = MSd(i1) 
...
! {Sd, VP, Hpm}
If ((Include_in_loopSd).and.(Include_in_loopVP).and.(Include_in_loopHpm)) Then 
Do i1=1,6
    Do i3=1,2
ML1 = MSd(i1) 
ML2 = MVP 
...
! {Sd, VZ, Hpm}
If ((Include_in_loopSd).and.(Include_in_loopVZ).and.(Include_in_loopHpm)) Then 
Do i1=1,6
    Do i3=1,2
ML1 = MSd(i1) 
ML2 = MVZ 
...
! {Sd, Ah, VWm}
If ((Include_in_loopSd).and.(Include_in_loopAh).and.(Include_in_loopVWm)) Then 
Do i1=1,6
  Do i2=1,3
ML1 = MSd(i1) 
ML2 = MAh(i2) 
...
! {Sd, hh, VWm}
If ((Include_in_loopSd).and.(Include_in_loophh).and.(Include_in_loopVWm)) Then 
Do i1=1,6
  Do i2=1,3
ML1 = MSd(i1) 
ML2 = Mhh(i2) 
...
! {Sd, VP, VWm}
If ((Include_in_loopSd).and.(Include_in_loopVP).and.(Include_in_loopVWm)) Then 
Do i1=1,6
ML1 = MSd(i1) 
ML2 = MVP 
ML3 = MVWm 
...
! {Sd, VZ, VWm}
If ((Include_in_loopSd).and.(Include_in_loopVZ).and.(Include_in_loopVWm)) Then 
Do i1=1,6
ML1 = MSd(i1) 
ML2 = MVZ 
ML3 = MVWm 
...
! {Su, conj[Hpm], Ah}
If ((Include_in_loopSu).and.(Include_in_loopHpm).and.(Include_in_loopAh)) Then 
Do i1=1,6
  Do i2=1,2
    Do i3=1,3
ML1 = MSu(i1) 
...
! {Su, conj[VWm], Ah}
If ((Include_in_loopSu).and.(Include_in_loopVWm).and.(Include_in_loopAh)) Then 
Do i1=1,6
    Do i3=1,3
ML1 = MSu(i1) 
ML2 = MVWm 
...
! {Su, conj[Hpm], hh}
If ((Include_in_loopSu).and.(Include_in_loopHpm).and.(Include_in_loophh)) Then 
Do i1=1,6
  Do i2=1,2
    Do i3=1,3
ML1 = MSu(i1) 
...
! {Su, conj[VWm], hh}
If ((Include_in_loopSu).and.(Include_in_loopVWm).and.(Include_in_loophh)) Then 
Do i1=1,6
    Do i3=1,3
ML1 = MSu(i1) 
ML2 = MVWm 
...
! {Su, conj[Hpm], VP}
If ((Include_in_loopSu).and.(Include_in_loopHpm).and.(Include_in_loopVP)) Then 
Do i1=1,6
  Do i2=1,2
ML1 = MSu(i1) 
ML2 = MHpm(i2) 
...
! {Su, conj[VWm], VP}
If ((Include_in_loopSu).and.(Include_in_loopVWm).and.(Include_in_loopVP)) Then 
Do i1=1,6
ML1 = MSu(i1) 
ML2 = MVWm 
ML3 = MVP 
...
! {Su, conj[Hpm], VZ}
If ((Include_in_loopSu).and.(Include_in_loopHpm).and.(Include_in_loopVZ)) Then 
Do i1=1,6
  Do i2=1,2
ML1 = MSu(i1) 
ML2 = MHpm(i2) 
...
! {Su, conj[VWm], VZ}
If ((Include_in_loopSu).and.(Include_in_loopVWm).and.(Include_in_loopVZ)) Then 
Do i1=1,6
ML1 = MSu(i1) 
ML2 = MVWm 
ML3 = MVZ 
...
! {VG, conj[Sd], conj[Su]}
If ((Include_in_loopVG).and.(Include_in_loopSd).and.(Include_in_loopSu)) Then 
  Do i2=1,6
    Do i3=1,6
ML1 = MVG 
ML2 = MSd(i2) 
...
! {VP, conj[Sd], conj[Su]}
If ((Include_in_loopVP).and.(Include_in_loopSd).and.(Include_in_loopSu)) Then 
  Do i2=1,6
    Do i3=1,6
ML1 = MVP 
ML2 = MSd(i2) 
...
! {VZ, conj[Sd], conj[Su]}
If ((Include_in_loopVZ).and.(Include_in_loopSd).and.(Include_in_loopSu)) Then 
  Do i2=1,6
    Do i3=1,6
ML1 = MVZ 
ML2 = MSd(i2) 
...
End if 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_SdToSuHpm


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SdToSuHpm(MAh,MCha,MChi,MFd,              & 
& MFu,MGlu,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,           & 
& MFd2,MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,               & 
& MVZ2,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSucSu,cplChaFucSdL,cplChaFucSdR,        & 
& cplcFdChaSuL,cplcFdChaSuR,cplChiFdcSdL,cplChiFdcSdR,cplcChaChiHpmL,cplcChaChiHpmR,     & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SdToSuHpm


Subroutine Amplitude_Tree_seesaw1nmssm_SdToSdVZ(cplSdcSdVZ,MSd,MVZ,MSd2,MVZ2,Amp)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_SdToSdVZ


Subroutine Gamma_Real_seesaw1nmssm_SdToSdVZ(MLambda,em,gs,cplSdcSdVZ,MSd,             & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_SdToSdVZ


Subroutine Amplitude_WAVE_seesaw1nmssm_SdToSdVZ(cplSdcSdVP,cplSdcSdVZ,ctcplSdcSdVP,   & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_SdToSdVZ


Subroutine Amplitude_VERTEX_seesaw1nmssm_SdToSdVZ(MAh,MCha,MChi,MFd,MFu,              & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
End if 
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_SdToSdVZ


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SdToSdVZ(MAh,MCha,MChi,MFd,               & 
& MFu,MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,           & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhhhVZ,cplAhSdcSd,cplChaFucSdL,           & 
& cplChaFucSdR,cplcChaChaVZL,cplcChaChaVZR,cplChiChiVZL,cplChiChiVZR,cplChiFdcSdL,       & 
& cplChiFdcSdR,cplcFdChiSdL,cplcFdChiSdR,cplGluFdcSdL,cplGluFdcSdR,cplcFdFdVZL,          & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SdToSdVZ


Subroutine Amplitude_Tree_seesaw1nmssm_SdToSuVWm(cplSucSdVWm,MSd,MSu,MVWm,            & 
& MSd2,MSu2,MVWm2,Amp)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_SdToSuVWm


Subroutine Gamma_Real_seesaw1nmssm_SdToSuVWm(MLambda,em,gs,cplSucSdVWm,               & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_SdToSuVWm


Subroutine Amplitude_WAVE_seesaw1nmssm_SdToSuVWm(cplSucSdVWm,ctcplSucSdVWm,           & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_SdToSuVWm


Subroutine Amplitude_VERTEX_seesaw1nmssm_SdToSuVWm(MAh,MCha,MChi,MFd,MFu,             & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
End if 
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_SdToSuVWm


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SdToSuVWm(MAh,MCha,MChi,MFd,              & 
& MFu,MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,           & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhSdcSd,cplAhSucSu,cplAhcHpmVWm,          & 
& cplChaFucSdL,cplChaFucSdR,cplcFdChaSuL,cplcFdChaSuR,cplChiFdcSdL,cplChiFdcSdR,         & 
& cplcFuChiSuL,cplcFuChiSuR,cplcChaChiVWmL,cplcChaChiVWmR,cplGluFdcSdL,cplGluFdcSdR,     & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SdToSuVWm


Subroutine Amplitude_WAVE_seesaw1nmssm_SdToSdVG(cplSdcSdVG,ctcplSdcSdVG,              & 
& MSd,MSd2,MVG,MVG2,ZfSd,ZfVG,Amp)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_SdToSdVG


Subroutine Amplitude_VERTEX_seesaw1nmssm_SdToSdVG(MAh,MCha,MChi,MFd,MFu,              & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
! {Fd, Glu, Glu}
If ((Include_in_loopFd).and.(Include_in_loopGlu).and.(Include_in_loopGlu)) Then 
Do i1=1,3
ML1 = MFd(i1) 
ML2 = MGlu 
ML3 = MGlu 
...
! {Sd, VG, VG}
If ((Include_in_loopSd).and.(Include_in_loopVG).and.(Include_in_loopVG)) Then 
Do i1=1,6
ML1 = MSd(i1) 
ML2 = MVG 
ML3 = MVG 
...
End if 
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_SdToSdVG


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SdToSdVG(MAh,MCha,MChi,MFd,               & 
& MFu,MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,           & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhSdcSd,cplChaFucSdL,cplChaFucSdR,        & 
& cplChiFdcSdL,cplChiFdcSdR,cplcFdChiSdL,cplcFdChiSdR,cplGluFdcSdL,cplGluFdcSdR,         & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFuFuVGL,cplcFuFuVGR,cplGluGluVGL,cplGluGluVGR,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SdToSdVG


Subroutine Amplitude_WAVE_seesaw1nmssm_SdToSdVP(cplSdcSdVP,cplSdcSdVZ,ctcplSdcSdVP,   & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_SdToSdVP


Subroutine Amplitude_VERTEX_seesaw1nmssm_SdToSdVP(MAh,MCha,MChi,MFd,MFu,              & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhSdcSd,cplChaFucSdL,cplChaFucSdR,        & 
...
End if 
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_SdToSdVP


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SdToSdVP(MAh,MCha,MChi,MFd,               & 
& MFu,MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,           & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhSdcSd,cplChaFucSdL,cplChaFucSdR,        & 
& cplcChaChaVPL,cplcChaChaVPR,cplChiFdcSdL,cplChiFdcSdR,cplcFdChiSdL,cplcFdChiSdR,       & 
& cplGluFdcSdL,cplGluFdcSdR,cplcFdFdVPL,cplcFdFdVPR,cplcFuFuVPL,cplcFuFuVPR,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SdToSdVP



End Module OneLoopDecay_Sd_seesaw1nmssm
