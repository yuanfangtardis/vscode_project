...
Module Wrapper_OneLoopDecay_Sd_seesaw1nmssm
Use Model_Data_seesaw1nmssm 
Use Kinematics 
Use OneLoopDecay_Sd_seesaw1nmssm 
Use Control 
Use Settings 
...
& cplAhSdcSd,cplAhSecSe,cplAhSucSu,cplAhSvImSvIm,cplAhSvReSvRe,cplcChacFuSdL,            & 
...
& cplAhSecSe(3,6,6),cplAhSucSu(3,6,6),cplAhSvImSvIm(3,6,6),cplAhSvReSvRe(3,6,6),         & 
...
& cplHpmSvImcSe(2,6,6),cplHpmSvRecSe(2,6,6),cplSdcHpmcSu(6,2,6),cplSdcSdcVWmVWmaa(6,6),  & 
...
& cplSdSvImSvImcSdaa(6,6,6,6),cplSdSvReSvRecSdaa(6,6,6,6),cplSeSuSvImcSdaa(6,6,6,6),     & 
& cplSeSuSvRecSdaa(6,6,6,6),cplSucSdVGVWmLamct3ct2ct1(6,6),cplSucSdVPVWmaa(6,6)
...
Call Amplitude_Tree_seesaw1nmssm_SdToSdAh(cplAhSdcSd,MAh,MSd,MAh2,MSd2,               & 
& AmpTreeSdToSdAh)

  Else 
Call Amplitude_Tree_seesaw1nmssm_SdToSdAh(ZcplAhSdcSd,MAh,MSd,MAh2,MSd2,              & 
& AmpTreeSdToSdAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_SdToSdAh(MLambda,em,gs,cplAhSdcSd,MAhOS,MSdOS,           & 
& MRPSdToSdAh,MRGSdToSdAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_SdToSdAh(MLambda,em,gs,ZcplAhSdcSd,MAhOS,MSdOS,          & 
& MRPSdToSdAh,MRGSdToSdAh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_SdToSdAh(MLambda,em,gs,cplAhSdcSd,MAh,MSd,               & 
& MRPSdToSdAh,MRGSdToSdAh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_SdToSdAh(MLambda,em,gs,ZcplAhSdcSd,MAh,MSd,              & 
& MRPSdToSdAh,MRGSdToSdAh)
...
Call Amplitude_WAVE_seesaw1nmssm_SdToSdAh(cplAhSdcSd,ctcplAhSdcSd,MAh,MAh2,           & 
& MSd,MSd2,ZfAh,ZfSd,AmpWaveSdToSdAh)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_SdToSdAh(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SdToSdAh(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplAhAhAh,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,             & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhhhhh,cplAhhhVZ,cplAhHpmcHpm,      & 
...
& AmpVertexIRdrSdToSdAh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SdToSdAh(MAhOS,MChaOS,MChiOS,MFdOS,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_SdToFuCha(cplChaFucSdL,cplChaFucSdR,MCha,            & 
& MFu,MSd,MCha2,MFu2,MSd2,AmpTreeSdToFuCha)

  Else 
Call Amplitude_Tree_seesaw1nmssm_SdToFuCha(ZcplChaFucSdL,ZcplChaFucSdR,               & 
& MCha,MFu,MSd,MCha2,MFu2,MSd2,AmpTreeSdToFuCha)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_SdToFuCha(MLambda,em,gs,cplChaFucSdL,cplChaFucSdR,       & 
& MChaOS,MFuOS,MSdOS,MRPSdToFuCha,MRGSdToFuCha)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_SdToFuCha(MLambda,em,gs,ZcplChaFucSdL,ZcplChaFucSdR,     & 
& MChaOS,MFuOS,MSdOS,MRPSdToFuCha,MRGSdToFuCha)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_SdToFuCha(cplChaFucSdL,cplChaFucSdR,ctcplChaFucSdL,  & 
& ctcplChaFucSdR,MCha,MCha2,MFu,MFu2,MSd,MSd2,ZfFUL,ZfFUR,ZfLm,ZfLp,ZfSd,AmpWaveSdToFuCha)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_SdToFuCha(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
...
& cplhhSdcSd,cplHpmSucSd,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSucSdVWm,AmpVertexSdToFuCha)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SdToFuCha(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcChaChaAhL,cplcChaChaAhR,cplcFuFuAhL,          & 
& cplcFuFuAhR,cplAhSdcSd,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,    & 
& cplChaFucSdL,cplChaFucSdR,cplcChaChahhL,cplcChaChahhR,cplcFdChaSuL,cplcFdChaSuR,       & 
...
& cplhhSdcSd,cplHpmSucSd,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSucSdVWm,AmpVertexIRdrSdToFuCha)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SdToFuCha(MAhOS,MChaOS,MChiOS,MFdOS,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_SdToFdChi(cplChiFdcSdL,cplChiFdcSdR,MChi,            & 
& MFd,MSd,MChi2,MFd2,MSd2,AmpTreeSdToFdChi)

  Else 
Call Amplitude_Tree_seesaw1nmssm_SdToFdChi(ZcplChiFdcSdL,ZcplChiFdcSdR,               & 
& MChi,MFd,MSd,MChi2,MFd2,MSd2,AmpTreeSdToFdChi)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_SdToFdChi(MLambda,em,gs,cplChiFdcSdL,cplChiFdcSdR,       & 
& MChiOS,MFdOS,MSdOS,MRPSdToFdChi,MRGSdToFdChi)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_SdToFdChi(MLambda,em,gs,ZcplChiFdcSdL,ZcplChiFdcSdR,     & 
& MChiOS,MFdOS,MSdOS,MRPSdToFdChi,MRGSdToFdChi)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_SdToFdChi(cplChiFdcSdL,cplChiFdcSdR,ctcplChiFdcSdL,  & 
& ctcplChiFdcSdR,MChi,MChi2,MFd,MFd2,MSd,MSd2,ZfFDL,ZfFDR,ZfL0,ZfSd,AmpWaveSdToFdChi)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_SdToFdChi(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
& cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSucSdVWm,AmpVertexSdToFdChi)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SdToFdChi(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,            & 
& cplcFdFdAhR,cplAhSdcSd,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,    & 
& cplChaFucSdL,cplChaFucSdR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,         & 
...
& cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSucSdVWm,AmpVertexIRdrSdToFdChi)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SdToFdChi(MAhOS,MChaOS,MChiOS,MFdOS,            & 
& MFuOS,MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,             & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_SdToGluFd(cplGluFdcSdL,cplGluFdcSdR,MFd,             & 
& MGlu,MSd,MFd2,MGlu2,MSd2,AmpTreeSdToGluFd)

  Else 
Call Amplitude_Tree_seesaw1nmssm_SdToGluFd(ZcplGluFdcSdL,ZcplGluFdcSdR,               & 
& MFd,MGlu,MSd,MFd2,MGlu2,MSd2,AmpTreeSdToGluFd)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_SdToGluFd(MLambda,em,gs,cplGluFdcSdL,cplGluFdcSdR,       & 
& MFdOS,MGluOS,MSdOS,MRPSdToGluFd,MRGSdToGluFd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_SdToGluFd(MLambda,em,gs,ZcplGluFdcSdL,ZcplGluFdcSdR,     & 
& MFdOS,MGluOS,MSdOS,MRPSdToGluFd,MRGSdToGluFd)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_SdToGluFd(cplGluFdcSdL,cplGluFdcSdR,ctcplGluFdcSdL,  & 
& ctcplGluFdcSdR,MFd,MFd2,MGlu,MGlu2,MSd,MSd2,ZfFDL,ZfFDR,ZffG,ZfSd,AmpWaveSdToGluFd)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_SdToGluFd(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
& cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSucSdVWm,AmpVertexSdToGluFd)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SdToGluFd(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,cplAhSdcSd,               & 
& cplChaFucSdL,cplChaFucSdR,cplChiFdcSdL,cplChiFdcSdR,cplGluFdcSdL,cplGluFdcSdR,         & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,               & 
...
& cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSucSdVWm,AmpVertexIRdrSdToGluFd)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SdToGluFd(MAhOS,MChaOS,MChiOS,MFdOS,            & 
& MFuOS,MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,             & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_SdToSdhh(cplhhSdcSd,Mhh,MSd,Mhh2,MSd2,               & 
& AmpTreeSdToSdhh)

  Else 
Call Amplitude_Tree_seesaw1nmssm_SdToSdhh(ZcplhhSdcSd,Mhh,MSd,Mhh2,MSd2,              & 
& AmpTreeSdToSdhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_SdToSdhh(MLambda,em,gs,cplhhSdcSd,MhhOS,MSdOS,           & 
& MRPSdToSdhh,MRGSdToSdhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_SdToSdhh(MLambda,em,gs,ZcplhhSdcSd,MhhOS,MSdOS,          & 
& MRPSdToSdhh,MRGSdToSdhh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_SdToSdhh(MLambda,em,gs,cplhhSdcSd,Mhh,MSd,               & 
& MRPSdToSdhh,MRGSdToSdhh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_SdToSdhh(MLambda,em,gs,ZcplhhSdcSd,Mhh,MSd,              & 
& MRPSdToSdhh,MRGSdToSdhh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_SdToSdhh(cplhhSdcSd,ctcplhhSdcSd,Mhh,Mhh2,           & 
& MSd,MSd2,Zfhh,ZfSd,AmpWaveSdToSdhh)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_SdToSdhh(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,MVZ2,               & 
...
& cplSdSvReSvRecSdaa,cplSdcSdcVWmVWmaa,cplSdcSdVZVZaa,AmpVertexSdToSdhh)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SdToSdhh(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplAhAhhh,cplAhhhhh,cplAhhhVZ,cplAhSdcSd,cplChaFucSdL,cplChaFucSdR,cplcChaChahhL,      & 
& cplcChaChahhR,cplChiChihhL,cplChiChihhR,cplChiFdcSdL,cplChiFdcSdR,cplcFdChiSdL,        & 
...
& cplSdSvReSvRecSdaa,cplSdcSdcVWmVWmaa,cplSdcSdVZVZaa,AmpVertexIRdrSdToSdhh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SdToSdhh(MAhOS,MChaOS,MChiOS,MFdOS,             & 
& MFuOS,MGluOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVG,MVP,MVWmOS,            & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,              & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_SdToSuHpm(cplHpmSucSd,MHpm,MSd,MSu,MHpm2,            & 
& MSd2,MSu2,AmpTreeSdToSuHpm)

  Else 
Call Amplitude_Tree_seesaw1nmssm_SdToSuHpm(ZcplHpmSucSd,MHpm,MSd,MSu,MHpm2,           & 
& MSd2,MSu2,AmpTreeSdToSuHpm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_SdToSuHpm(MLambda,em,gs,cplHpmSucSd,MHpmOS,              & 
& MSdOS,MSuOS,MRPSdToSuHpm,MRGSdToSuHpm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_SdToSuHpm(MLambda,em,gs,ZcplHpmSucSd,MHpmOS,             & 
& MSdOS,MSuOS,MRPSdToSuHpm,MRGSdToSuHpm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_SdToSuHpm(MLambda,em,gs,cplHpmSucSd,MHpm,MSd,            & 
& MSu,MRPSdToSuHpm,MRGSdToSuHpm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_SdToSuHpm(MLambda,em,gs,ZcplHpmSucSd,MHpm,               & 
& MSd,MSu,MRPSdToSuHpm,MRGSdToSuHpm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_SdToSuHpm(cplHpmSucSd,ctcplHpmSucSd,MHpm,            & 
& MHpm2,MSd,MSd2,MSu,MSu2,ZfHpm,ZfSd,ZfSu,AmpWaveSdToSuHpm)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_SdToSuHpm(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,MVZ2,               & 
...
& cplSucSdVWmVZaa,AmpVertexSdToSuHpm)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SdToSuHpm(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSucSu,cplChaFucSdL,cplChaFucSdR,             & 
& cplcFdChaSuL,cplcFdChaSuR,cplChiFdcSdL,cplChiFdcSdR,cplcChaChiHpmL,cplcChaChiHpmR,     & 
...
& cplSucSdVWmVZaa,AmpVertexIRdrSdToSuHpm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SdToSuHpm(MAhOS,MChaOS,MChiOS,MFdOS,            & 
& MFuOS,MGluOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVG,MVP,MVWmOS,            & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,              & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_SdToSdVZ(cplSdcSdVZ,MSd,MVZ,MSd2,MVZ2,               & 
& AmpTreeSdToSdVZ)

  Else 
Call Amplitude_Tree_seesaw1nmssm_SdToSdVZ(ZcplSdcSdVZ,MSd,MVZ,MSd2,MVZ2,              & 
& AmpTreeSdToSdVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_SdToSdVZ(MLambda,em,gs,cplSdcSdVZ,MSdOS,MVZOS,           & 
& MRPSdToSdVZ,MRGSdToSdVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_SdToSdVZ(MLambda,em,gs,ZcplSdcSdVZ,MSdOS,MVZOS,          & 
& MRPSdToSdVZ,MRGSdToSdVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_SdToSdVZ(MLambda,em,gs,cplSdcSdVZ,MSd,MVZ,               & 
& MRPSdToSdVZ,MRGSdToSdVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_SdToSdVZ(MLambda,em,gs,ZcplSdcSdVZ,MSd,MVZ,              & 
& MRPSdToSdVZ,MRGSdToSdVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_SdToSdVZ(cplSdcSdVP,cplSdcSdVZ,ctcplSdcSdVP,         & 
& ctcplSdcSdVZ,MSd,MSd2,MVP,MVP2,MVZ,MVZ2,ZfSd,ZfVPVZ,ZfVZ,AmpWaveSdToSdVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_SdToSdVZ(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SdToSdVZ(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhhhVZ,cplAhSdcSd,cplChaFucSdL,cplChaFucSdR,   & 
& cplcChaChaVZL,cplcChaChaVZR,cplChiChiVZL,cplChiChiVZR,cplChiFdcSdL,cplChiFdcSdR,       & 
& cplcFdChiSdL,cplcFdChiSdR,cplGluFdcSdL,cplGluFdcSdR,cplcFdFdVZL,cplcFdFdVZR,           & 
...
& cplSucSdVWmVZaa,AmpVertexIRdrSdToSdVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SdToSdVZ(MAhOS,MChaOS,MChiOS,MFdOS,             & 
& MFuOS,MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,             & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_SdToSuVWm(cplSucSdVWm,MSd,MSu,MVWm,MSd2,             & 
& MSu2,MVWm2,AmpTreeSdToSuVWm)

  Else 
Call Amplitude_Tree_seesaw1nmssm_SdToSuVWm(ZcplSucSdVWm,MSd,MSu,MVWm,MSd2,            & 
& MSu2,MVWm2,AmpTreeSdToSuVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_SdToSuVWm(MLambda,em,gs,cplSucSdVWm,MSdOS,               & 
& MSuOS,MVWmOS,MRPSdToSuVWm,MRGSdToSuVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_SdToSuVWm(MLambda,em,gs,ZcplSucSdVWm,MSdOS,              & 
& MSuOS,MVWmOS,MRPSdToSuVWm,MRGSdToSuVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_SdToSuVWm(MLambda,em,gs,cplSucSdVWm,MSd,MSu,             & 
& MVWm,MRPSdToSuVWm,MRGSdToSuVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_SdToSuVWm(MLambda,em,gs,ZcplSucSdVWm,MSd,MSu,            & 
& MVWm,MRPSdToSuVWm,MRGSdToSuVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_SdToSuVWm(cplSucSdVWm,ctcplSucSdVWm,MSd,             & 
& MSd2,MSu,MSu2,MVWm,MVWm2,ZfSd,ZfSu,ZfVWm,AmpWaveSdToSuVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_SdToSuVWm(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
& cplSucSdVWmVZaa,cplSucSucVWmVWmaa,AmpVertexSdToSuVWm)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SdToSuVWm(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhSdcSd,cplAhSucSu,cplAhcHpmVWm,               & 
& cplChaFucSdL,cplChaFucSdR,cplcFdChaSuL,cplcFdChaSuR,cplChiFdcSdL,cplChiFdcSdR,         & 
& cplcFuChiSuL,cplcFuChiSuR,cplcChaChiVWmL,cplcChaChiVWmR,cplGluFdcSdL,cplGluFdcSdR,     & 
...
& cplSucSdVWmVZaa,cplSucSucVWmVWmaa,AmpVertexIRdrSdToSuVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SdToSuVWm(MAhOS,MChaOS,MChiOS,MFdOS,            & 
& MFuOS,MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,             & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_seesaw1nmssm_SdToSdVG(cplSdcSdVG,ctcplSdcSdVG,MSdOS,              & 
& MSd2OS,MVG,MVG2,ZfSd,ZfVG,AmpWaveSdToSdVG)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_seesaw1nmssm_SdToSdVG(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,          & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_SdToSdVG(cplSdcSdVG,ctcplSdcSdVG,MSd,MSd2,           & 
& MVG,MVG2,ZfSd,ZfVG,AmpWaveSdToSdVG)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_SdToSdVG(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_seesaw1nmssm_SdToSdVP(cplSdcSdVP,cplSdcSdVZ,ctcplSdcSdVP,         & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_seesaw1nmssm_SdToSdVP(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,          & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,MChi2OS,           & 
& MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,           & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_SdToSdVP(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhSdcSd,cplChaFucSdL,cplChaFucSdR,             & 
...
End Module Wrapper_OneLoopDecay_Sd_seesaw1nmssm
