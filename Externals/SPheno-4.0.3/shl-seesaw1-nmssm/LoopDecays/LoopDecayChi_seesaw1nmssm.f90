...
! ------------------------------------------------------------------------------  
! File created at 18:44 on 2.10.2017   
! ----------------------------------------------------------------------  
 
 
Module OneLoopDecay_Chi_seesaw1nmssm
Use Control 
Use Settings 
Use LoopFunctions 
...
Subroutine Amplitude_Tree_seesaw1nmssm_ChiToChiAh(cplChiChiAhL,cplChiChiAhR,          & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_ChiToChiAh


Subroutine Gamma_Real_seesaw1nmssm_ChiToChiAh(MLambda,em,gs,cplChiChiAhL,             & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_ChiToChiAh


Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToChiAh(cplChiChiAhL,cplChiChiAhR,          & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToChiAh


Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToChiAh(MAh,MCha,MChi,MFd,MFe,            & 
...
! {Ah, Chi, Chi}
If ((Include_in_loopAh).and.(Include_in_loopChi).and.(Include_in_loopChi)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,5
ML1 = MAh(i1) 
...
! {Cha, Hpm, Hpm}
If ((Include_in_loopCha).and.(Include_in_loopHpm).and.(Include_in_loopHpm)) Then 
Do i1=1,2
  Do i2=1,2
    Do i3=1,2
ML1 = MCha(i1) 
...
! {Cha, VWm, Hpm}
If ((Include_in_loopCha).and.(Include_in_loopVWm).and.(Include_in_loopHpm)) Then 
Do i1=1,2
    Do i3=1,2
ML1 = MCha(i1) 
ML2 = MVWm 
...
! {Cha, Hpm, VWm}
If ((Include_in_loopCha).and.(Include_in_loopHpm).and.(Include_in_loopVWm)) Then 
Do i1=1,2
  Do i2=1,2
ML1 = MCha(i1) 
ML2 = MHpm(i2) 
...
! {Chi, Ah, Ah}
If ((Include_in_loopChi).and.(Include_in_loopAh).and.(Include_in_loopAh)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,3
ML1 = MChi(i1) 
...
! {Chi, hh, Ah}
If ((Include_in_loopChi).and.(Include_in_loophh).and.(Include_in_loopAh)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,3
ML1 = MChi(i1) 
...
! {Chi, Ah, hh}
If ((Include_in_loopChi).and.(Include_in_loopAh).and.(Include_in_loophh)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,3
ML1 = MChi(i1) 
...
! {Chi, hh, hh}
If ((Include_in_loopChi).and.(Include_in_loophh).and.(Include_in_loophh)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,3
ML1 = MChi(i1) 
...
! {Chi, VZ, hh}
If ((Include_in_loopChi).and.(Include_in_loopVZ).and.(Include_in_loophh)) Then 
Do i1=1,5
    Do i3=1,3
ML1 = MChi(i1) 
ML2 = MVZ 
...
! {Chi, hh, VZ}
If ((Include_in_loopChi).and.(Include_in_loophh).and.(Include_in_loopVZ)) Then 
Do i1=1,5
  Do i2=1,3
ML1 = MChi(i1) 
ML2 = Mhh(i2) 
...
! {Fd, Sd, Sd}
If ((Include_in_loopFd).and.(Include_in_loopSd).and.(Include_in_loopSd)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,6
ML1 = MFd(i1) 
...
! {Fe, Se, Se}
If ((Include_in_loopFe).and.(Include_in_loopSe).and.(Include_in_loopSe)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,6
ML1 = MFe(i1) 
...
! {Fu, Su, Su}
If ((Include_in_loopFu).and.(Include_in_loopSu).and.(Include_in_loopSu)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,6
ML1 = MFu(i1) 
...
! {Fv, SvIm, SvIm}
If ((Include_in_loopFv).and.(Include_in_loopSvIm).and.(Include_in_loopSvIm)) Then 
Do i1=1,6
  Do i2=1,6
    Do i3=1,6
ML1 = MFv(i1) 
...
! {Fv, SvRe, SvIm}
If ((Include_in_loopFv).and.(Include_in_loopSvRe).and.(Include_in_loopSvIm)) Then 
Do i1=1,6
  Do i2=1,6
    Do i3=1,6
ML1 = MFv(i1) 
...
! {Fv, SvIm, SvRe}
If ((Include_in_loopFv).and.(Include_in_loopSvIm).and.(Include_in_loopSvRe)) Then 
Do i1=1,6
  Do i2=1,6
    Do i3=1,6
ML1 = MFv(i1) 
...
! {Fv, SvRe, SvRe}
If ((Include_in_loopFv).and.(Include_in_loopSvRe).and.(Include_in_loopSvRe)) Then 
Do i1=1,6
  Do i2=1,6
    Do i3=1,6
ML1 = MFv(i1) 
...
! {hh, Chi, Chi}
If ((Include_in_loophh).and.(Include_in_loopChi).and.(Include_in_loopChi)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,5
ML1 = Mhh(i1) 
...
! {Hpm, Cha, Cha}
If ((Include_in_loopHpm).and.(Include_in_loopCha).and.(Include_in_loopCha)) Then 
Do i1=1,2
  Do i2=1,2
    Do i3=1,2
ML1 = MHpm(i1) 
...
! {Sd, Fd, Fd}
If ((Include_in_loopSd).and.(Include_in_loopFd).and.(Include_in_loopFd)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,3
ML1 = MSd(i1) 
...
! {Se, Fe, Fe}
If ((Include_in_loopSe).and.(Include_in_loopFe).and.(Include_in_loopFe)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,3
ML1 = MSe(i1) 
...
! {Su, Fu, Fu}
If ((Include_in_loopSu).and.(Include_in_loopFu).and.(Include_in_loopFu)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,3
ML1 = MSu(i1) 
...
! {SvIm, Fv, Fv}
If ((Include_in_loopSvIm).and.(Include_in_loopFv).and.(Include_in_loopFv)) Then 
Do i1=1,6
  Do i2=1,6
    Do i3=1,6
ML1 = MSvIm(i1) 
...
! {SvRe, Fv, Fv}
If ((Include_in_loopSvRe).and.(Include_in_loopFv).and.(Include_in_loopFv)) Then 
Do i1=1,6
  Do i2=1,6
    Do i3=1,6
ML1 = MSvRe(i1) 
...
! {VWm, Cha, Cha}
If ((Include_in_loopVWm).and.(Include_in_loopCha).and.(Include_in_loopCha)) Then 
  Do i2=1,2
    Do i3=1,2
ML1 = MVWm 
ML2 = MCha(i2) 
...
! {VZ, Chi, Chi}
If ((Include_in_loopVZ).and.(Include_in_loopChi).and.(Include_in_loopChi)) Then 
  Do i2=1,5
    Do i3=1,5
ML1 = MVZ 
ML2 = MChi(i2) 
...
End if 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToChiAh


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToChiAh(MAh,MCha,MChi,MFd,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToChiAh


Subroutine Amplitude_Tree_seesaw1nmssm_ChiToChacHpm(cplChiChacHpmL,cplChiChacHpmR,    & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_ChiToChacHpm


Subroutine Gamma_Real_seesaw1nmssm_ChiToChacHpm(MLambda,em,gs,cplChiChacHpmL,         & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_ChiToChacHpm


Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToChacHpm(cplChiChacHpmL,cplChiChacHpmR,    & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToChacHpm


Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToChacHpm(MAh,MCha,MChi,MFd,              & 
...
! {Ah, Chi, bar[Cha]}
If ((Include_in_loopAh).and.(Include_in_loopChi).and.(Include_in_loopCha)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,2
ML1 = MAh(i1) 
...
! {Cha, Hpm, Ah}
If ((Include_in_loopCha).and.(Include_in_loopHpm).and.(Include_in_loopAh)) Then 
Do i1=1,2
  Do i2=1,2
    Do i3=1,3
ML1 = MCha(i1) 
...
! {Cha, VWm, Ah}
If ((Include_in_loopCha).and.(Include_in_loopVWm).and.(Include_in_loopAh)) Then 
Do i1=1,2
    Do i3=1,3
ML1 = MCha(i1) 
ML2 = MVWm 
...
! {Cha, Hpm, hh}
If ((Include_in_loopCha).and.(Include_in_loopHpm).and.(Include_in_loophh)) Then 
Do i1=1,2
  Do i2=1,2
    Do i3=1,3
ML1 = MCha(i1) 
...
! {Cha, VWm, hh}
If ((Include_in_loopCha).and.(Include_in_loopVWm).and.(Include_in_loophh)) Then 
Do i1=1,2
    Do i3=1,3
ML1 = MCha(i1) 
ML2 = MVWm 
...
! {Cha, Hpm, VP}
If ((Include_in_loopCha).and.(Include_in_loopHpm).and.(Include_in_loopVP)) Then 
Do i1=1,2
  Do i2=1,2
ML1 = MCha(i1) 
ML2 = MHpm(i2) 
...
! {Cha, VWm, VP}
If ((Include_in_loopCha).and.(Include_in_loopVWm).and.(Include_in_loopVP)) Then 
Do i1=1,2
ML1 = MCha(i1) 
ML2 = MVWm 
ML3 = MVP 
...
! {Cha, Hpm, VZ}
If ((Include_in_loopCha).and.(Include_in_loopHpm).and.(Include_in_loopVZ)) Then 
Do i1=1,2
  Do i2=1,2
ML1 = MCha(i1) 
ML2 = MHpm(i2) 
...
! {Cha, VWm, VZ}
If ((Include_in_loopCha).and.(Include_in_loopVWm).and.(Include_in_loopVZ)) Then 
Do i1=1,2
ML1 = MCha(i1) 
ML2 = MVWm 
ML3 = MVZ 
...
! {Chi, Ah, conj[Hpm]}
If ((Include_in_loopChi).and.(Include_in_loopAh).and.(Include_in_loopHpm)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,2
ML1 = MChi(i1) 
...
! {Chi, hh, conj[Hpm]}
If ((Include_in_loopChi).and.(Include_in_loophh).and.(Include_in_loopHpm)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,2
ML1 = MChi(i1) 
...
! {Chi, VZ, conj[Hpm]}
If ((Include_in_loopChi).and.(Include_in_loopVZ).and.(Include_in_loopHpm)) Then 
Do i1=1,5
    Do i3=1,2
ML1 = MChi(i1) 
ML2 = MVZ 
...
! {Chi, Ah, conj[VWm]}
If ((Include_in_loopChi).and.(Include_in_loopAh).and.(Include_in_loopVWm)) Then 
Do i1=1,5
  Do i2=1,3
ML1 = MChi(i1) 
ML2 = MAh(i2) 
...
! {Chi, hh, conj[VWm]}
If ((Include_in_loopChi).and.(Include_in_loophh).and.(Include_in_loopVWm)) Then 
Do i1=1,5
  Do i2=1,3
ML1 = MChi(i1) 
ML2 = Mhh(i2) 
...
! {Chi, VZ, conj[VWm]}
If ((Include_in_loopChi).and.(Include_in_loopVZ).and.(Include_in_loopVWm)) Then 
Do i1=1,5
ML1 = MChi(i1) 
ML2 = MVZ 
ML3 = MVWm 
...
! {Fd, Sd, Su}
If ((Include_in_loopFd).and.(Include_in_loopSd).and.(Include_in_loopSu)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,6
ML1 = MFd(i1) 
...
! {Fe, Se, SvIm}
If ((Include_in_loopFe).and.(Include_in_loopSe).and.(Include_in_loopSvIm)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,6
ML1 = MFe(i1) 
...
! {Fe, Se, SvRe}
If ((Include_in_loopFe).and.(Include_in_loopSe).and.(Include_in_loopSvRe)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,6
ML1 = MFe(i1) 
...
! {Fv, SvIm, conj[Se]}
If ((Include_in_loopFv).and.(Include_in_loopSvIm).and.(Include_in_loopSe)) Then 
Do i1=1,6
  Do i2=1,6
    Do i3=1,6
ML1 = MFv(i1) 
...
! {Fv, SvRe, conj[Se]}
If ((Include_in_loopFv).and.(Include_in_loopSvRe).and.(Include_in_loopSe)) Then 
Do i1=1,6
  Do i2=1,6
    Do i3=1,6
ML1 = MFv(i1) 
...
! {hh, Chi, bar[Cha]}
If ((Include_in_loophh).and.(Include_in_loopChi).and.(Include_in_loopCha)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,2
ML1 = Mhh(i1) 
...
! {Hpm, Cha, Chi}
If ((Include_in_loopHpm).and.(Include_in_loopCha).and.(Include_in_loopChi)) Then 
Do i1=1,2
  Do i2=1,2
    Do i3=1,5
ML1 = MHpm(i1) 
...
! {Sd, Fd, Fu}
If ((Include_in_loopSd).and.(Include_in_loopFd).and.(Include_in_loopFu)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,3
ML1 = MSd(i1) 
...
! {Se, Fe, Fv}
If ((Include_in_loopSe).and.(Include_in_loopFe).and.(Include_in_loopFv)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,6
ML1 = MSe(i1) 
...
! {SvIm, Fv, bar[Fe]}
If ((Include_in_loopSvIm).and.(Include_in_loopFv).and.(Include_in_loopFe)) Then 
Do i1=1,6
  Do i2=1,6
    Do i3=1,3
ML1 = MSvIm(i1) 
...
! {SvRe, Fv, bar[Fe]}
If ((Include_in_loopSvRe).and.(Include_in_loopFv).and.(Include_in_loopFe)) Then 
Do i1=1,6
  Do i2=1,6
    Do i3=1,3
ML1 = MSvRe(i1) 
...
! {VWm, Cha, Chi}
If ((Include_in_loopVWm).and.(Include_in_loopCha).and.(Include_in_loopChi)) Then 
  Do i2=1,2
    Do i3=1,5
ML1 = MVWm 
ML2 = MCha(i2) 
...
! {VZ, Chi, bar[Cha]}
If ((Include_in_loopVZ).and.(Include_in_loopChi).and.(Include_in_loopCha)) Then 
  Do i2=1,5
    Do i3=1,2
ML1 = MVZ 
ML2 = MChi(i2) 
...
If ((Include_in_loopFu).and.(Include_in_loopSu).and.(Include_in_loopSd)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,6
ML1 = MFu(i1) 
...
If ((Include_in_loopSu).and.(Include_in_loopFu).and.(Include_in_loopFd)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,3
ML1 = MSu(i1) 
...
End if 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToChacHpm


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToChacHpm(MAh,MCha,MChi,               & 
& MFd,MFe,MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,              & 
& MChi2,MFd2,MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,          & 
& MVZ2,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplAhHpmcHpm,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToChacHpm


Subroutine Amplitude_Tree_seesaw1nmssm_ChiToChacVWm(cplChiChacVWmL,cplChiChacVWmR,    & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_ChiToChacVWm


Subroutine Gamma_Real_seesaw1nmssm_ChiToChacVWm(MLambda,em,gs,cplChiChacVWmL,         & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_ChiToChacVWm


Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToChacVWm(cplChiChacVWmL,cplChiChacVWmR,    & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToChacVWm


Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToChacVWm(MAh,MCha,MChi,MFd,              & 
& MFe,MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,            & 
& MFd2,MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,           & 
...
& cplChiFvSvImR(5,6,6),cplChiFvSvReL(5,6,6),cplChiFvSvReR(5,6,6),cplcChaChiHpmL(2,5,2),  & 
...
& cplFvFecVWmR(6,3),cplhhHpmcVWm(3,2),cplhhcVWmVWm(3),cplHpmcVWmVP(2),cplHpmcVWmVZ(2),   & 
...
End if 
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToChacVWm


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToChacVWm(MAh,MCha,MChi,               & 
& MFd,MFe,MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,              & 
& MChi2,MFd2,MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,          & 
& MVZ2,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplAhHpmcVWm,               & 
& cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,cplChaFucSdL,              & 
& cplChaFucSdR,cplFvChacSeL,cplFvChacSeR,cplcChaChahhL,cplcChaChahhR,cplcFdChaSuL,       & 
& cplcFdChaSuR,cplcFeChaSvImL,cplcFeChaSvImR,cplcFeChaSvReL,cplcFeChaSvReR,              & 
& cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,cplcChaChaVZR,cplChiChihhL,cplChiChihhR,     & 
...
& cplSdcSucVWm,cplSeSvImcVWm,cplSeSvRecVWm,cplcVWmVPVWm,cplcVWmVWmVZ,Amp)
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToChacVWm


Subroutine Amplitude_Tree_seesaw1nmssm_ChiToChihh(cplChiChihhL,cplChiChihhR,          & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_ChiToChihh


Subroutine Gamma_Real_seesaw1nmssm_ChiToChihh(MLambda,em,gs,cplChiChihhL,             & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_ChiToChihh


Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToChihh(cplChiChihhL,cplChiChihhR,          & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToChihh


Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToChihh(MAh,MCha,MChi,MFd,MFe,            & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
...
! {Cha, VWm, VWm}
If ((Include_in_loopCha).and.(Include_in_loopVWm).and.(Include_in_loopVWm)) Then 
Do i1=1,2
ML1 = MCha(i1) 
ML2 = MVWm 
ML3 = MVWm 
...
! {Chi, VZ, Ah}
If ((Include_in_loopChi).and.(Include_in_loopVZ).and.(Include_in_loopAh)) Then 
Do i1=1,5
    Do i3=1,3
ML1 = MChi(i1) 
ML2 = MVZ 
...
! {Chi, Ah, VZ}
If ((Include_in_loopChi).and.(Include_in_loopAh).and.(Include_in_loopVZ)) Then 
Do i1=1,5
  Do i2=1,3
ML1 = MChi(i1) 
ML2 = MAh(i2) 
...
! {Chi, VZ, VZ}
If ((Include_in_loopChi).and.(Include_in_loopVZ).and.(Include_in_loopVZ)) Then 
Do i1=1,5
ML1 = MChi(i1) 
ML2 = MVZ 
ML3 = MVZ 
...
End if 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToChihh


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToChihh(MAh,MCha,MChi,MFd,             & 
& MFe,MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,           & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVWm2,MVZ2,cplAhAhhh,           & 
& cplChiChiAhL,cplChiChiAhR,cplAhhhhh,cplAhhhVZ,cplChiChacHpmL,cplChiChacHpmR,           & 
& cplChiChacVWmL,cplChiChacVWmR,cplcChaChahhL,cplcChaChahhR,cplChiChihhL,cplChiChihhR,   & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToChihh


Subroutine Amplitude_Tree_seesaw1nmssm_ChiToChiVZ(cplChiChiVZL,cplChiChiVZR,          & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_ChiToChiVZ


Subroutine Gamma_Real_seesaw1nmssm_ChiToChiVZ(MLambda,em,gs,cplChiChiVZL,             & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_ChiToChiVZ


Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToChiVZ(cplChiChiVZL,cplChiChiVZR,          & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToChiVZ


Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToChiVZ(MAh,MCha,MChi,MFd,MFe,            & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
...
& cplSvImSvReVZ(6,6),cplcHpmVWmVZ(2),cplcVWmVWmVZ
...
End if 
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToChiVZ


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToChiVZ(MAh,MCha,MChi,MFd,             & 
& MFe,MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,           & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVWm2,MVZ2,cplChiChiAhL,        & 
& cplChiChiAhR,cplAhhhVZ,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,    & 
& cplcChaChaVZL,cplcChaChaVZR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,       & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToChiVZ


Subroutine Amplitude_Tree_seesaw1nmssm_ChiToFdcSd(cplChiFdcSdL,cplChiFdcSdR,          & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_ChiToFdcSd


Subroutine Gamma_Real_seesaw1nmssm_ChiToFdcSd(MLambda,em,gs,cplChiFdcSdL,             & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_ChiToFdcSd


Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToFdcSd(cplChiFdcSdL,cplChiFdcSdR,          & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToFdcSd


Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToFdcSd(MAh,MCha,MChi,MFd,MFu,            & 
...
! {Ah, Chi, bar[Fd]}
If ((Include_in_loopAh).and.(Include_in_loopChi).and.(Include_in_loopFd)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,3
ML1 = MAh(i1) 
...
! {Cha, Hpm, conj[Su]}
If ((Include_in_loopCha).and.(Include_in_loopHpm).and.(Include_in_loopSu)) Then 
Do i1=1,2
  Do i2=1,2
    Do i3=1,6
ML1 = MCha(i1) 
...
! {Cha, VWm, conj[Su]}
If ((Include_in_loopCha).and.(Include_in_loopVWm).and.(Include_in_loopSu)) Then 
Do i1=1,2
    Do i3=1,6
ML1 = MCha(i1) 
ML2 = MVWm 
...
! {Chi, Ah, conj[Sd]}
If ((Include_in_loopChi).and.(Include_in_loopAh).and.(Include_in_loopSd)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,6
ML1 = MChi(i1) 
...
! {Chi, hh, conj[Sd]}
If ((Include_in_loopChi).and.(Include_in_loophh).and.(Include_in_loopSd)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,6
ML1 = MChi(i1) 
...
! {Chi, VZ, conj[Sd]}
If ((Include_in_loopChi).and.(Include_in_loopVZ).and.(Include_in_loopSd)) Then 
Do i1=1,5
    Do i3=1,6
ML1 = MChi(i1) 
ML2 = MVZ 
...
! {Fd, Sd, Ah}
If ((Include_in_loopFd).and.(Include_in_loopSd).and.(Include_in_loopAh)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,3
ML1 = MFd(i1) 
...
! {Fd, Sd, hh}
If ((Include_in_loopFd).and.(Include_in_loopSd).and.(Include_in_loophh)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,3
ML1 = MFd(i1) 
...
! {Fd, Sd, VG}
If ((Include_in_loopFd).and.(Include_in_loopSd).and.(Include_in_loopVG)) Then 
Do i1=1,3
  Do i2=1,6
ML1 = MFd(i1) 
ML2 = MSd(i2) 
...
! {Fd, Sd, VP}
If ((Include_in_loopFd).and.(Include_in_loopSd).and.(Include_in_loopVP)) Then 
Do i1=1,3
  Do i2=1,6
ML1 = MFd(i1) 
ML2 = MSd(i2) 
...
! {Fd, Sd, VZ}
If ((Include_in_loopFd).and.(Include_in_loopSd).and.(Include_in_loopVZ)) Then 
Do i1=1,3
  Do i2=1,6
ML1 = MFd(i1) 
ML2 = MSd(i2) 
...
! {Fu, Su, conj[Hpm]}
If ((Include_in_loopFu).and.(Include_in_loopSu).and.(Include_in_loopHpm)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,2
ML1 = MFu(i1) 
...
! {Fu, Su, conj[VWm]}
If ((Include_in_loopFu).and.(Include_in_loopSu).and.(Include_in_loopVWm)) Then 
Do i1=1,3
  Do i2=1,6
ML1 = MFu(i1) 
ML2 = MSu(i2) 
...
! {hh, Chi, bar[Fd]}
If ((Include_in_loophh).and.(Include_in_loopChi).and.(Include_in_loopFd)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,3
ML1 = Mhh(i1) 
...
! {Hpm, Cha, bar[Fu]}
If ((Include_in_loopHpm).and.(Include_in_loopCha).and.(Include_in_loopFu)) Then 
Do i1=1,2
  Do i2=1,2
    Do i3=1,3
ML1 = MHpm(i1) 
...
! {Sd, Fd, Chi}
If ((Include_in_loopSd).and.(Include_in_loopFd).and.(Include_in_loopChi)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,5
ML1 = MSd(i1) 
...
! {Sd, Fd, Glu}
If ((Include_in_loopSd).and.(Include_in_loopFd).and.(Include_in_loopGlu)) Then 
Do i1=1,6
  Do i2=1,3
ML1 = MSd(i1) 
ML2 = MFd(i2) 
...
! {Su, Fu, bar[Cha]}
If ((Include_in_loopSu).and.(Include_in_loopFu).and.(Include_in_loopCha)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,2
ML1 = MSu(i1) 
...
! {VWm, Cha, bar[Fu]}
If ((Include_in_loopVWm).and.(Include_in_loopCha).and.(Include_in_loopFu)) Then 
  Do i2=1,2
    Do i3=1,3
ML1 = MVWm 
ML2 = MCha(i2) 
...
! {VZ, Chi, bar[Fd]}
If ((Include_in_loopVZ).and.(Include_in_loopChi).and.(Include_in_loopFd)) Then 
  Do i2=1,5
    Do i3=1,3
ML1 = MVZ 
ML2 = MChi(i2) 
...
End if 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToFdcSd


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToFdcSd(MAh,MCha,MChi,MFd,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToFdcSd


Subroutine Amplitude_Tree_seesaw1nmssm_ChiToFecSe(cplChiFecSeL,cplChiFecSeR,          & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_ChiToFecSe


Subroutine Gamma_Real_seesaw1nmssm_ChiToFecSe(MLambda,em,gs,cplChiFecSeL,             & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_ChiToFecSe


Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToFecSe(cplChiFecSeL,cplChiFecSeR,          & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToFecSe


Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToFecSe(MAh,MCha,MChi,MFe,MFv,            & 
...
! {Ah, Chi, bar[Fe]}
If ((Include_in_loopAh).and.(Include_in_loopChi).and.(Include_in_loopFe)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,3
ML1 = MAh(i1) 
...
! {Cha, Hpm, SvIm}
If ((Include_in_loopCha).and.(Include_in_loopHpm).and.(Include_in_loopSvIm)) Then 
Do i1=1,2
  Do i2=1,2
    Do i3=1,6
ML1 = MCha(i1) 
...
! {Cha, VWm, SvIm}
If ((Include_in_loopCha).and.(Include_in_loopVWm).and.(Include_in_loopSvIm)) Then 
Do i1=1,2
    Do i3=1,6
ML1 = MCha(i1) 
ML2 = MVWm 
...
! {Cha, Hpm, SvRe}
If ((Include_in_loopCha).and.(Include_in_loopHpm).and.(Include_in_loopSvRe)) Then 
Do i1=1,2
  Do i2=1,2
    Do i3=1,6
ML1 = MCha(i1) 
...
! {Cha, VWm, SvRe}
If ((Include_in_loopCha).and.(Include_in_loopVWm).and.(Include_in_loopSvRe)) Then 
Do i1=1,2
    Do i3=1,6
ML1 = MCha(i1) 
ML2 = MVWm 
...
! {Chi, Ah, conj[Se]}
If ((Include_in_loopChi).and.(Include_in_loopAh).and.(Include_in_loopSe)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,6
ML1 = MChi(i1) 
...
! {Chi, hh, conj[Se]}
If ((Include_in_loopChi).and.(Include_in_loophh).and.(Include_in_loopSe)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,6
ML1 = MChi(i1) 
...
! {Chi, VZ, conj[Se]}
If ((Include_in_loopChi).and.(Include_in_loopVZ).and.(Include_in_loopSe)) Then 
Do i1=1,5
    Do i3=1,6
ML1 = MChi(i1) 
ML2 = MVZ 
...
! {Fe, Se, Ah}
If ((Include_in_loopFe).and.(Include_in_loopSe).and.(Include_in_loopAh)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,3
ML1 = MFe(i1) 
...
! {Fe, Se, hh}
If ((Include_in_loopFe).and.(Include_in_loopSe).and.(Include_in_loophh)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,3
ML1 = MFe(i1) 
...
! {Fe, Se, VP}
If ((Include_in_loopFe).and.(Include_in_loopSe).and.(Include_in_loopVP)) Then 
Do i1=1,3
  Do i2=1,6
ML1 = MFe(i1) 
ML2 = MSe(i2) 
...
! {Fe, Se, VZ}
If ((Include_in_loopFe).and.(Include_in_loopSe).and.(Include_in_loopVZ)) Then 
Do i1=1,3
  Do i2=1,6
ML1 = MFe(i1) 
ML2 = MSe(i2) 
...
! {Fv, SvIm, conj[Hpm]}
If ((Include_in_loopFv).and.(Include_in_loopSvIm).and.(Include_in_loopHpm)) Then 
Do i1=1,6
  Do i2=1,6
    Do i3=1,2
ML1 = MFv(i1) 
...
! {Fv, SvRe, conj[Hpm]}
If ((Include_in_loopFv).and.(Include_in_loopSvRe).and.(Include_in_loopHpm)) Then 
Do i1=1,6
  Do i2=1,6
    Do i3=1,2
ML1 = MFv(i1) 
...
! {Fv, SvIm, conj[VWm]}
If ((Include_in_loopFv).and.(Include_in_loopSvIm).and.(Include_in_loopVWm)) Then 
Do i1=1,6
  Do i2=1,6
ML1 = MFv(i1) 
ML2 = MSvIm(i2) 
...
! {Fv, SvRe, conj[VWm]}
If ((Include_in_loopFv).and.(Include_in_loopSvRe).and.(Include_in_loopVWm)) Then 
Do i1=1,6
  Do i2=1,6
ML1 = MFv(i1) 
ML2 = MSvRe(i2) 
...
! {hh, Chi, bar[Fe]}
If ((Include_in_loophh).and.(Include_in_loopChi).and.(Include_in_loopFe)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,3
ML1 = Mhh(i1) 
...
! {Hpm, Cha, Fv}
If ((Include_in_loopHpm).and.(Include_in_loopCha).and.(Include_in_loopFv)) Then 
Do i1=1,2
  Do i2=1,2
    Do i3=1,6
ML1 = MHpm(i1) 
...
! {Se, Fe, Chi}
If ((Include_in_loopSe).and.(Include_in_loopFe).and.(Include_in_loopChi)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,5
ML1 = MSe(i1) 
...
! {SvIm, Fv, bar[Cha]}
If ((Include_in_loopSvIm).and.(Include_in_loopFv).and.(Include_in_loopCha)) Then 
Do i1=1,6
  Do i2=1,6
    Do i3=1,2
ML1 = MSvIm(i1) 
...
! {SvRe, Fv, bar[Cha]}
If ((Include_in_loopSvRe).and.(Include_in_loopFv).and.(Include_in_loopCha)) Then 
Do i1=1,6
  Do i2=1,6
    Do i3=1,2
ML1 = MSvRe(i1) 
...
! {VWm, Cha, Fv}
If ((Include_in_loopVWm).and.(Include_in_loopCha).and.(Include_in_loopFv)) Then 
  Do i2=1,2
    Do i3=1,6
ML1 = MVWm 
ML2 = MCha(i2) 
...
! {VZ, Chi, bar[Fe]}
If ((Include_in_loopVZ).and.(Include_in_loopChi).and.(Include_in_loopFe)) Then 
  Do i2=1,5
    Do i3=1,3
ML1 = MVZ 
ML2 = MChi(i2) 
...
End if 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToFecSe


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToFecSe(MAh,MCha,MChi,MFe,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToFecSe


Subroutine Amplitude_Tree_seesaw1nmssm_ChiToFucSu(cplChiFucSuL,cplChiFucSuR,          & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_ChiToFucSu


Subroutine Gamma_Real_seesaw1nmssm_ChiToFucSu(MLambda,em,gs,cplChiFucSuL,             & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_ChiToFucSu


Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToFucSu(cplChiFucSuL,cplChiFucSuR,          & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToFucSu


Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToFucSu(MAh,MCha,MChi,MFd,MFu,            & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
! {Ah, Chi, bar[Fu]}
If ((Include_in_loopAh).and.(Include_in_loopChi).and.(Include_in_loopFu)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,3
ML1 = MAh(i1) 
...
! {Chi, Ah, conj[Su]}
If ((Include_in_loopChi).and.(Include_in_loopAh).and.(Include_in_loopSu)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,6
ML1 = MChi(i1) 
...
! {Chi, hh, conj[Su]}
If ((Include_in_loopChi).and.(Include_in_loophh).and.(Include_in_loopSu)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,6
ML1 = MChi(i1) 
...
! {Chi, VZ, conj[Su]}
If ((Include_in_loopChi).and.(Include_in_loopVZ).and.(Include_in_loopSu)) Then 
Do i1=1,5
    Do i3=1,6
ML1 = MChi(i1) 
ML2 = MVZ 
...
! {Fd, Sd, Hpm}
If ((Include_in_loopFd).and.(Include_in_loopSd).and.(Include_in_loopHpm)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,2
ML1 = MFd(i1) 
...
! {Fd, Sd, VWm}
If ((Include_in_loopFd).and.(Include_in_loopSd).and.(Include_in_loopVWm)) Then 
Do i1=1,3
  Do i2=1,6
ML1 = MFd(i1) 
ML2 = MSd(i2) 
...
! {Fu, Su, Ah}
If ((Include_in_loopFu).and.(Include_in_loopSu).and.(Include_in_loopAh)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,3
ML1 = MFu(i1) 
...
! {Fu, Su, hh}
If ((Include_in_loopFu).and.(Include_in_loopSu).and.(Include_in_loophh)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,3
ML1 = MFu(i1) 
...
! {Fu, Su, VG}
If ((Include_in_loopFu).and.(Include_in_loopSu).and.(Include_in_loopVG)) Then 
Do i1=1,3
  Do i2=1,6
ML1 = MFu(i1) 
ML2 = MSu(i2) 
...
! {Fu, Su, VP}
If ((Include_in_loopFu).and.(Include_in_loopSu).and.(Include_in_loopVP)) Then 
Do i1=1,3
  Do i2=1,6
ML1 = MFu(i1) 
ML2 = MSu(i2) 
...
! {Fu, Su, VZ}
If ((Include_in_loopFu).and.(Include_in_loopSu).and.(Include_in_loopVZ)) Then 
Do i1=1,3
  Do i2=1,6
ML1 = MFu(i1) 
ML2 = MSu(i2) 
...
! {hh, Chi, bar[Fu]}
If ((Include_in_loophh).and.(Include_in_loopChi).and.(Include_in_loopFu)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,3
ML1 = Mhh(i1) 
...
! {Sd, Fd, Cha}
If ((Include_in_loopSd).and.(Include_in_loopFd).and.(Include_in_loopCha)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,2
ML1 = MSd(i1) 
...
! {Su, Fu, Chi}
If ((Include_in_loopSu).and.(Include_in_loopFu).and.(Include_in_loopChi)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,5
ML1 = MSu(i1) 
...
! {Su, Fu, Glu}
If ((Include_in_loopSu).and.(Include_in_loopFu).and.(Include_in_loopGlu)) Then 
Do i1=1,6
  Do i2=1,3
ML1 = MSu(i1) 
ML2 = MFu(i2) 
...
! {VZ, Chi, bar[Fu]}
If ((Include_in_loopVZ).and.(Include_in_loopChi).and.(Include_in_loopFu)) Then 
  Do i2=1,5
    Do i3=1,3
ML1 = MVZ 
ML2 = MChi(i2) 
...
If ((Include_in_loopCha).and.(Include_in_loopHpm).and.(Include_in_loopSd)) Then 
Do i1=1,2
  Do i2=1,2
    Do i3=1,6
ML1 = MCha(i1) 
...
If ((Include_in_loopCha).and.(Include_in_loopVWm).and.(Include_in_loopSd)) Then 
Do i1=1,2
    Do i3=1,6
ML1 = MCha(i1) 
ML2 = MVWm 
...
If ((Include_in_loopHpm).and.(Include_in_loopCha).and.(Include_in_loopFd)) Then 
Do i1=1,2
  Do i2=1,2
    Do i3=1,3
ML1 = MHpm(i1) 
...
If ((Include_in_loopVWm).and.(Include_in_loopCha).and.(Include_in_loopFd)) Then 
  Do i2=1,2
    Do i3=1,3
ML1 = MVWm 
ML2 = MCha(i2) 
...
End if 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToFucSu


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToFucSu(MAh,MCha,MChi,MFd,             & 
& MFu,MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,           & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplChiChiAhL,cplChiChiAhR,cplcFuFuAhL,       & 
& cplcFuFuAhR,cplAhSucSu,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,    & 
& cplChaFucSdL,cplChaFucSdR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToFucSu


Subroutine Amplitude_Tree_seesaw1nmssm_ChiToFvSvIm(cplChiFvSvImL,cplChiFvSvImR,       & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_ChiToFvSvIm


Subroutine Gamma_Real_seesaw1nmssm_ChiToFvSvIm(MLambda,em,gs,cplChiFvSvImL,           & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_ChiToFvSvIm


Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToFvSvIm(cplChiFvSvImL,cplChiFvSvImR,       & 
...
Complex(dp), Intent(out) :: Amp(2,5,6,6) 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToFvSvIm


Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToFvSvIm(MAh,MCha,MChi,MFe,               & 
...
! {Ah, Chi, Fv}
If ((Include_in_loopAh).and.(Include_in_loopChi).and.(Include_in_loopFv)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,6
ML1 = MAh(i1) 
...
! {Cha, Hpm, Se}
If ((Include_in_loopCha).and.(Include_in_loopHpm).and.(Include_in_loopSe)) Then 
Do i1=1,2
  Do i2=1,2
    Do i3=1,6
ML1 = MCha(i1) 
...
! {Cha, VWm, Se}
If ((Include_in_loopCha).and.(Include_in_loopVWm).and.(Include_in_loopSe)) Then 
Do i1=1,2
    Do i3=1,6
ML1 = MCha(i1) 
ML2 = MVWm 
...
! {Chi, Ah, SvIm}
If ((Include_in_loopChi).and.(Include_in_loopAh).and.(Include_in_loopSvIm)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,6
ML1 = MChi(i1) 
...
! {Chi, hh, SvIm}
If ((Include_in_loopChi).and.(Include_in_loophh).and.(Include_in_loopSvIm)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,6
ML1 = MChi(i1) 
...
! {Chi, Ah, SvRe}
If ((Include_in_loopChi).and.(Include_in_loopAh).and.(Include_in_loopSvRe)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,6
ML1 = MChi(i1) 
...
! {Chi, hh, SvRe}
If ((Include_in_loopChi).and.(Include_in_loophh).and.(Include_in_loopSvRe)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,6
ML1 = MChi(i1) 
...
! {Chi, VZ, SvRe}
If ((Include_in_loopChi).and.(Include_in_loopVZ).and.(Include_in_loopSvRe)) Then 
Do i1=1,5
    Do i3=1,6
ML1 = MChi(i1) 
ML2 = MVZ 
...
! {Fe, Se, Hpm}
If ((Include_in_loopFe).and.(Include_in_loopSe).and.(Include_in_loopHpm)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,2
ML1 = MFe(i1) 
...
! {Fe, Se, VWm}
If ((Include_in_loopFe).and.(Include_in_loopSe).and.(Include_in_loopVWm)) Then 
Do i1=1,3
  Do i2=1,6
ML1 = MFe(i1) 
ML2 = MSe(i2) 
...
! {Fv, SvIm, Ah}
If ((Include_in_loopFv).and.(Include_in_loopSvIm).and.(Include_in_loopAh)) Then 
Do i1=1,6
  Do i2=1,6
    Do i3=1,3
ML1 = MFv(i1) 
...
! {Fv, SvRe, Ah}
If ((Include_in_loopFv).and.(Include_in_loopSvRe).and.(Include_in_loopAh)) Then 
Do i1=1,6
  Do i2=1,6
    Do i3=1,3
ML1 = MFv(i1) 
...
! {Fv, SvIm, hh}
If ((Include_in_loopFv).and.(Include_in_loopSvIm).and.(Include_in_loophh)) Then 
Do i1=1,6
  Do i2=1,6
    Do i3=1,3
ML1 = MFv(i1) 
...
! {Fv, SvRe, hh}
If ((Include_in_loopFv).and.(Include_in_loopSvRe).and.(Include_in_loophh)) Then 
Do i1=1,6
  Do i2=1,6
    Do i3=1,3
ML1 = MFv(i1) 
...
! {Fv, SvRe, VZ}
If ((Include_in_loopFv).and.(Include_in_loopSvRe).and.(Include_in_loopVZ)) Then 
Do i1=1,6
  Do i2=1,6
ML1 = MFv(i1) 
ML2 = MSvRe(i2) 
...
! {hh, Chi, Fv}
If ((Include_in_loophh).and.(Include_in_loopChi).and.(Include_in_loopFv)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,6
ML1 = Mhh(i1) 
...
! {Hpm, Cha, Fe}
If ((Include_in_loopHpm).and.(Include_in_loopCha).and.(Include_in_loopFe)) Then 
Do i1=1,2
  Do i2=1,2
    Do i3=1,3
ML1 = MHpm(i1) 
...
! {Se, Fe, Cha}
If ((Include_in_loopSe).and.(Include_in_loopFe).and.(Include_in_loopCha)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,2
ML1 = MSe(i1) 
...
! {SvIm, Fv, Chi}
If ((Include_in_loopSvIm).and.(Include_in_loopFv).and.(Include_in_loopChi)) Then 
Do i1=1,6
  Do i2=1,6
    Do i3=1,5
ML1 = MSvIm(i1) 
...
! {SvRe, Fv, Chi}
If ((Include_in_loopSvRe).and.(Include_in_loopFv).and.(Include_in_loopChi)) Then 
Do i1=1,6
  Do i2=1,6
    Do i3=1,5
ML1 = MSvRe(i1) 
...
! {VWm, Cha, Fe}
If ((Include_in_loopVWm).and.(Include_in_loopCha).and.(Include_in_loopFe)) Then 
  Do i2=1,2
    Do i3=1,3
ML1 = MVWm 
ML2 = MCha(i2) 
...
! {VZ, Chi, Fv}
If ((Include_in_loopVZ).and.(Include_in_loopChi).and.(Include_in_loopFv)) Then 
  Do i2=1,5
    Do i3=1,6
ML1 = MVZ 
ML2 = MChi(i2) 
...
End if 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToFvSvIm


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToFvSvIm(MAh,MCha,MChi,MFe,            & 
& MFv,Mhh,MHpm,MSe,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,           & 
& MSe2,MSvIm2,MSvRe2,MVWm2,MVZ2,cplChiChiAhL,cplChiChiAhR,cplFvFvAhL,cplFvFvAhR,         & 
& cplAhSvImSvIm,cplAhSvImSvRe,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,              & 
& cplChiChacVWmR,cplFvChacSeL,cplFvChacSeR,cplcFeChaSvImL,cplcFeChaSvImR,cplChiChihhL,   & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToFvSvIm


Subroutine Amplitude_Tree_seesaw1nmssm_ChiToFvSvRe(cplChiFvSvReL,cplChiFvSvReR,       & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_ChiToFvSvRe


Subroutine Gamma_Real_seesaw1nmssm_ChiToFvSvRe(MLambda,em,gs,cplChiFvSvReL,           & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_ChiToFvSvRe


Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToFvSvRe(cplChiFvSvReL,cplChiFvSvReR,       & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToFvSvRe


Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToFvSvRe(MAh,MCha,MChi,MFe,               & 
& MFv,Mhh,MHpm,MSe,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,           & 
& MSe2,MSvIm2,MSvRe2,MVWm2,MVZ2,cplChiChiAhL,cplChiChiAhR,cplFvFvAhL,cplFvFvAhR,         & 
...
! {Chi, VZ, SvIm}
If ((Include_in_loopChi).and.(Include_in_loopVZ).and.(Include_in_loopSvIm)) Then 
Do i1=1,5
    Do i3=1,6
ML1 = MChi(i1) 
ML2 = MVZ 
...
! {Fv, SvIm, VZ}
If ((Include_in_loopFv).and.(Include_in_loopSvIm).and.(Include_in_loopVZ)) Then 
Do i1=1,6
  Do i2=1,6
ML1 = MFv(i1) 
ML2 = MSvIm(i2) 
...
End if 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToFvSvRe


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToFvSvRe(MAh,MCha,MChi,MFe,            & 
& MFv,Mhh,MHpm,MSe,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,           & 
& MSe2,MSvIm2,MSvRe2,MVWm2,MVZ2,cplChiChiAhL,cplChiChiAhR,cplFvFvAhL,cplFvFvAhR,         & 
& cplAhSvImSvRe,cplAhSvReSvRe,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,              & 
& cplChiChacVWmR,cplFvChacSeL,cplFvChacSeR,cplcFeChaSvReL,cplcFeChaSvReR,cplChiChihhL,   & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToFvSvRe


Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToChiVP(cplChiChiVZL,cplChiChiVZR,          & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToChiVP


Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToChiVP(MCha,MChi,MFd,MFe,MFu,            & 
...
End if 
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToChiVP


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToChiVP(MCha,MChi,MFd,MFe,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToChiVP


Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToGluVG(MChi,MChi2,MGlu,MGlu2,              & 
& MVG,MVG2,ZffG,ZfL0,ZfVG,Amp)
...
Amp(:,gt1) = 0._dp
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_ChiToGluVG


Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToGluVG(MChi,MFd,MFu,MGlu,MSd,            & 
...
End if 
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_ChiToGluVG


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToGluVG(MChi,MFd,MFu,MGlu,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_ChiToGluVG



End Module OneLoopDecay_Chi_seesaw1nmssm
