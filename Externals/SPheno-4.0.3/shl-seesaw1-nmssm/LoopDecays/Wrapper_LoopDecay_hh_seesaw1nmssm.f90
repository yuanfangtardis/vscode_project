...
Module Wrapper_OneLoopDecay_hh_seesaw1nmssm
Use Model_Data_seesaw1nmssm 
Use Kinematics 
Use OneLoopDecay_hh_seesaw1nmssm 
Use Control 
Use Settings 
...
Complex(dp),Intent(in) :: cplChiFecSeR(5,3,6),cplChiFucSuL(5,3,6),cplChiFucSuR(5,3,6),cplChiFvSvImL(5,6,6),      & 
...
& cplcVWmVPVPVWm1Q,cplcVWmVPVPVWm2Q,cplcVWmVPVPVWm3Q,cplcVWmVPVWm,cplcVWmVPVWmVZ1Q,      & 
& cplcVWmVPVWmVZ2Q,cplcVWmVPVWmVZ3Q,cplcVWmVWmVZ,cplcVWmVWmVZVZ1Q,cplcVWmVWmVZVZ2Q,      & 
& cplcVWmVWmVZVZ3Q,cplFvChacSeL(6,2,6),cplFvChacSeR(6,2,6),cplFvFecHpmL(6,3,2),          & 
...
& cplhhhhSvImSvRe1(3,3,6,6),cplhhhhSvReSvRe1(3,3,6,6),cplhhhhVZVZ1(3,3),cplhhHpmcHpm(3,2,2),& 
...
& cplhhSdcSd(3,6,6),cplhhSecSe(3,6,6),cplhhSeSvImcHpm1(3,6,6,2),cplhhSeSvRecHpm1(3,6,6,2),& 
...
Complex(dp),Intent(in) :: cplSvImSvImVZVZ1(6,6),cplSvImSvReSvReSvRe1(6,6,6,6),cplSvImSvReVZ(6,6),cplSvRecSeVWm(6,6),& 
...
& ctcplChiChihhR(5,5,3),ctcplFvFvhhL(6,6,3),ctcplFvFvhhR(6,6,3),ctcplhhcVWmVWm(3),       & 
& ctcplhhhhhh(3,3,3),ctcplhhHpmcHpm(3,2,2),ctcplhhHpmcVWm(3,2),ctcplhhSdcSd(3,6,6),      & 
& ctcplhhSecSe(3,6,6),ctcplhhSucSu(3,6,6),ctcplhhSvImSvIm(3,6,6),ctcplhhSvImSvRe(3,6,6), & 
& ctcplhhSvReSvRe(3,6,6),ctcplhhVZVZ(3),GcplcHpmVPVWm(2),GcplhhcHpmVWm(3,2),             & 
...
& ZcplChiChihhR(5,5,3),ZcplFvFvhhL(6,6,3),ZcplFvFvhhR(6,6,3),ZcplhhcVWmVWm(3),           & 
& Zcplhhhhhh(3,3,3),ZcplhhHpmcHpm(3,2,2),ZcplhhHpmcVWm(3,2),ZcplhhSdcSd(3,6,6),          & 
& ZcplhhSecSe(3,6,6),ZcplhhSucSu(3,6,6),ZcplhhSvImSvIm(3,6,6),ZcplhhSvImSvRe(3,6,6),     & 
& ZcplhhSvReSvRe(3,6,6),ZcplhhVZVZ(3)
...
Real(dp) :: MRPhhToFvFv(3,6,6),MRGhhToFvFv(3,6,6), MRPZhhToFvFv(3,6,6),MRGZhhToFvFv(3,6,6) 
Real(dp) :: MVPhhToFvFv(3,6,6) 
Real(dp) :: RMsqTreehhToFvFv(3,6,6),RMsqWavehhToFvFv(3,6,6),RMsqVertexhhToFvFv(3,6,6) 
Complex(dp) :: AmpTreehhToFvFv(2,3,6,6),AmpWavehhToFvFv(2,3,6,6)=(0._dp,0._dp),AmpVertexhhToFvFv(2,3,6,6)& 
 & ,AmpVertexIRoshhToFvFv(2,3,6,6),AmpVertexIRdrhhToFvFv(2,3,6,6), AmpSumhhToFvFv(2,3,6,6), AmpSum2hhToFvFv(2,3,6,6) 
Complex(dp) :: AmpTreeZhhToFvFv(2,3,6,6),AmpWaveZhhToFvFv(2,3,6,6),AmpVertexZhhToFvFv(2,3,6,6) 
Real(dp) :: AmpSqhhToFvFv(3,6,6),  AmpSqTreehhToFvFv(3,6,6) 
...
Real(dp) :: MRPhhToSvImSvIm(3,6,6),MRGhhToSvImSvIm(3,6,6), MRPZhhToSvImSvIm(3,6,6),MRGZhhToSvImSvIm(3,6,6) 
Real(dp) :: MVPhhToSvImSvIm(3,6,6) 
Real(dp) :: RMsqTreehhToSvImSvIm(3,6,6),RMsqWavehhToSvImSvIm(3,6,6),RMsqVertexhhToSvImSvIm(3,6,6) 
Complex(dp) :: AmpTreehhToSvImSvIm(3,6,6),AmpWavehhToSvImSvIm(3,6,6)=(0._dp,0._dp),AmpVertexhhToSvImSvIm(3,6,6)& 
 & ,AmpVertexIRoshhToSvImSvIm(3,6,6),AmpVertexIRdrhhToSvImSvIm(3,6,6), AmpSumhhToSvImSvIm(3,6,6), AmpSum2hhToSvImSvIm(3,6,6) 
Complex(dp) :: AmpTreeZhhToSvImSvIm(3,6,6),AmpWaveZhhToSvImSvIm(3,6,6),AmpVertexZhhToSvImSvIm(3,6,6) 
Real(dp) :: AmpSqhhToSvImSvIm(3,6,6),  AmpSqTreehhToSvImSvIm(3,6,6) 
Real(dp) :: MRPhhToSvReSvIm(3,6,6),MRGhhToSvReSvIm(3,6,6), MRPZhhToSvReSvIm(3,6,6),MRGZhhToSvReSvIm(3,6,6) 
Real(dp) :: MVPhhToSvReSvIm(3,6,6) 
Real(dp) :: RMsqTreehhToSvReSvIm(3,6,6),RMsqWavehhToSvReSvIm(3,6,6),RMsqVertexhhToSvReSvIm(3,6,6) 
Complex(dp) :: AmpTreehhToSvReSvIm(3,6,6),AmpWavehhToSvReSvIm(3,6,6)=(0._dp,0._dp),AmpVertexhhToSvReSvIm(3,6,6)& 
 & ,AmpVertexIRoshhToSvReSvIm(3,6,6),AmpVertexIRdrhhToSvReSvIm(3,6,6), AmpSumhhToSvReSvIm(3,6,6), AmpSum2hhToSvReSvIm(3,6,6) 
Complex(dp) :: AmpTreeZhhToSvReSvIm(3,6,6),AmpWaveZhhToSvReSvIm(3,6,6),AmpVertexZhhToSvReSvIm(3,6,6) 
Real(dp) :: AmpSqhhToSvReSvIm(3,6,6),  AmpSqTreehhToSvReSvIm(3,6,6) 
Real(dp) :: MRPhhToSvReSvRe(3,6,6),MRGhhToSvReSvRe(3,6,6), MRPZhhToSvReSvRe(3,6,6),MRGZhhToSvReSvRe(3,6,6) 
Real(dp) :: MVPhhToSvReSvRe(3,6,6) 
Real(dp) :: RMsqTreehhToSvReSvRe(3,6,6),RMsqWavehhToSvReSvRe(3,6,6),RMsqVertexhhToSvReSvRe(3,6,6) 
Complex(dp) :: AmpTreehhToSvReSvRe(3,6,6),AmpWavehhToSvReSvRe(3,6,6)=(0._dp,0._dp),AmpVertexhhToSvReSvRe(3,6,6)& 
 & ,AmpVertexIRoshhToSvReSvRe(3,6,6),AmpVertexIRdrhhToSvReSvRe(3,6,6), AmpSumhhToSvReSvRe(3,6,6), AmpSum2hhToSvReSvRe(3,6,6) 
Complex(dp) :: AmpTreeZhhToSvReSvRe(3,6,6),AmpWaveZhhToSvReSvRe(3,6,6),AmpVertexZhhToSvReSvRe(3,6,6) 
Real(dp) :: AmpSqhhToSvReSvRe(3,6,6),  AmpSqTreehhToSvReSvRe(3,6,6) 
...
Call Amplitude_Tree_seesaw1nmssm_hhToAhAh(cplAhAhhh,MAh,Mhh,MAh2,Mhh2,AmpTreehhToAhAh)

  Else 
Call Amplitude_Tree_seesaw1nmssm_hhToAhAh(ZcplAhAhhh,MAh,Mhh,MAh2,Mhh2,               & 
& AmpTreehhToAhAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToAhAh(MLambda,em,gs,cplAhAhhh,MAhOS,MhhOS,            & 
& MRPhhToAhAh,MRGhhToAhAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToAhAh(MLambda,em,gs,ZcplAhAhhh,MAhOS,MhhOS,           & 
& MRPhhToAhAh,MRGhhToAhAh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_hhToAhAh(MLambda,em,gs,cplAhAhhh,MAh,Mhh,MRPhhToAhAh,    & 
& MRGhhToAhAh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToAhAh(MLambda,em,gs,ZcplAhAhhh,MAh,Mhh,               & 
& MRPhhToAhAh,MRGhhToAhAh)
...
Call Amplitude_WAVE_seesaw1nmssm_hhToAhAh(cplAhAhhh,ctcplAhAhhh,MAh,MAh2,             & 
& Mhh,Mhh2,ZfAh,Zfhh,AmpWavehhToAhAh)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhToAhAh(MAh,MCha,MChi,MFd,MFe,MFu,MFv,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhToAhAh(MAh,MCha,MChi,MFd,MFe,MFu,             & 
...
& AmpVertexIRdrhhToAhAh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhToAhAh(MAhOS,MChaOS,MChiOS,MFdOS,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_hhTohhAh(cplAhhhhh,MAh,Mhh,MAh2,Mhh2,AmpTreehhTohhAh)

  Else 
Call Amplitude_Tree_seesaw1nmssm_hhTohhAh(ZcplAhhhhh,MAh,Mhh,MAh2,Mhh2,               & 
& AmpTreehhTohhAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTohhAh(MLambda,em,gs,cplAhhhhh,MAhOS,MhhOS,            & 
& MRPhhTohhAh,MRGhhTohhAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTohhAh(MLambda,em,gs,ZcplAhhhhh,MAhOS,MhhOS,           & 
& MRPhhTohhAh,MRGhhTohhAh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_hhTohhAh(MLambda,em,gs,cplAhhhhh,MAh,Mhh,MRPhhTohhAh,    & 
& MRGhhTohhAh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTohhAh(MLambda,em,gs,ZcplAhhhhh,MAh,Mhh,               & 
& MRPhhTohhAh,MRGhhTohhAh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_hhTohhAh(cplAhhhhh,ctcplAhhhhh,MAh,MAh2,             & 
& Mhh,Mhh2,ZfAh,Zfhh,AmpWavehhTohhAh)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhTohhAh(MAh,MCha,MChi,MFd,MFe,MFu,MFv,            & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,             & 
& MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,           & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,cplcgWmgWmAh,    & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhTohhAh(MAh,MCha,MChi,MFd,MFe,MFu,             & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,              & 
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,      & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,cplcgWmgWmAh,    & 
...
& cplhhhhSvImSvRe1,cplhhhhSvReSvRe1,AmpVertexIRdrhhTohhAh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhTohhAh(MAhOS,MChaOS,MChiOS,MFdOS,             & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVWmOS,               & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
& MSd2OS,MSe2OS,MSu2OS,MSvIm2OS,MSvRe2OS,MVWm2OS,MVZ2OS,cplAhAhAh,cplAhAhhh,             & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_hhToAhVZ(cplAhhhVZ,MAh,Mhh,MVZ,MAh2,Mhh2,            & 
& MVZ2,AmpTreehhToAhVZ)

  Else 
Call Amplitude_Tree_seesaw1nmssm_hhToAhVZ(ZcplAhhhVZ,MAh,Mhh,MVZ,MAh2,Mhh2,           & 
& MVZ2,AmpTreehhToAhVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToAhVZ(MLambda,em,gs,cplAhhhVZ,MAhOS,MhhOS,            & 
& MVZOS,MRPhhToAhVZ,MRGhhToAhVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToAhVZ(MLambda,em,gs,ZcplAhhhVZ,MAhOS,MhhOS,           & 
& MVZOS,MRPhhToAhVZ,MRGhhToAhVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_hhToAhVZ(MLambda,em,gs,cplAhhhVZ,MAh,Mhh,MVZ,            & 
& MRPhhToAhVZ,MRGhhToAhVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToAhVZ(MLambda,em,gs,ZcplAhhhVZ,MAh,Mhh,               & 
& MVZ,MRPhhToAhVZ,MRGhhToAhVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_hhToAhVZ(cplAhhhVZ,ctcplAhhhVZ,MAh,MAh2,             & 
& Mhh,Mhh2,MVZ,MVZ2,ZfAh,Zfhh,ZfVZ,AmpWavehhToAhVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhToAhVZ(MAh,MCha,MChi,MFd,MFe,MFu,MFv,            & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,             & 
& MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,           & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,cplcgWmgWmAh,    & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhToAhVZ(MAh,MCha,MChi,MFd,MFe,MFu,             & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,              & 
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,      & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,cplcgWmgWmAh,    & 
...
& AmpVertexIRdrhhToAhVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhToAhVZ(MAhOS,MChaOS,MChiOS,MFdOS,             & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVWmOS,               & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
& MSd2OS,MSe2OS,MSu2OS,MSvIm2OS,MSvRe2OS,MVWm2OS,MVZ2OS,cplAhAhAh,cplAhAhhh,             & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_hhTocChaCha(cplcChaChahhL,cplcChaChahhR,             & 
& MCha,Mhh,MCha2,Mhh2,AmpTreehhTocChaCha)

  Else 
Call Amplitude_Tree_seesaw1nmssm_hhTocChaCha(ZcplcChaChahhL,ZcplcChaChahhR,           & 
& MCha,Mhh,MCha2,Mhh2,AmpTreehhTocChaCha)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTocChaCha(MLambda,em,gs,cplcChaChahhL,cplcChaChahhR,   & 
& MChaOS,MhhOS,MRPhhTocChaCha,MRGhhTocChaCha)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTocChaCha(MLambda,em,gs,ZcplcChaChahhL,ZcplcChaChahhR, & 
& MChaOS,MhhOS,MRPhhTocChaCha,MRGhhTocChaCha)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_hhTocChaCha(cplcChaChahhL,cplcChaChahhR,             & 
& ctcplcChaChahhL,ctcplcChaChahhR,MCha,MCha2,Mhh,Mhh2,Zfhh,ZfLm,ZfLp,AmpWavehhTocChaCha)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhTocChaCha(MAh,MCha,MChi,MFd,MFe,MFu,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhTocChaCha(MAh,MCha,MChi,MFd,MFe,              & 
...
& cplcChacFuSdR,AmpVertexIRdrhhTocChaCha)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhTocChaCha(MAhOS,MChaOS,MChiOS,MFdOS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_hhToChiChi(cplChiChihhL,cplChiChihhR,MChi,           & 
& Mhh,MChi2,Mhh2,AmpTreehhToChiChi)

  Else 
Call Amplitude_Tree_seesaw1nmssm_hhToChiChi(ZcplChiChihhL,ZcplChiChihhR,              & 
& MChi,Mhh,MChi2,Mhh2,AmpTreehhToChiChi)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToChiChi(MLambda,em,gs,cplChiChihhL,cplChiChihhR,      & 
& MChiOS,MhhOS,MRPhhToChiChi,MRGhhToChiChi)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToChiChi(MLambda,em,gs,ZcplChiChihhL,ZcplChiChihhR,    & 
& MChiOS,MhhOS,MRPhhToChiChi,MRGhhToChiChi)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_hhToChiChi(cplChiChihhL,cplChiChihhR,ctcplChiChihhL, & 
& ctcplChiChihhR,MChi,MChi2,Mhh,Mhh2,Zfhh,ZfL0,AmpWavehhToChiChi)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhToChiChi(MAh,MCha,MChi,MFd,MFe,MFu,              & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhToChiChi(MAh,MCha,MChi,MFd,MFe,               & 
...
& cplhhSvImSvRe,cplhhSvReSvRe,cplhhcHpmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRdrhhToChiChi)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhToChiChi(MAhOS,MChaOS,MChiOS,MFdOS,           & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVWmOS,               & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvImSvIm,    & 
& cplhhSvImSvRe,cplhhSvReSvRe,cplhhcHpmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRoshhToChiChi)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_hhTocFdFd(cplcFdFdhhL,cplcFdFdhhR,MFd,               & 
& Mhh,MFd2,Mhh2,AmpTreehhTocFdFd)

  Else 
Call Amplitude_Tree_seesaw1nmssm_hhTocFdFd(ZcplcFdFdhhL,ZcplcFdFdhhR,MFd,             & 
& Mhh,MFd2,Mhh2,AmpTreehhTocFdFd)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTocFdFd(MLambda,em,gs,cplcFdFdhhL,cplcFdFdhhR,         & 
& MFdOS,MhhOS,MRPhhTocFdFd,MRGhhTocFdFd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTocFdFd(MLambda,em,gs,ZcplcFdFdhhL,ZcplcFdFdhhR,       & 
& MFdOS,MhhOS,MRPhhTocFdFd,MRGhhTocFdFd)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_hhTocFdFd(cplcFdFdhhL,cplcFdFdhhR,ctcplcFdFdhhL,     & 
& ctcplcFdFdhhR,MFd,MFd2,Mhh,Mhh2,ZfFDL,ZfFDR,Zfhh,AmpWavehhTocFdFd)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhTocFdFd(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhTocFdFd(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcFdFdAhL,cplcFdFdAhR,cplAhhhhh,      & 
& cplAhhhVZ,cplcChaChahhL,cplcChaChahhR,cplcFdChaSuL,cplcFdChaSuR,cplChiChihhL,          & 
& cplChiChihhR,cplChiFdcSdL,cplChiFdcSdR,cplcFdChiSdL,cplcFdChiSdR,cplGluFdcSdL,         & 
...
& cplhhVZVZ,AmpVertexIRdrhhTocFdFd)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhTocFdFd(MAhOS,MChaOS,MChiOS,MFdOS,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_hhTocFeFe(cplcFeFehhL,cplcFeFehhR,MFe,               & 
& Mhh,MFe2,Mhh2,AmpTreehhTocFeFe)

  Else 
Call Amplitude_Tree_seesaw1nmssm_hhTocFeFe(ZcplcFeFehhL,ZcplcFeFehhR,MFe,             & 
& Mhh,MFe2,Mhh2,AmpTreehhTocFeFe)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTocFeFe(MLambda,em,gs,cplcFeFehhL,cplcFeFehhR,         & 
& MFeOS,MhhOS,MRPhhTocFeFe,MRGhhTocFeFe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTocFeFe(MLambda,em,gs,ZcplcFeFehhL,ZcplcFeFehhR,       & 
& MFeOS,MhhOS,MRPhhTocFeFe,MRGhhTocFeFe)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_hhTocFeFe(cplcFeFehhL,cplcFeFehhR,ctcplcFeFehhL,     & 
& ctcplcFeFehhR,MFe,MFe2,Mhh,Mhh2,ZfFEL,ZfFER,Zfhh,AmpWavehhTocFeFe)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhTocFeFe(MAh,MCha,MChi,MFe,MFv,Mhh,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhTocFeFe(MAh,MCha,MChi,MFe,MFv,Mhh,            & 
& MHpm,MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,               & 
& MSe2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcFeFeAhL,cplcFeFeAhR,cplAhhhhh,        & 
& cplAhhhVZ,cplcChaChahhL,cplcChaChahhR,cplcFeChaSvImL,cplcFeChaSvImR,cplcFeChaSvReL,    & 
& cplcFeChaSvReR,cplChiChihhL,cplChiChihhR,cplChiFecSeL,cplChiFecSeR,cplcFeChiSeL,       & 
...
& cplhhVZVZ,AmpVertexIRdrhhTocFeFe)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhTocFeFe(MAhOS,MChaOS,MChiOS,MFeOS,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_hhTocFuFu(cplcFuFuhhL,cplcFuFuhhR,MFu,               & 
& Mhh,MFu2,Mhh2,AmpTreehhTocFuFu)

  Else 
Call Amplitude_Tree_seesaw1nmssm_hhTocFuFu(ZcplcFuFuhhL,ZcplcFuFuhhR,MFu,             & 
& Mhh,MFu2,Mhh2,AmpTreehhTocFuFu)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTocFuFu(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,         & 
& MFuOS,MhhOS,MRPhhTocFuFu,MRGhhTocFuFu)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTocFuFu(MLambda,em,gs,ZcplcFuFuhhL,ZcplcFuFuhhR,       & 
& MFuOS,MhhOS,MRPhhTocFuFu,MRGhhTocFuFu)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_hhTocFuFu(cplcFuFuhhL,cplcFuFuhhR,ctcplcFuFuhhL,     & 
& ctcplcFuFuhhR,MFu,MFu2,Mhh,Mhh2,ZfFUL,ZfFUR,Zfhh,AmpWavehhTocFuFu)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhTocFuFu(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhTocFuFu(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcFuFuAhL,cplcFuFuAhR,cplAhhhhh,      & 
& cplAhhhVZ,cplChaFucSdL,cplChaFucSdR,cplcChaChahhL,cplcChaChahhR,cplChiChihhL,          & 
& cplChiChihhR,cplChiFucSuL,cplChiFucSuR,cplcFuChiSuL,cplcFuChiSuR,cplcFdFdhhL,          & 
...
& cplcChacFuSdR,AmpVertexIRdrhhTocFuFu)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhTocFuFu(MAhOS,MChaOS,MChiOS,MFdOS,            & 
& MFuOS,MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,             & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_hhToFvFv(cplFvFvhhL,cplFvFvhhR,MFv,Mhh,              & 
& MFv2,Mhh2,AmpTreehhToFvFv)

  Else 
Call Amplitude_Tree_seesaw1nmssm_hhToFvFv(ZcplFvFvhhL,ZcplFvFvhhR,MFv,Mhh,            & 
& MFv2,Mhh2,AmpTreehhToFvFv)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToFvFv(MLambda,em,gs,cplFvFvhhL,cplFvFvhhR,            & 
& MFvOS,MhhOS,MRPhhToFvFv,MRGhhToFvFv)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToFvFv(MLambda,em,gs,ZcplFvFvhhL,ZcplFvFvhhR,          & 
& MFvOS,MhhOS,MRPhhToFvFv,MRGhhToFvFv)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_hhToFvFv(cplFvFvhhL,cplFvFvhhR,ctcplFvFvhhL,         & 
& ctcplFvFvhhR,MFv,MFv2,Mhh,Mhh2,ZfFV,Zfhh,AmpWavehhToFvFv)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhToFvFv(MAh,MCha,MChi,MFe,MFv,Mhh,MHpm,           & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhToFvFv(MAh,MCha,MChi,MFe,MFv,Mhh,             & 
...
& AmpVertexIRdrhhToFvFv)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhToFvFv(MAhOS,MChaOS,MChiOS,MFeOS,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_hhTohhhh(cplhhhhhh,Mhh,Mhh2,AmpTreehhTohhhh)

  Else 
Call Amplitude_Tree_seesaw1nmssm_hhTohhhh(Zcplhhhhhh,Mhh,Mhh2,AmpTreehhTohhhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTohhhh(MLambda,em,gs,cplhhhhhh,MhhOS,MRPhhTohhhh,      & 
& MRGhhTohhhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTohhhh(MLambda,em,gs,Zcplhhhhhh,MhhOS,MRPhhTohhhh,     & 
& MRGhhTohhhh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_hhTohhhh(MLambda,em,gs,cplhhhhhh,Mhh,MRPhhTohhhh,        & 
& MRGhhTohhhh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTohhhh(MLambda,em,gs,Zcplhhhhhh,Mhh,MRPhhTohhhh,       & 
& MRGhhTohhhh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_hhTohhhh(cplhhhhhh,ctcplhhhhhh,Mhh,Mhh2,             & 
& Zfhh,AmpWavehhTohhhh)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhTohhhh(MAh,MCha,MChi,MFd,MFe,MFu,MFv,            & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhTohhhh(MAh,MCha,MChi,MFd,MFe,MFu,             & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,              & 
...
& cplhhhhSvImSvRe1,cplhhhhSvReSvRe1,cplhhhhcVWmVWm1,cplhhhhVZVZ1,AmpVertexIRdrhhTohhhh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhTohhhh(MAhOS,MChaOS,MChiOS,MFdOS,             & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVWmOS,               & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_hhTocHpmHpm(cplhhHpmcHpm,Mhh,MHpm,Mhh2,              & 
& MHpm2,AmpTreehhTocHpmHpm)

  Else 
Call Amplitude_Tree_seesaw1nmssm_hhTocHpmHpm(ZcplhhHpmcHpm,Mhh,MHpm,Mhh2,             & 
& MHpm2,AmpTreehhTocHpmHpm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTocHpmHpm(MLambda,em,gs,cplhhHpmcHpm,MhhOS,            & 
& MHpmOS,MRPhhTocHpmHpm,MRGhhTocHpmHpm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTocHpmHpm(MLambda,em,gs,ZcplhhHpmcHpm,MhhOS,           & 
& MHpmOS,MRPhhTocHpmHpm,MRGhhTocHpmHpm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_hhTocHpmHpm(MLambda,em,gs,cplhhHpmcHpm,Mhh,              & 
& MHpm,MRPhhTocHpmHpm,MRGhhTocHpmHpm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTocHpmHpm(MLambda,em,gs,ZcplhhHpmcHpm,Mhh,             & 
& MHpm,MRPhhTocHpmHpm,MRGhhTocHpmHpm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_hhTocHpmHpm(cplhhHpmcHpm,ctcplhhHpmcHpm,             & 
& Mhh,Mhh2,MHpm,MHpm2,Zfhh,ZfHpm,AmpWavehhTocHpmHpm)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhTocHpmHpm(MAh,MCha,MChi,MFd,MFe,MFu,             & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhAhhh,      & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhTocHpmHpm(MAh,MCha,MChi,MFd,MFe,              & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,           & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhAhhh,      & 
& cplAhhhhh,cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,cplAhcHpmVWm,cplChiChacHpmL,             & 
& cplChiChacHpmR,cplcChaChahhL,cplcChaChahhR,cplChiChihhL,cplChiChihhR,cplcChaChiHpmL,   & 
...
& cplHpmcHpmcVWmVWm1,cplHpmcHpmVZVZ1,AmpVertexIRdrhhTocHpmHpm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhTocHpmHpm(MAhOS,MChaOS,MChiOS,MFdOS,          & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVP,MVWmOS,           & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_hhToHpmcVWm(cplhhHpmcVWm,Mhh,MHpm,MVWm,              & 
& Mhh2,MHpm2,MVWm2,AmpTreehhToHpmcVWm)

  Else 
Call Amplitude_Tree_seesaw1nmssm_hhToHpmcVWm(ZcplhhHpmcVWm,Mhh,MHpm,MVWm,             & 
& Mhh2,MHpm2,MVWm2,AmpTreehhToHpmcVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToHpmcVWm(MLambda,em,gs,cplhhHpmcVWm,MhhOS,            & 
& MHpmOS,MVWmOS,MRPhhToHpmcVWm,MRGhhToHpmcVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToHpmcVWm(MLambda,em,gs,ZcplhhHpmcVWm,MhhOS,           & 
& MHpmOS,MVWmOS,MRPhhToHpmcVWm,MRGhhToHpmcVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_hhToHpmcVWm(MLambda,em,gs,cplhhHpmcVWm,Mhh,              & 
& MHpm,MVWm,MRPhhToHpmcVWm,MRGhhToHpmcVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToHpmcVWm(MLambda,em,gs,ZcplhhHpmcVWm,Mhh,             & 
& MHpm,MVWm,MRPhhToHpmcVWm,MRGhhToHpmcVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_hhToHpmcVWm(cplhhHpmcVWm,ctcplhhHpmcVWm,             & 
& Mhh,Mhh2,MHpm,MHpm2,MVWm,MVWm2,Zfhh,ZfHpm,ZfVWm,AmpWavehhToHpmcVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhToHpmcVWm(MAh,MCha,MChi,MFd,MFe,MFu,             & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhAhhh,      & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhToHpmcVWm(MAh,MCha,MChi,MFd,MFe,              & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,           & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhAhhh,      & 
& cplAhhhhh,cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,cplChiChacVWmL,cplChiChacVWmR,           & 
& cplcChaChahhL,cplcChaChahhR,cplChiChihhL,cplChiChihhR,cplcChaChiHpmL,cplcChaChiHpmR,   & 
...
& cplhhHpmcVWmVZ1,cplHpmcHpmcVWmVWm1,AmpVertexIRdrhhToHpmcVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhToHpmcVWm(MAhOS,MChaOS,MChiOS,MFdOS,          & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVP,MVWmOS,           & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
& MSd2OS,MSe2OS,MSu2OS,MSvIm2OS,MSvRe2OS,MVP2,MVWm2OS,MVZ2OS,cplAhAhhh,cplAhhhhh,        & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_hhTocSdSd(cplhhSdcSd,Mhh,MSd,Mhh2,MSd2,              & 
& AmpTreehhTocSdSd)

  Else 
Call Amplitude_Tree_seesaw1nmssm_hhTocSdSd(ZcplhhSdcSd,Mhh,MSd,Mhh2,MSd2,             & 
& AmpTreehhTocSdSd)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTocSdSd(MLambda,em,gs,cplhhSdcSd,MhhOS,MSdOS,          & 
& MRPhhTocSdSd,MRGhhTocSdSd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTocSdSd(MLambda,em,gs,ZcplhhSdcSd,MhhOS,               & 
& MSdOS,MRPhhTocSdSd,MRGhhTocSdSd)

  End if 
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_hhTocSdSd(MLambda,em,gs,cplhhSdcSd,Mhh,MSd,              & 
& MRPhhTocSdSd,MRGhhTocSdSd)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTocSdSd(MLambda,em,gs,ZcplhhSdcSd,Mhh,MSd,             & 
& MRPhhTocSdSd,MRGhhTocSdSd)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_hhTocSdSd(cplhhSdcSd,ctcplhhSdcSd,Mhh,               & 
& Mhh2,MSd,MSd2,Zfhh,ZfSd,AmpWavehhTocSdSd)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhTocSdSd(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
...
& cplSdSvReSvRecSdaa,cplSdcSdcVWmVWmaa,cplSdcSdVZVZaa,AmpVertexhhTocSdSd)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhTocSdSd(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplAhAhhh,cplAhhhhh,cplAhhhVZ,cplAhSdcSd,cplChaFucSdL,cplChaFucSdR,cplcChaChahhL,      & 
& cplcChaChahhR,cplChiChihhL,cplChiChihhR,cplChiFdcSdL,cplChiFdcSdR,cplcFdChiSdL,        & 
...
& cplSdSvReSvRecSdaa,cplSdcSdcVWmVWmaa,cplSdcSdVZVZaa,AmpVertexIRdrhhTocSdSd)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhTocSdSd(MAhOS,MChaOS,MChiOS,MFdOS,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_hhTocSeSe(cplhhSecSe,Mhh,MSe,Mhh2,MSe2,              & 
& AmpTreehhTocSeSe)

  Else 
Call Amplitude_Tree_seesaw1nmssm_hhTocSeSe(ZcplhhSecSe,Mhh,MSe,Mhh2,MSe2,             & 
& AmpTreehhTocSeSe)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTocSeSe(MLambda,em,gs,cplhhSecSe,MhhOS,MSeOS,          & 
& MRPhhTocSeSe,MRGhhTocSeSe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTocSeSe(MLambda,em,gs,ZcplhhSecSe,MhhOS,               & 
& MSeOS,MRPhhTocSeSe,MRGhhTocSeSe)

  End if 
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_hhTocSeSe(MLambda,em,gs,cplhhSecSe,Mhh,MSe,              & 
& MRPhhTocSeSe,MRGhhTocSeSe)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTocSeSe(MLambda,em,gs,ZcplhhSecSe,Mhh,MSe,             & 
& MRPhhTocSeSe,MRGhhTocSeSe)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_hhTocSeSe(cplhhSecSe,ctcplhhSecSe,Mhh,               & 
& Mhh2,MSe,MSe2,Zfhh,ZfSe,AmpWavehhTocSeSe)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhTocSeSe(MAh,MCha,MChi,MFe,MFv,Mhh,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhTocSeSe(MAh,MCha,MChi,MFe,MFv,Mhh,            & 
& MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,             & 
& MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplAhhhhh,cplAhhhVZ,      & 
& cplAhSecSe,cplFvChacSeL,cplFvChacSeR,cplcChaChahhL,cplcChaChahhR,cplChiChihhL,         & 
& cplChiChihhR,cplChiFecSeL,cplChiFecSeR,cplcFeChiSeL,cplcFeChiSeR,cplcFeFehhL,          & 
...
& cplSecSecVWmVWm1,cplSecSeVZVZ1,AmpVertexIRdrhhTocSeSe)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhTocSeSe(MAhOS,MChaOS,MChiOS,MFeOS,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_hhTocSuSu(cplhhSucSu,Mhh,MSu,Mhh2,MSu2,              & 
& AmpTreehhTocSuSu)

  Else 
Call Amplitude_Tree_seesaw1nmssm_hhTocSuSu(ZcplhhSucSu,Mhh,MSu,Mhh2,MSu2,             & 
& AmpTreehhTocSuSu)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTocSuSu(MLambda,em,gs,cplhhSucSu,MhhOS,MSuOS,          & 
& MRPhhTocSuSu,MRGhhTocSuSu)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTocSuSu(MLambda,em,gs,ZcplhhSucSu,MhhOS,               & 
& MSuOS,MRPhhTocSuSu,MRGhhTocSuSu)

  End if 
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_hhTocSuSu(MLambda,em,gs,cplhhSucSu,Mhh,MSu,              & 
& MRPhhTocSuSu,MRGhhTocSuSu)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTocSuSu(MLambda,em,gs,ZcplhhSucSu,Mhh,MSu,             & 
& MRPhhTocSuSu,MRGhhTocSuSu)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_hhTocSuSu(cplhhSucSu,ctcplhhSucSu,Mhh,               & 
& Mhh2,MSu,MSu2,Zfhh,ZfSu,AmpWavehhTocSuSu)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhTocSuSu(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,MVZ2,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhTocSuSu(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplAhAhhh,cplAhhhhh,cplAhhhVZ,cplAhSucSu,cplcChaChahhL,cplcChaChahhR,cplcFdChaSuL,     & 
& cplcFdChaSuR,cplChiChihhL,cplChiChihhR,cplChiFucSuL,cplChiFucSuR,cplcFuChiSuL,         & 
...
& cplSucSuVZVZaa,AmpVertexIRdrhhTocSuSu)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhTocSuSu(MAhOS,MChaOS,MChiOS,MFdOS,            & 
& MFuOS,MGluOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVG,MVP,MVWmOS,            & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,              & 
& MSe2OS,MSu2OS,MSvIm2OS,MSvRe2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,cplAhAhhh,cplAhhhhh,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_hhToSvImSvIm(cplhhSvImSvIm,Mhh,MSvIm,Mhh2,           & 
& MSvIm2,AmpTreehhToSvImSvIm)

  Else 
Call Amplitude_Tree_seesaw1nmssm_hhToSvImSvIm(ZcplhhSvImSvIm,Mhh,MSvIm,               & 
& Mhh2,MSvIm2,AmpTreehhToSvImSvIm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToSvImSvIm(MLambda,em,gs,cplhhSvImSvIm,MhhOS,          & 
& MSvImOS,MRPhhToSvImSvIm,MRGhhToSvImSvIm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToSvImSvIm(MLambda,em,gs,ZcplhhSvImSvIm,               & 
& MhhOS,MSvImOS,MRPhhToSvImSvIm,MRGhhToSvImSvIm)

  End if 
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_hhToSvImSvIm(MLambda,em,gs,cplhhSvImSvIm,Mhh,            & 
& MSvIm,MRPhhToSvImSvIm,MRGhhToSvImSvIm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToSvImSvIm(MLambda,em,gs,ZcplhhSvImSvIm,               & 
& Mhh,MSvIm,MRPhhToSvImSvIm,MRGhhToSvImSvIm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_hhToSvImSvIm(cplhhSvImSvIm,ctcplhhSvImSvIm,          & 
& Mhh,Mhh2,MSvIm,MSvIm2,Zfhh,ZfSvIm,AmpWavehhToSvImSvIm)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhToSvImSvIm(MAh,MCha,MChi,MFe,MFv,Mhh,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhToSvImSvIm(MAh,MCha,MChi,MFe,MFv,             & 
...
& cplSvImSvImVZVZ1,AmpVertexIRdrhhToSvImSvIm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhToSvImSvIm(MAhOS,MChaOS,MChiOS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_hhToSvReSvIm(cplhhSvImSvRe,Mhh,MSvIm,MSvRe,          & 
& Mhh2,MSvIm2,MSvRe2,AmpTreehhToSvReSvIm)

  Else 
Call Amplitude_Tree_seesaw1nmssm_hhToSvReSvIm(ZcplhhSvImSvRe,Mhh,MSvIm,               & 
& MSvRe,Mhh2,MSvIm2,MSvRe2,AmpTreehhToSvReSvIm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToSvReSvIm(MLambda,em,gs,cplhhSvImSvRe,MhhOS,          & 
& MSvImOS,MSvReOS,MRPhhToSvReSvIm,MRGhhToSvReSvIm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToSvReSvIm(MLambda,em,gs,ZcplhhSvImSvRe,               & 
& MhhOS,MSvImOS,MSvReOS,MRPhhToSvReSvIm,MRGhhToSvReSvIm)

  End if 
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_hhToSvReSvIm(MLambda,em,gs,cplhhSvImSvRe,Mhh,            & 
& MSvIm,MSvRe,MRPhhToSvReSvIm,MRGhhToSvReSvIm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToSvReSvIm(MLambda,em,gs,ZcplhhSvImSvRe,               & 
& Mhh,MSvIm,MSvRe,MRPhhToSvReSvIm,MRGhhToSvReSvIm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_hhToSvReSvIm(cplhhSvImSvRe,ctcplhhSvImSvRe,          & 
& Mhh,Mhh2,MSvIm,MSvIm2,MSvRe,MSvRe2,Zfhh,ZfSvIm,ZfSvRe,AmpWavehhToSvReSvIm)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhToSvReSvIm(MAh,MCha,MChi,MFe,MFv,Mhh,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhToSvReSvIm(MAh,MCha,MChi,MFe,MFv,             & 
...
& cplSvImSvImSvReSvRe1,cplSvImSvReSvReSvRe1,AmpVertexIRdrhhToSvReSvIm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhToSvReSvIm(MAhOS,MChaOS,MChiOS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_hhToSvReSvRe(cplhhSvReSvRe,Mhh,MSvRe,Mhh2,           & 
& MSvRe2,AmpTreehhToSvReSvRe)

  Else 
Call Amplitude_Tree_seesaw1nmssm_hhToSvReSvRe(ZcplhhSvReSvRe,Mhh,MSvRe,               & 
& Mhh2,MSvRe2,AmpTreehhToSvReSvRe)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToSvReSvRe(MLambda,em,gs,cplhhSvReSvRe,MhhOS,          & 
& MSvReOS,MRPhhToSvReSvRe,MRGhhToSvReSvRe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToSvReSvRe(MLambda,em,gs,ZcplhhSvReSvRe,               & 
& MhhOS,MSvReOS,MRPhhToSvReSvRe,MRGhhToSvReSvRe)

  End if 
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_hhToSvReSvRe(MLambda,em,gs,cplhhSvReSvRe,Mhh,            & 
& MSvRe,MRPhhToSvReSvRe,MRGhhToSvReSvRe)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToSvReSvRe(MLambda,em,gs,ZcplhhSvReSvRe,               & 
& Mhh,MSvRe,MRPhhToSvReSvRe,MRGhhToSvReSvRe)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_hhToSvReSvRe(cplhhSvReSvRe,ctcplhhSvReSvRe,          & 
& Mhh,Mhh2,MSvRe,MSvRe2,Zfhh,ZfSvRe,AmpWavehhToSvReSvRe)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhToSvReSvRe(MAh,MCha,MChi,MFe,MFv,Mhh,            & 
& MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,           & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhToSvReSvRe(MAh,MCha,MChi,MFe,MFv,             & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,             & 
& MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVWm2,MVZ2,cplAhAhhh,cplAhhhhh,cplAhhhVZ,           & 
...
& cplSvReSvReVZVZ1,AmpVertexIRdrhhToSvReSvRe)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhToSvReSvRe(MAhOS,MChaOS,MChiOS,               & 
& MFeOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVWmOS,MVZOS,               & 
& MAh2OS,MCha2OS,MChi2OS,MFe2OS,MFv2OS,Mhh2OS,MHpm2OS,MSd2OS,MSe2OS,MSu2OS,              & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_hhTocVWmVWm(cplhhcVWmVWm,Mhh,MVWm,Mhh2,              & 
& MVWm2,AmpTreehhTocVWmVWm)

  Else 
Call Amplitude_Tree_seesaw1nmssm_hhTocVWmVWm(ZcplhhcVWmVWm,Mhh,MVWm,Mhh2,             & 
& MVWm2,AmpTreehhTocVWmVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTocVWmVWm(MLambda,em,gs,cplhhcVWmVWm,MhhOS,            & 
& MVWmOS,MRPhhTocVWmVWm,MRGhhTocVWmVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTocVWmVWm(MLambda,em,gs,ZcplhhcVWmVWm,MhhOS,           & 
& MVWmOS,MRPhhTocVWmVWm,MRGhhTocVWmVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_hhTocVWmVWm(MLambda,em,gs,cplhhcVWmVWm,Mhh,              & 
& MVWm,MRPhhTocVWmVWm,MRGhhTocVWmVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhTocVWmVWm(MLambda,em,gs,ZcplhhcVWmVWm,Mhh,             & 
& MVWm,MRPhhTocVWmVWm,MRGhhTocVWmVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_hhTocVWmVWm(cplhhcVWmVWm,ctcplhhcVWmVWm,             & 
& Mhh,Mhh2,MVWm,MVWm2,Zfhh,ZfVWm,AmpWavehhTocVWmVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhTocVWmVWm(MAh,MCha,MChi,MFd,MFe,MFu,             & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhAhhh,      & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhTocVWmVWm(MAh,MCha,MChi,MFd,MFe,              & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,           & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhAhhh,      & 
& cplAhhhhh,cplAhhhVZ,cplAhHpmcVWm,cplAhcHpmVWm,cplChiChacVWmL,cplChiChacVWmR,           & 
& cplcChaChahhL,cplcChaChahhR,cplChiChihhL,cplChiChihhR,cplcChaChiVWmL,cplcChaChiVWmR,   & 
...
& cplcVWmVWmVZVZ2Q,cplcVWmVWmVZVZ3Q,cplcVWmVWmVZVZ1Q,AmpVertexIRdrhhTocVWmVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhTocVWmVWm(MAhOS,MChaOS,MChiOS,MFdOS,          & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVP,MVWmOS,           & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
& MSd2OS,MSe2OS,MSu2OS,MSvIm2OS,MSvRe2OS,MVP2,MVWm2OS,MVZ2OS,cplAhAhhh,cplAhhhhh,        & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_hhToVZVZ(cplhhVZVZ,Mhh,MVZ,Mhh2,MVZ2,AmpTreehhToVZVZ)

  Else 
Call Amplitude_Tree_seesaw1nmssm_hhToVZVZ(ZcplhhVZVZ,Mhh,MVZ,Mhh2,MVZ2,               & 
& AmpTreehhToVZVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToVZVZ(MLambda,em,gs,cplhhVZVZ,MhhOS,MVZOS,            & 
& MRPhhToVZVZ,MRGhhToVZVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToVZVZ(MLambda,em,gs,ZcplhhVZVZ,MhhOS,MVZOS,           & 
& MRPhhToVZVZ,MRGhhToVZVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_hhToVZVZ(MLambda,em,gs,cplhhVZVZ,Mhh,MVZ,MRPhhToVZVZ,    & 
& MRGhhToVZVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_hhToVZVZ(MLambda,em,gs,ZcplhhVZVZ,Mhh,MVZ,               & 
& MRPhhToVZVZ,MRGhhToVZVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_hhToVZVZ(cplhhVZVZ,ctcplhhVZVZ,Mhh,Mhh2,             & 
& MVZ,MVZ2,Zfhh,ZfVZ,AmpWavehhToVZVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhToVZVZ(MAh,MCha,MChi,MFd,MFe,MFu,MFv,            & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhToVZVZ(MAh,MCha,MChi,MFd,MFe,MFu,             & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,              & 
...
& AmpVertexIRdrhhToVZVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_hhToVZVZ(MAhOS,MChaOS,MChiOS,MFdOS,             & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVWmOS,               & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_seesaw1nmssm_hhToAhVP(cplAhhhVZ,ctcplAhhhVZ,MAhOS,MAh2OS,         & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_seesaw1nmssm_hhToAhVP(MAhOS,MChaOS,MFdOS,MFeOS,MFuOS,           & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_hhToAhVP(cplAhhhVZ,ctcplAhhhVZ,MAh,MAh2,             & 
& Mhh,Mhh2,MVP,MVP2,MVZ,MVZ2,ZfAh,Zfhh,ZfVP,ZfVZVP,AmpWavehhToAhVP)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhToAhVP(MAh,MCha,MFd,MFe,MFu,Mhh,MHpm,            & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_seesaw1nmssm_hhToGluGlu(MFdOS,MFuOS,MGluOS,MhhOS,               & 
& MSdOS,MSuOS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MSd2OS,MSu2OS,cplGluFdcSdL,cplGluFdcSdR,      & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhToGluGlu(MFd,MFu,MGlu,Mhh,MSd,MSu,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_seesaw1nmssm_hhTohhVP(MChaOS,MFdOS,MFeOS,MFuOS,MhhOS,           & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhTohhVP(MCha,MFd,MFe,MFu,Mhh,MHpm,MSd,            & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_seesaw1nmssm_hhTohhVZ(MAhOS,MChaOS,MChiOS,MFdOS,MFeOS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhTohhVZ(MAh,MCha,MChi,MFd,MFe,MFu,MFv,            & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,             & 
& MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVWm2,MVZ2,cplAhAhhh,cplAhhhhh,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_seesaw1nmssm_hhToVGVG(MFdOS,MFuOS,MhhOS,MSdOS,MSuOS,            & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhToVGVG(MFd,MFu,Mhh,MSd,MSu,MVG,MFd2,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_seesaw1nmssm_hhToVPVP(MChaOS,MFdOS,MFeOS,MFuOS,MhhOS,           & 
& MHpmOS,MSdOS,MSeOS,MSuOS,MVP,MVWmOS,MCha2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,               & 
& MHpm2OS,MSd2OS,MSe2OS,MSu2OS,MVP2,MVWm2OS,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,   & 
& cplcChaChaVPR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFeFehhL,             & 
& cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVPL,               & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhToVPVP(MCha,MFd,MFe,MFu,Mhh,MHpm,MSd,            & 
& MSe,MSu,MVP,MVWm,MCha2,MFd2,MFe2,MFu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MVP2,MVWm2,            & 
& cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,cplcFdFdhhL,cplcFdFdhhR,       & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,               & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVPL,cplcFuFuVPR,cplcgWmgWmhh,cplcgWmgWmVP,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_seesaw1nmssm_hhToVPVZ(MChaOS,MFdOS,MFeOS,MFuOS,MhhOS,           & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_hhToVPVZ(MCha,MFd,MFe,MFu,Mhh,MHpm,MSd,            & 
...
End Module Wrapper_OneLoopDecay_hh_seesaw1nmssm
