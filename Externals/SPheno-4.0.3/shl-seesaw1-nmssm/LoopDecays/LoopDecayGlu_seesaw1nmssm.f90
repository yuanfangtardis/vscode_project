...
Module OneLoopDecay_Glu_seesaw1nmssm
Use Control 
Use Settings 
Use LoopFunctions 
...
Subroutine Amplitude_Tree_seesaw1nmssm_GluToFdcSd(cplGluFdcSdL,cplGluFdcSdR,          & 
...
Amp(:,gt2, gt3) = AmpC 
    End Do
  End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_GluToFdcSd


Subroutine Gamma_Real_seesaw1nmssm_GluToFdcSd(MLambda,em,gs,cplGluFdcSdL,             & 
...
End if 
    End Do
  End Do
End Subroutine Gamma_Real_seesaw1nmssm_GluToFdcSd


Subroutine Amplitude_WAVE_seesaw1nmssm_GluToFdcSd(cplGluFdcSdL,cplGluFdcSdR,          & 
...
Amp(:,gt2, gt3) = AmpC 
    End Do
  End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_GluToFdcSd


Subroutine Amplitude_VERTEX_seesaw1nmssm_GluToFdcSd(MAh,MCha,MChi,MFd,MFu,            & 
...
! {Glu, VG, conj[Sd]}
If ((Include_in_loopGlu).and.(Include_in_loopVG).and.(Include_in_loopSd)) Then 
    Do i3=1,6
ML1 = MGlu 
ML2 = MVG 
ML3 = MSd(i3) 
...
! {VG, Glu, bar[Fd]}
If ((Include_in_loopVG).and.(Include_in_loopGlu).and.(Include_in_loopFd)) Then 
    Do i3=1,3
ML1 = MVG 
ML2 = MGlu 
ML3 = MFd(i3) 
...
End if 
    End Do
  End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_GluToFdcSd


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_GluToFdcSd(MAh,MCha,MChi,MFd,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_GluToFdcSd


Subroutine Amplitude_Tree_seesaw1nmssm_GluToFucSu(cplGluFucSuL,cplGluFucSuR,          & 
...
Amp(:,gt2, gt3) = AmpC 
    End Do
  End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_GluToFucSu


Subroutine Gamma_Real_seesaw1nmssm_GluToFucSu(MLambda,em,gs,cplGluFucSuL,             & 
...
End if 
    End Do
  End Do
End Subroutine Gamma_Real_seesaw1nmssm_GluToFucSu


Subroutine Amplitude_WAVE_seesaw1nmssm_GluToFucSu(cplGluFucSuL,cplGluFucSuR,          & 
...
Amp(:,gt2, gt3) = AmpC 
    End Do
  End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_GluToFucSu


Subroutine Amplitude_VERTEX_seesaw1nmssm_GluToFucSu(MAh,MCha,MChi,MFd,MFu,            & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
! {Glu, VG, conj[Su]}
If ((Include_in_loopGlu).and.(Include_in_loopVG).and.(Include_in_loopSu)) Then 
    Do i3=1,6
ML1 = MGlu 
ML2 = MVG 
ML3 = MSu(i3) 
...
! {VG, Glu, bar[Fu]}
If ((Include_in_loopVG).and.(Include_in_loopGlu).and.(Include_in_loopFu)) Then 
    Do i3=1,3
ML1 = MVG 
ML2 = MGlu 
ML3 = MFu(i3) 
...
End if 
    End Do
  End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_GluToFucSu


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_GluToFucSu(MAh,MCha,MChi,MFd,             & 
& MFu,MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,           & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,cplAhSucSu,          & 
& cplChaFucSdL,cplChaFucSdR,cplChiFucSuL,cplChiFucSuR,cplGluFdcSdL,cplGluFdcSdR,         & 
& cplcChaFdcSuL,cplcChaFdcSuR,cplGluFucSuL,cplGluFucSuR,cplcFuFuhhL,cplcFuFuhhR,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_GluToFucSu


Subroutine Amplitude_WAVE_seesaw1nmssm_GluToChiVG(MChi,MChi2,MGlu,MGlu2,              & 
...
Amp(:,gt2) = 0._dp
  End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_GluToChiVG


Subroutine Amplitude_VERTEX_seesaw1nmssm_GluToChiVG(MChi,MFd,MFu,MGlu,MSd,            & 
...
End if 
  End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_GluToChiVG


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_GluToChiVG(MChi,MFd,MFu,MGlu,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_GluToChiVG


Subroutine Amplitude_WAVE_seesaw1nmssm_GluToGluAh(MAh,MAh2,MGlu,MGlu2,ZfAh,ZffG,Amp)
...
Amp(:,gt3) = 0._dp
    End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_GluToGluAh


Subroutine Amplitude_VERTEX_seesaw1nmssm_GluToGluAh(MAh,MFd,MFu,MGlu,MSd,             & 
...
End if 
    End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_GluToGluAh


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_GluToGluAh(MAh,MFd,MFu,MGlu,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_GluToGluAh


Subroutine Amplitude_WAVE_seesaw1nmssm_GluToGluhh(MGlu,MGlu2,Mhh,Mhh2,ZffG,Zfhh,Amp)
...
Amp(:,gt3) = 0._dp
    End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_GluToGluhh


Subroutine Amplitude_VERTEX_seesaw1nmssm_GluToGluhh(MFd,MFu,MGlu,Mhh,MSd,             & 
...
End if 
    End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_GluToGluhh


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_GluToGluhh(MFd,MFu,MGlu,Mhh,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_GluToGluhh


Subroutine Amplitude_WAVE_seesaw1nmssm_GluToGluVG(cplGluGluVGL,cplGluGluVGR,          & 
...
Amp(:) = -AmpC 
End Subroutine Amplitude_WAVE_seesaw1nmssm_GluToGluVG


Subroutine Amplitude_VERTEX_seesaw1nmssm_GluToGluVG(MFd,MFu,MGlu,MSd,MSu,             & 
...
! {Glu, VG, VG}
If ((Include_in_loopGlu).and.(Include_in_loopVG).and.(Include_in_loopVG)) Then 
ML1 = MGlu 
ML2 = MVG 
ML3 = MVG 
coup1L = cplGluGluVGL
...
! {VG, Glu, Glu}
If ((Include_in_loopVG).and.(Include_in_loopGlu).and.(Include_in_loopGlu)) Then 
ML1 = MVG 
ML2 = MGlu 
ML3 = MGlu 
coup1L = cplGluGluVGL
...
End Do
End if 
End Subroutine Amplitude_VERTEX_seesaw1nmssm_GluToGluVG


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_GluToGluVG(MFd,MFu,MGlu,MSd,              & 
& MSu,MVG,MFd2,MFu2,MGlu2,MSd2,MSu2,MVG2,cplGluFdcSdL,cplGluFdcSdR,cplcFdFdVGL,          & 
& cplcFdFdVGR,cplGluFucSuL,cplGluFucSuR,cplcFuFuVGL,cplcFuFuVGR,cplGluGluVGL,            & 
& cplGluGluVGR,cplcFdGluSdL,cplcFdGluSdR,cplcFuGluSuL,cplcFuGluSuR,cplSdcSdVG,           & 
& cplSucSuVG,cplVGVGVG,Amp)
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_GluToGluVG


Subroutine Amplitude_WAVE_seesaw1nmssm_GluToGluVP(MGlu,MGlu2,MVP,MVP2,ZffG,ZfVP,Amp)
...
! External Field 3 
Amp(:) = 0._dp
End Subroutine Amplitude_WAVE_seesaw1nmssm_GluToGluVP


Subroutine Amplitude_VERTEX_seesaw1nmssm_GluToGluVP(MFd,MFu,MGlu,MSd,MSu,             & 
...
End Do
End if 
End Subroutine Amplitude_VERTEX_seesaw1nmssm_GluToGluVP


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_GluToGluVP(MFd,MFu,MGlu,MSd,              & 
& MSu,MVP,MFd2,MFu2,MGlu2,MSd2,MSu2,MVP2,cplGluFdcSdL,cplGluFdcSdR,cplcFdFdVPL,          & 
& cplcFdFdVPR,cplGluFucSuL,cplGluFucSuR,cplcFuFuVPL,cplcFuFuVPR,cplcFdGluSdL,            & 
& cplcFdGluSdR,cplcFuGluSuL,cplcFuGluSuR,cplSdcSdVP,cplSucSuVP,Amp)
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_GluToGluVP


Subroutine Amplitude_WAVE_seesaw1nmssm_GluToGluVZ(MGlu,MGlu2,MVZ,MVZ2,ZffG,ZfVZ,Amp)
...
! External Field 3 
Amp(:) = 0._dp
End Subroutine Amplitude_WAVE_seesaw1nmssm_GluToGluVZ


Subroutine Amplitude_VERTEX_seesaw1nmssm_GluToGluVZ(MFd,MFu,MGlu,MSd,MSu,             & 
...
End Do
End if 
End Subroutine Amplitude_VERTEX_seesaw1nmssm_GluToGluVZ


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_GluToGluVZ(MFd,MFu,MGlu,MSd,              & 
& MSu,MVZ,MFd2,MFu2,MGlu2,MSd2,MSu2,MVZ2,cplGluFdcSdL,cplGluFdcSdR,cplcFdFdVZL,          & 
& cplcFdFdVZR,cplGluFucSuL,cplGluFucSuR,cplcFuFuVZL,cplcFuFuVZR,cplcFdGluSdL,            & 
& cplcFdGluSdR,cplcFuGluSuL,cplcFuGluSuR,cplSdcSdVZ,cplSucSuVZ,Amp)
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_GluToGluVZ



End Module OneLoopDecay_Glu_seesaw1nmssm
