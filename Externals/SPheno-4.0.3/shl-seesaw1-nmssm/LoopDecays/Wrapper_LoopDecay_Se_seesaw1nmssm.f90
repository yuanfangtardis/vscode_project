...
Module Wrapper_OneLoopDecay_Se_seesaw1nmssm
Use Model_Data_seesaw1nmssm 
Use Kinematics 
Use OneLoopDecay_Se_seesaw1nmssm 
Use Control 
Use Settings 
...
& cplhhHpmcHpm(3,2,2),cplhhHpmcVWm(3,2),cplhhHpmSvImcSe1(3,2,6,6),cplhhHpmSvRecSe1(3,2,6,6),& 
...
& cplSeSvRecVWm(6,6),cplSeSvRecVWmVP1(6,6),cplSeSvRecVWmVZ1(6,6),cplSeSvReSvRecSe1(6,6,6,6),& 
...
& cplSvReSvRecVWmVWm1(6,6),ctcplAhSecSe(3,6,6),ctcplChiFecSeL(5,3,6),ctcplChiFecSeR(5,3,6)

Complex(dp),Intent(in) :: ctcplFvChacSeL(6,2,6),ctcplFvChacSeR(6,2,6),ctcplhhSecSe(3,6,6),ctcplHpmSvImcSe(2,6,6),& 
& ctcplHpmSvRecSe(2,6,6),ctcplSecSeVP(6,6),ctcplSecSeVZ(6,6),ctcplSvImcSeVWm(6,6),       & 
...
& GZcplHpmSvRecSe(2,6,6),ZcplAhSecSe(3,6,6),ZcplChiFecSeL(5,3,6),ZcplChiFecSeR(5,3,6),   & 
& ZcplFvChacSeL(6,2,6),ZcplFvChacSeR(6,2,6),ZcplhhSecSe(3,6,6),ZcplHpmSvImcSe(2,6,6),    & 
& ZcplHpmSvRecSe(2,6,6),ZcplSecSeVZ(6,6),ZcplSvImcSeVWm(6,6),ZcplSvRecSeVWm(6,6)
...
Call Amplitude_Tree_seesaw1nmssm_SeToSeAh(cplAhSecSe,MAh,MSe,MAh2,MSe2,               & 
& AmpTreeSeToSeAh)

  Else 
Call Amplitude_Tree_seesaw1nmssm_SeToSeAh(ZcplAhSecSe,MAh,MSe,MAh2,MSe2,              & 
& AmpTreeSeToSeAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToSeAh(MLambda,em,gs,cplAhSecSe,MAhOS,MSeOS,           & 
& MRPSeToSeAh,MRGSeToSeAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToSeAh(MLambda,em,gs,ZcplAhSecSe,MAhOS,MSeOS,          & 
& MRPSeToSeAh,MRGSeToSeAh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_SeToSeAh(MLambda,em,gs,cplAhSecSe,MAh,MSe,               & 
& MRPSeToSeAh,MRGSeToSeAh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToSeAh(MLambda,em,gs,ZcplAhSecSe,MAh,MSe,              & 
& MRPSeToSeAh,MRGSeToSeAh)
...
Call Amplitude_WAVE_seesaw1nmssm_SeToSeAh(cplAhSecSe,ctcplAhSecSe,MAh,MAh2,           & 
& MSe,MSe2,ZfAh,ZfSe,AmpWaveSeToSeAh)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_SeToSeAh(MAh,MCha,MChi,MFe,MFv,Mhh,MHpm,           & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SeToSeAh(MAh,MCha,MChi,MFe,MFv,Mhh,             & 
...
& cplSeSucSecSuaa,cplSeSvImSvImcSe1,cplSeSvImSvRecSe1,cplSeSvReSvRecSe1,AmpVertexIRdrSeToSeAh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SeToSeAh(MAhOS,MChaOS,MChiOS,MFeOS,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_SeToFvCha(cplFvChacSeL,cplFvChacSeR,MCha,            & 
& MFv,MSe,MCha2,MFv2,MSe2,AmpTreeSeToFvCha)

  Else 
Call Amplitude_Tree_seesaw1nmssm_SeToFvCha(ZcplFvChacSeL,ZcplFvChacSeR,               & 
& MCha,MFv,MSe,MCha2,MFv2,MSe2,AmpTreeSeToFvCha)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToFvCha(MLambda,em,gs,cplFvChacSeL,cplFvChacSeR,       & 
& MChaOS,MFvOS,MSeOS,MRPSeToFvCha,MRGSeToFvCha)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToFvCha(MLambda,em,gs,ZcplFvChacSeL,ZcplFvChacSeR,     & 
& MChaOS,MFvOS,MSeOS,MRPSeToFvCha,MRGSeToFvCha)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_SeToFvCha(cplFvChacSeL,cplFvChacSeR,ctcplFvChacSeL,  & 
& ctcplFvChacSeR,MCha,MCha2,MFv,MFv2,MSe,MSe2,ZfFV,ZfLm,ZfLp,ZfSe,AmpWaveSeToFvCha)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_SeToFvCha(MAh,MCha,MChi,MFe,MFv,Mhh,               & 
...
& cplSecSeVP,cplSecSeVZ,cplSvImcSeVWm,cplSvRecSeVWm,AmpVertexSeToFvCha)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SeToFvCha(MAh,MCha,MChi,MFe,MFv,Mhh,            & 
& MHpm,MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,               & 
& MSe2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplcChaChaAhL,cplcChaChaAhR,cplFvFvAhL,             & 
& cplFvFvAhR,cplAhSecSe,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,     & 
& cplFvChacSeL,cplFvChacSeR,cplcChaChahhL,cplcChaChahhR,cplcFeChaSvImL,cplcFeChaSvImR,   & 
...
& cplSecSeVP,cplSecSeVZ,cplSvImcSeVWm,cplSvRecSeVWm,AmpVertexIRdrSeToFvCha)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SeToFvCha(MAhOS,MChaOS,MChiOS,MFeOS,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_SeToFeChi(cplChiFecSeL,cplChiFecSeR,MChi,            & 
& MFe,MSe,MChi2,MFe2,MSe2,AmpTreeSeToFeChi)

  Else 
Call Amplitude_Tree_seesaw1nmssm_SeToFeChi(ZcplChiFecSeL,ZcplChiFecSeR,               & 
& MChi,MFe,MSe,MChi2,MFe2,MSe2,AmpTreeSeToFeChi)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToFeChi(MLambda,em,gs,cplChiFecSeL,cplChiFecSeR,       & 
& MChiOS,MFeOS,MSeOS,MRPSeToFeChi,MRGSeToFeChi)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToFeChi(MLambda,em,gs,ZcplChiFecSeL,ZcplChiFecSeR,     & 
& MChiOS,MFeOS,MSeOS,MRPSeToFeChi,MRGSeToFeChi)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_SeToFeChi(cplChiFecSeL,cplChiFecSeR,ctcplChiFecSeL,  & 
& ctcplChiFecSeR,MChi,MChi2,MFe,MFe2,MSe,MSe2,ZfFEL,ZfFER,ZfL0,ZfSe,AmpWaveSeToFeChi)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_SeToFeChi(MAh,MCha,MChi,MFe,MFv,Mhh,               & 
& MHpm,MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,               & 
...
& cplSecSeVP,cplSecSeVZ,cplSvImcSeVWm,cplSvRecSeVWm,AmpVertexSeToFeChi)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SeToFeChi(MAh,MCha,MChi,MFe,MFv,Mhh,            & 
& MHpm,MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,               & 
& MSe2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplChiChiAhL,cplChiChiAhR,cplcFeFeAhL,              & 
& cplcFeFeAhR,cplAhSecSe,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,    & 
& cplFvChacSeL,cplFvChacSeR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,         & 
...
& cplSecSeVP,cplSecSeVZ,cplSvImcSeVWm,cplSvRecSeVWm,AmpVertexIRdrSeToFeChi)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SeToFeChi(MAhOS,MChaOS,MChiOS,MFeOS,            & 
& MFvOS,MhhOS,MHpmOS,MSeOS,MSvImOS,MSvReOS,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,              & 
& MChi2OS,MFe2OS,MFv2OS,Mhh2OS,MHpm2OS,MSe2OS,MSvIm2OS,MSvRe2OS,MVP2,MVWm2OS,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_SeToSehh(cplhhSecSe,Mhh,MSe,Mhh2,MSe2,               & 
& AmpTreeSeToSehh)

  Else 
Call Amplitude_Tree_seesaw1nmssm_SeToSehh(ZcplhhSecSe,Mhh,MSe,Mhh2,MSe2,              & 
& AmpTreeSeToSehh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToSehh(MLambda,em,gs,cplhhSecSe,MhhOS,MSeOS,           & 
& MRPSeToSehh,MRGSeToSehh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToSehh(MLambda,em,gs,ZcplhhSecSe,MhhOS,MSeOS,          & 
& MRPSeToSehh,MRGSeToSehh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_SeToSehh(MLambda,em,gs,cplhhSecSe,Mhh,MSe,               & 
& MRPSeToSehh,MRGSeToSehh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToSehh(MLambda,em,gs,ZcplhhSecSe,Mhh,MSe,              & 
& MRPSeToSehh,MRGSeToSehh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_SeToSehh(cplhhSecSe,ctcplhhSecSe,Mhh,Mhh2,           & 
& MSe,MSe2,Zfhh,ZfSe,AmpWaveSeToSehh)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_SeToSehh(MAh,MCha,MChi,MFe,MFv,Mhh,MHpm,           & 
& MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SeToSehh(MAh,MCha,MChi,MFe,MFv,Mhh,             & 
& MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,             & 
...
& cplSecSecVWmVWm1,cplSecSeVZVZ1,AmpVertexIRdrSeToSehh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SeToSehh(MAhOS,MChaOS,MChiOS,MFeOS,             & 
& MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVP,MVWmOS,MVZOS,MAh2OS,          & 
& MCha2OS,MChi2OS,MFe2OS,MFv2OS,Mhh2OS,MHpm2OS,MSd2OS,MSe2OS,MSu2OS,MSvIm2OS,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_SeToSvImHpm(cplHpmSvImcSe,MHpm,MSe,MSvIm,            & 
& MHpm2,MSe2,MSvIm2,AmpTreeSeToSvImHpm)

  Else 
Call Amplitude_Tree_seesaw1nmssm_SeToSvImHpm(ZcplHpmSvImcSe,MHpm,MSe,MSvIm,           & 
& MHpm2,MSe2,MSvIm2,AmpTreeSeToSvImHpm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToSvImHpm(MLambda,em,gs,cplHpmSvImcSe,MHpmOS,          & 
& MSeOS,MSvImOS,MRPSeToSvImHpm,MRGSeToSvImHpm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToSvImHpm(MLambda,em,gs,ZcplHpmSvImcSe,MHpmOS,         & 
& MSeOS,MSvImOS,MRPSeToSvImHpm,MRGSeToSvImHpm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_SeToSvImHpm(MLambda,em,gs,cplHpmSvImcSe,MHpm,            & 
& MSe,MSvIm,MRPSeToSvImHpm,MRGSeToSvImHpm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToSvImHpm(MLambda,em,gs,ZcplHpmSvImcSe,MHpm,           & 
& MSe,MSvIm,MRPSeToSvImHpm,MRGSeToSvImHpm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_SeToSvImHpm(cplHpmSvImcSe,ctcplHpmSvImcSe,           & 
& MHpm,MHpm2,MSe,MSe2,MSvIm,MSvIm2,ZfHpm,ZfSe,ZfSvIm,AmpWaveSeToSvImHpm)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_SeToSvImHpm(MAh,MCha,MChi,MFe,MFv,Mhh,             & 
& MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SeToSvImHpm(MAh,MCha,MChi,MFe,MFv,              & 
...
& cplSeSvImSvRecSe1,cplSvImcSeVPVWm1,cplSvImcSeVWmVZ1,AmpVertexIRdrSeToSvImHpm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SeToSvImHpm(MAhOS,MChaOS,MChiOS,MFeOS,          & 
& MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVP,MVWmOS,MVZOS,MAh2OS,          & 
& MCha2OS,MChi2OS,MFe2OS,MFv2OS,Mhh2OS,MHpm2OS,MSd2OS,MSe2OS,MSu2OS,MSvIm2OS,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_SeToSvReHpm(cplHpmSvRecSe,MHpm,MSe,MSvRe,            & 
& MHpm2,MSe2,MSvRe2,AmpTreeSeToSvReHpm)

  Else 
Call Amplitude_Tree_seesaw1nmssm_SeToSvReHpm(ZcplHpmSvRecSe,MHpm,MSe,MSvRe,           & 
& MHpm2,MSe2,MSvRe2,AmpTreeSeToSvReHpm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToSvReHpm(MLambda,em,gs,cplHpmSvRecSe,MHpmOS,          & 
& MSeOS,MSvReOS,MRPSeToSvReHpm,MRGSeToSvReHpm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToSvReHpm(MLambda,em,gs,ZcplHpmSvRecSe,MHpmOS,         & 
& MSeOS,MSvReOS,MRPSeToSvReHpm,MRGSeToSvReHpm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_SeToSvReHpm(MLambda,em,gs,cplHpmSvRecSe,MHpm,            & 
& MSe,MSvRe,MRPSeToSvReHpm,MRGSeToSvReHpm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToSvReHpm(MLambda,em,gs,ZcplHpmSvRecSe,MHpm,           & 
& MSe,MSvRe,MRPSeToSvReHpm,MRGSeToSvReHpm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_SeToSvReHpm(cplHpmSvRecSe,ctcplHpmSvRecSe,           & 
& MHpm,MHpm2,MSe,MSe2,MSvRe,MSvRe2,ZfHpm,ZfSe,ZfSvRe,AmpWaveSeToSvReHpm)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_SeToSvReHpm(MAh,MCha,MChi,MFe,MFv,Mhh,             & 
& MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,             & 
& MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhHpmcHpm,cplAhHpmcVWm,          & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SeToSvReHpm(MAh,MCha,MChi,MFe,MFv,              & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,              & 
& Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhHpmcHpm,cplAhHpmcVWm,     & 
& cplAhSecSe,cplAhSvImSvRe,cplAhSvReSvRe,cplFvChacSeL,cplFvChacSeR,cplcFeChaSvReL,       & 
& cplcFeChaSvReR,cplChiFecSeL,cplChiFecSeR,cplChiFvSvReL,cplChiFvSvReR,cplcChaChiHpmL,   & 
...
& cplSeSvReSvRecSe1,cplSvRecSeVPVWm1,cplSvRecSeVWmVZ1,AmpVertexIRdrSeToSvReHpm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SeToSvReHpm(MAhOS,MChaOS,MChiOS,MFeOS,          & 
& MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVP,MVWmOS,MVZOS,MAh2OS,          & 
& MCha2OS,MChi2OS,MFe2OS,MFv2OS,Mhh2OS,MHpm2OS,MSd2OS,MSe2OS,MSu2OS,MSvIm2OS,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_SeToSeVZ(cplSecSeVZ,MSe,MVZ,MSe2,MVZ2,               & 
& AmpTreeSeToSeVZ)

  Else 
Call Amplitude_Tree_seesaw1nmssm_SeToSeVZ(ZcplSecSeVZ,MSe,MVZ,MSe2,MVZ2,              & 
& AmpTreeSeToSeVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToSeVZ(MLambda,em,gs,cplSecSeVZ,MSeOS,MVZOS,           & 
& MRPSeToSeVZ,MRGSeToSeVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToSeVZ(MLambda,em,gs,ZcplSecSeVZ,MSeOS,MVZOS,          & 
& MRPSeToSeVZ,MRGSeToSeVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_SeToSeVZ(MLambda,em,gs,cplSecSeVZ,MSe,MVZ,               & 
& MRPSeToSeVZ,MRGSeToSeVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToSeVZ(MLambda,em,gs,ZcplSecSeVZ,MSe,MVZ,              & 
& MRPSeToSeVZ,MRGSeToSeVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_SeToSeVZ(cplSecSeVP,cplSecSeVZ,ctcplSecSeVP,         & 
& ctcplSecSeVZ,MSe,MSe2,MVP,MVP2,MVZ,MVZ2,ZfSe,ZfVPVZ,ZfVZ,AmpWaveSeToSeVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_SeToSeVZ(MAh,MCha,MChi,MFe,MFv,Mhh,MHpm,           & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SeToSeVZ(MAh,MCha,MChi,MFe,MFv,Mhh,             & 
& MHpm,MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,               & 
...
& cplSvImcSeVWmVZ1,cplSvRecSeVWmVZ1,AmpVertexIRdrSeToSeVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SeToSeVZ(MAhOS,MChaOS,MChiOS,MFeOS,             & 
& MFvOS,MhhOS,MHpmOS,MSeOS,MSvImOS,MSvReOS,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,              & 
& MChi2OS,MFe2OS,MFv2OS,Mhh2OS,MHpm2OS,MSe2OS,MSvIm2OS,MSvRe2OS,MVP2,MVWm2OS,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_SeToSvImVWm(cplSvImcSeVWm,MSe,MSvIm,MVWm,            & 
& MSe2,MSvIm2,MVWm2,AmpTreeSeToSvImVWm)

  Else 
Call Amplitude_Tree_seesaw1nmssm_SeToSvImVWm(ZcplSvImcSeVWm,MSe,MSvIm,MVWm,           & 
& MSe2,MSvIm2,MVWm2,AmpTreeSeToSvImVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToSvImVWm(MLambda,em,gs,cplSvImcSeVWm,MSeOS,           & 
& MSvImOS,MVWmOS,MRPSeToSvImVWm,MRGSeToSvImVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToSvImVWm(MLambda,em,gs,ZcplSvImcSeVWm,MSeOS,          & 
& MSvImOS,MVWmOS,MRPSeToSvImVWm,MRGSeToSvImVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_SeToSvImVWm(MLambda,em,gs,cplSvImcSeVWm,MSe,             & 
& MSvIm,MVWm,MRPSeToSvImVWm,MRGSeToSvImVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToSvImVWm(MLambda,em,gs,ZcplSvImcSeVWm,MSe,            & 
& MSvIm,MVWm,MRPSeToSvImVWm,MRGSeToSvImVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_SeToSvImVWm(cplSvImcSeVWm,ctcplSvImcSeVWm,           & 
& MSe,MSe2,MSvIm,MSvIm2,MVWm,MVWm2,ZfSe,ZfSvIm,ZfVWm,AmpWaveSeToSvImVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_SeToSvImVWm(MAh,MCha,MChi,MFe,MFv,Mhh,             & 
& MHpm,MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SeToSvImVWm(MAh,MCha,MChi,MFe,MFv,              & 
...
& cplSvImcSeVPVWm1,cplSvImcSeVWmVZ1,cplSvRecSeVWmVZ1,AmpVertexIRdrSeToSvImVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SeToSvImVWm(MAhOS,MChaOS,MChiOS,MFeOS,          & 
& MFvOS,MhhOS,MHpmOS,MSeOS,MSvImOS,MSvReOS,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,              & 
& MChi2OS,MFe2OS,MFv2OS,Mhh2OS,MHpm2OS,MSe2OS,MSvIm2OS,MSvRe2OS,MVP2,MVWm2OS,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_seesaw1nmssm_SeToSvReVWm(cplSvRecSeVWm,MSe,MSvRe,MVWm,            & 
& MSe2,MSvRe2,MVWm2,AmpTreeSeToSvReVWm)

  Else 
Call Amplitude_Tree_seesaw1nmssm_SeToSvReVWm(ZcplSvRecSeVWm,MSe,MSvRe,MVWm,           & 
& MSe2,MSvRe2,MVWm2,AmpTreeSeToSvReVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToSvReVWm(MLambda,em,gs,cplSvRecSeVWm,MSeOS,           & 
& MSvReOS,MVWmOS,MRPSeToSvReVWm,MRGSeToSvReVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToSvReVWm(MLambda,em,gs,ZcplSvRecSeVWm,MSeOS,          & 
& MSvReOS,MVWmOS,MRPSeToSvReVWm,MRGSeToSvReVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_seesaw1nmssm_SeToSvReVWm(MLambda,em,gs,cplSvRecSeVWm,MSe,             & 
& MSvRe,MVWm,MRPSeToSvReVWm,MRGSeToSvReVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_seesaw1nmssm_SeToSvReVWm(MLambda,em,gs,ZcplSvRecSeVWm,MSe,            & 
& MSvRe,MVWm,MRPSeToSvReVWm,MRGSeToSvReVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_seesaw1nmssm_SeToSvReVWm(cplSvRecSeVWm,ctcplSvRecSeVWm,           & 
& MSe,MSe2,MSvRe,MSvRe2,MVWm,MVWm2,ZfSe,ZfSvRe,ZfVWm,AmpWaveSeToSvReVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_SeToSvReVWm(MAh,MCha,MChi,MFe,MFv,Mhh,             & 
& MHpm,MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SeToSvReVWm(MAh,MCha,MChi,MFe,MFv,              & 
& Mhh,MHpm,MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,           & 
& MSe2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhSecSe,cplAhSvImSvRe,cplAhSvReSvRe,             & 
& cplAhcHpmVWm,cplFvChacSeL,cplFvChacSeR,cplcFeChaSvReL,cplcFeChaSvReR,cplChiFecSeL,     & 
& cplChiFecSeR,cplChiFvSvReL,cplChiFvSvReR,cplcChaChiVWmL,cplcChaChiVWmR,cplcChaFeSvReL, & 
...
& cplSvReSvRecVWmVWm1,cplSvRecSeVPVWm1,cplSvRecSeVWmVZ1,AmpVertexIRdrSeToSvReVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_seesaw1nmssm_SeToSvReVWm(MAhOS,MChaOS,MChiOS,MFeOS,          & 
& MFvOS,MhhOS,MHpmOS,MSeOS,MSvImOS,MSvReOS,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,              & 
& MChi2OS,MFe2OS,MFv2OS,Mhh2OS,MHpm2OS,MSe2OS,MSvIm2OS,MSvRe2OS,MVP2,MVWm2OS,            & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_seesaw1nmssm_SeToSeVP(cplSecSeVP,cplSecSeVZ,ctcplSecSeVP,         & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_seesaw1nmssm_SeToSeVP(MAhOS,MChaOS,MChiOS,MFeOS,MFvOS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_seesaw1nmssm_SeToSeVP(MAh,MCha,MChi,MFe,MFv,Mhh,MHpm,           & 
& MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,MSe2,               & 
...
End Module Wrapper_OneLoopDecay_Se_seesaw1nmssm
