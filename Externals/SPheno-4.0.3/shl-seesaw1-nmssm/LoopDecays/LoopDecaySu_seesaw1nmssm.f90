...
! ------------------------------------------------------------------------------  
! File created at 18:38 on 2.10.2017   
! ----------------------------------------------------------------------  
 
 
Module OneLoopDecay_Su_seesaw1nmssm
Use Control 
Use Settings 
Use LoopFunctions 
...
Subroutine Amplitude_Tree_seesaw1nmssm_SuToSuAh(cplAhSucSu,MAh,MSu,MAh2,MSu2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_SuToSuAh


Subroutine Gamma_Real_seesaw1nmssm_SuToSuAh(MLambda,em,gs,cplAhSucSu,MAh,             & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_SuToSuAh


Subroutine Amplitude_WAVE_seesaw1nmssm_SuToSuAh(cplAhSucSu,ctcplAhSucSu,              & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_SuToSuAh


Subroutine Amplitude_VERTEX_seesaw1nmssm_SuToSuAh(MAh,MCha,MChi,MFd,MFu,              & 
...
! {Ah, conj[Su], conj[Su]}
If ((Include_in_loopAh).and.(Include_in_loopSu).and.(Include_in_loopSu)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,6
ML1 = MAh(i1) 
...
! {Chi, bar[Fu], bar[Fu]}
If ((Include_in_loopChi).and.(Include_in_loopFu).and.(Include_in_loopFu)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,3
ML1 = MChi(i1) 
...
! {Fd, Cha, Cha}
If ((Include_in_loopFd).and.(Include_in_loopCha).and.(Include_in_loopCha)) Then 
Do i1=1,3
  Do i2=1,2
    Do i3=1,2
ML1 = MFd(i1) 
...
! {Fu, Chi, Chi}
If ((Include_in_loopFu).and.(Include_in_loopChi).and.(Include_in_loopChi)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,5
ML1 = MFu(i1) 
...
! {Glu, bar[Fu], bar[Fu]}
If ((Include_in_loopGlu).and.(Include_in_loopFu).and.(Include_in_loopFu)) Then 
  Do i2=1,3
    Do i3=1,3
ML1 = MGlu 
ML2 = MFu(i2) 
...
! {hh, conj[Su], conj[Su]}
If ((Include_in_loophh).and.(Include_in_loopSu).and.(Include_in_loopSu)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,6
ML1 = Mhh(i1) 
...
! {Sd, Hpm, Hpm}
If ((Include_in_loopSd).and.(Include_in_loopHpm).and.(Include_in_loopHpm)) Then 
Do i1=1,6
  Do i2=1,2
    Do i3=1,2
ML1 = MSd(i1) 
...
! {Sd, VWm, Hpm}
If ((Include_in_loopSd).and.(Include_in_loopVWm).and.(Include_in_loopHpm)) Then 
Do i1=1,6
    Do i3=1,2
ML1 = MSd(i1) 
ML2 = MVWm 
...
! {Sd, Hpm, VWm}
If ((Include_in_loopSd).and.(Include_in_loopHpm).and.(Include_in_loopVWm)) Then 
Do i1=1,6
  Do i2=1,2
ML1 = MSd(i1) 
ML2 = MHpm(i2) 
...
! {Su, Ah, Ah}
If ((Include_in_loopSu).and.(Include_in_loopAh).and.(Include_in_loopAh)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,3
ML1 = MSu(i1) 
...
! {Su, hh, Ah}
If ((Include_in_loopSu).and.(Include_in_loophh).and.(Include_in_loopAh)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,3
ML1 = MSu(i1) 
...
! {Su, Ah, hh}
If ((Include_in_loopSu).and.(Include_in_loopAh).and.(Include_in_loophh)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,3
ML1 = MSu(i1) 
...
! {Su, hh, hh}
If ((Include_in_loopSu).and.(Include_in_loophh).and.(Include_in_loophh)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,3
ML1 = MSu(i1) 
...
! {Su, VZ, hh}
If ((Include_in_loopSu).and.(Include_in_loopVZ).and.(Include_in_loophh)) Then 
Do i1=1,6
    Do i3=1,3
ML1 = MSu(i1) 
ML2 = MVZ 
...
! {Su, hh, VZ}
If ((Include_in_loopSu).and.(Include_in_loophh).and.(Include_in_loopVZ)) Then 
Do i1=1,6
  Do i2=1,3
ML1 = MSu(i1) 
ML2 = Mhh(i2) 
...
! {VG, conj[Su], conj[Su]}
If ((Include_in_loopVG).and.(Include_in_loopSu).and.(Include_in_loopSu)) Then 
  Do i2=1,6
    Do i3=1,6
ML1 = MVG 
ML2 = MSu(i2) 
...
! {VP, conj[Su], conj[Su]}
If ((Include_in_loopVP).and.(Include_in_loopSu).and.(Include_in_loopSu)) Then 
  Do i2=1,6
    Do i3=1,6
ML1 = MVP 
ML2 = MSu(i2) 
...
! {VZ, conj[Su], conj[Su]}
If ((Include_in_loopVZ).and.(Include_in_loopSu).and.(Include_in_loopSu)) Then 
  Do i2=1,6
    Do i3=1,6
ML1 = MVZ 
ML2 = MSu(i2) 
...
If ((Include_in_loopCha).and.(Include_in_loopFd).and.(Include_in_loopFd)) Then 
Do i1=1,2
  Do i2=1,3
    Do i3=1,3
ML1 = MCha(i1) 
...
If ((Include_in_loopHpm).and.(Include_in_loopSd).and.(Include_in_loopSd)) Then 
Do i1=1,2
  Do i2=1,6
    Do i3=1,6
ML1 = MHpm(i1) 
...
If ((Include_in_loopVWm).and.(Include_in_loopSd).and.(Include_in_loopSd)) Then 
  Do i2=1,6
    Do i3=1,6
ML1 = MVWm 
ML2 = MSd(i2) 
...
End if 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_SuToSuAh


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SuToSuAh(MAh,MCha,MChi,MFd,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SuToSuAh


Subroutine Amplitude_Tree_seesaw1nmssm_SuToFuChi(cplChiFucSuL,cplChiFucSuR,           & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_SuToFuChi


Subroutine Gamma_Real_seesaw1nmssm_SuToFuChi(MLambda,em,gs,cplChiFucSuL,              & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_SuToFuChi


Subroutine Amplitude_WAVE_seesaw1nmssm_SuToFuChi(cplChiFucSuL,cplChiFucSuR,           & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_SuToFuChi


Subroutine Amplitude_VERTEX_seesaw1nmssm_SuToFuChi(MAh,MCha,MChi,MFd,MFu,             & 
...
! {Ah, conj[Su], bar[Fu]}
If ((Include_in_loopAh).and.(Include_in_loopSu).and.(Include_in_loopFu)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,3
ML1 = MAh(i1) 
...
! {Chi, bar[Fu], conj[Su]}
If ((Include_in_loopChi).and.(Include_in_loopFu).and.(Include_in_loopSu)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,6
ML1 = MChi(i1) 
...
! {Fd, Cha, Hpm}
If ((Include_in_loopFd).and.(Include_in_loopCha).and.(Include_in_loopHpm)) Then 
Do i1=1,3
  Do i2=1,2
    Do i3=1,2
ML1 = MFd(i1) 
...
! {Fd, Cha, VWm}
If ((Include_in_loopFd).and.(Include_in_loopCha).and.(Include_in_loopVWm)) Then 
Do i1=1,3
  Do i2=1,2
ML1 = MFd(i1) 
ML2 = MCha(i2) 
...
! {Fu, Chi, Ah}
If ((Include_in_loopFu).and.(Include_in_loopChi).and.(Include_in_loopAh)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,3
ML1 = MFu(i1) 
...
! {Fu, Chi, hh}
If ((Include_in_loopFu).and.(Include_in_loopChi).and.(Include_in_loophh)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,3
ML1 = MFu(i1) 
...
! {Fu, Chi, VZ}
If ((Include_in_loopFu).and.(Include_in_loopChi).and.(Include_in_loopVZ)) Then 
Do i1=1,3
  Do i2=1,5
ML1 = MFu(i1) 
ML2 = MChi(i2) 
...
! {Glu, bar[Fu], conj[Su]}
If ((Include_in_loopGlu).and.(Include_in_loopFu).and.(Include_in_loopSu)) Then 
  Do i2=1,3
    Do i3=1,6
ML1 = MGlu 
ML2 = MFu(i2) 
...
! {hh, conj[Su], bar[Fu]}
If ((Include_in_loophh).and.(Include_in_loopSu).and.(Include_in_loopFu)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,3
ML1 = Mhh(i1) 
...
! {Sd, Hpm, Cha}
If ((Include_in_loopSd).and.(Include_in_loopHpm).and.(Include_in_loopCha)) Then 
Do i1=1,6
  Do i2=1,2
    Do i3=1,2
ML1 = MSd(i1) 
...
! {Sd, VWm, Cha}
If ((Include_in_loopSd).and.(Include_in_loopVWm).and.(Include_in_loopCha)) Then 
Do i1=1,6
    Do i3=1,2
ML1 = MSd(i1) 
ML2 = MVWm 
...
! {Su, Ah, Chi}
If ((Include_in_loopSu).and.(Include_in_loopAh).and.(Include_in_loopChi)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,5
ML1 = MSu(i1) 
...
! {Su, hh, Chi}
If ((Include_in_loopSu).and.(Include_in_loophh).and.(Include_in_loopChi)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,5
ML1 = MSu(i1) 
...
! {Su, VZ, Chi}
If ((Include_in_loopSu).and.(Include_in_loopVZ).and.(Include_in_loopChi)) Then 
Do i1=1,6
    Do i3=1,5
ML1 = MSu(i1) 
ML2 = MVZ 
...
! {VG, conj[Su], bar[Fu]}
If ((Include_in_loopVG).and.(Include_in_loopSu).and.(Include_in_loopFu)) Then 
  Do i2=1,6
    Do i3=1,3
ML1 = MVG 
ML2 = MSu(i2) 
...
! {VP, conj[Su], bar[Fu]}
If ((Include_in_loopVP).and.(Include_in_loopSu).and.(Include_in_loopFu)) Then 
  Do i2=1,6
    Do i3=1,3
ML1 = MVP 
ML2 = MSu(i2) 
...
! {VZ, conj[Su], bar[Fu]}
If ((Include_in_loopVZ).and.(Include_in_loopSu).and.(Include_in_loopFu)) Then 
  Do i2=1,6
    Do i3=1,3
ML1 = MVZ 
ML2 = MSu(i2) 
...
If ((Include_in_loopCha).and.(Include_in_loopFd).and.(Include_in_loopSd)) Then 
Do i1=1,2
  Do i2=1,3
    Do i3=1,6
ML1 = MCha(i1) 
...
If ((Include_in_loopHpm).and.(Include_in_loopSd).and.(Include_in_loopFd)) Then 
Do i1=1,2
  Do i2=1,6
    Do i3=1,3
ML1 = MHpm(i1) 
...
If ((Include_in_loopVWm).and.(Include_in_loopSd).and.(Include_in_loopFd)) Then 
  Do i2=1,6
    Do i3=1,3
ML1 = MVWm 
ML2 = MSd(i2) 
...
End if 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_SuToFuChi


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SuToFuChi(MAh,MCha,MChi,MFd,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SuToFuChi


Subroutine Amplitude_Tree_seesaw1nmssm_SuTocChaFd(cplcChaFdcSuL,cplcChaFdcSuR,        & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_SuTocChaFd


Subroutine Gamma_Real_seesaw1nmssm_SuTocChaFd(MLambda,em,gs,cplcChaFdcSuL,            & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_SuTocChaFd


Subroutine Amplitude_WAVE_seesaw1nmssm_SuTocChaFd(cplcChaFdcSuL,cplcChaFdcSuR,        & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_SuTocChaFd


Subroutine Amplitude_VERTEX_seesaw1nmssm_SuTocChaFd(MAh,MCha,MChi,MFd,MFu,            & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
! {Ah, conj[Su], Cha}
If ((Include_in_loopAh).and.(Include_in_loopSu).and.(Include_in_loopCha)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,2
ML1 = MAh(i1) 
...
! {Chi, bar[Fu], Hpm}
If ((Include_in_loopChi).and.(Include_in_loopFu).and.(Include_in_loopHpm)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,2
ML1 = MChi(i1) 
...
! {Chi, bar[Fu], VWm}
If ((Include_in_loopChi).and.(Include_in_loopFu).and.(Include_in_loopVWm)) Then 
Do i1=1,5
  Do i2=1,3
ML1 = MChi(i1) 
ML2 = MFu(i2) 
...
! {Fu, Chi, Sd}
If ((Include_in_loopFu).and.(Include_in_loopChi).and.(Include_in_loopSd)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,6
ML1 = MFu(i1) 
...
! {Fu, Glu, Sd}
If ((Include_in_loopFu).and.(Include_in_loopGlu).and.(Include_in_loopSd)) Then 
Do i1=1,3
    Do i3=1,6
ML1 = MFu(i1) 
ML2 = MGlu 
...
! {hh, conj[Su], Cha}
If ((Include_in_loophh).and.(Include_in_loopSu).and.(Include_in_loopCha)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,2
ML1 = Mhh(i1) 
...
! {Su, Ah, Fd}
If ((Include_in_loopSu).and.(Include_in_loopAh).and.(Include_in_loopFd)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,3
ML1 = MSu(i1) 
...
! {Su, hh, Fd}
If ((Include_in_loopSu).and.(Include_in_loophh).and.(Include_in_loopFd)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,3
ML1 = MSu(i1) 
...
! {Su, VG, Fd}
If ((Include_in_loopSu).and.(Include_in_loopVG).and.(Include_in_loopFd)) Then 
Do i1=1,6
    Do i3=1,3
ML1 = MSu(i1) 
ML2 = MVG 
...
! {Su, VP, Fd}
If ((Include_in_loopSu).and.(Include_in_loopVP).and.(Include_in_loopFd)) Then 
Do i1=1,6
    Do i3=1,3
ML1 = MSu(i1) 
ML2 = MVP 
...
! {Su, VZ, Fd}
If ((Include_in_loopSu).and.(Include_in_loopVZ).and.(Include_in_loopFd)) Then 
Do i1=1,6
    Do i3=1,3
ML1 = MSu(i1) 
ML2 = MVZ 
...
! {VP, conj[Su], Cha}
If ((Include_in_loopVP).and.(Include_in_loopSu).and.(Include_in_loopCha)) Then 
  Do i2=1,6
    Do i3=1,2
ML1 = MVP 
ML2 = MSu(i2) 
...
! {VZ, conj[Su], Cha}
If ((Include_in_loopVZ).and.(Include_in_loopSu).and.(Include_in_loopCha)) Then 
  Do i2=1,6
    Do i3=1,2
ML1 = MVZ 
ML2 = MSu(i2) 
...
! {bar[Cha], bar[Fd], Ah}
If ((Include_in_loopCha).and.(Include_in_loopFd).and.(Include_in_loopAh)) Then 
Do i1=1,2
  Do i2=1,3
    Do i3=1,3
ML1 = MCha(i1) 
...
! {bar[Cha], bar[Fd], hh}
If ((Include_in_loopCha).and.(Include_in_loopFd).and.(Include_in_loophh)) Then 
Do i1=1,2
  Do i2=1,3
    Do i3=1,3
ML1 = MCha(i1) 
...
! {bar[Cha], bar[Fd], VP}
If ((Include_in_loopCha).and.(Include_in_loopFd).and.(Include_in_loopVP)) Then 
Do i1=1,2
  Do i2=1,3
ML1 = MCha(i1) 
ML2 = MFd(i2) 
...
! {bar[Cha], bar[Fd], VZ}
If ((Include_in_loopCha).and.(Include_in_loopFd).and.(Include_in_loopVZ)) Then 
Do i1=1,2
  Do i2=1,3
ML1 = MCha(i1) 
ML2 = MFd(i2) 
...
If ((Include_in_loopHpm).and.(Include_in_loopSd).and.(Include_in_loopChi)) Then 
Do i1=1,2
  Do i2=1,6
    Do i3=1,5
ML1 = MHpm(i1) 
...
If ((Include_in_loopVWm).and.(Include_in_loopSd).and.(Include_in_loopChi)) Then 
  Do i2=1,6
    Do i3=1,5
ML1 = MVWm 
ML2 = MSd(i2) 
...
End if 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_SuTocChaFd


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SuTocChaFd(MAh,MCha,MChi,MFd,             & 
& MFu,MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,           & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcChaChaAhL,cplcChaChaAhR,cplcFdFdAhL,     & 
& cplcFdFdAhR,cplAhSucSu,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,        & 
& cplcChaChaVZL,cplcChaChaVZR,cplChiFdcSdL,cplChiFdcSdR,cplChiFucSuL,cplChiFucSuR,       & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SuTocChaFd


Subroutine Amplitude_Tree_seesaw1nmssm_SuToGluFu(cplGluFucSuL,cplGluFucSuR,           & 
...
Amp(:,gt1, gt3) = AmpC 
    End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_SuToGluFu


Subroutine Gamma_Real_seesaw1nmssm_SuToGluFu(MLambda,em,gs,cplGluFucSuL,              & 
...
End if 
    End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_SuToGluFu


Subroutine Amplitude_WAVE_seesaw1nmssm_SuToGluFu(cplGluFucSuL,cplGluFucSuR,           & 
...
Amp(:,gt1, gt3) = AmpC 
    End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_SuToGluFu


Subroutine Amplitude_VERTEX_seesaw1nmssm_SuToGluFu(MAh,MCha,MChi,MFd,MFu,             & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
! {Fd, Cha, Sd}
If ((Include_in_loopFd).and.(Include_in_loopCha).and.(Include_in_loopSd)) Then 
Do i1=1,3
  Do i2=1,2
    Do i3=1,6
ML1 = MFd(i1) 
...
! {Fu, Chi, Su}
If ((Include_in_loopFu).and.(Include_in_loopChi).and.(Include_in_loopSu)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,6
ML1 = MFu(i1) 
...
! {Fu, Glu, Su}
If ((Include_in_loopFu).and.(Include_in_loopGlu).and.(Include_in_loopSu)) Then 
Do i1=1,3
    Do i3=1,6
ML1 = MFu(i1) 
ML2 = MGlu 
...
! {Glu, bar[Fu], VG}
If ((Include_in_loopGlu).and.(Include_in_loopFu).and.(Include_in_loopVG)) Then 
  Do i2=1,3
ML1 = MGlu 
ML2 = MFu(i2) 
ML3 = MVG 
...
! {Sd, Hpm, Fd}
If ((Include_in_loopSd).and.(Include_in_loopHpm).and.(Include_in_loopFd)) Then 
Do i1=1,6
  Do i2=1,2
    Do i3=1,3
ML1 = MSd(i1) 
...
! {Sd, VWm, Fd}
If ((Include_in_loopSd).and.(Include_in_loopVWm).and.(Include_in_loopFd)) Then 
Do i1=1,6
    Do i3=1,3
ML1 = MSd(i1) 
ML2 = MVWm 
...
! {Su, Ah, Fu}
If ((Include_in_loopSu).and.(Include_in_loopAh).and.(Include_in_loopFu)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,3
ML1 = MSu(i1) 
...
! {Su, hh, Fu}
If ((Include_in_loopSu).and.(Include_in_loophh).and.(Include_in_loopFu)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,3
ML1 = MSu(i1) 
...
! {Su, VG, Fu}
If ((Include_in_loopSu).and.(Include_in_loopVG).and.(Include_in_loopFu)) Then 
Do i1=1,6
    Do i3=1,3
ML1 = MSu(i1) 
ML2 = MVG 
...
! {Su, VP, Fu}
If ((Include_in_loopSu).and.(Include_in_loopVP).and.(Include_in_loopFu)) Then 
Do i1=1,6
    Do i3=1,3
ML1 = MSu(i1) 
ML2 = MVP 
...
! {Su, VZ, Fu}
If ((Include_in_loopSu).and.(Include_in_loopVZ).and.(Include_in_loopFu)) Then 
Do i1=1,6
    Do i3=1,3
ML1 = MSu(i1) 
ML2 = MVZ 
...
! {VG, conj[Su], Glu}
If ((Include_in_loopVG).and.(Include_in_loopSu).and.(Include_in_loopGlu)) Then 
  Do i2=1,6
ML1 = MVG 
ML2 = MSu(i2) 
ML3 = MGlu 
...
End if 
    End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_SuToGluFu


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SuToGluFu(MAh,MCha,MChi,MFd,              & 
& MFu,MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,           & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,cplAhSucSu,          & 
& cplChaFucSdL,cplChaFucSdR,cplChiFucSuL,cplChiFucSuR,cplGluFdcSdL,cplGluFdcSdR,         & 
& cplcChaFdcSuL,cplcChaFdcSuR,cplGluFucSuL,cplGluFucSuR,cplcFuFuhhL,cplcFuFuhhR,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SuToGluFu


Subroutine Amplitude_Tree_seesaw1nmssm_SuToSuhh(cplhhSucSu,Mhh,MSu,Mhh2,MSu2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_SuToSuhh


Subroutine Gamma_Real_seesaw1nmssm_SuToSuhh(MLambda,em,gs,cplhhSucSu,Mhh,             & 
& MSu,GammarealPhoton,GammarealGluon)
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_SuToSuhh


Subroutine Amplitude_WAVE_seesaw1nmssm_SuToSuhh(cplhhSucSu,ctcplhhSucSu,              & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_SuToSuhh


Subroutine Amplitude_VERTEX_seesaw1nmssm_SuToSuhh(MAh,MCha,MChi,MFd,MFu,              & 
& MGlu,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,               & 
& MFd2,MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,               & 
...
! {Sd, VWm, VWm}
If ((Include_in_loopSd).and.(Include_in_loopVWm).and.(Include_in_loopVWm)) Then 
Do i1=1,6
ML1 = MSd(i1) 
ML2 = MVWm 
ML3 = MVWm 
...
! {Su, VZ, Ah}
If ((Include_in_loopSu).and.(Include_in_loopVZ).and.(Include_in_loopAh)) Then 
Do i1=1,6
    Do i3=1,3
ML1 = MSu(i1) 
ML2 = MVZ 
...
! {Su, Ah, VZ}
If ((Include_in_loopSu).and.(Include_in_loopAh).and.(Include_in_loopVZ)) Then 
Do i1=1,6
  Do i2=1,3
ML1 = MSu(i1) 
ML2 = MAh(i2) 
...
! {Su, VZ, VZ}
If ((Include_in_loopSu).and.(Include_in_loopVZ).and.(Include_in_loopVZ)) Then 
Do i1=1,6
ML1 = MSu(i1) 
ML2 = MVZ 
ML3 = MVZ 
...
End if 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_SuToSuhh


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SuToSuhh(MAh,MCha,MChi,MFd,               & 
& MFu,MGlu,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,           & 
& MFd2,MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,               & 
& MVZ2,cplAhAhhh,cplAhhhhh,cplAhhhVZ,cplAhSucSu,cplcChaChahhL,cplcChaChahhR,             & 
& cplcFdChaSuL,cplcFdChaSuR,cplChiChihhL,cplChiChihhR,cplChiFucSuL,cplChiFucSuR,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SuToSuhh


Subroutine Amplitude_Tree_seesaw1nmssm_SuTocHpmSd(cplSdcHpmcSu,MHpm,MSd,              & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_SuTocHpmSd


Subroutine Gamma_Real_seesaw1nmssm_SuTocHpmSd(MLambda,em,gs,cplSdcHpmcSu,             & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_SuTocHpmSd


Subroutine Amplitude_WAVE_seesaw1nmssm_SuTocHpmSd(cplSdcHpmcSu,ctcplSdcHpmcSu,        & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_SuTocHpmSd


Subroutine Amplitude_VERTEX_seesaw1nmssm_SuTocHpmSd(MAh,MCha,MChi,MFd,MFu,            & 
& MGlu,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,               & 
& MFd2,MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,               & 
...
! {Ah, conj[Su], Hpm}
If ((Include_in_loopAh).and.(Include_in_loopSu).and.(Include_in_loopHpm)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,2
ML1 = MAh(i1) 
...
! {Ah, conj[Su], VWm}
If ((Include_in_loopAh).and.(Include_in_loopSu).and.(Include_in_loopVWm)) Then 
Do i1=1,3
  Do i2=1,6
ML1 = MAh(i1) 
ML2 = MSu(i2) 
...
! {Chi, bar[Fu], Cha}
If ((Include_in_loopChi).and.(Include_in_loopFu).and.(Include_in_loopCha)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,2
ML1 = MChi(i1) 
...
! {Fu, Chi, Fd}
If ((Include_in_loopFu).and.(Include_in_loopChi).and.(Include_in_loopFd)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,3
ML1 = MFu(i1) 
...
! {Fu, Glu, Fd}
If ((Include_in_loopFu).and.(Include_in_loopGlu).and.(Include_in_loopFd)) Then 
Do i1=1,3
    Do i3=1,3
ML1 = MFu(i1) 
ML2 = MGlu 
...
! {hh, conj[Su], Hpm}
If ((Include_in_loophh).and.(Include_in_loopSu).and.(Include_in_loopHpm)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,2
ML1 = Mhh(i1) 
...
! {hh, conj[Su], VWm}
If ((Include_in_loophh).and.(Include_in_loopSu).and.(Include_in_loopVWm)) Then 
Do i1=1,3
  Do i2=1,6
ML1 = Mhh(i1) 
ML2 = MSu(i2) 
...
! {Su, Ah, Sd}
If ((Include_in_loopSu).and.(Include_in_loopAh).and.(Include_in_loopSd)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,6
ML1 = MSu(i1) 
...
! {Su, hh, Sd}
If ((Include_in_loopSu).and.(Include_in_loophh).and.(Include_in_loopSd)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,6
ML1 = MSu(i1) 
...
! {Su, VG, Sd}
If ((Include_in_loopSu).and.(Include_in_loopVG).and.(Include_in_loopSd)) Then 
Do i1=1,6
    Do i3=1,6
ML1 = MSu(i1) 
ML2 = MVG 
...
! {Su, VP, Sd}
If ((Include_in_loopSu).and.(Include_in_loopVP).and.(Include_in_loopSd)) Then 
Do i1=1,6
    Do i3=1,6
ML1 = MSu(i1) 
ML2 = MVP 
...
! {Su, VZ, Sd}
If ((Include_in_loopSu).and.(Include_in_loopVZ).and.(Include_in_loopSd)) Then 
Do i1=1,6
    Do i3=1,6
ML1 = MSu(i1) 
ML2 = MVZ 
...
! {VP, conj[Su], Hpm}
If ((Include_in_loopVP).and.(Include_in_loopSu).and.(Include_in_loopHpm)) Then 
  Do i2=1,6
    Do i3=1,2
ML1 = MVP 
ML2 = MSu(i2) 
...
! {VP, conj[Su], VWm}
If ((Include_in_loopVP).and.(Include_in_loopSu).and.(Include_in_loopVWm)) Then 
  Do i2=1,6
ML1 = MVP 
ML2 = MSu(i2) 
ML3 = MVWm 
...
! {VZ, conj[Su], Hpm}
If ((Include_in_loopVZ).and.(Include_in_loopSu).and.(Include_in_loopHpm)) Then 
  Do i2=1,6
    Do i3=1,2
ML1 = MVZ 
ML2 = MSu(i2) 
...
! {VZ, conj[Su], VWm}
If ((Include_in_loopVZ).and.(Include_in_loopSu).and.(Include_in_loopVWm)) Then 
  Do i2=1,6
ML1 = MVZ 
ML2 = MSu(i2) 
ML3 = MVWm 
...
! {bar[Cha], bar[Fd], Chi}
If ((Include_in_loopCha).and.(Include_in_loopFd).and.(Include_in_loopChi)) Then 
Do i1=1,2
  Do i2=1,3
    Do i3=1,5
ML1 = MCha(i1) 
...
! {conj[Hpm], conj[Sd], Ah}
If ((Include_in_loopHpm).and.(Include_in_loopSd).and.(Include_in_loopAh)) Then 
Do i1=1,2
  Do i2=1,6
    Do i3=1,3
ML1 = MHpm(i1) 
...
! {conj[Hpm], conj[Sd], hh}
If ((Include_in_loopHpm).and.(Include_in_loopSd).and.(Include_in_loophh)) Then 
Do i1=1,2
  Do i2=1,6
    Do i3=1,3
ML1 = MHpm(i1) 
...
! {conj[Hpm], conj[Sd], VP}
If ((Include_in_loopHpm).and.(Include_in_loopSd).and.(Include_in_loopVP)) Then 
Do i1=1,2
  Do i2=1,6
ML1 = MHpm(i1) 
ML2 = MSd(i2) 
...
! {conj[Hpm], conj[Sd], VZ}
If ((Include_in_loopHpm).and.(Include_in_loopSd).and.(Include_in_loopVZ)) Then 
Do i1=1,2
  Do i2=1,6
ML1 = MHpm(i1) 
ML2 = MSd(i2) 
...
! {conj[VWm], conj[Sd], Ah}
If ((Include_in_loopVWm).and.(Include_in_loopSd).and.(Include_in_loopAh)) Then 
  Do i2=1,6
    Do i3=1,3
ML1 = MVWm 
ML2 = MSd(i2) 
...
! {conj[VWm], conj[Sd], hh}
If ((Include_in_loopVWm).and.(Include_in_loopSd).and.(Include_in_loophh)) Then 
  Do i2=1,6
    Do i3=1,3
ML1 = MVWm 
ML2 = MSd(i2) 
...
! {conj[VWm], conj[Sd], VP}
If ((Include_in_loopVWm).and.(Include_in_loopSd).and.(Include_in_loopVP)) Then 
  Do i2=1,6
ML1 = MVWm 
ML2 = MSd(i2) 
ML3 = MVP 
...
! {conj[VWm], conj[Sd], VZ}
If ((Include_in_loopVWm).and.(Include_in_loopSd).and.(Include_in_loopVZ)) Then 
  Do i2=1,6
ML1 = MVWm 
ML2 = MSd(i2) 
ML3 = MVZ 
...
End if 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_SuTocHpmSd


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SuTocHpmSd(MAh,MCha,MChi,MFd,             & 
& MFu,MGlu,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,           & 
& MFd2,MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,               & 
& MVZ2,cplAhHpmcHpm,cplAhSdcSd,cplAhSucSu,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,    & 
& cplChiFucSuL,cplChiFucSuR,cplcFdChiSdL,cplcFdChiSdR,cplcChaFdcSuL,cplcChaFdcSuR,       & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SuTocHpmSd


Subroutine Amplitude_Tree_seesaw1nmssm_SuToSdcVWm(cplSdcSucVWm,MSd,MSu,               & 
& MVWm,MSd2,MSu2,MVWm2,Amp)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_SuToSdcVWm


Subroutine Gamma_Real_seesaw1nmssm_SuToSdcVWm(MLambda,em,gs,cplSdcSucVWm,             & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_SuToSdcVWm


Subroutine Amplitude_WAVE_seesaw1nmssm_SuToSdcVWm(cplSdcSucVWm,ctcplSdcSucVWm,        & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_SuToSdcVWm


Subroutine Amplitude_VERTEX_seesaw1nmssm_SuToSdcVWm(MAh,MCha,MChi,MFd,MFu,            & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
! {Ah, conj[Su], conj[Sd]}
If ((Include_in_loopAh).and.(Include_in_loopSu).and.(Include_in_loopSd)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,6
ML1 = MAh(i1) 
...
! {Chi, bar[Fu], bar[Fd]}
If ((Include_in_loopChi).and.(Include_in_loopFu).and.(Include_in_loopFd)) Then 
Do i1=1,5
  Do i2=1,3
    Do i3=1,3
ML1 = MChi(i1) 
...
! {Fd, Cha, Chi}
If ((Include_in_loopFd).and.(Include_in_loopCha).and.(Include_in_loopChi)) Then 
Do i1=1,3
  Do i2=1,2
    Do i3=1,5
ML1 = MFd(i1) 
...
! {Fu, Chi, bar[Cha]}
If ((Include_in_loopFu).and.(Include_in_loopChi).and.(Include_in_loopCha)) Then 
Do i1=1,3
  Do i2=1,5
    Do i3=1,2
ML1 = MFu(i1) 
...
! {Glu, bar[Fu], bar[Fd]}
If ((Include_in_loopGlu).and.(Include_in_loopFu).and.(Include_in_loopFd)) Then 
  Do i2=1,3
    Do i3=1,3
ML1 = MGlu 
ML2 = MFu(i2) 
...
! {hh, conj[Su], conj[Sd]}
If ((Include_in_loophh).and.(Include_in_loopSu).and.(Include_in_loopSd)) Then 
Do i1=1,3
  Do i2=1,6
    Do i3=1,6
ML1 = Mhh(i1) 
...
! {Sd, Hpm, Ah}
If ((Include_in_loopSd).and.(Include_in_loopHpm).and.(Include_in_loopAh)) Then 
Do i1=1,6
  Do i2=1,2
    Do i3=1,3
ML1 = MSd(i1) 
...
! {Sd, Hpm, hh}
If ((Include_in_loopSd).and.(Include_in_loopHpm).and.(Include_in_loophh)) Then 
Do i1=1,6
  Do i2=1,2
    Do i3=1,3
ML1 = MSd(i1) 
...
! {Sd, VWm, hh}
If ((Include_in_loopSd).and.(Include_in_loopVWm).and.(Include_in_loophh)) Then 
Do i1=1,6
    Do i3=1,3
ML1 = MSd(i1) 
ML2 = MVWm 
...
! {Sd, Hpm, VP}
If ((Include_in_loopSd).and.(Include_in_loopHpm).and.(Include_in_loopVP)) Then 
Do i1=1,6
  Do i2=1,2
ML1 = MSd(i1) 
ML2 = MHpm(i2) 
...
! {Sd, VWm, VP}
If ((Include_in_loopSd).and.(Include_in_loopVWm).and.(Include_in_loopVP)) Then 
Do i1=1,6
ML1 = MSd(i1) 
ML2 = MVWm 
ML3 = MVP 
...
! {Sd, Hpm, VZ}
If ((Include_in_loopSd).and.(Include_in_loopHpm).and.(Include_in_loopVZ)) Then 
Do i1=1,6
  Do i2=1,2
ML1 = MSd(i1) 
ML2 = MHpm(i2) 
...
! {Sd, VWm, VZ}
If ((Include_in_loopSd).and.(Include_in_loopVWm).and.(Include_in_loopVZ)) Then 
Do i1=1,6
ML1 = MSd(i1) 
ML2 = MVWm 
ML3 = MVZ 
...
! {Su, Ah, conj[Hpm]}
If ((Include_in_loopSu).and.(Include_in_loopAh).and.(Include_in_loopHpm)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,2
ML1 = MSu(i1) 
...
! {Su, hh, conj[Hpm]}
If ((Include_in_loopSu).and.(Include_in_loophh).and.(Include_in_loopHpm)) Then 
Do i1=1,6
  Do i2=1,3
    Do i3=1,2
ML1 = MSu(i1) 
...
! {Su, VP, conj[Hpm]}
If ((Include_in_loopSu).and.(Include_in_loopVP).and.(Include_in_loopHpm)) Then 
Do i1=1,6
    Do i3=1,2
ML1 = MSu(i1) 
ML2 = MVP 
...
! {Su, VZ, conj[Hpm]}
If ((Include_in_loopSu).and.(Include_in_loopVZ).and.(Include_in_loopHpm)) Then 
Do i1=1,6
    Do i3=1,2
ML1 = MSu(i1) 
ML2 = MVZ 
...
! {Su, hh, conj[VWm]}
If ((Include_in_loopSu).and.(Include_in_loophh).and.(Include_in_loopVWm)) Then 
Do i1=1,6
  Do i2=1,3
ML1 = MSu(i1) 
ML2 = Mhh(i2) 
...
! {Su, VP, conj[VWm]}
If ((Include_in_loopSu).and.(Include_in_loopVP).and.(Include_in_loopVWm)) Then 
Do i1=1,6
ML1 = MSu(i1) 
ML2 = MVP 
ML3 = MVWm 
...
! {Su, VZ, conj[VWm]}
If ((Include_in_loopSu).and.(Include_in_loopVZ).and.(Include_in_loopVWm)) Then 
Do i1=1,6
ML1 = MSu(i1) 
ML2 = MVZ 
ML3 = MVWm 
...
! {VG, conj[Su], conj[Sd]}
If ((Include_in_loopVG).and.(Include_in_loopSu).and.(Include_in_loopSd)) Then 
  Do i2=1,6
    Do i3=1,6
ML1 = MVG 
ML2 = MSu(i2) 
...
! {VP, conj[Su], conj[Sd]}
If ((Include_in_loopVP).and.(Include_in_loopSu).and.(Include_in_loopSd)) Then 
  Do i2=1,6
    Do i3=1,6
ML1 = MVP 
ML2 = MSu(i2) 
...
! {VZ, conj[Su], conj[Sd]}
If ((Include_in_loopVZ).and.(Include_in_loopSu).and.(Include_in_loopSd)) Then 
  Do i2=1,6
    Do i3=1,6
ML1 = MVZ 
ML2 = MSu(i2) 
...
! {Sd, VWm}
If ((Include_in_loopSd).and.(Include_in_loopVWm)) Then 
Do i1=1,6
ML1 = MSd(i1) 
ML2 = MVWm 
coup1 = -cplSdcSucVWm(i1,gt1)
...
! {Su, VG}
If ((Include_in_loopSu).and.(Include_in_loopVG)) Then 
Do i1=1,6
ML1 = MSu(i1) 
ML2 = MVG 
coup1 = -cplSucSuVG(i1,gt1)
...
! {Su, VP}
If ((Include_in_loopSu).and.(Include_in_loopVP)) Then 
Do i1=1,6
ML1 = MSu(i1) 
ML2 = MVP 
coup1 = -cplSucSuVP(i1,gt1)
...
! {Su, VZ}
If ((Include_in_loopSu).and.(Include_in_loopVZ)) Then 
Do i1=1,6
ML1 = MSu(i1) 
ML2 = MVZ 
coup1 = -cplSucSuVZ(i1,gt1)
...
! {Sd, VG}
If ((Include_in_loopSd).and.(Include_in_loopVG)) Then 
Do i1=1,6
ML1 = MSd(i1) 
ML2 = MVG 
...
! {Sd, VP}
If ((Include_in_loopSd).and.(Include_in_loopVP)) Then 
Do i1=1,6
ML1 = MSd(i1) 
ML2 = MVP 
...
! {Sd, VZ}
If ((Include_in_loopSd).and.(Include_in_loopVZ)) Then 
Do i1=1,6
ML1 = MSd(i1) 
ML2 = MVZ 
...
! {Su, conj[VWm]}
If ((Include_in_loopSu).and.(Include_in_loopVWm)) Then 
Do i1=1,6
ML1 = MSu(i1) 
ML2 = MVWm 
...
End if 
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_SuToSdcVWm


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SuToSdcVWm(MAh,MCha,MChi,MFd,             & 
& MFu,MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,           & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhHpmcVWm,cplAhSdcSd,cplAhSucSu,          & 
& cplChiChacVWmL,cplChiChacVWmR,cplChiFucSuL,cplChiFucSuR,cplcFdChiSdL,cplcFdChiSdR,     & 
& cplcChaFdcSuL,cplcChaFdcSuR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplGluFucSuL,cplGluFucSuR,     & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SuToSdcVWm


Subroutine Amplitude_Tree_seesaw1nmssm_SuToSuVZ(cplSucSuVZ,MSu,MVZ,MSu2,MVZ2,Amp)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_seesaw1nmssm_SuToSuVZ


Subroutine Gamma_Real_seesaw1nmssm_SuToSuVZ(MLambda,em,gs,cplSucSuVZ,MSu,             & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_seesaw1nmssm_SuToSuVZ


Subroutine Amplitude_WAVE_seesaw1nmssm_SuToSuVZ(cplSucSuVP,cplSucSuVZ,ctcplSucSuVP,   & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_SuToSuVZ


Subroutine Amplitude_VERTEX_seesaw1nmssm_SuToSuVZ(MAh,MCha,MChi,MFd,MFu,              & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
End if 
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_SuToSuVZ


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SuToSuVZ(MAh,MCha,MChi,MFd,               & 
& MFu,MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,           & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhhhVZ,cplAhSucSu,cplcFdChaSuL,           & 
& cplcFdChaSuR,cplcChaChaVZL,cplcChaChaVZR,cplChiChiVZL,cplChiChiVZR,cplChiFucSuL,       & 
& cplChiFucSuR,cplcFuChiSuL,cplcFuChiSuR,cplcFdFdVZL,cplcFdFdVZR,cplcChaFdcSuL,          & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SuToSuVZ


Subroutine Amplitude_WAVE_seesaw1nmssm_SuToSuVG(cplSucSuVG,ctcplSucSuVG,              & 
& MSu,MSu2,MVG,MVG2,ZfSu,ZfVG,Amp)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_SuToSuVG


Subroutine Amplitude_VERTEX_seesaw1nmssm_SuToSuVG(MAh,MCha,MChi,MFd,MFu,              & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
! {Fu, Glu, Glu}
If ((Include_in_loopFu).and.(Include_in_loopGlu).and.(Include_in_loopGlu)) Then 
Do i1=1,3
ML1 = MFu(i1) 
ML2 = MGlu 
ML3 = MGlu 
...
! {Su, VG, VG}
If ((Include_in_loopSu).and.(Include_in_loopVG).and.(Include_in_loopVG)) Then 
Do i1=1,6
ML1 = MSu(i1) 
ML2 = MVG 
ML3 = MVG 
...
End if 
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_SuToSuVG


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SuToSuVG(MAh,MCha,MChi,MFd,               & 
& MFu,MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,           & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhSucSu,cplcFdChaSuL,cplcFdChaSuR,        & 
& cplChiFucSuL,cplChiFucSuR,cplcFuChiSuL,cplcFuChiSuR,cplcFdFdVGL,cplcFdFdVGR,           & 
& cplcChaFdcSuL,cplcChaFdcSuR,cplGluFucSuL,cplGluFucSuR,cplcFuFuVGL,cplcFuFuVGR,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SuToSuVG


Subroutine Amplitude_WAVE_seesaw1nmssm_SuToSuVP(cplSucSuVP,cplSucSuVZ,ctcplSucSuVP,   & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_seesaw1nmssm_SuToSuVP


Subroutine Amplitude_VERTEX_seesaw1nmssm_SuToSuVP(MAh,MCha,MChi,MFd,MFu,              & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhSucSu,cplcFdChaSuL,cplcFdChaSuR,        & 
...
End if 
  End Do
End Do
End Subroutine Amplitude_VERTEX_seesaw1nmssm_SuToSuVP


Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SuToSuVP(MAh,MCha,MChi,MFd,               & 
& MFu,MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,           & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhSucSu,cplcFdChaSuL,cplcFdChaSuR,        & 
& cplcChaChaVPL,cplcChaChaVPR,cplChiFucSuL,cplChiFucSuR,cplcFuChiSuL,cplcFuChiSuR,       & 
& cplcFdFdVPL,cplcFdFdVPR,cplcChaFdcSuL,cplcChaFdcSuR,cplGluFucSuL,cplGluFucSuR,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_seesaw1nmssm_SuToSuVP



End Module OneLoopDecay_Su_seesaw1nmssm
