...
Module Model_Data_seesaw1nmssm 
...
Complex(dp) :: ZVIOS_0(6, 6)
Complex(dp) :: ZVIOS_p2(6, 6)
Complex(dp) :: ZVROS_0(6, 6)
Complex(dp) :: ZVROS_p2(6, 6)
...
Real(dp) :: ms21L 
Real(dp) :: ms22L 
Real(dp) :: mass_uncertainty_Q(61), mass_uncertainty_Yt(61), g_SM_save(62) 
...
Complex(dp) :: YdIN(3,3),YeIN(3,3),lamIN,kapIN,lamNIN(3,3),YuIN(3,3),YvIN(3,3),TdIN(3,3),            & 
& TeIN(3,3),TlamIN,TkIN,TLNIN(3,3),TuIN(3,3),TvIN(3,3),mq2IN(3,3),ml2IN(3,3),            & 
& md2IN(3,3),mu2IN(3,3),me2IN(3,3),mv2IN(3,3),M1IN,M2IN,M3IN

Real(dp) :: g1MZ,g2MZ,g3MZ,mHd2MZ,mHu2MZ,ms2MZ

Complex(dp) :: YdMZ(3,3),YeMZ(3,3),lamMZ,kapMZ,lamNMZ(3,3),YuMZ(3,3),YvMZ(3,3),TdMZ(3,3),            & 
& TeMZ(3,3),TlamMZ,TkMZ,TLNMZ(3,3),TuMZ(3,3),TvMZ(3,3),mq2MZ(3,3),ml2MZ(3,3),            & 
& md2MZ(3,3),mu2MZ(3,3),me2MZ(3,3),mv2MZ(3,3),M1MZ,M2MZ,M3MZ
...
& TdGUT(3,3),TeGUT(3,3),TlamGUT,TkGUT,TLNGUT(3,3),TuGUT(3,3),TvGUT(3,3),mq2GUT(3,3),     & 
& ml2GUT(3,3),md2GUT(3,3),mu2GUT(3,3),me2GUT(3,3),mv2GUT(3,3),M1GUT,M2GUT,M3GUT
...
Real(dp) :: gPSvRe(6,2052),gTSvRe(6),BRSvRe(6,2052),gPSvIm(6,2052),gTSvIm(6),BRSvIm(6,2052),      & 
...
Real(dp) :: gP1LSvRe(6,132),gT1LSvRe(6),BR1LSvRe(6,132),gP1LSvIm(6,132),gT1LSvIm(6),              & 
& BR1LSvIm(6,132),gP1LHpm(2,159),gT1LHpm(2),BR1LHpm(2,159),gP1Lhh(3,290),gT1Lhh(3),      & 
& BR1Lhh(3,290),gP1LAh(3,288),gT1LAh(3),BR1LAh(3,288),gP1LSu(6,84),gT1LSu(6),            & 
& BR1LSu(6,84),gP1LSd(6,84),gT1LSd(6),BR1LSd(6,84),gP1LSe(6,93),gT1LSe(6),               & 
& BR1LSe(6,93),gP1LGlu(1,49),gT1LGlu,BR1LGlu(1,49),gP1LCha(2,132),gT1LCha(2),            & 
& BR1LCha(2,132),gP1LChi(5,166),gT1LChi(5),BR1LChi(5,166),gP1LFv(6,120),gT1LFv(6),       & 
& BR1LFv(6,120)
...
Logical :: Include_in_loopGlu = .true. 
Logical :: Include_in_loopChi = .true. 
Logical :: Include_in_loopFv = .true. 
Logical :: Include_in_loopCha = .true. 
Logical :: Include_in_loopFe = .true. 
Logical :: Include_in_loopFd = .true. 
Logical :: Include_in_loopFu = .true. 
Logical :: Include_in_loopSd = .true. 
Logical :: Include_in_loopSvIm = .true. 
Logical :: Include_in_loopSvRe = .true. 
Logical :: Include_in_loopSu = .true. 
Logical :: Include_in_loopSe = .true. 
Logical :: Include_in_loophh = .true. 
Logical :: Include_in_loopAh = .true. 
Logical :: Include_in_loopHpm = .true. 
Logical :: Include_in_loopVG = .true. 
Logical :: Include_in_loopVP = .true. 
Logical :: Include_in_loopVZ = .true. 
Logical :: Include_in_loopVWm = .true. 
Logical :: Include_in_loopgG = .true. 
Logical :: Include_in_loopgA = .true. 
Logical :: Include_in_loopgZ = .true. 
Logical :: Include_in_loopgWm = .true. 
Logical :: Include_in_loopgWpC = .true. 
...
ratioPPP =  0._dp  
TanBeta= 0._dp 
MuEffinput=(0._dp,0._dp)
End Subroutine Set_All_Parameters_0 
 


Subroutine SetMatchingConditions(g1SM,g2SM,g3SM,YuSM,YdSM,YeSM,vSM,vd,vu,             & 
& vS,g1,g2,g3,Yd,Ye,lam,kap,lamN,Yu,Yv,Td,Te,Tlam,Tk,TLN,Tu,Tv,mq2,ml2,mHd2,             & 
& mHu2,md2,mu2,me2,mv2,ms2,M1,M2,M3,MZsuffix)
...
End Module Model_Data_seesaw1nmssm