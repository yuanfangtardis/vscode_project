...
Program SPhenoNInvSeesaw 
 
Use Control
Use InputOutput_NInvSeesaw
Use LoopFunctions
Use Settings
Use RunSM_NInvSeesaw
Use LowEnergy_NInvSeesaw
Use FlavorKit_LFV_NInvSeesaw
Use FlavorKit_QFV_NInvSeesaw
Use FlavorKit_Observables_NInvSeesaw
Use Mathematics
Use Model_Data_NInvSeesaw
Use Tadpoles_NInvSeesaw 
 !Use StandardModel
Use Boundaries_NInvSeesaw
 Use HiggsCS_NInvSeesaw
Use TreeLevelMasses_NInvSeesaw
Use LoopMasses_NInvSeesaw
 
Use BranchingRatios_NInvSeesaw
...
& g2,g3,Yd,Ye,lam,kap,lamN,Yu,Yv,MUX,Td,Te,Tlam,Tk,TLN,Tu,Tv,BMUX,mq2,ml2,               & 
& mHd2,mHu2,md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,.False.)
...
& ZW,ZZ,betaH,vd,vu,vS,g1,g2,g3,Yd,Ye,lam,kap,lamN,Yu,Yv,MUX,Td,Te,Tlam,Tk,              & 
& TLN,Tu,Tv,BMUX,mq2,ml2,mHd2,mHu2,md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,mGUT)
...
& MVZ2,pG,TW,UM,UP,UV,v,ZA,ZD,ZDL,ZDR,ZE,ZEL,ZER,ZH,ZN,ZP,ZU,ZUL,ZUR,ZVI,ZVR,            & 
& ZW,ZZ,betaH,vd,vu,vS,g1,g2,g3,Yd,Ye,lam,kap,lamN,Yu,Yv,MUX,Td,Te,Tlam,Tk,              & 
& TLN,Tu,Tv,BMUX,mq2,ml2,mHd2,mHu2,md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,gPhh,gThh,           & 
...
Call CalculateLowEnergyConstraints(g1,g2,g3,Yd,Ye,lam,kap,lamN,Yu,Yv,MUX,             & 
& Td,Te,Tlam,Tk,TLN,Tu,Tv,BMUX,mq2,ml2,mHd2,mHu2,md2,mu2,me2,mv2,ms2,mx2,M1,             & 
& M2,M3,vd,vu,vS,ae,amu,atau,EDMe,EDMmu,EDMtau,dRho,BrBsGamma,ratioBsGamma,              & 
...
& me2,mv2,ms2,mx2,M1,M2,M3,mGut,kont,WriteOut,n_run)
...
& Yeinput,laminput,kapinput,lamNinput,Yuinput,Yvinput,MUXinput,Tdinput,Teinput,          & 
& Tlaminput,Tkinput,TLNinput,Tuinput,Tvinput,BMUXinput,mq2input,ml2input,mHd2input,      & 
& mHu2input,md2input,mu2input,me2input,mv2input,ms2input,mx2input,M1input,               & 
& M2input,M3input,vdinput,vuinput,vSinput,ae,amu,atau,EDMe,EDMmu,EDMtau,dRho,            & 
& BrBsGamma,ratioBsGamma,BrDmunu,ratioDmunu,BrDsmunu,ratioDsmunu,BrDstaunu,              & 
& ratioDstaunu,BrBmunu,ratioBmunu,BrBtaunu,ratioBtaunu,BrKmunu,ratioKmunu,               & 
& RK,RKSM,muEgamma,tauEgamma,tauMuGamma,CRmuEAl,CRmuETi,CRmuESr,CRmuESb,CRmuEAu,         & 
& CRmuEPb,BRmuTo3e,BRtauTo3e,BRtauTo3mu,BRtauToemumu,BRtauTomuee,BRtauToemumu2,          & 
...
& cplcFuGluSuR(3,6),cplcgAgWmcVWm,cplcgWmgWmVZ,cplcgWpCgAcVWm,cplcgWpCgWpCVZ,            & 
& cplcgWpCgZcVWm,cplcgZgWmcVWm,cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),cplChiChacHpmL(5,2,2),& 
...
& cplcVWmVWmVZVZ3,cplFvChacSeL(9,2,6),cplFvChacSeR(9,2,6),cplFvFecHpmL(9,3,2),           & 
...
& cplGluGluVGL,cplGluGluVGR,cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),cplhhhhcVWmVWm(3,3)

Complex(dp) :: cplhhhhhh(3,3,3),cplhhhhVZVZ(3,3),cplhhHpmcHpm(3,2,2),cplhhHpmcVWm(3,2),               & 
& cplhhSdcSd(3,6,6),cplhhSecSe(3,6,6),cplhhSucSu(3,6,6),cplhhSvImSvIm(3,9,9),            & 
& cplhhSvImSvRe(3,9,9),cplhhSvReSvRe(3,9,9),cplhhVZVZ(3),cplHpmcHpmcVWmVWm(2,2),         & 
& cplHpmcHpmVP(2,2),cplHpmcHpmVPVZ(2,2),cplHpmcHpmVZ(2,2),cplHpmcHpmVZVZ(2,2),           & 
& cplHpmcVWmVP(2),cplHpmcVWmVZ(2),cplHpmSucSd(2,6,6),cplHpmSvImcSe(2,9,6),               & 
& cplHpmSvRecSe(2,9,6),cplSdcHpmcSu(6,2,6),cplSdcSdcVWmVWm(6,6),cplSdcSdVG(6,6),         & 
& cplSdcSdVP(6,6),cplSdcSdVPVZ(6,6),cplSdcSdVZ(6,6),cplSdcSdVZVZ(6,6),cplSdcSucVWm(6,6), & 
& cplSecSecVWmVWm(6,6),cplSecSeVP(6,6),cplSecSeVPVZ(6,6),cplSecSeVZ(6,6),cplSecSeVZVZ(6,6),& 
& cplSeSvImcHpm(6,9,2),cplSeSvImcVWm(6,9),cplSeSvRecHpm(6,9,2),cplSeSvRecVWm(6,9),       & 
& cplSucSdVWm(6,6),cplSucSucVWmVWm(6,6),cplSucSuVG(6,6),cplSucSuVP(6,6),cplSucSuVPVZ(6,6),& 
& cplSucSuVZ(6,6),cplSucSuVZVZ(6,6),cplSvImcSeVWm(9,6),cplSvImSvImcVWmVWm(9,9),          & 
& cplSvImSvImVZVZ(9,9),cplSvImSvReVZ(9,9),cplSvRecSeVWm(9,6),cplSvReSvRecVWmVWm(9,9),    & 
& cplSvReSvReVZVZ(9,9),cplVGVGVG
...
& laminput,kapinput,lamNinput,Yuinput,Yvinput,MUXinput,Tdinput,Teinput,Tlaminput,        & 
& Tkinput,TLNinput,Tuinput,Tvinput,BMUXinput,mq2input,ml2input,mHd2input,mHu2input,      & 
& md2input,mu2input,me2input,mv2input,ms2input,mx2input,M1input,M2input,M3input,         & 
& vdinput,vuinput,vSinput,g1,g2,g3,Yd,Ye,lam,kap,lamN,Yu,Yv,MUX,Td,Te,Tlam,              & 
& Tk,TLN,Tu,Tv,BMUX,mq2,ml2,mHd2,mHu2,md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,vd,               & 
& vu,vS,CKM_160,sinW2_160,Alpha_160,AlphaS_160,.false.)
...
& ZE,Yu,Tu,ZU,MUX,lamN,TLN,Yv,Tv,ZVI,ZVR,TW,g3,UM,UP,ZN,ZDL,ZDR,ZEL,ZER,ZUL,             & 
...
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,cplChiChacHpmL,  & 
...
& kapinput,lamNinput,Yuinput,Yvinput,MUXinput,Tdinput,Teinput,Tlaminput,Tkinput,         & 
& TLNinput,Tuinput,Tvinput,BMUXinput,mq2input,ml2input,mHd2input,mHu2input,              & 
& md2input,mu2input,me2input,mv2input,ms2input,mx2input,M1input,M2input,M3input,         & 
& vdinput,vuinput,vSinput,g1,g2,g3,Yd,Ye,lam,kap,lamN,Yu,Yv,MUX,Td,Te,Tlam,              & 
& Tk,TLN,Tu,Tv,BMUX,mq2,ml2,mHd2,mHu2,md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,vd,               & 
& vu,vS,CKM_MZ,sinW2_MZ,Alpha_MZ,AlphaS_MZ,.true.)
