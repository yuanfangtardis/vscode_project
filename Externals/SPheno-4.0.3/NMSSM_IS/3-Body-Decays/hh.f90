...
& md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,vd,vu,vS,ghhAhChacCha,ghhAhChiChi,ghhAhFdcFd,         & 
& ghhAhFecFe,ghhAhFucFu,ghhAhFvFv,ghhcHpmChaChi,ghhcSdChaFu,ghhcSeChaFv,ghhhhChacCha,    & 
...
& ghhcSuFuGlu(3,6,3,1),ghhhhFucFu(3,3,3,3),ghhhhFvFv(3,3,9,9)

Real(dp) :: ghhAhChacChai(3,2,2),ghhAhChiChii(3,5,5),ghhAhFdcFdi(3,3,3),ghhAhFecFei(3,3,3),       & 
& ghhAhFucFui(3,3,3),ghhAhFvFvi(3,9,9),ghhcHpmChaChii(2,2,5),ghhcSdChaFui(6,2,3),        & 
& ghhcSeChaFvi(6,2,9),ghhhhChacChai(3,2,2),ghhSuChacFdi(6,2,3),ghhSvImChacFei(9,2,3),    & 
& ghhSvReChacFei(9,2,3),ghhhhChiChii(3,5,5),ghhcSdChiFdi(6,5,3),ghhcSeChiFei(6,5,3),     & 
& ghhcSuChiFui(6,5,3),ghhSvImChiFvi(9,5,9),ghhSvReChiFvi(9,5,9),ghhcSdFdGlui(6,3,1),     & 
& ghhhhFdcFdi(3,3,3),ghhcHpmFdcFui(2,3,3),ghhcHpmFeFvi(2,3,9),ghhhhFecFei(3,3,3),        & 
& ghhcSuFuGlui(6,3,1),ghhhhFucFui(3,3,3),ghhhhFvFvi(3,9,9)
...
& mq2,ml2,mHd2,mHu2,md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,vd,vu,vS,cplAhAhhh,cplAhhhhh,       & 
& cplAhhhVZ,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,       & 
& cplcChaChaVZR,cplcFdChaSuL,cplcFdChaSuR,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,           & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFeChaSvImL,cplcFeChaSvImR,cplcFeChaSvReL,      & 
& cplcFeChaSvReR,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,            & 
& cplcFeFeVZR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuAhL,       & 
...
Real(dp),Intent(in) :: MAh(3),MFv(9),MVZ,Mhh(3)
...
Real(dp),Intent(in) :: MSe(6),MCha(2),MFv(9),Mhh(3)
...
Real(dp),Intent(in) :: MSvIm(9),MCha(2),MFe(3),MSvRe(9),Mhh(3)
...
Real(dp),Intent(in) :: MSvRe(9),MCha(2),MFe(3),MSvIm(9),Mhh(3)
...
Real(dp),Intent(in) :: MSvIm(9),MChi(5),MFv(9),MSvRe(9),Mhh(3)
...
Real(dp),Intent(in) :: MSvRe(9),MChi(5),MFv(9),MSvIm(9),Mhh(3)
...
Real(dp),Intent(in) :: MHpm(2),MFe(3),MFv(9),MVWm,Mhh(3)
...
Real(dp),Intent(in) :: Mhh(3),MFv(9),MAh(3)

Complex(dp),Intent(in) :: cplAhhhhh(3,3,3),cplhhhhhh(3,3,3),cplFvFvAhL(9,9,3),cplFvFvAhR(9,9,3),cplFvFvhhL(9,9,3),& 
& cplFvFvhhR(9,9,3)
...
End Module hh3Decays_NInvSeesaw 
