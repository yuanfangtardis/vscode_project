...
& md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,vd,vu,vS,gTAh,gThh,gTHpm,gTSe,gTSvIm,gTSvRe,          & 
& gTVWm,gTVZ,gFvFvcChaCha,gFvFvChiChi,gFvFvcFdFd,gFvFvcFeFe,gFvFvcFuFu,gFvFvFvFv,        & 
& gFvcFeChiCha,gFvFecFdFu,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
Real(dp),Intent(inout) :: gFvFvcChaCha(9,9,2,2),gFvFvChiChi(9,9,5,5),gFvFvcFdFd(9,9,3,3),gFvFvcFeFe(9,9,3,3),   & 
& gFvFvcFuFu(9,9,3,3),gFvFvFvFv(9,9,9,9),gFvcFeChiCha(9,3,5,2),gFvFecFdFu(9,3,3,3)

Real(dp),Intent(in) :: gTAh(3),gThh(3),gTHpm(2),gTSe(6),gTSvIm(9),gTSvRe(9),gTVWm,gTVZ

Real(dp) :: gFvFvcChaChai(9,2,2),gFvFvChiChii(9,5,5),gFvFvcFdFdi(9,3,3),gFvFvcFeFei(9,3,3),       & 
& gFvFvcFuFui(9,3,3),gFvFvFvFvi(9,9,9),gFvcFeChiChai(3,5,2),gFvFecFdFui(3,3,3)

Real(dp) :: gTAhtemp(3),gThhtemp(3),gTHpmtemp(2),gTSetemp(6),gTSvImtemp(9),gTSvRetemp(9)          & 
& ,gTVWmtemp,gTVZtemp
...
& cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,cplcChaChaVZR,cplcChaFvSeL,    & 
& cplcChaFvSeR,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,              & 
...
& cplcFeFvHpmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,            & 
& cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,      & 
& cplChiChacVWmR,cplChiChiAhL,cplChiChiAhR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,       & 
& cplChiChiVZR,cplChiFvSvImL,cplChiFvSvImR,cplChiFvSvReL,cplChiFvSvReR,cplFvChacSeL,     & 
& cplFvChacSeR,cplFvFecHpmL,cplFvFecHpmR,cplFvFecVWmL,cplFvFecVWmR,cplFvFvAhL,           & 
& cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVZL,cplFvFvVZR,deltaM)
...
Real(dp),Intent(in) :: MFv(9),MCha(2),MVZ,MSe(6),MAh(3),Mhh(3)
...
Real(dp),Intent(in) :: MFv(9),MChi(5),MVZ,MAh(3),MSvIm(9),MSvRe(9),Mhh(3)
...
Real(dp),Intent(inout) :: gTVZ,gTAh(3),gTSvIm(9),gTSvRe(9),gThh(3)
...
Real(dp),Intent(in) :: MFv(9),MFd(3),MVZ,MAh(3),Mhh(3)

Complex(dp),Intent(in) :: cplcFdFdAhL(3,3,3),cplcFdFdAhR(3,3,3),cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),          & 
& cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplFvFvAhL(9,9,3),cplFvFvAhR(9,9,3),cplFvFvhhL(9,9,3),& 
& cplFvFvhhR(9,9,3),cplFvFvVZL(9,9),cplFvFvVZR(9,9)
...
Real(dp),Intent(in) :: MFv(9),MFe(3),MVZ,MVWm,MHpm(2),MAh(3),Mhh(3)

Complex(dp),Intent(in) :: cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3),          & 
& cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFvHpmL(3,9,2),cplcFeFvHpmR(3,9,2),             & 
& cplcFeFvVWmL(3,9),cplcFeFvVWmR(3,9),cplFvFecHpmL(9,3,2),cplFvFecHpmR(9,3,2),           & 
...
Real(dp),Intent(in) :: MFv(9),MFu(3),MVZ,MAh(3),Mhh(3)

Complex(dp),Intent(in) :: cplcFuFuAhL(3,3,3),cplcFuFuAhR(3,3,3),cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),          & 
& cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplFvFvAhL(9,9,3),cplFvFvAhR(9,9,3),cplFvFvhhL(9,9,3),& 
& cplFvFvhhR(9,9,3),cplFvFvVZL(9,9),cplFvFvVZR(9,9)
...
Real(dp),Intent(in) :: MFv(9),MVZ,MAh(3),Mhh(3)

Complex(dp),Intent(in) :: cplFvFvAhL(9,9,3),cplFvFvAhR(9,9,3),cplFvFvhhL(9,9,3),cplFvFvhhR(9,9,3),              & 
& cplFvFvVZL(9,9),cplFvFvVZR(9,9)
...
Real(dp),Intent(in) :: MFe(3),MChi(5),MCha(2),MVWm,MSe(6),MHpm(2),MSvIm(9),MSvRe(9),MFv(9)
...
Real(dp),Intent(inout) :: gTVWm,gTSe(6),gTHpm(2),gTSvIm(9),gTSvRe(9)
...
Real(dp),Intent(in) :: MFe(3),MFd(3),MFu(3),MVWm,MHpm(2),MFv(9)
...
End Module Fv3Decays_NInvSeesaw 
