...
& md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,vd,vu,vS,gSdAhChaFu,gSdAhChiFd,gSdAhFdGlu,            & 
& gSdSuChaChi,gSdChaFdcHpm,gSdhhChaFu,gSdChaGluSu,gSdSdChacCha,gSdSdChiChi,              & 
& gSdhhChiFd,gSdHpmChiFu,gSdChiGluSd,gSdFdFdcSd,gSdFdFecSe,gSdFuFdcSu,gSdFdFvSvIm,       & 
& gSdFdFvSvRe,gSdHpmFdcCha,gSdSdFdcFd,gSdFdSecFe,gSdSuFdcFu,gSdFuFeSvIm,gSdFuFeSvRe,     & 
& gSdFuFvSe,gSdSdFucFu,gSdhhFdGlu,gSdHpmFuGlu,gSdGluGluSd,gSdSdFecFe,gSdSdFvFv,          & 
& gSdSuFeFv,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
Complex(dp) :: cplAhSdcSd(3,6,6),cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),cplcChaChaAhL(2,2,3),     & 
...
& cplcChaFeSvReR(2,3,9),cplcChaFvSeL(2,9,6),cplcChaFvSeR(2,9,6),cplcFdChaSuL(3,2,6),     & 
...
Real(dp),Intent(inout) :: gSdAhChaFu(6,3,2,3),gSdAhChiFd(6,3,5,3),gSdAhFdGlu(6,3,3,1),gSdSuChaChi(6,6,2,5),     & 
...
& gSdSdFecFe(6,6,3,3),gSdSdFvFv(6,6,9,9),gSdSuFeFv(6,6,3,9)

Real(dp) :: gSdAhChaFui(3,2,3),gSdAhChiFdi(3,5,3),gSdAhFdGlui(3,3,1),gSdSuChaChii(6,2,5),         & 
& gSdChaFdcHpmi(2,3,2),gSdhhChaFui(3,2,3),gSdChaGluSui(2,1,6),gSdSdChacChai(6,2,2),      & 
& gSdSdChiChii(6,5,5),gSdhhChiFdi(3,5,3),gSdHpmChiFui(2,5,3),gSdChiGluSdi(5,1,6),        & 
& gSdFdFdcSdi(3,3,6),gSdFdFecSei(3,3,6),gSdFuFdcSui(3,3,6),gSdFdFvSvImi(3,9,9),          & 
& gSdFdFvSvRei(3,9,9),gSdHpmFdcChai(2,3,2),gSdSdFdcFdi(6,3,3),gSdFdSecFei(3,6,3),        & 
& gSdSuFdcFui(6,3,3),gSdFuFeSvImi(3,3,9),gSdFuFeSvRei(3,3,9),gSdFuFvSei(3,9,6),          & 
& gSdSdFucFui(6,3,3),gSdhhFdGlui(3,3,1),gSdHpmFuGlui(2,3,1),gSdGluGluSdi(1,1,6),         & 
& gSdSdFecFei(6,3,3),gSdSdFvFvi(6,9,9),gSdSuFeFvi(6,3,9)
...
& mq2,ml2,mHd2,mHu2,md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,vd,vu,vS,cplAhSdcSd,cplcChacFuSdL,  & 
...
& cplcFdFuHpmR,cplcFdGluSdL,cplcFdGluSdR,cplcFeChiSeL,cplcFeChiSeR,cplcFeFeAhL,          & 
...
& cplChiFucSuR,cplChiFvSvImL,cplChiFvSvImR,cplChiFvSvReL,cplChiFvSvReR,cplFvFecHpmL,     & 
...
& cplGluFucSuR,cplhhSdcSd,cplHpmSucSd,cplSdcSdVZ,cplSucSdVWm,deltaM)
...
gSdFdFvSvImi = 0._dp 
Call SdToFdFvSvIm(i_run,MFd,MFv,MSvIm,MChi,MSd,cplChiFdcSdL,cplChiFdcSdR,             & 
& cplChiFvSvImL,cplChiFvSvImR,deltaM,epsI,check,gSdFdFvSvImi)

gSdFdFvSvIm(i_run,:,:,:) = gSdFdFvSvImi 
gT(i_run) = gT(i_run) + Sum(gSdFdFvSvImi) 
 
gSdFdFvSvRei = 0._dp 
Call SdToFdFvSvRe(i_run,MFd,MFv,MSvRe,MChi,MSd,cplChiFdcSdL,cplChiFdcSdR,             & 
& cplChiFvSvReL,cplChiFvSvReR,deltaM,epsI,check,gSdFdFvSvRei)

gSdFdFvSvRe(i_run,:,:,:) = gSdFdFvSvRei 
gT(i_run) = gT(i_run) + Sum(gSdFdFvSvRei) 
...
gSdFuFeSvImi = 0._dp 
Call SdToFuFeSvIm(i_run,MFu,MFe,MSvIm,MCha,MSd,cplcChaFeSvImL,cplcChaFeSvImR,         & 
& cplChaFucSdL,cplChaFucSdR,deltaM,epsI,check,gSdFuFeSvImi)

gSdFuFeSvIm(i_run,:,:,:) = gSdFuFeSvImi 
gT(i_run) = gT(i_run) + Sum(gSdFuFeSvImi) 
 
gSdFuFeSvRei = 0._dp 
Call SdToFuFeSvRe(i_run,MFu,MFe,MSvRe,MCha,MSd,cplcChaFeSvReL,cplcChaFeSvReR,         & 
& cplChaFucSdL,cplChaFucSdR,deltaM,epsI,check,gSdFuFeSvRei)

gSdFuFeSvRe(i_run,:,:,:) = gSdFuFeSvRei 
gT(i_run) = gT(i_run) + Sum(gSdFuFeSvRei) 
 
gSdFuFvSei = 0._dp 
Call SdToFuFvSe(i_run,MFu,MFv,MSe,MCha,MSd,cplcChaFvSeL,cplcChaFvSeR,cplChaFucSdL,    & 
& cplChaFucSdR,deltaM,epsI,check,gSdFuFvSei)
...
gSdSdFvFvi = 0._dp 
Call SdToSdFvFv(i_run,MSd,MFv,MVZ,MAh,Mhh,cplAhSdcSd,cplhhSdcSd,cplSdcSdVZ,           & 
& cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVZL,cplFvFvVZR,deltaM,              & 
& epsI,check,gSdSdFvFvi)

gSdSdFvFv(i_run,:,:,:) = gSdSdFvFvi 
gT(i_run) = gT(i_run) + Sum(gSdSdFvFvi) 
 
gSdSuFeFvi = 0._dp 
Call SdToSuFeFv(i_run,MSu,MFe,MFv,MVWm,MHpm,MSd,cplHpmSucSd,cplSucSdVWm,              & 
& cplFvFecHpmL,cplFvFecHpmR,cplFvFecVWmL,cplFvFecVWmR,deltaM,epsI,check,gSdSuFeFvi)
...
Do gt1=1,3
  Do gt2=1,9
    Do gt3=1,9
gPartial(i1,n_length)= gSdFdFvSvIm(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
Do gt1=1,3
  Do gt2=1,9
    Do gt3=1,9
gPartial(i1,n_length)= gSdFdFvSvRe(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
...
Do gt1=1,3
  Do gt2=1,3
    Do gt3=1,9
gPartial(i1,n_length)= gSdFuFeSvIm(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
Do gt1=1,3
  Do gt2=1,3
    Do gt3=1,9
gPartial(i1,n_length)= gSdFuFeSvRe(i1,gt1,gt2,gt3)
n_length=n_length+1
     End Do 
  End Do 
End Do 
...
Real(dp),Intent(in) :: MAh(3),MCha(2),MFu(3),MSd(6)
...
Real(dp),Intent(in) :: MAh(3),MChi(5),MFd(3),MSd(6)
...
Real(dp),Intent(in) :: MAh(3),MFd(3),MGlu,MSd(6)
...
Real(dp),Intent(in) :: MSu(6),MCha(2),MChi(5),MVWm,MHpm(2),MFu(3),MFd(3),MSd(6)

Complex(dp),Intent(in) :: cplHpmSucSd(2,6,6),cplSucSdVWm(6,6),cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6),          & 
& cplcFuChiSuL(3,5,6),cplcFuChiSuR(3,5,6),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),       & 
& cplChiChacHpmL(5,2,2),cplChiChacHpmR(5,2,2),cplChiChacVWmL(5,2),cplChiChacVWmR(5,2),   & 
& cplChiFdcSdL(5,3,6),cplChiFdcSdR(5,3,6)
...
Real(dp),Intent(in) :: MCha(2),MFd(3),MHpm(2),MFu(3),MChi(5),MSd(6)
...
Real(dp),Intent(in) :: Mhh(3),MCha(2),MFu(3),MSd(6)
...
Real(dp),Intent(in) :: MSd(6),MCha(2),MVZ,MAh(3),Mhh(3),MFu(3)

Complex(dp),Intent(in) :: cplAhSdcSd(3,6,6),cplhhSdcSd(3,6,6),cplSdcSdVZ(6,6),cplcChacFuSdL(2,3,6),             & 
& cplcChacFuSdR(2,3,6),cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),cplcChaChahhL(2,2,3),   & 
& cplcChaChahhR(2,2,3),cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),cplChaFucSdL(2,3,6),        & 
& cplChaFucSdR(2,3,6)
...
Real(dp),Intent(in) :: MSd(6),MChi(5),MVZ,MAh(3),Mhh(3),MFd(3)

Complex(dp),Intent(in) :: cplAhSdcSd(3,6,6),cplhhSdcSd(3,6,6),cplSdcSdVZ(6,6),cplcFdChiSdL(3,5,6),              & 
& cplcFdChiSdR(3,5,6),cplChiChiAhL(5,5,3),cplChiChiAhR(5,5,3),cplChiChihhL(5,5,3),       & 
& cplChiChihhR(5,5,3),cplChiChiVZL(5,5),cplChiChiVZR(5,5),cplChiFdcSdL(5,3,6),           & 
& cplChiFdcSdR(5,3,6)
...
Real(dp),Intent(in) :: Mhh(3),MChi(5),MFd(3),MSd(6)
...
Real(dp),Intent(in) :: MHpm(2),MChi(5),MFu(3),MSu(6),MFd(3),MCha(2),MSd(6)

Complex(dp),Intent(in) :: cplHpmSucSd(2,6,6),cplcChaChiHpmL(2,5,2),cplcChaChiHpmR(2,5,2),cplcFdFuHpmL(3,3,2),   & 
& cplcFdFuHpmR(3,3,2),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),cplChiFdcSdL(5,3,6),       & 
...
Real(dp),Intent(in) :: MChi(5),MGlu,MSd(6),MFd(3)
...
Real(dp),Intent(in) :: MFd(3),MSd(6),MChi(5),MGlu

Complex(dp),Intent(in) :: cplChiFdcSdL(5,3,6),cplChiFdcSdR(5,3,6),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6)
...
Real(dp),Intent(in) :: MFd(3),MFe(3),MSe(6),MChi(5),MSd(6)
...
Real(dp),Intent(in) :: MFu(3),MFd(3),MSu(6),MCha(2),MChi(5),MGlu,MSd(6)
...
Subroutine SdToFdFvSvIm(iIN,MFd,MFv,MSvIm,MChi,MSd,cplChiFdcSdL,cplChiFdcSdR,         & 
& cplChiFvSvImL,cplChiFvSvImR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFd(3),MFv(9),MSvIm(9),MChi(5),MSd(6)

Complex(dp),Intent(in) :: cplChiFdcSdL(5,3,6),cplChiFdcSdR(5,3,6),cplChiFvSvImL(5,9,9),cplChiFvSvImR(5,9,9)
...
rk2 = (MFd(gt1)/MSd(iIN))**2 
rm2 = (MFv(gt2)/MSd(iIN))**2 
rj2 = (MSvIm(gt3)/MSd(iIN))**2 
smin=2._dp*Sqrt(rk2) 
smax=1._dp+rk2-rj2-rm2-2._dp*Sqrt(rj2*rm2) 
smin2=2._dp*Sqrt(rm2) 
smax2=1._dp+rm2-rj2-rk2-2._dp*Sqrt(rj2*rk2) 
...
r_outcrossed(2)=rm2 
r_outcrossed(3)=rk2 
If(Abs(MSd(iIN)).gt.(Abs(MSvIm(gt3))+Abs(MFv(gt2))+Abs(MFd(gt1)))) Then 
!-------------- 
!  Chi 
!-------------- 
Do i1=1,5
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Sd->Fd Fv SvIm Propagator: Chi" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Sd->Fd Fv SvIm Propagator: Chi,Chi" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
End If
     ...
     End Do 
   End Do 
End Subroutine SdToFdFvSvIm 
 
 
Subroutine SdToFdFvSvRe(iIN,MFd,MFv,MSvRe,MChi,MSd,cplChiFdcSdL,cplChiFdcSdR,         & 
& cplChiFvSvReL,cplChiFvSvReR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFd(3),MFv(9),MSvRe(9),MChi(5),MSd(6)

Complex(dp),Intent(in) :: cplChiFdcSdL(5,3,6),cplChiFdcSdR(5,3,6),cplChiFvSvReL(5,9,9),cplChiFvSvReR(5,9,9)
...
r_outcrossed(2)=rm2 
r_outcrossed(3)=rk2 
If(Abs(MSd(iIN)).gt.(Abs(MSvRe(gt3))+Abs(MFv(gt2))+Abs(MFd(gt1)))) Then 
!-------------- 
!  Chi 
!-------------- 
Do i1=1,5
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Sd->Fd Fv SvRe Propagator: Chi" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Sd->Fd Fv SvRe Propagator: Chi,Chi" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Real(dp),Intent(in) :: MHpm(2),MFd(3),MCha(2),MSu(6),MChi(5),MSd(6)

Complex(dp),Intent(in) :: cplHpmSucSd(2,6,6),cplcChaChiHpmL(2,5,2),cplcChaChiHpmR(2,5,2),cplcChaFdcSuL(2,3,6),  & 
& cplcChaFdcSuR(2,3,6),cplChiFdcSdL(5,3,6),cplChiFdcSdR(5,3,6)
...
Real(dp),Intent(in) :: MSd(6),MFd(3),MVZ,MAh(3),Mhh(3),MChi(5),MGlu

Complex(dp),Intent(in) :: cplAhSdcSd(3,6,6),cplhhSdcSd(3,6,6),cplSdcSdVZ(6,6),cplcFdChiSdL(3,5,6),              & 
& cplcFdChiSdR(3,5,6),cplcFdFdAhL(3,3,3),cplcFdFdAhR(3,3,3),cplcFdFdhhL(3,3,3),          & 
& cplcFdFdhhR(3,3,3),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFdGluSdL(3,6),cplcFdGluSdR(3,6),& 
& cplChiFdcSdL(5,3,6),cplChiFdcSdR(5,3,6),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6)
...
Real(dp),Intent(in) :: MFd(3),MSe(6),MFe(3),MChi(5),MSd(6)

Complex(dp),Intent(in) :: cplcFeChiSeL(3,5,6),cplcFeChiSeR(3,5,6),cplChiFdcSdL(5,3,6),cplChiFdcSdR(5,3,6)
...
Real(dp),Intent(in) :: MSu(6),MFd(3),MFu(3),MVWm,MHpm(2),MChi(5),MGlu,MSd(6)

Complex(dp),Intent(in) :: cplHpmSucSd(2,6,6),cplSucSdVWm(6,6),cplcFuChiSuL(3,5,6),cplcFuChiSuR(3,5,6),          & 
& cplcFuFdcHpmL(3,3,2),cplcFuFdcHpmR(3,3,2),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),       & 
& cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplChiFdcSdL(5,3,6),cplChiFdcSdR(5,3,6),           & 
...
Subroutine SdToFuFeSvIm(iIN,MFu,MFe,MSvIm,MCha,MSd,cplcChaFeSvImL,cplcChaFeSvImR,     & 
& cplChaFucSdL,cplChaFucSdR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFu(3),MFe(3),MSvIm(9),MCha(2),MSd(6)

Complex(dp),Intent(in) :: cplcChaFeSvImL(2,3,9),cplcChaFeSvImR(2,3,9),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6)
...
r_outcrossed(2)=rm2 
r_outcrossed(3)=rk2 
If(Abs(MSd(iIN)).gt.(Abs(MSvIm(gt3))+Abs(MFe(gt2))+Abs(MFu(gt1)))) Then 
!-------------- 
!  Cha 
!-------------- 
Do i1=1,2
...
coup(2) = Conjg(cplChaFucSdL(i1,gt1,iIN)) 
coup(1) = Conjg(cplChaFucSdR(i1,gt1,iIN)) 
coup(4) = Conjg(cplcChaFeSvImL(i1,gt2,gt3)) 
coup(3) = Conjg(cplcChaFeSvImR(i1,gt2,gt3))
coup(5:8) = coup(1:4) 
Call IntegrateFFLM(mass,m_in,r_out,coup,smin,smax,epsI,resC) 
If (resC.ne.resC) resC = 0._dp
resC = 1*resC  ! Color factor 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Sd->Fu Fe SvIm Propagator: Cha" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup(1) = cplChaFucSdL(i1,gt1,iIN) 
coup(2) = cplChaFucSdR(i1,gt1,iIN) 
coup(3) = cplcChaFeSvImL(i1,gt2,gt3) 
coup(4) = cplcChaFeSvImR(i1,gt2,gt3) 
coup(5) = cplChaFucSdL(i2,gt1,iIN) 
coup(6) = cplChaFucSdR(i2,gt1,iIN)  
coup(7) = cplcChaFeSvImL(i2,gt2,gt3) 
coup(8) = cplcChaFeSvImR(i2,gt2,gt3) 
Call IntegrateFFLM(mass,m_in,r_out,coup,smin,smax,epsI,resC) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC = 1*resC  ! Color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Sd->Fu Fe SvIm Propagator: Cha,Cha" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
End If
     ...
     End Do 
   End Do 
End Subroutine SdToFuFeSvIm 
 
 
Subroutine SdToFuFeSvRe(iIN,MFu,MFe,MSvRe,MCha,MSd,cplcChaFeSvReL,cplcChaFeSvReR,     & 
& cplChaFucSdL,cplChaFucSdR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFu(3),MFe(3),MSvRe(9),MCha(2),MSd(6)

Complex(dp),Intent(in) :: cplcChaFeSvReL(2,3,9),cplcChaFeSvReR(2,3,9),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6)
...
r_outcrossed(2)=rm2 
r_outcrossed(3)=rk2 
If(Abs(MSd(iIN)).gt.(Abs(MSvRe(gt3))+Abs(MFe(gt2))+Abs(MFu(gt1)))) Then 
!-------------- 
!  Cha 
!-------------- 
Do i1=1,2
...
coup(2) = Conjg(cplChaFucSdL(i1,gt1,iIN)) 
coup(1) = Conjg(cplChaFucSdR(i1,gt1,iIN)) 
coup(4) = Conjg(cplcChaFeSvReL(i1,gt2,gt3)) 
coup(3) = Conjg(cplcChaFeSvReR(i1,gt2,gt3))
coup(5:8) = coup(1:4) 
Call IntegrateFFLM(mass,m_in,r_out,coup,smin,smax,epsI,resC) 
If (resC.ne.resC) resC = 0._dp
resC = 1*resC  ! Color factor 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Sd->Fu Fe SvRe Propagator: Cha" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup(1) = cplChaFucSdL(i1,gt1,iIN) 
coup(2) = cplChaFucSdR(i1,gt1,iIN) 
coup(3) = cplcChaFeSvReL(i1,gt2,gt3) 
coup(4) = cplcChaFeSvReR(i1,gt2,gt3) 
coup(5) = cplChaFucSdL(i2,gt1,iIN) 
coup(6) = cplChaFucSdR(i2,gt1,iIN)  
coup(7) = cplcChaFeSvReL(i2,gt2,gt3) 
coup(8) = cplcChaFeSvReR(i2,gt2,gt3) 
Call IntegrateFFLM(mass,m_in,r_out,coup,smin,smax,epsI,resC) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC = 1*resC  ! Color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Sd->Fu Fe SvRe Propagator: Cha,Cha" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
End If
     ...
     End Do 
   End Do 
End Subroutine SdToFuFeSvRe 
 
 
Subroutine SdToFuFvSe(iIN,MFu,MFv,MSe,MCha,MSd,cplcChaFvSeL,cplcChaFvSeR,             & 
& cplChaFucSdL,cplChaFucSdR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFu(3),MFv(9),MSe(6),MCha(2),MSd(6)

Complex(dp),Intent(in) :: cplcChaFvSeL(2,9,6),cplcChaFvSeR(2,9,6),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6)
...
Isum = 4 
Allocate( gSum(3,9,6, Isum) ) 
Allocate( Contribution(3,9,6, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
r_outcrossed(2)=rm2 
r_outcrossed(3)=rk2 
If(Abs(MSd(iIN)).gt.(Abs(MSe(gt3))+Abs(MFv(gt2))+Abs(MFu(gt1)))) Then 
!-------------- 
!  Cha 
!-------------- 
Do i1=1,2
...
Real(dp),Intent(in) :: MSd(6),MFu(3),MVZ,MAh(3),Mhh(3),MCha(2)

Complex(dp),Intent(in) :: cplAhSdcSd(3,6,6),cplhhSdcSd(3,6,6),cplSdcSdVZ(6,6),cplcChacFuSdL(2,3,6),             & 
& cplcChacFuSdR(2,3,6),cplcFuFuAhL(3,3,3),cplcFuFuAhR(3,3,3),cplcFuFuhhL(3,3,3),         & 
& cplcFuFuhhR(3,3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplChaFucSdL(2,3,6),              & 
& cplChaFucSdR(2,3,6)
...
Real(dp),Intent(in) :: Mhh(3),MFd(3),MGlu,MSd(6)
...
Real(dp),Intent(in) :: MSd(6),MFe(3),MVZ,MAh(3),Mhh(3)

Complex(dp),Intent(in) :: cplAhSdcSd(3,6,6),cplhhSdcSd(3,6,6),cplSdcSdVZ(6,6),cplcFeFeAhL(3,3,3),               & 
& cplcFeFeAhR(3,3,3),cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3),cplcFeFeVZL(3,3),             & 
& cplcFeFeVZR(3,3)
...
Subroutine SdToSdFvFv(iIN,MSd,MFv,MVZ,MAh,Mhh,cplAhSdcSd,cplhhSdcSd,cplSdcSdVZ,       & 
& cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVZL,cplFvFvVZR,deltaM,              & 
& epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MSd(6),MFv(9),MVZ,MAh(3),Mhh(3)

Complex(dp),Intent(in) :: cplAhSdcSd(3,6,6),cplhhSdcSd(3,6,6),cplSdcSdVZ(6,6),cplFvFvAhL(9,9,3),cplFvFvAhR(9,9,3),& 
...
rk2 = (MFv(gt2)/MSd(iIN))**2 
rm2 = (MFv(gt3)/MSd(iIN))**2 
rj2 = (MSd(gt1)/MSd(iIN))**2 
smin=2._dp*Sqrt(rk2) 
smax=1._dp+rk2-rj2-rm2-2._dp*Sqrt(rj2*rm2) 
smin2=2._dp*Sqrt(rm2) 
...
r_outcrossed(2)=rm2 
r_outcrossed(3)=rk2 
If(Abs(MSd(iIN)).gt.(Abs(MFv(gt3))+Abs(MFv(gt2))+Abs(MSd(gt1)))) Then 
!-------------- 
!  VZ 
!-------------- 
Isum = Isum + 1 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Sd->Sd Fv Fv Propagator: Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Sd->Sd Fv Fv Propagator: hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Sd->Sd Fv Fv Propagator: VZ,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Sd->Sd Fv Fv Propagator: VZ,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Sd->Sd Fv Fv Propagator: Ah,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Sd->Sd Fv Fv Propagator: Ah,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Sd->Sd Fv Fv Propagator: hh,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine SdToSuFeFv(iIN,MSu,MFe,MFv,MVWm,MHpm,MSd,cplHpmSucSd,cplSucSdVWm,          & 
& cplFvFecHpmL,cplFvFecHpmR,cplFvFecVWmL,cplFvFecVWmR,deltaM,epsI,check,g,               & 
& WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MSu(6),MFe(3),MFv(9),MVWm,MHpm(2),MSd(6)

Complex(dp),Intent(in) :: cplHpmSucSd(2,6,6),cplSucSdVWm(6,6),cplFvFecHpmL(9,3,2),cplFvFecHpmR(9,3,2),          & 
...
Isum = 9 
Allocate( gSum(6,3,9, Isum) ) 
Allocate( Contribution(6,3,9, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
r_outcrossed(2)=rm2 
r_outcrossed(3)=rk2 
If(Abs(MSd(iIN)).gt.(Abs(MFv(gt3))+Abs(MFe(gt2))+Abs(MSu(gt1)))) Then 
!-------------- 
!  VWm 
!-------------- 
Isum = Isum + 1 
...
End Module Sd3Decays_NInvSeesaw 
