...
Complex(dp) :: cplAhSvImSvIm(3,9,9),cplAhSvImSvRe(3,9,9),cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),  & 
...
& cplFvFvVZL(9,9),cplFvFvVZR(9,9),cplhhSvImSvIm(3,9,9),cplhhSvImSvRe(3,9,9),             & 
& cplHpmSvImcSe(2,9,6),cplSeSvImcHpm(6,9,2),cplSeSvImcVWm(6,9),cplSvImcSeVWm(9,6),       & 
& cplSvImSvReVZ(9,9)
...
Real(dp),Intent(inout) :: gSvImAhChacFe(9,3,2,3),gSvImAhChiFv(9,3,5,9),gSvImcSeChaChi(9,6,2,5),gSvImcHpmChaFv(9,2,2,9),& 
& gSvImhhChacFe(9,3,2,3),gSvImSvImChacCha(9,9,2,2),gSvImSvReChacCha(9,9,2,2),            & 
& gSvImSvImChiChi(9,9,5,5),gSvImSvReChiChi(9,9,5,5),gSvImcHpmChiFe(9,2,5,3),             & 
& gSvImhhChiFv(9,3,5,9),gSvImFeFucSd(9,3,3,6),gSvImcSeFeFv(9,6,3,9),gSvImFeSucFd(9,3,6,3),& 
& gSvImSvImFecFe(9,9,3,3),gSvImSvReFecFe(9,9,3,3),gSvImFvFdcSd(9,9,3,6),gSvImFvFucSu(9,9,3,6),& 
& gSvImSvImFvFv(9,9,9,9),gSvImSvReFvFv(9,9,9,9),gSvImSeFucFd(9,6,3,3),gSvImSvImFdcFd(9,9,3,3),& 
& gSvImSvImFucFu(9,9,3,3),gSvImSvReFdcFd(9,9,3,3),gSvImSvReFucFu(9,9,3,3)

Real(dp) :: gSvImAhChacFei(3,2,3),gSvImAhChiFvi(3,5,9),gSvImcSeChaChii(6,2,5),gSvImcHpmChaFvi(2,2,9),& 
& gSvImhhChacFei(3,2,3),gSvImSvImChacChai(9,2,2),gSvImSvReChacChai(9,2,2),               & 
& gSvImSvImChiChii(9,5,5),gSvImSvReChiChii(9,5,5),gSvImcHpmChiFei(2,5,3),gSvImhhChiFvi(3,5,9),& 
& gSvImFeFucSdi(3,3,6),gSvImcSeFeFvi(6,3,9),gSvImFeSucFdi(3,6,3),gSvImSvImFecFei(9,3,3), & 
& gSvImSvReFecFei(9,3,3),gSvImFvFdcSdi(9,3,6),gSvImFvFucSui(9,3,6),gSvImSvImFvFvi(9,9,9),& 
& gSvImSvReFvFvi(9,9,9),gSvImSeFucFdi(6,3,3),gSvImSvImFdcFdi(9,3,3),gSvImSvImFucFui(9,3,3),& 
& gSvImSvReFdcFdi(9,3,3),gSvImSvReFucFui(9,3,3)
...
If (n_in.Lt.0) Then 
 i_start = 1 
 i_end = 9 
 Else If ( (n_in.Ge.1).And.(n_in.Le. 9) ) Then 
 i_start = n_in 
 i_end = n_in 
Else 
 If (ErrorLevel.Ge.-1) Then 
   Write (ErrCan, *) 'Problem in subroutine'//NameOfUnit(Iname) 
   Write (ErrCan, *) 'Value of n_in out of range, (n_in,9) = ',n_in,9 
 End If 
...
& ZW,ZZ,betaH,g1,g2,g3,Yd,Ye,lam,kap,lamN,Yu,Yv,MUX,Td,Te,Tlam,Tk,TLN,Tu,Tv,             & 
& BMUX,mq2,ml2,mHd2,mHu2,md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,vd,vu,vS,cplAhSvImSvIm,        & 
& cplAhSvImSvRe,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,   & 
...
& cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFuAhL,               & 
...
Real(dp),Intent(in) :: MAh(3),MCha(2),MFe(3),MSvIm(9),MSvRe(9)
...
Real(dp),Intent(in) :: MAh(3),MChi(5),MFv(9),MSvIm(9),MSvRe(9)
...
Isum = 1024 
Allocate( gSum(3,5,9, Isum) ) 
Allocate( Contribution(3,5,9, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: MSe(6),MCha(2),MChi(5),MVWm,MHpm(2),MFe(3),MFv(9),MSvIm(9)
...
Real(dp),Intent(in) :: MHpm(2),MCha(2),MFv(9),MSe(6),MFe(3),MChi(5),MSvIm(9)
...
Isum = 196 
Allocate( gSum(2,2,9, Isum) ) 
Allocate( Contribution(2,2,9, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: Mhh(3),MCha(2),MFe(3),MSvIm(9),MSvRe(9)

Complex(dp),Intent(in) :: cplhhSvImSvIm(3,9,9),cplhhSvImSvRe(3,9,9),cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),  & 
& cplcFeChaSvImL(3,2,9),cplcFeChaSvImR(3,2,9),cplcFeChaSvReL(3,2,9),cplcFeChaSvReR(3,2,9),& 
...
Real(dp),Intent(in) :: MSvIm(9),MCha(2),MAh(3),Mhh(3),MFe(3)

Complex(dp),Intent(in) :: cplAhSvImSvIm(3,9,9),cplhhSvImSvIm(3,9,9),cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),  & 
& cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),cplcChaFeSvImL(2,3,9),cplcChaFeSvImR(2,3,9), & 
& cplcFeChaSvImL(3,2,9),cplcFeChaSvImR(3,2,9)
...
Isum = 144 
Allocate( gSum(9,2,2, Isum) ) 
Allocate( Contribution(9,2,2, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: MSvRe(9),MCha(2),MVZ,MAh(3),Mhh(3),MFe(3),MSvIm(9)

Complex(dp),Intent(in) :: cplAhSvImSvRe(3,9,9),cplhhSvImSvRe(3,9,9),cplSvImSvReVZ(9,9),cplcChaChaAhL(2,2,3),    & 
& cplcChaChaAhR(2,2,3),cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),cplcChaChaVZL(2,2),     & 
& cplcChaChaVZR(2,2),cplcChaFeSvImL(2,3,9),cplcChaFeSvImR(2,3,9),cplcChaFeSvReL(2,3,9),  & 
& cplcChaFeSvReR(2,3,9),cplcFeChaSvImL(3,2,9),cplcFeChaSvImR(3,2,9),cplcFeChaSvReL(3,2,9),& 
& cplcFeChaSvReR(3,2,9)
...
Real(dp),Intent(in) :: MSvIm(9),MChi(5),MAh(3),Mhh(3),MFv(9)

Complex(dp),Intent(in) :: cplAhSvImSvIm(3,9,9),cplhhSvImSvIm(3,9,9),cplChiChiAhL(5,5,3),cplChiChiAhR(5,5,3),    & 
...
Isum = 225 
Allocate( gSum(9,5,5, Isum) ) 
Allocate( Contribution(9,5,5, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: MSvRe(9),MChi(5),MVZ,MAh(3),Mhh(3),MFv(9),MSvIm(9)

Complex(dp),Intent(in) :: cplAhSvImSvRe(3,9,9),cplhhSvImSvRe(3,9,9),cplSvImSvReVZ(9,9),cplChiChiAhL(5,5,3),     & 
...
Real(dp),Intent(in) :: MHpm(2),MChi(5),MFe(3),MSe(6),MCha(2),MFv(9),MSvIm(9)
...
Real(dp),Intent(in) :: Mhh(3),MChi(5),MFv(9),MSvIm(9),MSvRe(9)

Complex(dp),Intent(in) :: cplhhSvImSvIm(3,9,9),cplhhSvImSvRe(3,9,9),cplChiChihhL(5,5,3),cplChiChihhR(5,5,3),    & 
& cplChiFvSvImL(5,9,9),cplChiFvSvImR(5,9,9),cplChiFvSvReL(5,9,9),cplChiFvSvReR(5,9,9),   & 
...
Real(dp),Intent(in) :: MFe(3),MFu(3),MSd(6),MCha(2),MSvIm(9)
...
Real(dp),Intent(in) :: MSe(6),MFe(3),MFv(9),MVWm,MHpm(2),MCha(2),MChi(5),MSvIm(9)
...
Real(dp),Intent(in) :: MFe(3),MSu(6),MFd(3),MCha(2),MSvIm(9)

Complex(dp),Intent(in) :: cplcChaFeSvImL(2,3,9),cplcChaFeSvImR(2,3,9),cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6)
...
Real(dp),Intent(in) :: MSvIm(9),MFe(3),MAh(3),Mhh(3),MCha(2)

Complex(dp),Intent(in) :: cplAhSvImSvIm(3,9,9),cplhhSvImSvIm(3,9,9),cplcChaFeSvImL(2,3,9),cplcChaFeSvImR(2,3,9),& 
& cplcFeChaSvImL(3,2,9),cplcFeChaSvImR(3,2,9),cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),     & 
& cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3)
...
Real(dp),Intent(in) :: MSvRe(9),MFe(3),MVZ,MAh(3),Mhh(3),MCha(2),MSvIm(9)

Complex(dp),Intent(in) :: cplAhSvImSvRe(3,9,9),cplhhSvImSvRe(3,9,9),cplSvImSvReVZ(9,9),cplcChaFeSvImL(2,3,9),   & 
& cplcChaFeSvImR(2,3,9),cplcChaFeSvReL(2,3,9),cplcChaFeSvReR(2,3,9),cplcFeChaSvImL(3,2,9),& 
& cplcFeChaSvImR(3,2,9),cplcFeChaSvReL(3,2,9),cplcFeChaSvReR(3,2,9),cplcFeFeAhL(3,3,3),  & 
...
Real(dp),Intent(in) :: MFv(9),MFd(3),MSd(6),MChi(5),MSvIm(9)
...
Real(dp),Intent(in) :: MFv(9),MFu(3),MSu(6),MChi(5),MSvIm(9)

Complex(dp),Intent(in) :: cplChiFucSuL(5,3,6),cplChiFucSuR(5,3,6),cplChiFvSvImL(5,9,9),cplChiFvSvImR(5,9,9)
...
Real(dp),Intent(in) :: MSvIm(9),MFv(9),MAh(3),Mhh(3),MChi(5)

Complex(dp),Intent(in) :: cplAhSvImSvIm(3,9,9),cplhhSvImSvIm(3,9,9),cplChiFvSvImL(5,9,9),cplChiFvSvImR(5,9,9),  & 
& cplFvFvAhL(9,9,3),cplFvFvAhR(9,9,3),cplFvFvhhL(9,9,3),cplFvFvhhR(9,9,3)
...
Isum = 121 
Allocate( gSum(9,9,9, Isum) ) 
Allocate( Contribution(9,9,9, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: MSvRe(9),MFv(9),MVZ,MAh(3),Mhh(3),MChi(5),MSvIm(9)

Complex(dp),Intent(in) :: cplAhSvImSvRe(3,9,9),cplhhSvImSvRe(3,9,9),cplSvImSvReVZ(9,9),cplChiFvSvImL(5,9,9),    & 
& cplChiFvSvImR(5,9,9),cplChiFvSvReL(5,9,9),cplChiFvSvReR(5,9,9),cplFvFvAhL(9,9,3),      & 
...
Real(dp),Intent(in) :: MSe(6),MFu(3),MFd(3),MVWm,MHpm(2),MSvIm(9)

Complex(dp),Intent(in) :: cplSeSvImcHpm(6,9,2),cplSeSvImcVWm(6,9),cplcFdFuHpmL(3,3,2),cplcFdFuHpmR(3,3,2),      & 
...
Real(dp),Intent(in) :: MSvIm(9),MFd(3),MAh(3),Mhh(3)

Complex(dp),Intent(in) :: cplAhSvImSvIm(3,9,9),cplhhSvImSvIm(3,9,9),cplcFdFdAhL(3,3,3),cplcFdFdAhR(3,3,3),      & 
...
Real(dp),Intent(in) :: MSvIm(9),MFu(3),MAh(3),Mhh(3)

Complex(dp),Intent(in) :: cplAhSvImSvIm(3,9,9),cplhhSvImSvIm(3,9,9),cplcFuFuAhL(3,3,3),cplcFuFuAhR(3,3,3),      & 
...
Real(dp),Intent(in) :: MSvRe(9),MFd(3),MVZ,MAh(3),Mhh(3),MSvIm(9)

Complex(dp),Intent(in) :: cplAhSvImSvRe(3,9,9),cplhhSvImSvRe(3,9,9),cplSvImSvReVZ(9,9),cplcFdFdAhL(3,3,3),      & 
...
Real(dp),Intent(in) :: MSvRe(9),MFu(3),MVZ,MAh(3),Mhh(3),MSvIm(9)

Complex(dp),Intent(in) :: cplAhSvImSvRe(3,9,9),cplhhSvImSvRe(3,9,9),cplSvImSvReVZ(9,9),cplcFuFuAhL(3,3,3),      & 
...
End Module SvIm3Decays_NInvSeesaw 
