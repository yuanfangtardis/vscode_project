...
& md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,vd,vu,vS,gSuAhChiFu,gSuAhFdcCha,gSuAhFuGlu,           & 
& gSuSuChiChi,gSucHpmChiFd,gSuhhChiFu,gSuChiGluSu,gSuSdChicCha,gSuFdFucSd,               & 
& gSuFdFvcSe,gSuhhFdcCha,gSuSuFdcFd,gSuFdSvImcFe,gSuFdSvRecFe,gSucHpmChaFu,              & 
...
& gSuSuFecFe,gSuSuFvFv,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
& gSuFdFucSd(6,3,3,6),gSuFdFvcSe(6,3,9,6),gSuhhFdcCha(6,3,3,2),gSuSuFdcFd(6,6,3,3),      & 
& gSuFdSvImcFe(6,3,9,3),gSuFdSvRecFe(6,3,9,3),gSucHpmChaFu(6,2,2,3),gSuFuFecSe(6,3,3,6), & 
& gSuFuFucSu(6,3,3,6),gSuFuFvSvIm(6,3,9,9),gSuFuFvSvRe(6,3,9,9),gSucChaFuHpm(6,2,3,2),   & 
& gSuSdFucFd(6,6,3,3),gSuFuSecFe(6,3,6,3),gSuSuFucFu(6,6,3,3),gSucHpmFdGlu(6,2,3,1),     & 
& gSuhhFuGlu(6,3,3,1),gSuGluGluSu(6,1,1,6),gSuGluSdcCha(6,1,6,2),gSuSdFvcFe(6,6,9,3),    & 
& gSuSuChacCha(6,6,2,2),gSuSuFecFe(6,6,3,3),gSuSuFvFv(6,6,9,9)
...
& gSuFdFucSdi(3,3,6),gSuFdFvcSei(3,9,6),gSuhhFdcChai(3,3,2),gSuSuFdcFdi(6,3,3),          & 
& gSuFdSvImcFei(3,9,3),gSuFdSvRecFei(3,9,3),gSucHpmChaFui(2,2,3),gSuFuFecSei(3,3,6),     & 
& gSuFuFucSui(3,3,6),gSuFuFvSvImi(3,9,9),gSuFuFvSvRei(3,9,9),gSucChaFuHpmi(2,3,2),       & 
& gSuSdFucFdi(6,3,3),gSuFuSecFei(3,6,3),gSuSuFucFui(6,3,3),gSucHpmFdGlui(2,3,1),         & 
& gSuhhFuGlui(3,3,1),gSuGluGluSui(1,1,6),gSuGluSdcChai(1,6,2),gSuSdFvcFei(6,9,3),        & 
& gSuSuChacChai(6,2,2),gSuSuFecFei(6,3,3),gSuSuFvFvi(6,9,9)
...
& mq2,ml2,mHd2,mHu2,md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,vd,vu,vS,cplAhSucSu,cplcChacFuSdL,  & 
...
Real(dp),Intent(in) :: MFd(3),MFv(9),MSe(6),MCha(2),MSu(6)
...
Real(dp),Intent(in) :: MFd(3),MSvIm(9),MFe(3),MCha(2),MSu(6)

Complex(dp),Intent(in) :: cplcChaFdcSuL(2,3,6),cplcChaFdcSuR(2,3,6),cplcFeChaSvImL(3,2,9),cplcFeChaSvImR(3,2,9)
...
Real(dp),Intent(in) :: MFd(3),MSvRe(9),MFe(3),MCha(2),MSu(6)

Complex(dp),Intent(in) :: cplcChaFdcSuL(2,3,6),cplcChaFdcSuR(2,3,6),cplcFeChaSvReL(3,2,9),cplcFeChaSvReR(3,2,9)
...
Real(dp),Intent(in) :: MFu(3),MFv(9),MSvIm(9),MChi(5),MSu(6)
...
Real(dp),Intent(in) :: MFu(3),MFv(9),MSvRe(9),MChi(5),MSu(6)
...
Real(dp),Intent(in) :: MSd(6),MFv(9),MFe(3),MVWm,MHpm(2),MSu(6)

Complex(dp),Intent(in) :: cplSdcHpmcSu(6,2,6),cplSdcSucVWm(6,6),cplcFeFvHpmL(3,9,2),cplcFeFvHpmR(3,9,2),        & 
& cplcFeFvVWmL(3,9),cplcFeFvVWmR(3,9)
...
Real(dp),Intent(in) :: MSu(6),MFv(9),MVZ,MAh(3),Mhh(3)

Complex(dp),Intent(in) :: cplAhSucSu(3,6,6),cplhhSucSu(3,6,6),cplSucSuVZ(6,6),cplFvFvAhL(9,9,3),cplFvFvAhR(9,9,3),& 
...
End Module Su3Decays_NInvSeesaw 
