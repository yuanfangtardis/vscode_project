...
! ------------------------------------------------------------------------------  
! File created at 11:19 on 20.8.2017   
! ----------------------------------------------------------------------  
 
 
Module LoopCouplings_NInvSeesaw 
...
Complex(dp),Intent(in) :: UM(2,2),UP(2,2),UVinput(9,9),Ye(3,3),Yv(3,3),ZE(6,6),ZEL(3,3),ZER(3,3),               & 
& ZN(5,5),ZVI(9,9),ZVR(9,9),lamN(3,3)

Real(dp) :: MAh2(3),MCha2(2),MChi2(5),MFe2(3),MFv2(9),Mhh2(3),MHpm2(2),MSe2(6),MSvIm2(9),         & 
& MSvRe2(9),MVWm2

Complex(dp) :: cplAhcHpmVWm(3,2),cplcChaChiVWmL(2,5),cplcChaChiVWmR(2,5),cplcChaFeSvImL(2,3,9),      & 
...
& cplcFeFeAhR(3,3,3),cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3),cplcFeFvHpmL(3,9,2),          & 
& cplcFeFvHpmR(3,9,2),cplcFeFvVWmL(3,9),cplcFeFvVWmR(3,9),cplChiFecSeL(5,3,6),           & 
...
& cplFvFvAhR(9,9,3),cplFvFvhhL(9,9,3),cplFvFvhhR(9,9,3),cplhhcHpmVWm(3,2),               & 
& cplhhcVWmVWm(3),cplSvImcSeVWm(9,6),cplSvRecSeVWm(9,6)
...
End Module LoopCouplings_NInvSeesaw 
