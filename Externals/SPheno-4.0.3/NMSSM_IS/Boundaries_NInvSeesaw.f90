...
& mHd2,mHu2,md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,delta0,gMZ,kont)
...
& cplcFuFuVZR(3,3),cplFvFvVZL(9,9),cplFvFvVZR(9,9),cplcgWmgWmVZ,cplcgWpCgWpCVZ,          & 
& cplhhVZVZ(3),cplHpmcHpmVZ(2,2),cplHpmcVWmVZ(2),cplSdcSdVZ(6,6),cplSecSeVZ(6,6),        & 
& cplSucSuVZ(6,6),cplSvImSvReVZ(9,9),cplcVWmVWmVZ,cplAhAhVZVZ(3,3),cplhhhhVZVZ(3,3),     & 
& cplHpmcHpmVZVZ(2,2),cplSdcSdVZVZ(6,6),cplSecSeVZVZ(6,6),cplSucSuVZVZ(6,6),             & 
& cplSvImSvImVZVZ(9,9),cplSvReSvReVZVZ(9,9),cplcVWmVWmVZVZ1,cplcVWmVWmVZVZ2,             & 
& cplcVWmVWmVZVZ3,cplAhHpmcVWm(3,2),cplChiChacVWmL(5,2),cplChiChacVWmR(5,2),             & 
& cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),cplFvFecVWmL(9,3),cplFvFecVWmR(9,3),             & 
& cplcgWpCgAcVWm,cplcgAgWmcVWm,cplcgZgWmcVWm,cplcgWpCgZcVWm,cplhhHpmcVWm(3,2),           & 
& cplhhcVWmVWm(3),cplSdcSucVWm(6,6),cplSeSvImcVWm(6,9),cplSeSvRecVWm(6,9),               & 
& cplAhAhcVWmVWm(3,3),cplhhhhcVWmVWm(3,3),cplHpmcHpmcVWmVWm(2,2),cplSdcSdcVWmVWm(6,6),   & 
& cplSecSecVWmVWm(6,6),cplSucSucVWmVWm(6,6),cplSvImSvImcVWmVWm(9,9),cplSvReSvRecVWmVWm(9,9),& 
& cplcVWmcVWmVWmVWm1,cplcVWmcVWmVWmVWm2,cplcVWmcVWmVWmVWm3,cplHpmcHpmVPVZ(2,2),          & 
& cplSdcSdVPVZ(6,6),cplSecSeVPVZ(6,6),cplSucSuVPVZ(6,6),cplcVWmVPVWmVZ1,cplcVWmVPVWmVZ2, & 
& cplcVWmVPVWmVZ3

Complex(dp) :: cplcUFeFeAhL(3,3,3),cplcUFeFeAhR(3,3,3),cplcUFeChaSvImL(3,2,9),cplcUFeChaSvImR(3,2,9),& 
...
& cplcUFeFvVWmL(3,9),cplcUFeFvVWmR(3,9),cplcUFdFdAhL(3,3,3),cplcUFdFdAhR(3,3,3),         & 
...
Call SetMatchingConditions(g1SM,g2SM,g3SM,YuSM,YdSM,YeSM,vSM,vd,vu,vS,g1,             & 
& g2,g3,Yd,Ye,lam,kap,lamN,Yu,Yv,MUX,Td,Te,Tlam,Tk,TLN,Tu,Tv,BMUX,mq2,ml2,               & 
& mHd2,mHu2,md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,.True.)
...
Call ParametersToG362(g1,g2,g3,Yd,Ye,lam,kap,lamN,Yu,Yv,MUX,Td,Te,Tlam,               & 
& Tk,TLN,Tu,Tv,BMUX,mq2,ml2,mHd2,mHu2,md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,gMZ)
...
& md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,mGut,kont,WriteComment,niter)
...
Real(dp) :: g_SM(62) 
Real(dp) :: delta0,deltaG0, gA(362), gB(362)
Real(dp) :: gC(365),  gD(365) 
Real(dp),Intent(out) :: mGUT
Complex(dp) :: Tad1Loop(6), lambda_SM, lambda_MZ 
Real(dp) :: comp(3), tanbQ, vev2 
Complex(dp) :: cplAhSvImUSvRe(3,9,9),cplAhUSvReSvRe(3,9,9),cplcFeChaUSvReL(3,2,9),cplcFeChaUSvReR(3,2,9),& 
...
Real(dp) ::mass_new(52),mass_old(52),diff_m(52)
...
n_tot = n_tot + 6 
mass_old(n_tot:n_tot+8) = MSvIm
n_tot = n_tot + 9 
mass_old(n_tot:n_tot+8) = MSvRe
n_tot = n_tot + 9 
...
& Yd,Ye,lam,kap,lamN,Yu,Yv,MUX,Td,Te,Tlam,Tk,TLN,Tu,Tv,BMUX,mq2,ml2,mHd2,mHu2,           & 
& md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,delta0,gB,kont)
...
mGUT = 1._dp 
Call GToParameters362(gB,g1,g2,g3,Yd,Ye,lam,kap,lamN,Yu,Yv,MUX,Td,Te,Tlam,            & 
...
n_tot = n_tot + 6 
mass_new(n_tot:n_tot+8) = MSvIm
n_tot = n_tot + 9 
mass_new(n_tot:n_tot+8) = MSvRe
n_tot = n_tot + 9 
...
Real(dp):: gA(362), gB(362), Scale_Save 
...
End Module Boundaries_NInvSeesaw 
