...
Real(dp),Intent(in)  :: MAh(3),MAh2(3),MCha(2),MCha2(2),MChi(5),MChi2(5),MFe(3),MFe2(3),MFv(9),               & 
& MFv2(9),Mhh(3),Mhh2(3),MHpm(2),MHpm2(2),MSe(6),MSe2(6),MSvIm(9),MSvIm2(9),             & 
& MSvRe(9),MSvRe2(9)

Complex(dp),Intent(in)  :: cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),cplcFeChaSvImL(3,2,9),cplcFeChaSvImR(3,2,9),    & 
...
Real(dp),Intent(in)  :: MAh(3),MAh2(3),MCha(2),MCha2(2),MChi(5),MChi2(5),MFe(3),MFe2(3),MFv(9),               & 
& MFv2(9),Mhh(3),Mhh2(3),MHpm(2),MHpm2(2),MSe(6),MSe2(6),MSvIm(9),MSvIm2(9),             & 
& MSvRe(9),MSvRe2(9),MVWm,MVWm2,MVZ,MVZ2
...
& cplcFeFvVWmL(3,9),cplcFeFvVWmR(3,9),cplHpmcHpmVP(2,2),cplSecSeVP(6,6),cplcVWmVPVWm
...
& cplcVWmVWmVZVZ1,cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,cplFvFecVWmL(9,3),cplFvFecVWmR(9,3),   & 
& cplFvFvVZL(9,9),cplFvFvVZR(9,9),cplhhcVWmVWm(3),cplhhhhcVWmVWm(3,3),cplhhhhVZVZ(3,3),  & 
...
& cplSecSeVZ(6,6),cplSecSeVZVZ(6,6),cplSeSvImcVWm(6,9),cplSeSvRecVWm(6,9),               & 
& cplSucSucVWmVWm(6,6),cplSucSuVZ(6,6),cplSucSuVZVZ(6,6),cplSvImSvImcVWmVWm(9,9),        & 
& cplSvImSvImVZVZ(9,9),cplSvImSvReVZ(9,9),cplSvReSvRecVWmVWm(9,9),cplSvReSvReVZVZ(9,9)
...
End Function C1C2 
End Module LowEnergy_NInvSeesaw 
