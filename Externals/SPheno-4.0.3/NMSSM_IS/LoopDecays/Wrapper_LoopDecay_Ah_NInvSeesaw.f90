...
Module Wrapper_OneLoopDecay_Ah_NInvSeesaw
Use Model_Data_NInvSeesaw 
Use Kinematics 
Use OneLoopDecay_Ah_NInvSeesaw 
Use Control 
Use Settings 
...
& cplAhHpmcVWmVP1(3,2),cplAhHpmcVWmVZ1(3,2),cplAhHpmSucSdaa(3,2,6,6),cplAhHpmSvImcSe1(3,2,9,6),& 
& cplAhHpmSvRecSe1(3,2,9,6),cplAhSdcHpmcSuaa(3,6,2,6),cplAhSdcSd(3,6,6),cplAhSecSe(3,6,6),& 
& cplAhSeSvImcHpm1(3,6,9,2),cplAhSeSvRecHpm1(3,6,9,2),cplAhSucSu(3,6,6),cplAhSvImSvIm(3,9,9),& 
& cplAhSvImSvRe(3,9,9),cplAhSvReSvRe(3,9,9),cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),   & 
...
& cplcFdFuVWmR(3,3),cplcFdGluSdL(3,6),cplcFdGluSdR(3,6),cplcFeChaSvImL(3,2,9),           & 
...
& cplcHpmVWmVZ(2),cplcVWmVPVWm,cplcVWmVWmVZ,cplFvChacSeL(9,2,6),cplFvChacSeR(9,2,6),     & 
& cplFvFecHpmL(9,3,2),cplFvFecHpmR(9,3,2),cplFvFecVWmL(9,3),cplFvFecVWmR(9,3),           & 
& cplFvFvAhL(9,9,3),cplFvFvAhR(9,9,3),cplFvFvhhL(9,9,3),cplFvFvhhR(9,9,3),               & 
& cplFvFvVZL(9,9),cplFvFvVZR(9,9),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),cplGluFucSuL(3,6), & 
...
& cplhhhhSucSuaa(3,3,6,6),cplhhhhSvImSvIm1(3,3,9,9),cplhhhhSvImSvRe1(3,3,9,9),           & 
& cplhhhhSvReSvRe1(3,3,9,9),cplhhhhVZVZ1(3,3),cplhhHpmcHpm(3,2,2),cplhhHpmcVWm(3,2),     & 
...
& cplSvImSvImVZVZ1(9,9),cplSvImSvReSvReSvRe1(9,9,9,9),cplSvImSvReVZ(9,9),cplSvRecSeVWm(9,6),& 
...
& ctcplAhSucSu(3,6,6),ctcplAhSvImSvIm(3,9,9),ctcplAhSvImSvRe(3,9,9),ctcplAhSvReSvRe(3,9,9),& 
...
& ctcplChiChiAhL(5,5,3),ctcplChiChiAhR(5,5,3),ctcplFvFvAhL(9,9,3),ctcplFvFvAhR(9,9,3),   & 
...
& ZcplAhSecSe(3,6,6),ZcplAhSucSu(3,6,6),ZcplAhSvImSvIm(3,9,9),ZcplAhSvImSvRe(3,9,9),     & 
& ZcplAhSvReSvRe(3,9,9),ZcplcChaChaAhL(2,2,3),ZcplcChaChaAhR(2,2,3),ZcplcFdFdAhL(3,3,3), & 
& ZcplcFdFdAhR(3,3,3),ZcplcFeFeAhL(3,3,3),ZcplcFeFeAhR(3,3,3),ZcplcFuFuAhL(3,3,3),       & 
& ZcplcFuFuAhR(3,3,3),ZcplChiChiAhL(5,5,3),ZcplChiChiAhR(5,5,3),ZcplFvFvAhL(9,9,3),      & 
& ZcplFvFvAhR(9,9,3)
...
Real(dp) :: MRPAhToFvFv(3,9,9),MRGAhToFvFv(3,9,9), MRPZAhToFvFv(3,9,9),MRGZAhToFvFv(3,9,9) 
Real(dp) :: MVPAhToFvFv(3,9,9) 
Real(dp) :: RMsqTreeAhToFvFv(3,9,9),RMsqWaveAhToFvFv(3,9,9),RMsqVertexAhToFvFv(3,9,9) 
Complex(dp) :: AmpTreeAhToFvFv(2,3,9,9),AmpWaveAhToFvFv(2,3,9,9)=(0._dp,0._dp),AmpVertexAhToFvFv(2,3,9,9)& 
 & ,AmpVertexIRosAhToFvFv(2,3,9,9),AmpVertexIRdrAhToFvFv(2,3,9,9), AmpSumAhToFvFv(2,3,9,9), AmpSum2AhToFvFv(2,3,9,9) 
Complex(dp) :: AmpTreeZAhToFvFv(2,3,9,9),AmpWaveZAhToFvFv(2,3,9,9),AmpVertexZAhToFvFv(2,3,9,9) 
Real(dp) :: AmpSqAhToFvFv(3,9,9),  AmpSqTreeAhToFvFv(3,9,9) 
...
Real(dp) :: MRPAhToSvImSvIm(3,9,9),MRGAhToSvImSvIm(3,9,9), MRPZAhToSvImSvIm(3,9,9),MRGZAhToSvImSvIm(3,9,9) 
Real(dp) :: MVPAhToSvImSvIm(3,9,9) 
Real(dp) :: RMsqTreeAhToSvImSvIm(3,9,9),RMsqWaveAhToSvImSvIm(3,9,9),RMsqVertexAhToSvImSvIm(3,9,9) 
Complex(dp) :: AmpTreeAhToSvImSvIm(3,9,9),AmpWaveAhToSvImSvIm(3,9,9)=(0._dp,0._dp),AmpVertexAhToSvImSvIm(3,9,9)& 
 & ,AmpVertexIRosAhToSvImSvIm(3,9,9),AmpVertexIRdrAhToSvImSvIm(3,9,9), AmpSumAhToSvImSvIm(3,9,9), AmpSum2AhToSvImSvIm(3,9,9) 
Complex(dp) :: AmpTreeZAhToSvImSvIm(3,9,9),AmpWaveZAhToSvImSvIm(3,9,9),AmpVertexZAhToSvImSvIm(3,9,9) 
Real(dp) :: AmpSqAhToSvImSvIm(3,9,9),  AmpSqTreeAhToSvImSvIm(3,9,9) 
Real(dp) :: MRPAhToSvReSvIm(3,9,9),MRGAhToSvReSvIm(3,9,9), MRPZAhToSvReSvIm(3,9,9),MRGZAhToSvReSvIm(3,9,9) 
Real(dp) :: MVPAhToSvReSvIm(3,9,9) 
Real(dp) :: RMsqTreeAhToSvReSvIm(3,9,9),RMsqWaveAhToSvReSvIm(3,9,9),RMsqVertexAhToSvReSvIm(3,9,9) 
Complex(dp) :: AmpTreeAhToSvReSvIm(3,9,9),AmpWaveAhToSvReSvIm(3,9,9)=(0._dp,0._dp),AmpVertexAhToSvReSvIm(3,9,9)& 
 & ,AmpVertexIRosAhToSvReSvIm(3,9,9),AmpVertexIRdrAhToSvReSvIm(3,9,9), AmpSumAhToSvReSvIm(3,9,9), AmpSum2AhToSvReSvIm(3,9,9) 
Complex(dp) :: AmpTreeZAhToSvReSvIm(3,9,9),AmpWaveZAhToSvReSvIm(3,9,9),AmpVertexZAhToSvReSvIm(3,9,9) 
Real(dp) :: AmpSqAhToSvReSvIm(3,9,9),  AmpSqTreeAhToSvReSvIm(3,9,9) 
Real(dp) :: MRPAhToSvReSvRe(3,9,9),MRGAhToSvReSvRe(3,9,9), MRPZAhToSvReSvRe(3,9,9),MRGZAhToSvReSvRe(3,9,9) 
Real(dp) :: MVPAhToSvReSvRe(3,9,9) 
Real(dp) :: RMsqTreeAhToSvReSvRe(3,9,9),RMsqWaveAhToSvReSvRe(3,9,9),RMsqVertexAhToSvReSvRe(3,9,9) 
Complex(dp) :: AmpTreeAhToSvReSvRe(3,9,9),AmpWaveAhToSvReSvRe(3,9,9)=(0._dp,0._dp),AmpVertexAhToSvReSvRe(3,9,9)& 
 & ,AmpVertexIRosAhToSvReSvRe(3,9,9),AmpVertexIRdrAhToSvReSvRe(3,9,9), AmpSumAhToSvReSvRe(3,9,9), AmpSum2AhToSvReSvRe(3,9,9) 
Complex(dp) :: AmpTreeZAhToSvReSvRe(3,9,9),AmpWaveZAhToSvReSvRe(3,9,9),AmpVertexZAhToSvReSvRe(3,9,9) 
Real(dp) :: AmpSqAhToSvReSvRe(3,9,9),  AmpSqTreeAhToSvReSvRe(3,9,9) 
...
Call Amplitude_Tree_NInvSeesaw_AhToAhAh(cplAhAhAh,MAh,MAh2,AmpTreeAhToAhAh)

  Else 
Call Amplitude_Tree_NInvSeesaw_AhToAhAh(ZcplAhAhAh,MAh,MAh2,AmpTreeAhToAhAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_AhToAhAh(MLambda,em,gs,cplAhAhAh,MAhOS,MRPAhToAhAh,        & 
& MRGAhToAhAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_AhToAhAh(MLambda,em,gs,ZcplAhAhAh,MAhOS,MRPAhToAhAh,       & 
& MRGAhToAhAh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_AhToAhAh(MLambda,em,gs,cplAhAhAh,MAh,MRPAhToAhAh,          & 
& MRGAhToAhAh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_AhToAhAh(MLambda,em,gs,ZcplAhAhAh,MAh,MRPAhToAhAh,         & 
& MRGAhToAhAh)
...
Call Amplitude_WAVE_NInvSeesaw_AhToAhAh(cplAhAhAh,ctcplAhAhAh,MAh,MAh2,               & 
& ZfAh,AmpWaveAhToAhAh)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhToAhAh(MAh,MCha,MChi,MFd,MFe,MFu,MFv,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhToAhAh(MAh,MCha,MChi,MFd,MFe,MFu,               & 
...
& cplAhAhSucSuaa,cplAhAhSvImSvIm1,cplAhAhSvImSvRe1,cplAhAhSvReSvRe1,AmpVertexIRdrAhToAhAh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhToAhAh(MAhOS,MChaOS,MChiOS,MFdOS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_AhTohhAh(cplAhAhhh,MAh,Mhh,MAh2,Mhh2,AmpTreeAhTohhAh)

  Else 
Call Amplitude_Tree_NInvSeesaw_AhTohhAh(ZcplAhAhhh,MAh,Mhh,MAh2,Mhh2,AmpTreeAhTohhAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_AhTohhAh(MLambda,em,gs,cplAhAhhh,MAhOS,MhhOS,              & 
& MRPAhTohhAh,MRGAhTohhAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_AhTohhAh(MLambda,em,gs,ZcplAhAhhh,MAhOS,MhhOS,             & 
& MRPAhTohhAh,MRGAhTohhAh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_AhTohhAh(MLambda,em,gs,cplAhAhhh,MAh,Mhh,MRPAhTohhAh,      & 
& MRGAhTohhAh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_AhTohhAh(MLambda,em,gs,ZcplAhAhhh,MAh,Mhh,MRPAhTohhAh,     & 
& MRGAhTohhAh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_AhTohhAh(cplAhAhhh,ctcplAhAhhh,MAh,MAh2,               & 
& Mhh,Mhh2,ZfAh,Zfhh,AmpWaveAhTohhAh)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhTohhAh(MAh,MCha,MChi,MFd,MFe,MFu,MFv,              & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,             & 
& MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,           & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,cplcgWmgWmAh,    & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhTohhAh(MAh,MCha,MChi,MFd,MFe,MFu,               & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,              & 
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,      & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,cplcgWmgWmAh,    & 
...
& AmpVertexIRdrAhTohhAh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhTohhAh(MAhOS,MChaOS,MChiOS,MFdOS,               & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVWmOS,               & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_AhTocChaCha(cplcChaChaAhL,cplcChaChaAhR,               & 
& MAh,MCha,MAh2,MCha2,AmpTreeAhTocChaCha)

  Else 
Call Amplitude_Tree_NInvSeesaw_AhTocChaCha(ZcplcChaChaAhL,ZcplcChaChaAhR,             & 
& MAh,MCha,MAh2,MCha2,AmpTreeAhTocChaCha)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_AhTocChaCha(MLambda,em,gs,cplcChaChaAhL,cplcChaChaAhR,     & 
& MAhOS,MChaOS,MRPAhTocChaCha,MRGAhTocChaCha)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_AhTocChaCha(MLambda,em,gs,ZcplcChaChaAhL,ZcplcChaChaAhR,   & 
& MAhOS,MChaOS,MRPAhTocChaCha,MRGAhTocChaCha)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_AhTocChaCha(cplcChaChaAhL,cplcChaChaAhR,               & 
& ctcplcChaChaAhL,ctcplcChaChaAhR,MAh,MAh2,MCha,MCha2,ZfAh,ZfLm,ZfLp,AmpWaveAhTocChaCha)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhTocChaCha(MAh,MCha,MChi,MFd,MFe,MFu,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhTocChaCha(MAh,MCha,MChi,MFd,MFe,MFu,            & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhAhAh,      & 
& cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,           & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,     & 
...
& cplcChaFeSvReR,cplcChaFvSeL,cplcChaFvSeR,cplcChacFuSdL,cplcChacFuSdR,AmpVertexIRdrAhTocChaCha)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhTocChaCha(MAhOS,MChaOS,MChiOS,MFdOS,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_AhToChiChi(cplChiChiAhL,cplChiChiAhR,MAh,              & 
& MChi,MAh2,MChi2,AmpTreeAhToChiChi)

  Else 
Call Amplitude_Tree_NInvSeesaw_AhToChiChi(ZcplChiChiAhL,ZcplChiChiAhR,MAh,            & 
& MChi,MAh2,MChi2,AmpTreeAhToChiChi)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_AhToChiChi(MLambda,em,gs,cplChiChiAhL,cplChiChiAhR,        & 
& MAhOS,MChiOS,MRPAhToChiChi,MRGAhToChiChi)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_AhToChiChi(MLambda,em,gs,ZcplChiChiAhL,ZcplChiChiAhR,      & 
& MAhOS,MChiOS,MRPAhToChiChi,MRGAhToChiChi)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_AhToChiChi(cplChiChiAhL,cplChiChiAhR,ctcplChiChiAhL,   & 
& ctcplChiChiAhR,MAh,MAh2,MChi,MChi2,ZfAh,ZfL0,AmpWaveAhToChiChi)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhToChiChi(MAh,MCha,MChi,MFd,MFe,MFu,MFv,            & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,             & 
& MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,           & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,cplAhhhhh,       & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhToChiChi(MAh,MCha,MChi,MFd,MFe,MFu,             & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,              & 
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,      & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,cplAhhhhh,       & 
...
& cplcChaChiVWmL,cplcChaChiVWmR,AmpVertexIRdrAhToChiChi)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhToChiChi(MAhOS,MChaOS,MChiOS,MFdOS,             & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVWmOS,               & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
& MSd2OS,MSe2OS,MSu2OS,MSvIm2OS,MSvRe2OS,MVWm2OS,MVZ2OS,cplAhAhAh,cplAhAhhh,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_AhTocFdFd(cplcFdFdAhL,cplcFdFdAhR,MAh,MFd,             & 
& MAh2,MFd2,AmpTreeAhTocFdFd)

  Else 
Call Amplitude_Tree_NInvSeesaw_AhTocFdFd(ZcplcFdFdAhL,ZcplcFdFdAhR,MAh,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_AhTocFdFd(MLambda,em,gs,cplcFdFdAhL,cplcFdFdAhR,           & 
& MAhOS,MFdOS,MRPAhTocFdFd,MRGAhTocFdFd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_AhTocFdFd(MLambda,em,gs,ZcplcFdFdAhL,ZcplcFdFdAhR,         & 
& MAhOS,MFdOS,MRPAhTocFdFd,MRGAhTocFdFd)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_AhTocFdFd(cplcFdFdAhL,cplcFdFdAhR,ctcplcFdFdAhL,       & 
& ctcplcFdFdAhR,MAh,MAh2,MFd,MFd2,ZfAh,ZfFDL,ZfFDR,AmpWaveAhTocFdFd)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhTocFdFd(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,MHpm2,             & 
& MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,        & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhTocFdFd(MAh,MCha,MChi,MFd,MFu,MGlu,             & 
...
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFdGluSdL,cplcFdGluSdR,AmpVertexIRdrAhTocFdFd)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhTocFdFd(MAhOS,MChaOS,MChiOS,MFdOS,              & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_AhTocFeFe(cplcFeFeAhL,cplcFeFeAhR,MAh,MFe,             & 
& MAh2,MFe2,AmpTreeAhTocFeFe)

  Else 
Call Amplitude_Tree_NInvSeesaw_AhTocFeFe(ZcplcFeFeAhL,ZcplcFeFeAhR,MAh,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_AhTocFeFe(MLambda,em,gs,cplcFeFeAhL,cplcFeFeAhR,           & 
& MAhOS,MFeOS,MRPAhTocFeFe,MRGAhTocFeFe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_AhTocFeFe(MLambda,em,gs,ZcplcFeFeAhL,ZcplcFeFeAhR,         & 
& MAhOS,MFeOS,MRPAhTocFeFe,MRGAhTocFeFe)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_AhTocFeFe(cplcFeFeAhL,cplcFeFeAhR,ctcplcFeFeAhL,       & 
& ctcplcFeFeAhR,MAh,MAh2,MFe,MFe2,ZfAh,ZfFEL,ZfFER,AmpWaveAhTocFeFe)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhTocFeFe(MAh,MCha,MChi,MFe,MFv,Mhh,MHpm,            & 
& MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,MSe2,               & 
& MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,         & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhTocFeFe(MAh,MCha,MChi,MFe,MFv,Mhh,              & 
...
& cplcFeFeVZR,cplcFeFvHpmL,cplcFeFvHpmR,cplcFeFvVWmL,cplcFeFvVWmR,AmpVertexIRdrAhTocFeFe)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhTocFeFe(MAhOS,MChaOS,MChiOS,MFeOS,              & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_AhTocFuFu(cplcFuFuAhL,cplcFuFuAhR,MAh,MFu,             & 
& MAh2,MFu2,AmpTreeAhTocFuFu)

  Else 
Call Amplitude_Tree_NInvSeesaw_AhTocFuFu(ZcplcFuFuAhL,ZcplcFuFuAhR,MAh,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_AhTocFuFu(MLambda,em,gs,cplcFuFuAhL,cplcFuFuAhR,           & 
& MAhOS,MFuOS,MRPAhTocFuFu,MRGAhTocFuFu)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_AhTocFuFu(MLambda,em,gs,ZcplcFuFuAhL,ZcplcFuFuAhR,         & 
& MAhOS,MFuOS,MRPAhTocFuFu,MRGAhTocFuFu)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_AhTocFuFu(cplcFuFuAhL,cplcFuFuAhR,ctcplcFuFuAhL,       & 
& ctcplcFuFuAhR,MAh,MAh2,MFu,MFu2,ZfAh,ZfFUL,ZfFUR,AmpWaveAhTocFuFu)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhTocFuFu(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,MHpm2,             & 
& MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,        & 
& cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,             & 
& cplAhhhhh,cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSucSu,cplAhcHpmVWm,      & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhTocFuFu(MAh,MCha,MChi,MFd,MFu,MGlu,             & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,  & 
& cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,             & 
& cplAhhhhh,cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSucSu,cplAhcHpmVWm,      & 
...
& cplcFuGluSuL,cplcFuGluSuR,cplcChacFuSdL,cplcChacFuSdR,AmpVertexIRdrAhTocFuFu)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhTocFuFu(MAhOS,MChaOS,MChiOS,MFdOS,              & 
& MFuOS,MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,             & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
& MVZ2OS,cplAhAhAh,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,      & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_AhToFvFv(cplFvFvAhL,cplFvFvAhR,MAh,MFv,MAh2,           & 
& MFv2,AmpTreeAhToFvFv)

  Else 
Call Amplitude_Tree_NInvSeesaw_AhToFvFv(ZcplFvFvAhL,ZcplFvFvAhR,MAh,MFv,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_AhToFvFv(MLambda,em,gs,cplFvFvAhL,cplFvFvAhR,              & 
& MAhOS,MFvOS,MRPAhToFvFv,MRGAhToFvFv)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_AhToFvFv(MLambda,em,gs,ZcplFvFvAhL,ZcplFvFvAhR,            & 
& MAhOS,MFvOS,MRPAhToFvFv,MRGAhToFvFv)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_AhToFvFv(cplFvFvAhL,cplFvFvAhR,ctcplFvFvAhL,           & 
& ctcplFvFvAhR,MAh,MAh2,MFv,MFv2,ZfAh,ZfFV,AmpWaveAhToFvFv)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhToFvFv(MAh,MCha,MChi,MFe,MFv,Mhh,MHpm,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhToFvFv(MAh,MCha,MChi,MFe,MFv,Mhh,               & 
...
& cplcChaFvSeR,cplcFeFvVWmL,cplcFeFvVWmR,AmpVertexIRdrAhToFvFv)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhToFvFv(MAhOS,MChaOS,MChiOS,MFeOS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_AhTohhhh(cplAhhhhh,MAh,Mhh,MAh2,Mhh2,AmpTreeAhTohhhh)

  Else 
Call Amplitude_Tree_NInvSeesaw_AhTohhhh(ZcplAhhhhh,MAh,Mhh,MAh2,Mhh2,AmpTreeAhTohhhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_AhTohhhh(MLambda,em,gs,cplAhhhhh,MAhOS,MhhOS,              & 
& MRPAhTohhhh,MRGAhTohhhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_AhTohhhh(MLambda,em,gs,ZcplAhhhhh,MAhOS,MhhOS,             & 
& MRPAhTohhhh,MRGAhTohhhh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_AhTohhhh(MLambda,em,gs,cplAhhhhh,MAh,Mhh,MRPAhTohhhh,      & 
& MRGAhTohhhh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_AhTohhhh(MLambda,em,gs,ZcplAhhhhh,MAh,Mhh,MRPAhTohhhh,     & 
& MRGAhTohhhh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_AhTohhhh(cplAhhhhh,ctcplAhhhhh,MAh,MAh2,               & 
& Mhh,Mhh2,ZfAh,Zfhh,AmpWaveAhTohhhh)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhTohhhh(MAh,MCha,MChi,MFd,MFe,MFu,MFv,              & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,             & 
& MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,           & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,cplcgWmgWmAh,    & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhTohhhh(MAh,MCha,MChi,MFd,MFe,MFu,               & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,              & 
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,      & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,cplcgWmgWmAh,    & 
...
& cplhhhhSvImSvRe1,cplhhhhSvReSvRe1,AmpVertexIRdrAhTohhhh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhTohhhh(MAhOS,MChaOS,MChiOS,MFdOS,               & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVWmOS,               & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
& MSd2OS,MSe2OS,MSu2OS,MSvIm2OS,MSvRe2OS,MVWm2OS,MVZ2OS,cplAhAhAh,cplAhAhhh,             & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_AhTohhVZ(cplAhhhVZ,MAh,Mhh,MVZ,MAh2,Mhh2,              & 
& MVZ2,AmpTreeAhTohhVZ)

  Else 
Call Amplitude_Tree_NInvSeesaw_AhTohhVZ(ZcplAhhhVZ,MAh,Mhh,MVZ,MAh2,Mhh2,             & 
& MVZ2,AmpTreeAhTohhVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_AhTohhVZ(MLambda,em,gs,cplAhhhVZ,MAhOS,MhhOS,              & 
& MVZOS,MRPAhTohhVZ,MRGAhTohhVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_AhTohhVZ(MLambda,em,gs,ZcplAhhhVZ,MAhOS,MhhOS,             & 
& MVZOS,MRPAhTohhVZ,MRGAhTohhVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_AhTohhVZ(MLambda,em,gs,cplAhhhVZ,MAh,Mhh,MVZ,              & 
& MRPAhTohhVZ,MRGAhTohhVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_AhTohhVZ(MLambda,em,gs,ZcplAhhhVZ,MAh,Mhh,MVZ,             & 
& MRPAhTohhVZ,MRGAhTohhVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_AhTohhVZ(cplAhhhVZ,ctcplAhhhVZ,MAh,MAh2,               & 
& Mhh,Mhh2,MVZ,MVZ2,ZfAh,Zfhh,ZfVZ,AmpWaveAhTohhVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhTohhVZ(MAh,MCha,MChi,MFd,MFe,MFu,MFv,              & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,             & 
& MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,           & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,cplcgWmgWmAh,    & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhTohhVZ(MAh,MCha,MChi,MFd,MFe,MFu,               & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,              & 
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,      & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,cplcgWmgWmAh,    & 
...
& AmpVertexIRdrAhTohhVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhTohhVZ(MAhOS,MChaOS,MChiOS,MFdOS,               & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVWmOS,               & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
& MSd2OS,MSe2OS,MSu2OS,MSvIm2OS,MSvRe2OS,MVWm2OS,MVZ2OS,cplAhAhAh,cplAhAhhh,             & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_AhTocHpmHpm(cplAhHpmcHpm,MAh,MHpm,MAh2,MHpm2,          & 
& AmpTreeAhTocHpmHpm)

  Else 
Call Amplitude_Tree_NInvSeesaw_AhTocHpmHpm(ZcplAhHpmcHpm,MAh,MHpm,MAh2,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_AhTocHpmHpm(MLambda,em,gs,cplAhHpmcHpm,MAhOS,              & 
& MHpmOS,MRPAhTocHpmHpm,MRGAhTocHpmHpm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_AhTocHpmHpm(MLambda,em,gs,ZcplAhHpmcHpm,MAhOS,             & 
& MHpmOS,MRPAhTocHpmHpm,MRGAhTocHpmHpm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_AhTocHpmHpm(MLambda,em,gs,cplAhHpmcHpm,MAh,MHpm,           & 
& MRPAhTocHpmHpm,MRGAhTocHpmHpm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_AhTocHpmHpm(MLambda,em,gs,ZcplAhHpmcHpm,MAh,               & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_AhTocHpmHpm(cplAhHpmcHpm,ctcplAhHpmcHpm,               & 
& MAh,MAh2,MHpm,MHpm2,ZfAh,ZfHpm,AmpWaveAhTocHpmHpm)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhTocHpmHpm(MAh,MCha,MChi,MFd,MFe,MFu,               & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhAhAh,      & 
& cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,           & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,     & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhTocHpmHpm(MAh,MCha,MChi,MFd,MFe,MFu,            & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhAhAh,      & 
& cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,           & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,     & 
...
& cplHpmSvImSvImcHpm1,cplHpmSvImSvRecHpm1,cplHpmSvReSvRecHpm1,AmpVertexIRdrAhTocHpmHpm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhTocHpmHpm(MAhOS,MChaOS,MChiOS,MFdOS,            & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVP,MVWmOS,           & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
& MSd2OS,MSe2OS,MSu2OS,MSvIm2OS,MSvRe2OS,MVP2,MVWm2OS,MVZ2OS,cplAhAhAh,cplAhAhhh,        & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_AhToHpmcVWm(cplAhHpmcVWm,MAh,MHpm,MVWm,MAh2,           & 
& MHpm2,MVWm2,AmpTreeAhToHpmcVWm)

  Else 
Call Amplitude_Tree_NInvSeesaw_AhToHpmcVWm(ZcplAhHpmcVWm,MAh,MHpm,MVWm,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_AhToHpmcVWm(MLambda,em,gs,cplAhHpmcVWm,MAhOS,              & 
& MHpmOS,MVWmOS,MRPAhToHpmcVWm,MRGAhToHpmcVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_AhToHpmcVWm(MLambda,em,gs,ZcplAhHpmcVWm,MAhOS,             & 
& MHpmOS,MVWmOS,MRPAhToHpmcVWm,MRGAhToHpmcVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_AhToHpmcVWm(MLambda,em,gs,cplAhHpmcVWm,MAh,MHpm,           & 
& MVWm,MRPAhToHpmcVWm,MRGAhToHpmcVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_AhToHpmcVWm(MLambda,em,gs,ZcplAhHpmcVWm,MAh,               & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_AhToHpmcVWm(cplAhHpmcVWm,ctcplAhHpmcVWm,               & 
& MAh,MAh2,MHpm,MHpm2,MVWm,MVWm2,ZfAh,ZfHpm,ZfVWm,AmpWaveAhToHpmcVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhToHpmcVWm(MAh,MCha,MChi,MFd,MFe,MFu,               & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhAhAh,      & 
& cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,           & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,     & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhToHpmcVWm(MAh,MCha,MChi,MFd,MFe,MFu,            & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhAhAh,      & 
& cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,           & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,     & 
...
& cplAhHpmcVWmVP1,cplAhHpmcVWmVZ1,cplhhHpmcVWmVZ1,cplHpmcHpmcVWmVWm1,AmpVertexIRdrAhToHpmcVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhToHpmcVWm(MAhOS,MChaOS,MChiOS,MFdOS,            & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVP,MVWmOS,           & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
& MSd2OS,MSe2OS,MSu2OS,MSvIm2OS,MSvRe2OS,MVP2,MVWm2OS,MVZ2OS,cplAhAhAh,cplAhAhhh,        & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_AhTocSdSd(cplAhSdcSd,MAh,MSd,MAh2,MSd2,AmpTreeAhTocSdSd)

  Else 
Call Amplitude_Tree_NInvSeesaw_AhTocSdSd(ZcplAhSdcSd,MAh,MSd,MAh2,MSd2,               & 
& AmpTreeAhTocSdSd)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_AhTocSdSd(MLambda,em,gs,cplAhSdcSd,MAhOS,MSdOS,            & 
& MRPAhTocSdSd,MRGAhTocSdSd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_AhTocSdSd(MLambda,em,gs,ZcplAhSdcSd,MAhOS,MSdOS,           & 
& MRPAhTocSdSd,MRGAhTocSdSd)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_AhTocSdSd(MLambda,em,gs,cplAhSdcSd,MAh,MSd,MRPAhTocSdSd,   & 
& MRGAhTocSdSd)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_AhTocSdSd(MLambda,em,gs,ZcplAhSdcSd,MAh,MSd,               & 
& MRPAhTocSdSd,MRGAhTocSdSd)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_AhTocSdSd(cplAhSdcSd,ctcplAhSdcSd,MAh,MAh2,            & 
& MSd,MSd2,ZfAh,ZfSd,AmpWaveAhTocSdSd)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhTocSdSd(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhTocSdSd(MAh,MCha,MChi,MFd,MFu,MGlu,             & 
...
& AmpVertexIRdrAhTocSdSd)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhTocSdSd(MAhOS,MChaOS,MChiOS,MFdOS,              & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_AhTocSeSe(cplAhSecSe,MAh,MSe,MAh2,MSe2,AmpTreeAhTocSeSe)

  Else 
Call Amplitude_Tree_NInvSeesaw_AhTocSeSe(ZcplAhSecSe,MAh,MSe,MAh2,MSe2,               & 
& AmpTreeAhTocSeSe)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_AhTocSeSe(MLambda,em,gs,cplAhSecSe,MAhOS,MSeOS,            & 
& MRPAhTocSeSe,MRGAhTocSeSe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_AhTocSeSe(MLambda,em,gs,ZcplAhSecSe,MAhOS,MSeOS,           & 
& MRPAhTocSeSe,MRGAhTocSeSe)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_AhTocSeSe(MLambda,em,gs,cplAhSecSe,MAh,MSe,MRPAhTocSeSe,   & 
& MRGAhTocSeSe)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_AhTocSeSe(MLambda,em,gs,ZcplAhSecSe,MAh,MSe,               & 
& MRPAhTocSeSe,MRGAhTocSeSe)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_AhTocSeSe(cplAhSecSe,ctcplAhSecSe,MAh,MAh2,            & 
& MSe,MSe2,ZfAh,ZfSe,AmpWaveAhTocSeSe)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhTocSeSe(MAh,MCha,MChi,MFe,MFv,Mhh,MHpm,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhTocSeSe(MAh,MCha,MChi,MFe,MFv,Mhh,              & 
...
& cplSeSucSecSuaa,cplSeSvImSvImcSe1,cplSeSvImSvRecSe1,cplSeSvReSvRecSe1,AmpVertexIRdrAhTocSeSe)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhTocSeSe(MAhOS,MChaOS,MChiOS,MFeOS,              & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_AhTocSuSu(cplAhSucSu,MAh,MSu,MAh2,MSu2,AmpTreeAhTocSuSu)

  Else 
Call Amplitude_Tree_NInvSeesaw_AhTocSuSu(ZcplAhSucSu,MAh,MSu,MAh2,MSu2,               & 
& AmpTreeAhTocSuSu)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_AhTocSuSu(MLambda,em,gs,cplAhSucSu,MAhOS,MSuOS,            & 
& MRPAhTocSuSu,MRGAhTocSuSu)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_AhTocSuSu(MLambda,em,gs,ZcplAhSucSu,MAhOS,MSuOS,           & 
& MRPAhTocSuSu,MRGAhTocSuSu)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_AhTocSuSu(MLambda,em,gs,cplAhSucSu,MAh,MSu,MRPAhTocSuSu,   & 
& MRGAhTocSuSu)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_AhTocSuSu(MLambda,em,gs,ZcplAhSucSu,MAh,MSu,               & 
& MRPAhTocSuSu,MRGAhTocSuSu)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_AhTocSuSu(cplAhSucSu,ctcplAhSucSu,MAh,MAh2,            & 
& MSu,MSu2,ZfAh,ZfSu,AmpWaveAhTocSuSu)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhTocSuSu(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
& MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,              & 
& MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhAh,          & 
& cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,           & 
& cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhhhhh,cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,     & 
...
& cplSucSuVP,cplSucSdVWm,cplSucSuVZ,cplAhAhSucSuaa,cplAhhhSucSuaa,cplAhHpmSucSdaa,       & 
& cplAhSdcHpmcSuaa,cplhhhhSucSuaa,cplHpmSucHpmcSuaa,cplSdSucSdcSuabba,cplSdSucSdcSuabab, & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhTocSuSu(MAh,MCha,MChi,MFd,MFu,MGlu,             & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplAhAhAh,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,             & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhhhhh,cplAhhhVZ,cplAhHpmcHpm,      & 
...
& cplSuSvImSvRecSuaa,cplSuSvReSvRecSuaa,AmpVertexIRdrAhTocSuSu)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhTocSuSu(MAhOS,MChaOS,MChiOS,MFdOS,              & 
& MFuOS,MGluOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVG,MVP,MVWmOS,            & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,              & 
& MSe2OS,MSu2OS,MSvIm2OS,MSvRe2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,cplAhAhAh,cplAhAhhh,          & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_AhToSvImSvIm(cplAhSvImSvIm,MAh,MSvIm,MAh2,             & 
& MSvIm2,AmpTreeAhToSvImSvIm)

  Else 
Call Amplitude_Tree_NInvSeesaw_AhToSvImSvIm(ZcplAhSvImSvIm,MAh,MSvIm,MAh2,            & 
& MSvIm2,AmpTreeAhToSvImSvIm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_AhToSvImSvIm(MLambda,em,gs,cplAhSvImSvIm,MAhOS,            & 
& MSvImOS,MRPAhToSvImSvIm,MRGAhToSvImSvIm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_AhToSvImSvIm(MLambda,em,gs,ZcplAhSvImSvIm,MAhOS,           & 
& MSvImOS,MRPAhToSvImSvIm,MRGAhToSvImSvIm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_AhToSvImSvIm(MLambda,em,gs,cplAhSvImSvIm,MAh,              & 
& MSvIm,MRPAhToSvImSvIm,MRGAhToSvImSvIm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_AhToSvImSvIm(MLambda,em,gs,ZcplAhSvImSvIm,MAh,             & 
& MSvIm,MRPAhToSvImSvIm,MRGAhToSvImSvIm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_AhToSvImSvIm(cplAhSvImSvIm,ctcplAhSvImSvIm,            & 
& MAh,MAh2,MSvIm,MSvIm2,ZfAh,ZfSvIm,AmpWaveAhToSvImSvIm)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhToSvImSvIm(MAh,MCha,MChi,MFe,MFv,Mhh,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhToSvImSvIm(MAh,MCha,MChi,MFe,MFv,               & 
...
& cplSvImSvImSvReSvRe1,AmpVertexIRdrAhToSvImSvIm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhToSvImSvIm(MAhOS,MChaOS,MChiOS,MFeOS,           & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_AhToSvReSvIm(cplAhSvImSvRe,MAh,MSvIm,MSvRe,            & 
& MAh2,MSvIm2,MSvRe2,AmpTreeAhToSvReSvIm)

  Else 
Call Amplitude_Tree_NInvSeesaw_AhToSvReSvIm(ZcplAhSvImSvRe,MAh,MSvIm,MSvRe,           & 
& MAh2,MSvIm2,MSvRe2,AmpTreeAhToSvReSvIm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_AhToSvReSvIm(MLambda,em,gs,cplAhSvImSvRe,MAhOS,            & 
& MSvImOS,MSvReOS,MRPAhToSvReSvIm,MRGAhToSvReSvIm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_AhToSvReSvIm(MLambda,em,gs,ZcplAhSvImSvRe,MAhOS,           & 
& MSvImOS,MSvReOS,MRPAhToSvReSvIm,MRGAhToSvReSvIm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_AhToSvReSvIm(MLambda,em,gs,cplAhSvImSvRe,MAh,              & 
& MSvIm,MSvRe,MRPAhToSvReSvIm,MRGAhToSvReSvIm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_AhToSvReSvIm(MLambda,em,gs,ZcplAhSvImSvRe,MAh,             & 
& MSvIm,MSvRe,MRPAhToSvReSvIm,MRGAhToSvReSvIm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_AhToSvReSvIm(cplAhSvImSvRe,ctcplAhSvImSvRe,            & 
& MAh,MAh2,MSvIm,MSvIm2,MSvRe,MSvRe2,ZfAh,ZfSvIm,ZfSvRe,AmpWaveAhToSvReSvIm)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhToSvReSvIm(MAh,MCha,MChi,MFe,MFv,Mhh,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhToSvReSvIm(MAh,MCha,MChi,MFe,MFv,               & 
...
& cplSvImSvImSvReSvRe1,cplSvImSvReSvReSvRe1,AmpVertexIRdrAhToSvReSvIm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhToSvReSvIm(MAhOS,MChaOS,MChiOS,MFeOS,           & 
...
& cplSvImSvReSvReSvRe1,AmpVertexIRosAhToSvReSvIm)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_AhToSvReSvRe(cplAhSvReSvRe,MAh,MSvRe,MAh2,             & 
& MSvRe2,AmpTreeAhToSvReSvRe)

  Else 
Call Amplitude_Tree_NInvSeesaw_AhToSvReSvRe(ZcplAhSvReSvRe,MAh,MSvRe,MAh2,            & 
& MSvRe2,AmpTreeAhToSvReSvRe)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_AhToSvReSvRe(MLambda,em,gs,cplAhSvReSvRe,MAhOS,            & 
& MSvReOS,MRPAhToSvReSvRe,MRGAhToSvReSvRe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_AhToSvReSvRe(MLambda,em,gs,ZcplAhSvReSvRe,MAhOS,           & 
& MSvReOS,MRPAhToSvReSvRe,MRGAhToSvReSvRe)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_AhToSvReSvRe(MLambda,em,gs,cplAhSvReSvRe,MAh,              & 
& MSvRe,MRPAhToSvReSvRe,MRGAhToSvReSvRe)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_AhToSvReSvRe(MLambda,em,gs,ZcplAhSvReSvRe,MAh,             & 
& MSvRe,MRPAhToSvReSvRe,MRGAhToSvReSvRe)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_AhToSvReSvRe(cplAhSvReSvRe,ctcplAhSvReSvRe,            & 
& MAh,MAh2,MSvRe,MSvRe2,ZfAh,ZfSvRe,AmpWaveAhToSvReSvRe)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhToSvReSvRe(MAh,MCha,MChi,MFe,MFv,Mhh,              & 
& MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,           & 
& MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcChaChaAhL,             & 
& cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFeFeAhL,cplcFeFeAhR,cplFvFvAhL,            & 
& cplFvFvAhR,cplAhhhhh,cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSecSe,        & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhToSvReSvRe(MAh,MCha,MChi,MFe,MFv,               & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,             & 
& MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcChaChaAhL,       & 
& cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFeFeAhL,cplcFeFeAhR,cplFvFvAhL,            & 
& cplFvFvAhR,cplAhhhhh,cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSecSe,        & 
...
& cplSvReSvReSvReSvRe1,AmpVertexIRdrAhToSvReSvRe)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_AhToSvReSvRe(MAhOS,MChaOS,MChiOS,MFeOS,           & 
& MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVWmOS,MVZOS,MAh2OS,              & 
& MCha2OS,MChi2OS,MFe2OS,MFv2OS,Mhh2OS,MHpm2OS,MSd2OS,MSe2OS,MSu2OS,MSvIm2OS,            & 
& MSvRe2OS,MVWm2OS,MVZ2OS,cplAhAhAh,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,               & 
& cplChiChiAhL,cplChiChiAhR,cplcFeFeAhL,cplcFeFeAhR,cplFvFvAhL,cplFvFvAhR,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_NInvSeesaw_AhToAhVP(MAhOS,MChaOS,MFdOS,MFeOS,MFuOS,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhToAhVP(MAh,MCha,MFd,MFe,MFu,MHpm,MSd,              & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_NInvSeesaw_AhToAhVZ(MAhOS,MChaOS,MChiOS,MFdOS,MFeOS,            & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhToAhVZ(MAh,MCha,MChi,MFd,MFe,MFu,MFv,              & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,             & 
& MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,           & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,cplcgWmgWmAh,    & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_NInvSeesaw_AhToGluGlu(MAhOS,MFdOS,MFuOS,MGluOS,MSdOS,           & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhToGluGlu(MAh,MFd,MFu,MGlu,MSd,MSu,MAh2,            & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_NInvSeesaw_AhTohhVP(cplAhhhVZ,ctcplAhhhVZ,MAhOS,MAh2OS,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_NInvSeesaw_AhTohhVP(MAhOS,MChaOS,MFdOS,MFeOS,MFuOS,             & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_AhTohhVP(cplAhhhVZ,ctcplAhhhVZ,MAh,MAh2,               & 
& Mhh,Mhh2,MVP,MVP2,MVZ,MVZ2,ZfAh,Zfhh,ZfVP,ZfVZVP,AmpWaveAhTohhVP)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhTohhVP(MAh,MCha,MFd,MFe,MFu,Mhh,MHpm,              & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_NInvSeesaw_AhToVGVG(MAhOS,MFdOS,MFuOS,MSdOS,MSuOS,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhToVGVG(MAh,MFd,MFu,MSd,MSu,MVG,MAh2,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_NInvSeesaw_AhToVPVP(MAhOS,MChaOS,MFdOS,MFeOS,MFuOS,             & 
& MHpmOS,MSdOS,MSeOS,MSuOS,MVP,MVWmOS,MAh2OS,MCha2OS,MFd2OS,MFe2OS,MFu2OS,               & 
& MHpm2OS,MSd2OS,MSe2OS,MSu2OS,MVP2,MVWm2OS,cplcChaChaAhL,cplcChaChaAhR,cplcFdFdAhL,     & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
& cplcgWpCgWpCAh,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSecSe,cplAhSucSu,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhToVPVP(MAh,MCha,MFd,MFe,MFu,MHpm,MSd,              & 
& MSe,MSu,MVP,MVWm,MAh2,MCha2,MFd2,MFe2,MFu2,MHpm2,MSd2,MSe2,MSu2,MVP2,MVWm2,            & 
& cplcChaChaAhL,cplcChaChaAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,           & 
& cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhHpmcHpm,cplAhHpmcVWm,         & 
& cplAhSdcSd,cplAhSecSe,cplAhSucSu,cplAhcHpmVWm,cplcChaChaVPL,cplcChaChaVPR,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_NInvSeesaw_AhToVPVZ(MAhOS,MChaOS,MFdOS,MFeOS,MFuOS,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhToVPVZ(MAh,MCha,MFd,MFe,MFu,MHpm,MSd,              & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_NInvSeesaw_AhToVWmcVWm(MAhOS,MChaOS,MChiOS,MFdOS,               & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVP,MVWmOS,           & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
& MSd2OS,MSe2OS,MSu2OS,MSvIm2OS,MSvRe2OS,MVP2,MVWm2OS,MVZ2OS,cplAhAhAh,cplAhAhhh,        & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhToVWmcVWm(MAh,MCha,MChi,MFd,MFe,MFu,               & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhAhAh,      & 
& cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,           & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,     & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_NInvSeesaw_AhToVZVZ(MAhOS,MChaOS,MChiOS,MFdOS,MFeOS,            & 
& MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVWmOS,MVZOS,               & 
& MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,MSd2OS,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_AhToVZVZ(MAh,MCha,MChi,MFd,MFe,MFu,MFv,              & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,             & 
...
End Module Wrapper_OneLoopDecay_Ah_NInvSeesaw
