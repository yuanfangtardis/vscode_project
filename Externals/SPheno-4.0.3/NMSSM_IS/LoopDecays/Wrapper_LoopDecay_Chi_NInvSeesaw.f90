...
Module Wrapper_OneLoopDecay_Chi_NInvSeesaw
Use Model_Data_NInvSeesaw 
Use Kinematics 
Use OneLoopDecay_Chi_NInvSeesaw 
Use Control 
Use Settings 
...
& cplHpmSvImcSe(2,9,6),cplHpmSvRecSe(2,9,6),cplSdcHpmcSu(6,2,6),cplSdcSdVG(6,6),         & 
& cplSdcSdVP(6,6),cplSdcSdVZ(6,6),cplSdcSucVWm(6,6),cplSecSeVP(6,6),cplSecSeVZ(6,6)

Complex(dp),Intent(in) :: cplSeSvImcHpm(6,9,2),cplSeSvImcVWm(6,9),cplSeSvRecHpm(6,9,2),cplSeSvRecVWm(6,9),       & 
& cplSucSdVWm(6,6),cplSucSuVG(6,6),cplSucSuVP(6,6),cplSucSuVZ(6,6),cplSvImcSeVWm(9,6),   & 
& cplSvImSvReVZ(9,9),cplSvRecSeVWm(9,6),ctcplChiChacHpmL(5,2,2),ctcplChiChacHpmR(5,2,2), & 
...
& ctcplChiFucSuL(5,3,6),ctcplChiFucSuR(5,3,6),ctcplChiFvSvImL(5,9,9),ctcplChiFvSvImR(5,9,9),& 
& ctcplChiFvSvReL(5,9,9),ctcplChiFvSvReR(5,9,9),GcplChiChacHpmL(5,2,2),GcplChiChacHpmR(5,2,2),& 
...
& ZcplChiFvSvImL(5,9,9),ZcplChiFvSvImR(5,9,9),ZcplChiFvSvReL(5,9,9),ZcplChiFvSvReR(5,9,9),& 
...
Real(dp) :: MRPChiToFvSvIm(5,9,9),MRGChiToFvSvIm(5,9,9), MRPZChiToFvSvIm(5,9,9),MRGZChiToFvSvIm(5,9,9) 
Real(dp) :: MVPChiToFvSvIm(5,9,9) 
Real(dp) :: RMsqTreeChiToFvSvIm(5,9,9),RMsqWaveChiToFvSvIm(5,9,9),RMsqVertexChiToFvSvIm(5,9,9) 
Complex(dp) :: AmpTreeChiToFvSvIm(2,5,9,9),AmpWaveChiToFvSvIm(2,5,9,9)=(0._dp,0._dp),AmpVertexChiToFvSvIm(2,5,9,9)& 
 & ,AmpVertexIRosChiToFvSvIm(2,5,9,9),AmpVertexIRdrChiToFvSvIm(2,5,9,9), AmpSumChiToFvSvIm(2,5,9,9), AmpSum2ChiToFvSvIm(2,5,9,9) 
Complex(dp) :: AmpTreeZChiToFvSvIm(2,5,9,9),AmpWaveZChiToFvSvIm(2,5,9,9),AmpVertexZChiToFvSvIm(2,5,9,9) 
Real(dp) :: AmpSqChiToFvSvIm(5,9,9),  AmpSqTreeChiToFvSvIm(5,9,9) 
Real(dp) :: MRPChiToFvSvRe(5,9,9),MRGChiToFvSvRe(5,9,9), MRPZChiToFvSvRe(5,9,9),MRGZChiToFvSvRe(5,9,9) 
Real(dp) :: MVPChiToFvSvRe(5,9,9) 
Real(dp) :: RMsqTreeChiToFvSvRe(5,9,9),RMsqWaveChiToFvSvRe(5,9,9),RMsqVertexChiToFvSvRe(5,9,9) 
Complex(dp) :: AmpTreeChiToFvSvRe(2,5,9,9),AmpWaveChiToFvSvRe(2,5,9,9)=(0._dp,0._dp),AmpVertexChiToFvSvRe(2,5,9,9)& 
 & ,AmpVertexIRosChiToFvSvRe(2,5,9,9),AmpVertexIRdrChiToFvSvRe(2,5,9,9), AmpSumChiToFvSvRe(2,5,9,9), AmpSum2ChiToFvSvRe(2,5,9,9) 
Complex(dp) :: AmpTreeZChiToFvSvRe(2,5,9,9),AmpWaveZChiToFvSvRe(2,5,9,9),AmpVertexZChiToFvSvRe(2,5,9,9) 
Real(dp) :: AmpSqChiToFvSvRe(5,9,9),  AmpSqTreeChiToFvSvRe(5,9,9) 
...
Call Amplitude_Tree_NInvSeesaw_ChiToChiAh(cplChiChiAhL,cplChiChiAhR,MAh,              & 
& MChi,MAh2,MChi2,AmpTreeChiToChiAh)

  Else 
Call Amplitude_Tree_NInvSeesaw_ChiToChiAh(ZcplChiChiAhL,ZcplChiChiAhR,MAh,            & 
& MChi,MAh2,MChi2,AmpTreeChiToChiAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_ChiToChiAh(MLambda,em,gs,cplChiChiAhL,cplChiChiAhR,        & 
& MAhOS,MChiOS,MRPChiToChiAh,MRGChiToChiAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_ChiToChiAh(MLambda,em,gs,ZcplChiChiAhL,ZcplChiChiAhR,      & 
& MAhOS,MChiOS,MRPChiToChiAh,MRGChiToChiAh)
...
Call Amplitude_WAVE_NInvSeesaw_ChiToChiAh(cplChiChiAhL,cplChiChiAhR,ctcplChiChiAhL,   & 
& ctcplChiChiAhR,MAh,MAh2,MChi,MChi2,ZfAh,ZfL0,AmpWaveChiToChiAh)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_ChiToChiAh(MAh,MCha,MChi,MFd,MFe,MFu,MFv,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_ChiToChiAh(MAh,MCha,MChi,MFd,MFe,MFu,             & 
...
& cplcChaChiVWmL,cplcChaChiVWmR,AmpVertexIRdrChiToChiAh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_ChiToChiAh(MAhOS,MChaOS,MChiOS,MFdOS,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_ChiToChacHpm(cplChiChacHpmL,cplChiChacHpmR,            & 
& MCha,MChi,MHpm,MCha2,MChi2,MHpm2,AmpTreeChiToChacHpm)

  Else 
Call Amplitude_Tree_NInvSeesaw_ChiToChacHpm(ZcplChiChacHpmL,ZcplChiChacHpmR,          & 
& MCha,MChi,MHpm,MCha2,MChi2,MHpm2,AmpTreeChiToChacHpm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_ChiToChacHpm(MLambda,em,gs,cplChiChacHpmL,cplChiChacHpmR,  & 
& MChaOS,MChiOS,MHpmOS,MRPChiToChacHpm,MRGChiToChacHpm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_ChiToChacHpm(MLambda,em,gs,ZcplChiChacHpmL,ZcplChiChacHpmR,& 
& MChaOS,MChiOS,MHpmOS,MRPChiToChacHpm,MRGChiToChacHpm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_ChiToChacHpm(cplChiChacHpmL,cplChiChacHpmR,            & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_ChiToChacHpm(MAh,MCha,MChi,MFd,MFe,MFu,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_ChiToChacHpm(MAh,MCha,MChi,MFd,MFe,               & 
...
& cplSeSvRecHpm,cplcHpmVPVWm,cplcHpmVWmVZ,AmpVertexIRdrChiToChacHpm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_ChiToChacHpm(MAhOS,MChaOS,MChiOS,MFdOS,           & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_ChiToChacVWm(cplChiChacVWmL,cplChiChacVWmR,            & 
& MCha,MChi,MVWm,MCha2,MChi2,MVWm2,AmpTreeChiToChacVWm)

  Else 
Call Amplitude_Tree_NInvSeesaw_ChiToChacVWm(ZcplChiChacVWmL,ZcplChiChacVWmR,          & 
& MCha,MChi,MVWm,MCha2,MChi2,MVWm2,AmpTreeChiToChacVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_ChiToChacVWm(MLambda,em,gs,cplChiChacVWmL,cplChiChacVWmR,  & 
& MChaOS,MChiOS,MVWmOS,MRPChiToChacVWm,MRGChiToChacVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_ChiToChacVWm(MLambda,em,gs,ZcplChiChacVWmL,ZcplChiChacVWmR,& 
& MChaOS,MChiOS,MVWmOS,MRPChiToChacVWm,MRGChiToChacVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_ChiToChacVWm(cplChiChacVWmL,cplChiChacVWmR,            & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_ChiToChacVWm(MAh,MCha,MChi,MFd,MFe,MFu,              & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplcChaChaAhL,  & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_ChiToChacVWm(MAh,MCha,MChi,MFd,MFe,               & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,           & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplcChaChaAhL,  & 
& cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplAhHpmcVWm,cplChiChacHpmL,cplChiChacHpmR,    & 
& cplChiChacVWmL,cplChiChacVWmR,cplChaFucSdL,cplChaFucSdR,cplFvChacSeL,cplFvChacSeR,     & 
...
& cplSeSvRecVWm,cplcVWmVPVWm,cplcVWmVWmVZ,AmpVertexIRdrChiToChacVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_ChiToChacVWm(MAhOS,MChaOS,MChiOS,MFdOS,           & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVP,MVWmOS,           & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
& MSd2OS,MSe2OS,MSu2OS,MSvIm2OS,MSvRe2OS,MVP2,MVWm2OS,MVZ2OS,cplcChaChaAhL,              & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_ChiToChihh(cplChiChihhL,cplChiChihhR,MChi,             & 
& Mhh,MChi2,Mhh2,AmpTreeChiToChihh)

  Else 
Call Amplitude_Tree_NInvSeesaw_ChiToChihh(ZcplChiChihhL,ZcplChiChihhR,MChi,           & 
& Mhh,MChi2,Mhh2,AmpTreeChiToChihh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_ChiToChihh(MLambda,em,gs,cplChiChihhL,cplChiChihhR,        & 
& MChiOS,MhhOS,MRPChiToChihh,MRGChiToChihh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_ChiToChihh(MLambda,em,gs,ZcplChiChihhL,ZcplChiChihhR,      & 
& MChiOS,MhhOS,MRPChiToChihh,MRGChiToChihh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_ChiToChihh(cplChiChihhL,cplChiChihhR,ctcplChiChihhL,   & 
& ctcplChiChihhR,MChi,MChi2,Mhh,Mhh2,Zfhh,ZfL0,AmpWaveChiToChihh)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_ChiToChihh(MAh,MCha,MChi,MFd,MFe,MFu,MFv,            & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_ChiToChihh(MAh,MCha,MChi,MFd,MFe,MFu,             & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,              & 
...
& cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplFvFvhhL,cplFvFvhhR,cplhhhhhh,cplhhHpmcHpm,      & 
& cplhhHpmcVWm,cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvImSvIm,cplhhSvImSvRe,             & 
& cplhhSvReSvRe,cplhhcHpmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRdrChiToChihh)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_ChiToChihh(MAhOS,MChaOS,MChiOS,MFdOS,             & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVWmOS,               & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_ChiToChiVZ(cplChiChiVZL,cplChiChiVZR,MChi,             & 
& MVZ,MChi2,MVZ2,AmpTreeChiToChiVZ)

  Else 
Call Amplitude_Tree_NInvSeesaw_ChiToChiVZ(ZcplChiChiVZL,ZcplChiChiVZR,MChi,           & 
& MVZ,MChi2,MVZ2,AmpTreeChiToChiVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_ChiToChiVZ(MLambda,em,gs,cplChiChiVZL,cplChiChiVZR,        & 
& MChiOS,MVZOS,MRPChiToChiVZ,MRGChiToChiVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_ChiToChiVZ(MLambda,em,gs,ZcplChiChiVZL,ZcplChiChiVZR,      & 
& MChiOS,MVZOS,MRPChiToChiVZ,MRGChiToChiVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_ChiToChiVZ(cplChiChiVZL,cplChiChiVZR,ctcplChiChiVZL,   & 
& ctcplChiChiVZR,MChi,MChi2,MVZ,MVZ2,ZfL0,ZfVZ,AmpWaveChiToChiVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_ChiToChiVZ(MAh,MCha,MChi,MFd,MFe,MFu,MFv,            & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,             & 
& MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVWm2,MVZ2,cplChiChiAhL,cplChiChiAhR,     & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_ChiToChiVZ(MAh,MCha,MChi,MFd,MFe,MFu,             & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,              & 
...
& AmpVertexIRdrChiToChiVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_ChiToChiVZ(MAhOS,MChaOS,MChiOS,MFdOS,             & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVWmOS,               & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_ChiToFdcSd(cplChiFdcSdL,cplChiFdcSdR,MChi,             & 
& MFd,MSd,MChi2,MFd2,MSd2,AmpTreeChiToFdcSd)

  Else 
Call Amplitude_Tree_NInvSeesaw_ChiToFdcSd(ZcplChiFdcSdL,ZcplChiFdcSdR,MChi,           & 
& MFd,MSd,MChi2,MFd2,MSd2,AmpTreeChiToFdcSd)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_ChiToFdcSd(MLambda,em,gs,cplChiFdcSdL,cplChiFdcSdR,        & 
& MChiOS,MFdOS,MSdOS,MRPChiToFdcSd,MRGChiToFdcSd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_ChiToFdcSd(MLambda,em,gs,ZcplChiFdcSdL,ZcplChiFdcSdR,      & 
& MChiOS,MFdOS,MSdOS,MRPChiToFdcSd,MRGChiToFdcSd)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_ChiToFdcSd(cplChiFdcSdL,cplChiFdcSdR,ctcplChiFdcSdL,   & 
& ctcplChiFdcSdR,MChi,MChi2,MFd,MFd2,MSd,MSd2,ZfFDL,ZfFDR,ZfL0,ZfSd,AmpWaveChiToFdcSd)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_ChiToFdcSd(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_ChiToFdcSd(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,            & 
& cplcFdFdAhR,cplAhSdcSd,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,    & 
& cplChaFucSdL,cplChaFucSdR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,         & 
...
& cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSucSdVWm,AmpVertexIRdrChiToFdcSd)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_ChiToFdcSd(MAhOS,MChaOS,MChiOS,MFdOS,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_ChiToFecSe(cplChiFecSeL,cplChiFecSeR,MChi,             & 
& MFe,MSe,MChi2,MFe2,MSe2,AmpTreeChiToFecSe)

  Else 
Call Amplitude_Tree_NInvSeesaw_ChiToFecSe(ZcplChiFecSeL,ZcplChiFecSeR,MChi,           & 
& MFe,MSe,MChi2,MFe2,MSe2,AmpTreeChiToFecSe)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_ChiToFecSe(MLambda,em,gs,cplChiFecSeL,cplChiFecSeR,        & 
& MChiOS,MFeOS,MSeOS,MRPChiToFecSe,MRGChiToFecSe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_ChiToFecSe(MLambda,em,gs,ZcplChiFecSeL,ZcplChiFecSeR,      & 
& MChiOS,MFeOS,MSeOS,MRPChiToFecSe,MRGChiToFecSe)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_ChiToFecSe(cplChiFecSeL,cplChiFecSeR,ctcplChiFecSeL,   & 
& ctcplChiFecSeR,MChi,MChi2,MFe,MFe2,MSe,MSe2,ZfFEL,ZfFER,ZfL0,ZfSe,AmpWaveChiToFecSe)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_ChiToFecSe(MAh,MCha,MChi,MFe,MFv,Mhh,MHpm,           & 
...
& cplSvImcSeVWm,cplSvRecSeVWm,AmpVertexChiToFecSe)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_ChiToFecSe(MAh,MCha,MChi,MFe,MFv,Mhh,             & 
...
& cplSecSeVP,cplSecSeVZ,cplSvImcSeVWm,cplSvRecSeVWm,AmpVertexIRdrChiToFecSe)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_ChiToFecSe(MAhOS,MChaOS,MChiOS,MFeOS,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_ChiToFucSu(cplChiFucSuL,cplChiFucSuR,MChi,             & 
& MFu,MSu,MChi2,MFu2,MSu2,AmpTreeChiToFucSu)

  Else 
Call Amplitude_Tree_NInvSeesaw_ChiToFucSu(ZcplChiFucSuL,ZcplChiFucSuR,MChi,           & 
& MFu,MSu,MChi2,MFu2,MSu2,AmpTreeChiToFucSu)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_ChiToFucSu(MLambda,em,gs,cplChiFucSuL,cplChiFucSuR,        & 
& MChiOS,MFuOS,MSuOS,MRPChiToFucSu,MRGChiToFucSu)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_ChiToFucSu(MLambda,em,gs,ZcplChiFucSuL,ZcplChiFucSuR,      & 
& MChiOS,MFuOS,MSuOS,MRPChiToFucSu,MRGChiToFucSu)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_ChiToFucSu(cplChiFucSuL,cplChiFucSuR,ctcplChiFucSuL,   & 
& ctcplChiFucSuR,MChi,MChi2,MFu,MFu2,MSu,MSu2,ZfFUL,ZfFUR,ZfL0,ZfSu,AmpWaveChiToFucSu)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_ChiToFucSu(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_ChiToFucSu(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplChiChiAhL,cplChiChiAhR,cplcFuFuAhL,            & 
& cplcFuFuAhR,cplAhSucSu,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,    & 
& cplChaFucSdL,cplChaFucSdR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,         & 
...
& cplSdcSucVWm,cplSucSuVG,cplSucSuVP,cplSucSuVZ,AmpVertexIRdrChiToFucSu)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_ChiToFucSu(MAhOS,MChaOS,MChiOS,MFdOS,             & 
& MFuOS,MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,             & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_ChiToFvSvIm(cplChiFvSvImL,cplChiFvSvImR,               & 
& MChi,MFv,MSvIm,MChi2,MFv2,MSvIm2,AmpTreeChiToFvSvIm)

  Else 
Call Amplitude_Tree_NInvSeesaw_ChiToFvSvIm(ZcplChiFvSvImL,ZcplChiFvSvImR,             & 
& MChi,MFv,MSvIm,MChi2,MFv2,MSvIm2,AmpTreeChiToFvSvIm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_ChiToFvSvIm(MLambda,em,gs,cplChiFvSvImL,cplChiFvSvImR,     & 
& MChiOS,MFvOS,MSvImOS,MRPChiToFvSvIm,MRGChiToFvSvIm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_ChiToFvSvIm(MLambda,em,gs,ZcplChiFvSvImL,ZcplChiFvSvImR,   & 
& MChiOS,MFvOS,MSvImOS,MRPChiToFvSvIm,MRGChiToFvSvIm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_ChiToFvSvIm(cplChiFvSvImL,cplChiFvSvImR,               & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_ChiToFvSvIm(MAh,MCha,MChi,MFe,MFv,Mhh,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_ChiToFvSvIm(MAh,MCha,MChi,MFe,MFv,Mhh,            & 
& MHpm,MSe,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,MSe2,              & 
& MSvIm2,MSvRe2,MVWm2,MVZ2,cplChiChiAhL,cplChiChiAhR,cplFvFvAhL,cplFvFvAhR,              & 
& cplAhSvImSvIm,cplAhSvImSvRe,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,              & 
& cplChiChacVWmR,cplFvChacSeL,cplFvChacSeR,cplcFeChaSvImL,cplcFeChaSvImR,cplChiChihhL,   & 
...
& cplSeSvImcVWm,cplSvImSvReVZ,cplSvImcSeVWm,AmpVertexIRdrChiToFvSvIm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_ChiToFvSvIm(MAhOS,MChaOS,MChiOS,MFeOS,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_ChiToFvSvRe(cplChiFvSvReL,cplChiFvSvReR,               & 
& MChi,MFv,MSvRe,MChi2,MFv2,MSvRe2,AmpTreeChiToFvSvRe)

  Else 
Call Amplitude_Tree_NInvSeesaw_ChiToFvSvRe(ZcplChiFvSvReL,ZcplChiFvSvReR,             & 
& MChi,MFv,MSvRe,MChi2,MFv2,MSvRe2,AmpTreeChiToFvSvRe)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_ChiToFvSvRe(MLambda,em,gs,cplChiFvSvReL,cplChiFvSvReR,     & 
& MChiOS,MFvOS,MSvReOS,MRPChiToFvSvRe,MRGChiToFvSvRe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_ChiToFvSvRe(MLambda,em,gs,ZcplChiFvSvReL,ZcplChiFvSvReR,   & 
& MChiOS,MFvOS,MSvReOS,MRPChiToFvSvRe,MRGChiToFvSvRe)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_ChiToFvSvRe(cplChiFvSvReL,cplChiFvSvReR,               & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_ChiToFvSvRe(MAh,MCha,MChi,MFe,MFv,Mhh,               & 
& MHpm,MSe,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,MSe2,              & 
& MSvIm2,MSvRe2,MVWm2,MVZ2,cplChiChiAhL,cplChiChiAhR,cplFvFvAhL,cplFvFvAhR,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_ChiToFvSvRe(MAh,MCha,MChi,MFe,MFv,Mhh,            & 
& MHpm,MSe,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,MSe2,              & 
& MSvIm2,MSvRe2,MVWm2,MVZ2,cplChiChiAhL,cplChiChiAhR,cplFvFvAhL,cplFvFvAhR,              & 
& cplAhSvImSvRe,cplAhSvReSvRe,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,              & 
& cplChiChacVWmR,cplFvChacSeL,cplFvChacSeR,cplcFeChaSvReL,cplcFeChaSvReR,cplChiChihhL,   & 
...
& cplSeSvRecVWm,cplSvImSvReVZ,cplSvRecSeVWm,AmpVertexIRdrChiToFvSvRe)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_ChiToFvSvRe(MAhOS,MChaOS,MChiOS,MFeOS,            & 
& MFvOS,MhhOS,MHpmOS,MSeOS,MSvImOS,MSvReOS,MVWmOS,MVZOS,MAh2OS,MCha2OS,MChi2OS,          & 
& MFe2OS,MFv2OS,Mhh2OS,MHpm2OS,MSe2OS,MSvIm2OS,MSvRe2OS,MVWm2OS,MVZ2OS,cplChiChiAhL,     & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_NInvSeesaw_ChiToChiVP(ZcplChiChiVZL,ZcplChiChiVZR,ctcplChiChiVZL, & 
& ctcplChiChiVZR,MChiOS,MChi2OS,MVP,MVP2,MVZOS,MVZ2OS,ZfL0,ZfVP,ZfVZVP,AmpWaveChiToChiVP)

 Else 
Call Amplitude_WAVE_NInvSeesaw_ChiToChiVP(cplChiChiVZL,cplChiChiVZR,ctcplChiChiVZL,   & 
& ctcplChiChiVZR,MChiOS,MChi2OS,MVP,MVP2,MVZOS,MVZ2OS,ZfL0,ZfVP,ZfVZVP,AmpWaveChiToChiVP)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_NInvSeesaw_ChiToChiVP(MChaOS,MChiOS,MFdOS,MFeOS,MFuOS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_ChiToChiVP(MCha,MChi,MFd,MFe,MFu,MHpm,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_NInvSeesaw_ChiToGluVG(MChiOS,MFdOS,MFuOS,MGluOS,MSdOS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_ChiToGluVG(MChi,MFd,MFu,MGlu,MSd,MSu,MVG,            & 
...
End Module Wrapper_OneLoopDecay_Chi_NInvSeesaw
