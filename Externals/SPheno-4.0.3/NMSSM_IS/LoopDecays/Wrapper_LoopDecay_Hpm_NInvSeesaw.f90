...
Module Wrapper_OneLoopDecay_Hpm_NInvSeesaw
Use Model_Data_NInvSeesaw 
Use Kinematics 
Use OneLoopDecay_Hpm_NInvSeesaw 
Use Control 
Use Settings 
...
& cplChiFvSvReR(5,9,9),cplcHpmVPVWm(2),cplcHpmVWmVZ(2),cplcVWmVPVPVWm1Q,cplcVWmVPVPVWm2Q,& 
& cplcVWmVPVPVWm3Q,cplcVWmVPVWm,cplcVWmVPVWmVZ1Q,cplcVWmVPVWmVZ2Q,cplcVWmVPVWmVZ3Q,      & 
& cplcVWmVWmVZ,cplcVWmVWmVZVZ1Q,cplcVWmVWmVZVZ2Q,cplcVWmVWmVZVZ3Q,cplFvChacSeL(9,2,6)

Complex(dp),Intent(in) :: cplFvChacSeR(9,2,6),cplFvFecHpmL(9,3,2),cplFvFecHpmR(9,3,2),cplFvFecVWmL(9,3),         & 
...
& cplhhHpmcVWmVZ1(3,2),cplhhHpmSucSdaa(3,2,6,6),cplhhHpmSvImcSe1(3,2,9,6),               & 
& cplhhHpmSvRecSe1(3,2,9,6),cplhhSdcHpmcSuaa(3,6,2,6),cplhhSdcSd(3,6,6),cplhhSecSe(3,6,6),& 
& cplhhSeSvImcHpm1(3,6,9,2),cplhhSeSvRecHpm1(3,6,9,2),cplhhSucSu(3,6,6),cplhhSvImSvIm(3,9,9),& 
& cplhhSvImSvRe(3,9,9),cplhhSvReSvRe(3,9,9),cplhhVZVZ(3),cplHpmcHpmcVWmVWm1(2,2),        & 
...
& cplHpmSvRecSe(2,9,6),cplHpmSvReSvRecHpm1(2,9,9,2),cplSdcHpmcSu(6,2,6),cplSdcSdVG(6,6), & 
...
& cplSdSvImcSecSuaa(6,9,6,6),cplSdSvRecSecSuaa(6,9,6,6),cplSecSeVP(6,6),cplSecSeVZ(6,6), & 
& cplSeSuSvImcSdaa(6,6,9,6),cplSeSuSvRecSdaa(6,6,9,6),cplSeSvImcHpm(6,9,2),              & 
...
& cplSeSvRecVWmVZ1(6,9),cplSeSvReSvRecSe1(6,9,9,6),cplSucSdVPVWmaa(6,6),cplSucSdVWm(6,6),& 
& cplSucSdVWmVZaa(6,6),cplSucSuVG(6,6),cplSucSuVP(6,6),cplSucSuVZ(6,6),cplSvImcSeVPVWm1(9,6),& 
& cplSvImcSeVWm(9,6),cplSvImcSeVWmVZ1(9,6),cplSvImSvReVZ(9,9),cplSvRecSeVPVWm1(9,6),     & 
& cplSvRecSeVWm(9,6),cplSvRecSeVWmVZ1(9,6),ctcplAhcHpmVWm(3,2),ctcplAhHpmcHpm(3,2,2),    & 
& ctcplcFuFdcHpmL(3,3,2),ctcplcFuFdcHpmR(3,3,2),ctcplChiChacHpmL(5,2,2),ctcplChiChacHpmR(5,2,2),& 
& ctcplcHpmVPVWm(2),ctcplcHpmVWmVZ(2),ctcplFvFecHpmL(9,3,2),ctcplFvFecHpmR(9,3,2),       & 
& ctcplhhcHpmVWm(3,2),ctcplhhHpmcHpm(3,2,2),ctcplHpmcHpmVP(2,2),ctcplHpmcHpmVZ(2,2),     & 
& ctcplSdcHpmcSu(6,2,6),ctcplSeSvImcHpm(6,9,2),ctcplSeSvRecHpm(6,9,2),GcplAhHpmcHpm(3,2,2),& 
...
& ZcplcHpmVWmVZ(2),ZcplFvFecHpmL(9,3,2),ZcplFvFecHpmR(9,3,2),ZcplhhcHpmVWm(3,2),         & 
& ZcplhhHpmcHpm(3,2,2),ZcplHpmcHpmVZ(2,2),ZcplSdcHpmcSu(6,2,6),ZcplSeSvImcHpm(6,9,2),    & 
& ZcplSeSvRecHpm(6,9,2)
...
Real(dp) :: MRPHpmToFvFe(2,9,3),MRGHpmToFvFe(2,9,3), MRPZHpmToFvFe(2,9,3),MRGZHpmToFvFe(2,9,3) 
Real(dp) :: MVPHpmToFvFe(2,9,3) 
Real(dp) :: RMsqTreeHpmToFvFe(2,9,3),RMsqWaveHpmToFvFe(2,9,3),RMsqVertexHpmToFvFe(2,9,3) 
Complex(dp) :: AmpTreeHpmToFvFe(2,2,9,3),AmpWaveHpmToFvFe(2,2,9,3)=(0._dp,0._dp),AmpVertexHpmToFvFe(2,2,9,3)& 
 & ,AmpVertexIRosHpmToFvFe(2,2,9,3),AmpVertexIRdrHpmToFvFe(2,2,9,3), AmpSumHpmToFvFe(2,2,9,3), AmpSum2HpmToFvFe(2,2,9,3) 
Complex(dp) :: AmpTreeZHpmToFvFe(2,2,9,3),AmpWaveZHpmToFvFe(2,2,9,3),AmpVertexZHpmToFvFe(2,2,9,3) 
Real(dp) :: AmpSqHpmToFvFe(2,9,3),  AmpSqTreeHpmToFvFe(2,9,3) 
...
Real(dp) :: MRPHpmToSvImSe(2,9,6),MRGHpmToSvImSe(2,9,6), MRPZHpmToSvImSe(2,9,6),MRGZHpmToSvImSe(2,9,6) 
Real(dp) :: MVPHpmToSvImSe(2,9,6) 
Real(dp) :: RMsqTreeHpmToSvImSe(2,9,6),RMsqWaveHpmToSvImSe(2,9,6),RMsqVertexHpmToSvImSe(2,9,6) 
Complex(dp) :: AmpTreeHpmToSvImSe(2,9,6),AmpWaveHpmToSvImSe(2,9,6)=(0._dp,0._dp),AmpVertexHpmToSvImSe(2,9,6)& 
 & ,AmpVertexIRosHpmToSvImSe(2,9,6),AmpVertexIRdrHpmToSvImSe(2,9,6), AmpSumHpmToSvImSe(2,9,6), AmpSum2HpmToSvImSe(2,9,6) 
Complex(dp) :: AmpTreeZHpmToSvImSe(2,9,6),AmpWaveZHpmToSvImSe(2,9,6),AmpVertexZHpmToSvImSe(2,9,6) 
Real(dp) :: AmpSqHpmToSvImSe(2,9,6),  AmpSqTreeHpmToSvImSe(2,9,6) 
Real(dp) :: MRPHpmToSvReSe(2,9,6),MRGHpmToSvReSe(2,9,6), MRPZHpmToSvReSe(2,9,6),MRGZHpmToSvReSe(2,9,6) 
Real(dp) :: MVPHpmToSvReSe(2,9,6) 
Real(dp) :: RMsqTreeHpmToSvReSe(2,9,6),RMsqWaveHpmToSvReSe(2,9,6),RMsqVertexHpmToSvReSe(2,9,6) 
Complex(dp) :: AmpTreeHpmToSvReSe(2,9,6),AmpWaveHpmToSvReSe(2,9,6)=(0._dp,0._dp),AmpVertexHpmToSvReSe(2,9,6)& 
 & ,AmpVertexIRosHpmToSvReSe(2,9,6),AmpVertexIRdrHpmToSvReSe(2,9,6), AmpSumHpmToSvReSe(2,9,6), AmpSum2HpmToSvReSe(2,9,6) 
Complex(dp) :: AmpTreeZHpmToSvReSe(2,9,6),AmpWaveZHpmToSvReSe(2,9,6),AmpVertexZHpmToSvReSe(2,9,6) 
Real(dp) :: AmpSqHpmToSvReSe(2,9,6),  AmpSqTreeHpmToSvReSe(2,9,6) 
...
Call Amplitude_Tree_NInvSeesaw_HpmToHpmAh(cplAhHpmcHpm,MAh,MHpm,MAh2,MHpm2,           & 
& AmpTreeHpmToHpmAh)

  Else 
Call Amplitude_Tree_NInvSeesaw_HpmToHpmAh(ZcplAhHpmcHpm,MAh,MHpm,MAh2,MHpm2,          & 
& AmpTreeHpmToHpmAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToHpmAh(MLambda,em,gs,cplAhHpmcHpm,MAhOS,               & 
& MHpmOS,MRPHpmToHpmAh,MRGHpmToHpmAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToHpmAh(MLambda,em,gs,ZcplAhHpmcHpm,MAhOS,              & 
& MHpmOS,MRPHpmToHpmAh,MRGHpmToHpmAh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_HpmToHpmAh(MLambda,em,gs,cplAhHpmcHpm,MAh,MHpm,            & 
& MRPHpmToHpmAh,MRGHpmToHpmAh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToHpmAh(MLambda,em,gs,ZcplAhHpmcHpm,MAh,MHpm,           & 
& MRPHpmToHpmAh,MRGHpmToHpmAh)
...
Call Amplitude_WAVE_NInvSeesaw_HpmToHpmAh(cplAhHpmcHpm,ctcplAhHpmcHpm,MAh,            & 
& MAh2,MHpm,MHpm2,ZfAh,ZfHpm,AmpWaveHpmToHpmAh)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_HpmToHpmAh(MAh,MCha,MChi,MFd,MFe,MFu,MFv,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmToHpmAh(MAh,MCha,MChi,MFd,MFe,MFu,             & 
...
& cplHpmSvImSvImcHpm1,cplHpmSvImSvRecHpm1,cplHpmSvReSvRecHpm1,AmpVertexIRdrHpmToHpmAh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmToHpmAh(MAhOS,MChaOS,MChiOS,MFdOS,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_HpmToAhVWm(cplAhcHpmVWm,MAh,MHpm,MVWm,MAh2,            & 
& MHpm2,MVWm2,AmpTreeHpmToAhVWm)

  Else 
Call Amplitude_Tree_NInvSeesaw_HpmToAhVWm(ZcplAhcHpmVWm,MAh,MHpm,MVWm,MAh2,           & 
& MHpm2,MVWm2,AmpTreeHpmToAhVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToAhVWm(MLambda,em,gs,cplAhcHpmVWm,MAhOS,               & 
& MHpmOS,MVWmOS,MRPHpmToAhVWm,MRGHpmToAhVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToAhVWm(MLambda,em,gs,ZcplAhcHpmVWm,MAhOS,              & 
& MHpmOS,MVWmOS,MRPHpmToAhVWm,MRGHpmToAhVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_HpmToAhVWm(MLambda,em,gs,cplAhcHpmVWm,MAh,MHpm,            & 
& MVWm,MRPHpmToAhVWm,MRGHpmToAhVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToAhVWm(MLambda,em,gs,ZcplAhcHpmVWm,MAh,MHpm,           & 
& MVWm,MRPHpmToAhVWm,MRGHpmToAhVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_HpmToAhVWm(cplAhcHpmVWm,ctcplAhcHpmVWm,MAh,            & 
& MAh2,MHpm,MHpm2,MVWm,MVWm2,ZfAh,ZfHpm,ZfVWm,AmpWaveHpmToAhVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_HpmToAhVWm(MAh,MCha,MChi,MFd,MFe,MFu,MFv,            & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,              & 
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhAhAh,           & 
& cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,           & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,     & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmToAhVWm(MAh,MCha,MChi,MFd,MFe,MFu,             & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhAhAh,      & 
& cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,           & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,     & 
...
& cplAhcHpmVPVWm1,cplAhcHpmVWmVZ1,cplhhcHpmVWmVZ1,cplHpmcHpmcVWmVWm1,AmpVertexIRdrHpmToAhVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmToAhVWm(MAhOS,MChaOS,MChiOS,MFdOS,             & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVP,MVWmOS,           & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
& MSd2OS,MSe2OS,MSu2OS,MSvIm2OS,MSvRe2OS,MVP2,MVWm2OS,MVZ2OS,cplAhAhAh,cplAhAhhh,        & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_HpmToChiCha(cplChiChacHpmL,cplChiChacHpmR,             & 
& MCha,MChi,MHpm,MCha2,MChi2,MHpm2,AmpTreeHpmToChiCha)

  Else 
Call Amplitude_Tree_NInvSeesaw_HpmToChiCha(ZcplChiChacHpmL,ZcplChiChacHpmR,           & 
& MCha,MChi,MHpm,MCha2,MChi2,MHpm2,AmpTreeHpmToChiCha)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToChiCha(MLambda,em,gs,cplChiChacHpmL,cplChiChacHpmR,   & 
& MChaOS,MChiOS,MHpmOS,MRPHpmToChiCha,MRGHpmToChiCha)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToChiCha(MLambda,em,gs,ZcplChiChacHpmL,ZcplChiChacHpmR, & 
& MChaOS,MChiOS,MHpmOS,MRPHpmToChiCha,MRGHpmToChiCha)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_HpmToChiCha(cplChiChacHpmL,cplChiChacHpmR,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_HpmToChiCha(MAh,MCha,MChi,MFd,MFe,MFu,               & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmToChiCha(MAh,MCha,MChi,MFd,MFe,MFu,            & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplcChaChaAhL,  & 
& cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplAhHpmcHpm,cplAhcHpmVWm,cplChiChacHpmL,      & 
& cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,cplChaFucSdL,cplChaFucSdR,cplFvChacSeL,   & 
...
& cplSeSvRecHpm,cplcHpmVPVWm,cplcHpmVWmVZ,AmpVertexIRdrHpmToChiCha)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmToChiCha(MAhOS,MChaOS,MChiOS,MFdOS,            & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVP,MVWmOS,           & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_HpmTocFuFd(cplcFuFdcHpmL,cplcFuFdcHpmR,MFd,            & 
& MFu,MHpm,MFd2,MFu2,MHpm2,AmpTreeHpmTocFuFd)

  Else 
Call Amplitude_Tree_NInvSeesaw_HpmTocFuFd(ZcplcFuFdcHpmL,ZcplcFuFdcHpmR,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_HpmTocFuFd(MLambda,em,gs,cplcFuFdcHpmL,cplcFuFdcHpmR,      & 
& MFdOS,MFuOS,MHpmOS,MRPHpmTocFuFd,MRGHpmTocFuFd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_HpmTocFuFd(MLambda,em,gs,ZcplcFuFdcHpmL,ZcplcFuFdcHpmR,    & 
& MFdOS,MFuOS,MHpmOS,MRPHpmTocFuFd,MRGHpmTocFuFd)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_HpmTocFuFd(cplcFuFdcHpmL,cplcFuFdcHpmR,ctcplcFuFdcHpmL,& 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_HpmTocFuFd(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmTocFuFd(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,              & 
& cplcFuFuAhR,cplAhHpmcHpm,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,cplChiFdcSdL,      & 
& cplChiFdcSdR,cplcFuChiSuL,cplcFuChiSuR,cplGluFdcSdL,cplGluFdcSdR,cplcFdFdhhL,          & 
...
& cplcHpmVPVWm,cplcHpmVWmVZ,AmpVertexIRdrHpmTocFuFd)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmTocFuFd(MAhOS,MChaOS,MChiOS,MFdOS,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_HpmToFvFe(cplFvFecHpmL,cplFvFecHpmR,MFe,               & 
& MFv,MHpm,MFe2,MFv2,MHpm2,AmpTreeHpmToFvFe)

  Else 
Call Amplitude_Tree_NInvSeesaw_HpmToFvFe(ZcplFvFecHpmL,ZcplFvFecHpmR,MFe,             & 
& MFv,MHpm,MFe2,MFv2,MHpm2,AmpTreeHpmToFvFe)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToFvFe(MLambda,em,gs,cplFvFecHpmL,cplFvFecHpmR,         & 
& MFeOS,MFvOS,MHpmOS,MRPHpmToFvFe,MRGHpmToFvFe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToFvFe(MLambda,em,gs,ZcplFvFecHpmL,ZcplFvFecHpmR,       & 
& MFeOS,MFvOS,MHpmOS,MRPHpmToFvFe,MRGHpmToFvFe)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_HpmToFvFe(cplFvFecHpmL,cplFvFecHpmR,ctcplFvFecHpmL,    & 
& ctcplFvFecHpmR,MFe,MFe2,MFv,MFv2,MHpm,MHpm2,ZfFEL,ZfFER,ZfFV,ZfHpm,AmpWaveHpmToFvFe)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_HpmToFvFe(MAh,MCha,MChi,MFe,MFv,Mhh,MHpm,            & 
& MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,MSe2,               & 
& MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplFvFvAhL,cplFvFvAhR,           & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmToFvFe(MAh,MCha,MChi,MFe,MFv,Mhh,              & 
...
& cplcHpmVPVWm,cplcHpmVWmVZ,AmpVertexIRdrHpmToFvFe)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmToFvFe(MAhOS,MChaOS,MChiOS,MFeOS,              & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_HpmToHpmhh(cplhhHpmcHpm,Mhh,MHpm,Mhh2,MHpm2,           & 
& AmpTreeHpmToHpmhh)

  Else 
Call Amplitude_Tree_NInvSeesaw_HpmToHpmhh(ZcplhhHpmcHpm,Mhh,MHpm,Mhh2,MHpm2,          & 
& AmpTreeHpmToHpmhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToHpmhh(MLambda,em,gs,cplhhHpmcHpm,MhhOS,               & 
& MHpmOS,MRPHpmToHpmhh,MRGHpmToHpmhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToHpmhh(MLambda,em,gs,ZcplhhHpmcHpm,MhhOS,              & 
& MHpmOS,MRPHpmToHpmhh,MRGHpmToHpmhh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_HpmToHpmhh(MLambda,em,gs,cplhhHpmcHpm,Mhh,MHpm,            & 
& MRPHpmToHpmhh,MRGHpmToHpmhh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToHpmhh(MLambda,em,gs,ZcplhhHpmcHpm,Mhh,MHpm,           & 
& MRPHpmToHpmhh,MRGHpmToHpmhh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_HpmToHpmhh(cplhhHpmcHpm,ctcplhhHpmcHpm,Mhh,            & 
& Mhh2,MHpm,MHpm2,Zfhh,ZfHpm,AmpWaveHpmToHpmhh)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_HpmToHpmhh(MAh,MCha,MChi,MFd,MFe,MFu,MFv,            & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmToHpmhh(MAh,MCha,MChi,MFd,MFe,MFu,             & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
...
& cplHpmcHpmcVWmVWm1,cplHpmcHpmVZVZ1,AmpVertexIRdrHpmToHpmhh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmToHpmhh(MAhOS,MChaOS,MChiOS,MFdOS,             & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVP,MVWmOS,           & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_HpmTohhVWm(cplhhcHpmVWm,Mhh,MHpm,MVWm,Mhh2,            & 
& MHpm2,MVWm2,AmpTreeHpmTohhVWm)

  Else 
Call Amplitude_Tree_NInvSeesaw_HpmTohhVWm(ZcplhhcHpmVWm,Mhh,MHpm,MVWm,Mhh2,           & 
& MHpm2,MVWm2,AmpTreeHpmTohhVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_HpmTohhVWm(MLambda,em,gs,cplhhcHpmVWm,MhhOS,               & 
& MHpmOS,MVWmOS,MRPHpmTohhVWm,MRGHpmTohhVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_HpmTohhVWm(MLambda,em,gs,ZcplhhcHpmVWm,MhhOS,              & 
& MHpmOS,MVWmOS,MRPHpmTohhVWm,MRGHpmTohhVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_HpmTohhVWm(MLambda,em,gs,cplhhcHpmVWm,Mhh,MHpm,            & 
& MVWm,MRPHpmTohhVWm,MRGHpmTohhVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_HpmTohhVWm(MLambda,em,gs,ZcplhhcHpmVWm,Mhh,MHpm,           & 
& MVWm,MRPHpmTohhVWm,MRGHpmTohhVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_HpmTohhVWm(cplhhcHpmVWm,ctcplhhcHpmVWm,Mhh,            & 
& Mhh2,MHpm,MHpm2,MVWm,MVWm2,Zfhh,ZfHpm,ZfVWm,AmpWaveHpmTohhVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_HpmTohhVWm(MAh,MCha,MChi,MFd,MFe,MFu,MFv,            & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,              & 
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhAhhh,           & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmTohhVWm(MAh,MCha,MChi,MFd,MFe,MFu,             & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhAhhh,      & 
& cplAhhhhh,cplAhhhVZ,cplAhHpmcHpm,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,           & 
& cplcChaChahhL,cplcChaChahhR,cplChiChihhL,cplChiChihhR,cplcChaChiVWmL,cplcChaChiVWmR,   & 
...
& cplhhcHpmVWmVZ1,cplHpmcHpmcVWmVWm1,AmpVertexIRdrHpmTohhVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmTohhVWm(MAhOS,MChaOS,MChiOS,MFdOS,             & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVP,MVWmOS,           & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
& MSd2OS,MSe2OS,MSu2OS,MSvIm2OS,MSvRe2OS,MVP2,MVWm2OS,MVZ2OS,cplAhAhhh,cplAhhhhh,        & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_HpmToHpmVZ(cplHpmcHpmVZ,MHpm,MVZ,MHpm2,MVZ2,           & 
& AmpTreeHpmToHpmVZ)

  Else 
Call Amplitude_Tree_NInvSeesaw_HpmToHpmVZ(ZcplHpmcHpmVZ,MHpm,MVZ,MHpm2,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToHpmVZ(MLambda,em,gs,cplHpmcHpmVZ,MHpmOS,              & 
& MVZOS,MRPHpmToHpmVZ,MRGHpmToHpmVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToHpmVZ(MLambda,em,gs,ZcplHpmcHpmVZ,MHpmOS,             & 
& MVZOS,MRPHpmToHpmVZ,MRGHpmToHpmVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_HpmToHpmVZ(MLambda,em,gs,cplHpmcHpmVZ,MHpm,MVZ,            & 
& MRPHpmToHpmVZ,MRGHpmToHpmVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToHpmVZ(MLambda,em,gs,ZcplHpmcHpmVZ,MHpm,               & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_HpmToHpmVZ(cplHpmcHpmVP,cplHpmcHpmVZ,ctcplHpmcHpmVP,   & 
& ctcplHpmcHpmVZ,MHpm,MHpm2,MVP,MVP2,MVZ,MVZ2,ZfHpm,ZfVPVZ,ZfVZ,AmpWaveHpmToHpmVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_HpmToHpmVZ(MAh,MCha,MChi,MFd,MFe,MFu,MFv,            & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,              & 
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhhhVZ,           & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmToHpmVZ(MAh,MCha,MChi,MFd,MFe,MFu,             & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
...
& cplHpmcHpmVZVZ1,AmpVertexIRdrHpmToHpmVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmToHpmVZ(MAhOS,MChaOS,MChiOS,MFdOS,             & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVP,MVWmOS,           & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_HpmTocSuSd(cplSdcHpmcSu,MHpm,MSd,MSu,MHpm2,            & 
& MSd2,MSu2,AmpTreeHpmTocSuSd)

  Else 
Call Amplitude_Tree_NInvSeesaw_HpmTocSuSd(ZcplSdcHpmcSu,MHpm,MSd,MSu,MHpm2,           & 
& MSd2,MSu2,AmpTreeHpmTocSuSd)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_HpmTocSuSd(MLambda,em,gs,cplSdcHpmcSu,MHpmOS,              & 
& MSdOS,MSuOS,MRPHpmTocSuSd,MRGHpmTocSuSd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_HpmTocSuSd(MLambda,em,gs,ZcplSdcHpmcSu,MHpmOS,             & 
& MSdOS,MSuOS,MRPHpmTocSuSd,MRGHpmTocSuSd)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_HpmTocSuSd(MLambda,em,gs,cplSdcHpmcSu,MHpm,MSd,            & 
& MSu,MRPHpmTocSuSd,MRGHpmTocSuSd)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_HpmTocSuSd(MLambda,em,gs,ZcplSdcHpmcSu,MHpm,               & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_HpmTocSuSd(cplSdcHpmcSu,ctcplSdcHpmcSu,MHpm,           & 
& MHpm2,MSd,MSd2,MSu,MSu2,ZfHpm,ZfSd,ZfSu,AmpWaveHpmTocSuSd)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_HpmTocSuSd(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmTocSuSd(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplAhHpmcHpm,cplAhSdcSd,cplAhSucSu,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,         & 
& cplChiFucSuL,cplChiFucSuR,cplcFdChiSdL,cplcFdChiSdR,cplcChaFdcSuL,cplcChaFdcSuR,       & 
...
& cplSdSvRecSecSuaa,cplSdcSucVWmVPaa,cplSdcSucVWmVZaa,AmpVertexIRdrHpmTocSuSd)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmTocSuSd(MAhOS,MChaOS,MChiOS,MFdOS,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_HpmToSvImSe(cplSeSvImcHpm,MHpm,MSe,MSvIm,              & 
& MHpm2,MSe2,MSvIm2,AmpTreeHpmToSvImSe)

  Else 
Call Amplitude_Tree_NInvSeesaw_HpmToSvImSe(ZcplSeSvImcHpm,MHpm,MSe,MSvIm,             & 
& MHpm2,MSe2,MSvIm2,AmpTreeHpmToSvImSe)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToSvImSe(MLambda,em,gs,cplSeSvImcHpm,MHpmOS,            & 
& MSeOS,MSvImOS,MRPHpmToSvImSe,MRGHpmToSvImSe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToSvImSe(MLambda,em,gs,ZcplSeSvImcHpm,MHpmOS,           & 
& MSeOS,MSvImOS,MRPHpmToSvImSe,MRGHpmToSvImSe)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_HpmToSvImSe(MLambda,em,gs,cplSeSvImcHpm,MHpm,              & 
& MSe,MSvIm,MRPHpmToSvImSe,MRGHpmToSvImSe)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToSvImSe(MLambda,em,gs,ZcplSeSvImcHpm,MHpm,             & 
& MSe,MSvIm,MRPHpmToSvImSe,MRGHpmToSvImSe)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_HpmToSvImSe(cplSeSvImcHpm,ctcplSeSvImcHpm,             & 
& MHpm,MHpm2,MSe,MSe2,MSvIm,MSvIm2,ZfHpm,ZfSe,ZfSvIm,AmpWaveHpmToSvImSe)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_HpmToSvImSe(MAh,MCha,MChi,MFe,MFv,Mhh,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmToSvImSe(MAh,MCha,MChi,MFe,MFv,Mhh,            & 
& MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,             & 
& MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhHpmcHpm,cplAhSecSe,            & 
& cplAhSvImSvIm,cplAhSvImSvRe,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,cplcFeChaSvImL, & 
& cplcFeChaSvImR,cplChiFvSvImL,cplChiFvSvImR,cplcFeChiSeL,cplcFeChiSeR,cplFvFecHpmL,     & 
...
& cplSeSvImSvRecSe1,cplSeSvImcVWmVP1,cplSeSvImcVWmVZ1,AmpVertexIRdrHpmToSvImSe)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmToSvImSe(MAhOS,MChaOS,MChiOS,MFeOS,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_HpmToSvReSe(cplSeSvRecHpm,MHpm,MSe,MSvRe,              & 
& MHpm2,MSe2,MSvRe2,AmpTreeHpmToSvReSe)

  Else 
Call Amplitude_Tree_NInvSeesaw_HpmToSvReSe(ZcplSeSvRecHpm,MHpm,MSe,MSvRe,             & 
& MHpm2,MSe2,MSvRe2,AmpTreeHpmToSvReSe)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToSvReSe(MLambda,em,gs,cplSeSvRecHpm,MHpmOS,            & 
& MSeOS,MSvReOS,MRPHpmToSvReSe,MRGHpmToSvReSe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToSvReSe(MLambda,em,gs,ZcplSeSvRecHpm,MHpmOS,           & 
& MSeOS,MSvReOS,MRPHpmToSvReSe,MRGHpmToSvReSe)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_HpmToSvReSe(MLambda,em,gs,cplSeSvRecHpm,MHpm,              & 
& MSe,MSvRe,MRPHpmToSvReSe,MRGHpmToSvReSe)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToSvReSe(MLambda,em,gs,ZcplSeSvRecHpm,MHpm,             & 
& MSe,MSvRe,MRPHpmToSvReSe,MRGHpmToSvReSe)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_HpmToSvReSe(cplSeSvRecHpm,ctcplSeSvRecHpm,             & 
& MHpm,MHpm2,MSe,MSe2,MSvRe,MSvRe2,ZfHpm,ZfSe,ZfSvRe,AmpWaveHpmToSvReSe)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_HpmToSvReSe(MAh,MCha,MChi,MFe,MFv,Mhh,               & 
& MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,             & 
& MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhHpmcHpm,cplAhSecSe,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmToSvReSe(MAh,MCha,MChi,MFe,MFv,Mhh,            & 
& MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,             & 
& MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhHpmcHpm,cplAhSecSe,            & 
& cplAhSvImSvRe,cplAhSvReSvRe,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,cplcFeChaSvReL, & 
& cplcFeChaSvReR,cplChiFvSvReL,cplChiFvSvReR,cplcFeChiSeL,cplcFeChiSeR,cplFvFecHpmL,     & 
...
& cplSeSvReSvRecSe1,cplSeSvRecVWmVP1,cplSeSvRecVWmVZ1,AmpVertexIRdrHpmToSvReSe)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmToSvReSe(MAhOS,MChaOS,MChiOS,MFeOS,            & 
& MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVP,MVWmOS,MVZOS,MAh2OS,          & 
& MCha2OS,MChi2OS,MFe2OS,MFv2OS,Mhh2OS,MHpm2OS,MSd2OS,MSe2OS,MSu2OS,MSvIm2OS,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_HpmToVZVWm(cplcHpmVWmVZ,MHpm,MVWm,MVZ,MHpm2,           & 
& MVWm2,MVZ2,AmpTreeHpmToVZVWm)

  Else 
Call Amplitude_Tree_NInvSeesaw_HpmToVZVWm(ZcplcHpmVWmVZ,MHpm,MVWm,MVZ,MHpm2,          & 
& MVWm2,MVZ2,AmpTreeHpmToVZVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToVZVWm(MLambda,em,gs,cplcHpmVWmVZ,MHpmOS,              & 
& MVWmOS,MVZOS,MRPHpmToVZVWm,MRGHpmToVZVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToVZVWm(MLambda,em,gs,ZcplcHpmVWmVZ,MHpmOS,             & 
& MVWmOS,MVZOS,MRPHpmToVZVWm,MRGHpmToVZVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_HpmToVZVWm(MLambda,em,gs,cplcHpmVWmVZ,MHpm,MVWm,           & 
& MVZ,MRPHpmToVZVWm,MRGHpmToVZVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_HpmToVZVWm(MLambda,em,gs,ZcplcHpmVWmVZ,MHpm,               & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_HpmToVZVWm(cplcHpmVPVWm,cplcHpmVWmVZ,ctcplcHpmVPVWm,   & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_HpmToVZVWm(MAh,MCha,MChi,MFd,MFe,MFu,MFv,            & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,              & 
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhhhVZ,           & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmToVZVWm(MAh,MCha,MChi,MFd,MFe,MFu,             & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhhhVZ,      & 
& cplAhHpmcHpm,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,cplcChaChaVZL,cplcChaChaVZR,   & 
& cplChiChiVZL,cplChiChiVZR,cplcChaChiVWmL,cplcChaChiVWmR,cplcFdFdVZL,cplcFdFdVZR,       & 
...
& AmpVertexIRdrHpmToVZVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_HpmToVZVWm(MAhOS,MChaOS,MChiOS,MFdOS,             & 
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVP,MVWmOS,           & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,               & 
& MSd2OS,MSe2OS,MSu2OS,MSvIm2OS,MSvRe2OS,MVP2,MVWm2OS,MVZ2OS,cplAhhhVZ,cplAhHpmcHpm,     & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_NInvSeesaw_HpmToHpmVP(cplHpmcHpmVP,cplHpmcHpmVZ,ctcplHpmcHpmVP,   & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_NInvSeesaw_HpmToHpmVP(MAhOS,MChaOS,MChiOS,MFdOS,MFeOS,          & 
...
& MSe2OS,MSu2OS,MSvIm2OS,MSvRe2OS,MVP2,MVWm2OS,MVZ2OS,cplAhHpmcHpm,cplAhHpmcVWm,         & 
...
& cplHpmSucSd,cplHpmSvImcSe,cplHpmSvRecSe,cplHpmcHpmVP,cplHpmcVWmVP,cplHpmcHpmVZ,        & 
& cplHpmcVWmVZ,cplSdcSdVP,cplSdcHpmcSu,cplSeSvImcHpm,cplSeSvRecHpm,cplSecSeVP,           & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_HpmToHpmVP(MAh,MCha,MChi,MFd,MFe,MFu,MFv,            & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,              & 
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhHpmcHpm,        & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_NInvSeesaw_HpmToVPVWm(cplcHpmVPVWm,cplcHpmVWmVZ,ctcplcHpmVPVWm,   & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_NInvSeesaw_HpmToVPVWm(MAhOS,MChaOS,MChiOS,MFdOS,MFeOS,          & 
& MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVP,MVWmOS,MVZOS,           & 
& MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,MSd2OS,              & 
& MSe2OS,MSu2OS,MSvIm2OS,MSvRe2OS,MVP2,MVWm2OS,MVZ2OS,cplAhHpmcHpm,cplAhcHpmVWm,         & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_HpmToVPVWm(MAh,MCha,MChi,MFd,MFe,MFu,MFv,            & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFe2,              & 
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhHpmcHpm,        & 
...
End Module Wrapper_OneLoopDecay_Hpm_NInvSeesaw
