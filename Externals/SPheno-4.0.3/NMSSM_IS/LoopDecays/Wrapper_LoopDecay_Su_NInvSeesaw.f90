...
Module Wrapper_OneLoopDecay_Su_NInvSeesaw
Use Model_Data_NInvSeesaw 
Use Kinematics 
Use OneLoopDecay_Su_NInvSeesaw 
Use Control 
Use Settings 
...
& cplAhSvReSvRe(3,9,9),cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),cplcChaChaAhL(2,2,3),   & 
...
& cplSdSvImcSecSuaa(6,9,6,6),cplSdSvRecSecSuaa(6,9,6,6),cplSeSucSecSuaa(6,6,6,6),        & 
& cplSeSvImcHpm(6,9,2),cplSeSvRecHpm(6,9,2),cplSucSdVGVWmLamct3ct2ct1(6,6),              & 
...
Complex(dp),Intent(in) :: cplSuSucSucSuabab(6,6,6,6),cplSuSucSucSuabba(6,6,6,6),cplSuSvImSvImcSuaa(6,9,9,6),     & 
& cplSuSvImSvRecSuaa(6,9,9,6),cplSuSvReSvRecSuaa(6,9,9,6),cplVGVGVG,ctcplAhSucSu(3,6,6), & 
...
Call Amplitude_Tree_NInvSeesaw_SuToSuAh(cplAhSucSu,MAh,MSu,MAh2,MSu2,AmpTreeSuToSuAh)

  Else 
Call Amplitude_Tree_NInvSeesaw_SuToSuAh(ZcplAhSucSu,MAh,MSu,MAh2,MSu2,AmpTreeSuToSuAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_SuToSuAh(MLambda,em,gs,cplAhSucSu,MAhOS,MSuOS,             & 
& MRPSuToSuAh,MRGSuToSuAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_SuToSuAh(MLambda,em,gs,ZcplAhSucSu,MAhOS,MSuOS,            & 
& MRPSuToSuAh,MRGSuToSuAh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_SuToSuAh(MLambda,em,gs,cplAhSucSu,MAh,MSu,MRPSuToSuAh,     & 
& MRGSuToSuAh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_SuToSuAh(MLambda,em,gs,ZcplAhSucSu,MAh,MSu,MRPSuToSuAh,    & 
& MRGSuToSuAh)
...
Call Amplitude_WAVE_NInvSeesaw_SuToSuAh(cplAhSucSu,ctcplAhSucSu,MAh,MAh2,             & 
& MSu,MSu2,ZfAh,ZfSu,AmpWaveSuToSuAh)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_SuToSuAh(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,             & 
...
& cplSuSvReSvRecSuaa,AmpVertexSuToSuAh)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_SuToSuAh(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
...
& cplSuSvImSvRecSuaa,cplSuSvReSvRecSuaa,AmpVertexIRdrSuToSuAh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_SuToSuAh(MAhOS,MChaOS,MChiOS,MFdOS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_SuToFuChi(cplChiFucSuL,cplChiFucSuR,MChi,              & 
& MFu,MSu,MChi2,MFu2,MSu2,AmpTreeSuToFuChi)

  Else 
Call Amplitude_Tree_NInvSeesaw_SuToFuChi(ZcplChiFucSuL,ZcplChiFucSuR,MChi,            & 
& MFu,MSu,MChi2,MFu2,MSu2,AmpTreeSuToFuChi)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_SuToFuChi(MLambda,em,gs,cplChiFucSuL,cplChiFucSuR,         & 
& MChiOS,MFuOS,MSuOS,MRPSuToFuChi,MRGSuToFuChi)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_SuToFuChi(MLambda,em,gs,ZcplChiFucSuL,ZcplChiFucSuR,       & 
& MChiOS,MFuOS,MSuOS,MRPSuToFuChi,MRGSuToFuChi)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_SuToFuChi(cplChiFucSuL,cplChiFucSuR,ctcplChiFucSuL,    & 
& ctcplChiFucSuR,MChi,MChi2,MFu,MFu2,MSu,MSu2,ZfFUL,ZfFUR,ZfL0,ZfSu,AmpWaveSuToFuChi)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_SuToFuChi(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_SuToFuChi(MAh,MCha,MChi,MFd,MFu,MGlu,             & 
...
& cplSdcSucVWm,cplSucSuVG,cplSucSuVP,cplSucSuVZ,AmpVertexIRdrSuToFuChi)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_SuToFuChi(MAhOS,MChaOS,MChiOS,MFdOS,              & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_SuTocChaFd(cplcChaFdcSuL,cplcChaFdcSuR,MCha,           & 
& MFd,MSu,MCha2,MFd2,MSu2,AmpTreeSuTocChaFd)

  Else 
Call Amplitude_Tree_NInvSeesaw_SuTocChaFd(ZcplcChaFdcSuL,ZcplcChaFdcSuR,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_SuTocChaFd(MLambda,em,gs,cplcChaFdcSuL,cplcChaFdcSuR,      & 
& MChaOS,MFdOS,MSuOS,MRPSuTocChaFd,MRGSuTocChaFd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_SuTocChaFd(MLambda,em,gs,ZcplcChaFdcSuL,ZcplcChaFdcSuR,    & 
& MChaOS,MFdOS,MSuOS,MRPSuTocChaFd,MRGSuTocChaFd)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_SuTocChaFd(cplcChaFdcSuL,cplcChaFdcSuR,ctcplcChaFdcSuL,& 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_SuTocChaFd(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_SuTocChaFd(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplcChaChaAhL,cplcChaChaAhR,cplcFdFdAhL,          & 
& cplcFdFdAhR,cplAhSucSu,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,        & 
& cplcChaChaVZL,cplcChaChaVZR,cplChiFdcSdL,cplChiFdcSdR,cplChiFucSuL,cplChiFucSuR,       & 
...
& cplSucSuVZ,AmpVertexIRdrSuTocChaFd)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_SuTocChaFd(MAhOS,MChaOS,MChiOS,MFdOS,             & 
& MFuOS,MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,             & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_SuToGluFu(cplGluFucSuL,cplGluFucSuR,MFu,               & 
& MGlu,MSu,MFu2,MGlu2,MSu2,AmpTreeSuToGluFu)

  Else 
Call Amplitude_Tree_NInvSeesaw_SuToGluFu(ZcplGluFucSuL,ZcplGluFucSuR,MFu,             & 
& MGlu,MSu,MFu2,MGlu2,MSu2,AmpTreeSuToGluFu)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_SuToGluFu(MLambda,em,gs,cplGluFucSuL,cplGluFucSuR,         & 
& MFuOS,MGluOS,MSuOS,MRPSuToGluFu,MRGSuToGluFu)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_SuToGluFu(MLambda,em,gs,ZcplGluFucSuL,ZcplGluFucSuR,       & 
& MFuOS,MGluOS,MSuOS,MRPSuToGluFu,MRGSuToGluFu)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_SuToGluFu(cplGluFucSuL,cplGluFucSuR,ctcplGluFucSuL,    & 
& ctcplGluFucSuR,MFu,MFu2,MGlu,MGlu2,MSu,MSu2,ZffG,ZfFUL,ZfFUR,ZfSu,AmpWaveSuToGluFu)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_SuToGluFu(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,MHpm2,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_SuToGluFu(MAh,MCha,MChi,MFd,MFu,MGlu,             & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
& cplSdcSucVWm,cplSucSuVG,cplSucSuVP,cplSucSuVZ,AmpVertexIRdrSuToGluFu)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_SuToGluFu(MAhOS,MChaOS,MChiOS,MFdOS,              & 
& MFuOS,MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,             & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_SuToSuhh(cplhhSucSu,Mhh,MSu,Mhh2,MSu2,AmpTreeSuToSuhh)

  Else 
Call Amplitude_Tree_NInvSeesaw_SuToSuhh(ZcplhhSucSu,Mhh,MSu,Mhh2,MSu2,AmpTreeSuToSuhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_SuToSuhh(MLambda,em,gs,cplhhSucSu,MhhOS,MSuOS,             & 
& MRPSuToSuhh,MRGSuToSuhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_SuToSuhh(MLambda,em,gs,ZcplhhSucSu,MhhOS,MSuOS,            & 
& MRPSuToSuhh,MRGSuToSuhh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_SuToSuhh(MLambda,em,gs,cplhhSucSu,Mhh,MSu,MRPSuToSuhh,     & 
& MRGSuToSuhh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_SuToSuhh(MLambda,em,gs,ZcplhhSucSu,Mhh,MSu,MRPSuToSuhh,    & 
& MRGSuToSuhh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_SuToSuhh(cplhhSucSu,ctcplhhSucSu,Mhh,Mhh2,             & 
& MSu,MSu2,Zfhh,ZfSu,AmpWaveSuToSuhh)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_SuToSuhh(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,             & 
& MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_SuToSuhh(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,MVZ2,               & 
...
& cplSucSuVZVZaa,AmpVertexIRdrSuToSuhh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_SuToSuhh(MAhOS,MChaOS,MChiOS,MFdOS,               & 
& MFuOS,MGluOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVG,MVP,MVWmOS,            & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,              & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_SuTocHpmSd(cplSdcHpmcSu,MHpm,MSd,MSu,MHpm2,            & 
& MSd2,MSu2,AmpTreeSuTocHpmSd)

  Else 
Call Amplitude_Tree_NInvSeesaw_SuTocHpmSd(ZcplSdcHpmcSu,MHpm,MSd,MSu,MHpm2,           & 
& MSd2,MSu2,AmpTreeSuTocHpmSd)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_SuTocHpmSd(MLambda,em,gs,cplSdcHpmcSu,MHpmOS,              & 
& MSdOS,MSuOS,MRPSuTocHpmSd,MRGSuTocHpmSd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_SuTocHpmSd(MLambda,em,gs,ZcplSdcHpmcSu,MHpmOS,             & 
& MSdOS,MSuOS,MRPSuTocHpmSd,MRGSuTocHpmSd)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_SuTocHpmSd(MLambda,em,gs,cplSdcHpmcSu,MHpm,MSd,            & 
& MSu,MRPSuTocHpmSd,MRGSuTocHpmSd)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_SuTocHpmSd(MLambda,em,gs,ZcplSdcHpmcSu,MHpm,               & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_SuTocHpmSd(cplSdcHpmcSu,ctcplSdcHpmcSu,MHpm,           & 
& MHpm2,MSd,MSd2,MSu,MSu2,ZfHpm,ZfSd,ZfSu,AmpWaveSuTocHpmSd)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_SuTocHpmSd(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,MVZ2,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_SuTocHpmSd(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,               & 
& MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplAhHpmcHpm,cplAhSdcSd,cplAhSucSu,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,         & 
& cplChiFucSuL,cplChiFucSuR,cplcFdChiSdL,cplcFdChiSdR,cplcChaFdcSuL,cplcChaFdcSuR,       & 
...
& cplSdSvRecSecSuaa,cplSdcSucVWmVPaa,cplSdcSucVWmVZaa,AmpVertexIRdrSuTocHpmSd)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_SuTocHpmSd(MAhOS,MChaOS,MChiOS,MFdOS,             & 
& MFuOS,MGluOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVG,MVP,MVWmOS,            & 
& MVZOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,              & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_SuToSdcVWm(cplSdcSucVWm,MSd,MSu,MVWm,MSd2,             & 
& MSu2,MVWm2,AmpTreeSuToSdcVWm)

  Else 
Call Amplitude_Tree_NInvSeesaw_SuToSdcVWm(ZcplSdcSucVWm,MSd,MSu,MVWm,MSd2,            & 
& MSu2,MVWm2,AmpTreeSuToSdcVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_SuToSdcVWm(MLambda,em,gs,cplSdcSucVWm,MSdOS,               & 
& MSuOS,MVWmOS,MRPSuToSdcVWm,MRGSuToSdcVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_SuToSdcVWm(MLambda,em,gs,ZcplSdcSucVWm,MSdOS,              & 
& MSuOS,MVWmOS,MRPSuToSdcVWm,MRGSuToSdcVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_SuToSdcVWm(MLambda,em,gs,cplSdcSucVWm,MSd,MSu,             & 
& MVWm,MRPSuToSdcVWm,MRGSuToSdcVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_SuToSdcVWm(MLambda,em,gs,ZcplSdcSucVWm,MSd,MSu,            & 
& MVWm,MRPSuToSdcVWm,MRGSuToSdcVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_SuToSdcVWm(cplSdcSucVWm,ctcplSdcSucVWm,MSd,            & 
& MSd2,MSu,MSu2,MVWm,MVWm2,ZfSd,ZfSu,ZfVWm,AmpWaveSuToSdcVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_SuToSdcVWm(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_SuToSdcVWm(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhHpmcVWm,cplAhSdcSd,cplAhSucSu,               & 
& cplChiChacVWmL,cplChiChacVWmR,cplChiFucSuL,cplChiFucSuR,cplcFdChiSdL,cplcFdChiSdR,     & 
& cplcChaFdcSuL,cplcChaFdcSuR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplGluFucSuL,cplGluFucSuR,     & 
...
& cplSdcSucVWmVZaa,cplSucSucVWmVWmaa,AmpVertexIRdrSuToSdcVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_SuToSdcVWm(MAhOS,MChaOS,MChiOS,MFdOS,             & 
& MFuOS,MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,             & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_SuToSuVZ(cplSucSuVZ,MSu,MVZ,MSu2,MVZ2,AmpTreeSuToSuVZ)

  Else 
Call Amplitude_Tree_NInvSeesaw_SuToSuVZ(ZcplSucSuVZ,MSu,MVZ,MSu2,MVZ2,AmpTreeSuToSuVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_SuToSuVZ(MLambda,em,gs,cplSucSuVZ,MSuOS,MVZOS,             & 
& MRPSuToSuVZ,MRGSuToSuVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_SuToSuVZ(MLambda,em,gs,ZcplSucSuVZ,MSuOS,MVZOS,            & 
& MRPSuToSuVZ,MRGSuToSuVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NInvSeesaw_SuToSuVZ(MLambda,em,gs,cplSucSuVZ,MSu,MVZ,MRPSuToSuVZ,     & 
& MRGSuToSuVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NInvSeesaw_SuToSuVZ(MLambda,em,gs,ZcplSucSuVZ,MSu,MVZ,MRPSuToSuVZ,    & 
& MRGSuToSuVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_SuToSuVZ(cplSucSuVP,cplSucSuVZ,ctcplSucSuVP,           & 
& ctcplSucSuVZ,MSu,MSu2,MVP,MVP2,MVZ,MVZ2,ZfSu,ZfVPVZ,ZfVZ,AmpWaveSuToSuVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_SuToSuVZ(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,             & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,MHpm2,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_SuToSuVZ(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,               & 
...
& cplSucSuVZVZaa,AmpVertexIRdrSuToSuVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_SuToSuVZ(MAhOS,MChaOS,MChiOS,MFdOS,               & 
& MFuOS,MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,             & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_NInvSeesaw_SuToSuVG(cplSucSuVG,ctcplSucSuVG,MSuOS,MSu2OS,         & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_NInvSeesaw_SuToSuVG(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,            & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_SuToSuVG(cplSucSuVG,ctcplSucSuVG,MSu,MSu2,             & 
& MVG,MVG2,ZfSu,ZfVG,AmpWaveSuToSuVG)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_SuToSuVG(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,             & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,MHpm2,             & 
& MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhSucSu,cplcFdChaSuL,cplcFdChaSuR,cplChiFucSuL,      & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_NInvSeesaw_SuToSuVP(cplSucSuVP,cplSucSuVZ,ctcplSucSuVP,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_NInvSeesaw_SuToSuVP(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,            & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,MChi2OS,           & 
& MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,           & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_SuToSuVP(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,             & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,MHpm2,             & 
& MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,cplAhSucSu,cplcFdChaSuL,cplcFdChaSuR,cplcChaChaVPL,     & 
...
End Module Wrapper_OneLoopDecay_Su_NInvSeesaw
