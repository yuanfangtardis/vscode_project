...
Module OneLoopDecay_Se_NInvSeesaw
Use Control 
Use Settings 
Use LoopFunctions 
...
Subroutine Amplitude_Tree_NInvSeesaw_SeToSeAh(cplAhSecSe,MAh,MSe,MAh2,MSe2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NInvSeesaw_SeToSeAh


Subroutine Gamma_Real_NInvSeesaw_SeToSeAh(MLambda,em,gs,cplAhSecSe,MAh,               & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NInvSeesaw_SeToSeAh


Subroutine Amplitude_WAVE_NInvSeesaw_SeToSeAh(cplAhSecSe,ctcplAhSecSe,MAh,            & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NInvSeesaw_SeToSeAh


Subroutine Amplitude_VERTEX_NInvSeesaw_SeToSeAh(MAh,MCha,MChi,MFe,MFv,Mhh,            & 
...
& cplcFeChiSeL(3,5,6),cplcFeChiSeR(3,5,6),cplcChaFvSeL(2,9,6),cplcChaFvSeR(2,9,6),       & 
& cplhhSecSe(3,6,6),cplHpmSvImcSe(2,9,6),cplHpmSvRecSe(2,9,6),cplSeSvImcHpm(6,9,2),      & 
& cplSeSvImcVWm(6,9),cplSeSvRecHpm(6,9,2),cplSeSvRecVWm(6,9),cplSecSeVP(6,6),            & 
& cplSecSeVZ(6,6),cplSvImcSeVWm(9,6),cplSvRecSeVWm(9,6),cplAhAhSecSe1(3,3,6,6),          & 
& cplAhhhSecSe1(3,3,6,6),cplAhHpmSvImcSe1(3,2,9,6),cplAhHpmSvRecSe1(3,2,9,6),            & 
& cplAhSeSvImcHpm1(3,6,9,2),cplAhSeSvRecHpm1(3,6,9,2),cplhhhhSecSe1(3,3,6,6),            & 
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NInvSeesaw_SeToSeAh


Subroutine Amplitude_IR_VERTEX_NInvSeesaw_SeToSeAh(MAh,MCha,MChi,MFe,MFv,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NInvSeesaw_SeToSeAh


Subroutine Amplitude_Tree_NInvSeesaw_SeToFvCha(cplFvChacSeL,cplFvChacSeR,             & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NInvSeesaw_SeToFvCha


Subroutine Gamma_Real_NInvSeesaw_SeToFvCha(MLambda,em,gs,cplFvChacSeL,cplFvChacSeR,   & 
...
Real(dp), Intent(out) :: GammarealPhoton(6,9,2), GammarealGluon(6,9,2) 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NInvSeesaw_SeToFvCha


Subroutine Amplitude_WAVE_NInvSeesaw_SeToFvCha(cplFvChacSeL,cplFvChacSeR,             & 
...
Complex(dp), Intent(out) :: Amp(2,6,9,2) 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NInvSeesaw_SeToFvCha


Subroutine Amplitude_VERTEX_NInvSeesaw_SeToFvCha(MAh,MCha,MChi,MFe,MFv,               & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NInvSeesaw_SeToFvCha


Subroutine Amplitude_IR_VERTEX_NInvSeesaw_SeToFvCha(MAh,MCha,MChi,MFe,MFv,            & 
& Mhh,MHpm,MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,           & 
& MSe2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplcChaChaAhL,cplcChaChaAhR,cplFvFvAhL,             & 
& cplFvFvAhR,cplAhSecSe,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,     & 
& cplFvChacSeL,cplFvChacSeR,cplcChaChahhL,cplcChaChahhR,cplcFeChaSvImL,cplcFeChaSvImR,   & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NInvSeesaw_SeToFvCha


Subroutine Amplitude_Tree_NInvSeesaw_SeToFeChi(cplChiFecSeL,cplChiFecSeR,             & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NInvSeesaw_SeToFeChi


Subroutine Gamma_Real_NInvSeesaw_SeToFeChi(MLambda,em,gs,cplChiFecSeL,cplChiFecSeR,   & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NInvSeesaw_SeToFeChi


Subroutine Amplitude_WAVE_NInvSeesaw_SeToFeChi(cplChiFecSeL,cplChiFecSeR,             & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NInvSeesaw_SeToFeChi


Subroutine Amplitude_VERTEX_NInvSeesaw_SeToFeChi(MAh,MCha,MChi,MFe,MFv,               & 
& Mhh,MHpm,MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,           & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NInvSeesaw_SeToFeChi


Subroutine Amplitude_IR_VERTEX_NInvSeesaw_SeToFeChi(MAh,MCha,MChi,MFe,MFv,            & 
& Mhh,MHpm,MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,           & 
& MSe2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplChiChiAhL,cplChiChiAhR,cplcFeFeAhL,              & 
& cplcFeFeAhR,cplAhSecSe,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,    & 
& cplFvChacSeL,cplFvChacSeR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NInvSeesaw_SeToFeChi


Subroutine Amplitude_Tree_NInvSeesaw_SeToSehh(cplhhSecSe,Mhh,MSe,Mhh2,MSe2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NInvSeesaw_SeToSehh


Subroutine Gamma_Real_NInvSeesaw_SeToSehh(MLambda,em,gs,cplhhSecSe,Mhh,               & 
& MSe,GammarealPhoton,GammarealGluon)
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NInvSeesaw_SeToSehh


Subroutine Amplitude_WAVE_NInvSeesaw_SeToSehh(cplhhSecSe,ctcplhhSecSe,Mhh,            & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NInvSeesaw_SeToSehh


Subroutine Amplitude_VERTEX_NInvSeesaw_SeToSehh(MAh,MCha,MChi,MFe,MFv,Mhh,            & 
& MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,             & 
...
& cplSecSecVWmVWm1,cplSecSeVZVZ1,Amp)
...
Amp(gt1, gt2, gt3) = Amp(gt1, gt2, gt3) + oo16pi2*(1._dp/2._dp)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NInvSeesaw_SeToSehh


Subroutine Amplitude_IR_VERTEX_NInvSeesaw_SeToSehh(MAh,MCha,MChi,MFe,MFv,             & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NInvSeesaw_SeToSehh


Subroutine Amplitude_Tree_NInvSeesaw_SeToSvImHpm(cplHpmSvImcSe,MHpm,MSe,              & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NInvSeesaw_SeToSvImHpm


Subroutine Gamma_Real_NInvSeesaw_SeToSvImHpm(MLambda,em,gs,cplHpmSvImcSe,             & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NInvSeesaw_SeToSvImHpm


Subroutine Amplitude_WAVE_NInvSeesaw_SeToSvImHpm(cplHpmSvImcSe,ctcplHpmSvImcSe,       & 
...
Complex(dp), Intent(out) :: Amp(6,9,2) 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NInvSeesaw_SeToSvImHpm


Subroutine Amplitude_VERTEX_NInvSeesaw_SeToSvImHpm(MAh,MCha,MChi,MFe,MFv,             & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,              & 
...
Amp(gt1, gt2, gt3) = Amp(gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NInvSeesaw_SeToSvImHpm


Subroutine Amplitude_IR_VERTEX_NInvSeesaw_SeToSvImHpm(MAh,MCha,MChi,MFe,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NInvSeesaw_SeToSvImHpm


Subroutine Amplitude_Tree_NInvSeesaw_SeToSvReHpm(cplHpmSvRecSe,MHpm,MSe,              & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NInvSeesaw_SeToSvReHpm


Subroutine Gamma_Real_NInvSeesaw_SeToSvReHpm(MLambda,em,gs,cplHpmSvRecSe,             & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NInvSeesaw_SeToSvReHpm


Subroutine Amplitude_WAVE_NInvSeesaw_SeToSvReHpm(cplHpmSvRecSe,ctcplHpmSvRecSe,       & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NInvSeesaw_SeToSvReHpm


Subroutine Amplitude_VERTEX_NInvSeesaw_SeToSvReHpm(MAh,MCha,MChi,MFe,MFv,             & 
& Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,              & 
& Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhHpmcHpm,cplAhHpmcVWm,     & 
...
Amp(gt1, gt2, gt3) = Amp(gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NInvSeesaw_SeToSvReHpm


Subroutine Amplitude_IR_VERTEX_NInvSeesaw_SeToSvReHpm(MAh,MCha,MChi,MFe,              & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,               & 
& MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhHpmcHpm,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NInvSeesaw_SeToSvReHpm


Subroutine Amplitude_Tree_NInvSeesaw_SeToSeVZ(cplSecSeVZ,MSe,MVZ,MSe2,MVZ2,Amp)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_NInvSeesaw_SeToSeVZ


Subroutine Gamma_Real_NInvSeesaw_SeToSeVZ(MLambda,em,gs,cplSecSeVZ,MSe,               & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_NInvSeesaw_SeToSeVZ


Subroutine Amplitude_WAVE_NInvSeesaw_SeToSeVZ(cplSecSeVP,cplSecSeVZ,ctcplSecSeVP,     & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NInvSeesaw_SeToSeVZ


Subroutine Amplitude_VERTEX_NInvSeesaw_SeToSeVZ(MAh,MCha,MChi,MFe,MFv,Mhh,            & 
...
Complex(dp), Intent(in) :: cplAhhhVZ(3,3),cplAhSecSe(3,6,6),cplFvChacSeL(9,2,6),cplFvChacSeR(9,2,6),             & 
...
& cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplFvFvVZL(9,9),cplFvFvVZR(9,9),cplcChaFvSeL(2,9,6), & 
& cplcChaFvSeR(2,9,6),cplhhSecSe(3,6,6),cplhhVZVZ(3),cplHpmSvImcSe(2,9,6),               & 
& cplHpmSvRecSe(2,9,6),cplHpmcHpmVZ(2,2),cplHpmcVWmVZ(2),cplSeSvImcHpm(6,9,2),           & 
& cplSeSvImcVWm(6,9),cplSeSvRecHpm(6,9,2),cplSeSvRecVWm(6,9),cplSecSeVP(6,6),            & 
& cplSecSeVZ(6,6),cplSvImSvReVZ(9,9),cplSvImcSeVWm(9,6),cplSvRecSeVWm(9,6),              & 
& cplcHpmVWmVZ(2),cplcVWmVWmVZ,cplSeSvImcVWmVZ1(6,9),cplSeSvRecVWmVZ1(6,9),              & 
& cplSecSeVPVZ1(6,6),cplSecSeVZVZ1(6,6),cplSvImcSeVWmVZ1(9,6),cplSvRecSeVWmVZ1(9,6)
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_NInvSeesaw_SeToSeVZ


Subroutine Amplitude_IR_VERTEX_NInvSeesaw_SeToSeVZ(MAh,MCha,MChi,MFe,MFv,             & 
& Mhh,MHpm,MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,           & 
& MSe2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhhhVZ,cplAhSecSe,cplFvChacSeL,cplFvChacSeR,     & 
& cplcChaChaVZL,cplcChaChaVZR,cplChiChiVZL,cplChiChiVZR,cplChiFecSeL,cplChiFecSeR,       & 
& cplcFeChiSeL,cplcFeChiSeR,cplcFeFeVZL,cplcFeFeVZR,cplFvFvVZL,cplFvFvVZR,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NInvSeesaw_SeToSeVZ


Subroutine Amplitude_Tree_NInvSeesaw_SeToSvImVWm(cplSvImcSeVWm,MSe,MSvIm,             & 
...
Complex(dp), Intent(in) :: cplSvImcSeVWm(9,6)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_NInvSeesaw_SeToSvImVWm


Subroutine Gamma_Real_NInvSeesaw_SeToSvImVWm(MLambda,em,gs,cplSvImcSeVWm,             & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_NInvSeesaw_SeToSvImVWm


Subroutine Amplitude_WAVE_NInvSeesaw_SeToSvImVWm(cplSvImcSeVWm,ctcplSvImcSeVWm,       & 
...
Complex(dp), Intent(in) :: ctcplSvImcSeVWm(9,6)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NInvSeesaw_SeToSvImVWm


Subroutine Amplitude_VERTEX_NInvSeesaw_SeToSvImVWm(MAh,MCha,MChi,MFe,MFv,             & 
& Mhh,MHpm,MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,           & 
...
Complex(dp), Intent(in) :: cplAhSecSe(3,6,6),cplAhSvImSvIm(3,9,9),cplAhSvImSvRe(3,9,9),cplAhcHpmVWm(3,2),        & 
& cplFvChacSeL(9,2,6),cplFvChacSeR(9,2,6),cplcFeChaSvImL(3,2,9),cplcFeChaSvImR(3,2,9),   & 
...
& cplcFeFvVWmL(3,9),cplcFeFvVWmR(3,9),cplhhSecSe(3,6,6),cplhhSvImSvIm(3,9,9),            & 
& cplhhSvImSvRe(3,9,9),cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),cplHpmSvImcSe(2,9,6),           & 
& cplHpmSvRecSe(2,9,6),cplSeSvImcHpm(6,9,2),cplSeSvImcVWm(6,9),cplSecSeVP(6,6),          & 
& cplSecSeVZ(6,6),cplSvImSvReVZ(9,9),cplSvImcSeVWm(9,6),cplSvRecSeVWm(9,6),              & 
& cplcHpmVPVWm(2),cplcVWmVPVWm,cplcHpmVWmVZ(2),cplcVWmVWmVZ,cplSecSecVWmVWm1(6,6),       & 
& cplSvImSvImcVWmVWm1(9,9),cplSvImcSeVPVWm1(9,6),cplSvImcSeVWmVZ1(9,6),cplSvRecSeVWmVZ1(9,6)
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_NInvSeesaw_SeToSvImVWm


Subroutine Amplitude_IR_VERTEX_NInvSeesaw_SeToSvImVWm(MAh,MCha,MChi,MFe,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NInvSeesaw_SeToSvImVWm


Subroutine Amplitude_Tree_NInvSeesaw_SeToSvReVWm(cplSvRecSeVWm,MSe,MSvRe,             & 
...
Complex(dp), Intent(in) :: cplSvRecSeVWm(9,6)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_NInvSeesaw_SeToSvReVWm


Subroutine Gamma_Real_NInvSeesaw_SeToSvReVWm(MLambda,em,gs,cplSvRecSeVWm,             & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_NInvSeesaw_SeToSvReVWm


Subroutine Amplitude_WAVE_NInvSeesaw_SeToSvReVWm(cplSvRecSeVWm,ctcplSvRecSeVWm,       & 
...
Complex(dp), Intent(in) :: ctcplSvRecSeVWm(9,6)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NInvSeesaw_SeToSvReVWm


Subroutine Amplitude_VERTEX_NInvSeesaw_SeToSvReVWm(MAh,MCha,MChi,MFe,MFv,             & 
& Mhh,MHpm,MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,           & 
...
Complex(dp), Intent(in) :: cplAhSecSe(3,6,6),cplAhSvImSvRe(3,9,9),cplAhSvReSvRe(3,9,9),cplAhcHpmVWm(3,2),        & 
& cplFvChacSeL(9,2,6),cplFvChacSeR(9,2,6),cplcFeChaSvReL(3,2,9),cplcFeChaSvReR(3,2,9),   & 
& cplChiFecSeL(5,3,6),cplChiFecSeR(5,3,6),cplChiFvSvReL(5,9,9),cplChiFvSvReR(5,9,9),     & 
& cplcChaChiVWmL(2,5),cplcChaChiVWmR(2,5),cplcChaFeSvReL(2,3,9),cplcChaFeSvReR(2,3,9),   & 
& cplcFeFvVWmL(3,9),cplcFeFvVWmR(3,9),cplhhSecSe(3,6,6),cplhhSvImSvRe(3,9,9),            & 
& cplhhSvReSvRe(3,9,9),cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),cplHpmSvImcSe(2,9,6),           & 
& cplHpmSvRecSe(2,9,6),cplSeSvRecHpm(6,9,2),cplSeSvRecVWm(6,9),cplSecSeVP(6,6),          & 
& cplSecSeVZ(6,6),cplSvImSvReVZ(9,9),cplSvImcSeVWm(9,6),cplSvRecSeVWm(9,6),              & 
& cplcHpmVPVWm(2),cplcVWmVPVWm,cplcHpmVWmVZ(2),cplcVWmVWmVZ,cplSecSecVWmVWm1(6,6),       & 
& cplSvImcSeVWmVZ1(9,6),cplSvReSvRecVWmVWm1(9,9),cplSvRecSeVPVWm1(9,6),cplSvRecSeVWmVZ1(9,6)
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_NInvSeesaw_SeToSvReVWm


Subroutine Amplitude_IR_VERTEX_NInvSeesaw_SeToSvReVWm(MAh,MCha,MChi,MFe,              & 
& MFv,Mhh,MHpm,MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NInvSeesaw_SeToSvReVWm


Subroutine Amplitude_WAVE_NInvSeesaw_SeToSeVP(cplSecSeVP,cplSecSeVZ,ctcplSecSeVP,     & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NInvSeesaw_SeToSeVP


Subroutine Amplitude_VERTEX_NInvSeesaw_SeToSeVP(MAh,MCha,MChi,MFe,MFv,Mhh,            & 
& MHpm,MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,               & 
...
Complex(dp), Intent(in) :: cplAhSecSe(3,6,6),cplFvChacSeL(9,2,6),cplFvChacSeR(9,2,6),cplcChaChaVPL(2,2),         & 
& cplcChaChaVPR(2,2),cplChiFecSeL(5,3,6),cplChiFecSeR(5,3,6),cplcFeChiSeL(3,5,6),        & 
& cplcFeChiSeR(3,5,6),cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),cplcChaFvSeL(2,9,6),             & 
& cplcChaFvSeR(2,9,6),cplhhSecSe(3,6,6),cplHpmSvImcSe(2,9,6),cplHpmSvRecSe(2,9,6),       & 
& cplHpmcHpmVP(2,2),cplHpmcVWmVP(2),cplSeSvImcHpm(6,9,2),cplSeSvImcVWm(6,9),             & 
& cplSeSvRecHpm(6,9,2),cplSeSvRecVWm(6,9),cplSecSeVP(6,6),cplSecSeVZ(6,6),               & 
& cplSvImcSeVWm(9,6),cplSvRecSeVWm(9,6),cplcHpmVPVWm(2),cplcVWmVPVWm,cplSeSvImcVWmVP1(6,9),& 
& cplSeSvRecVWmVP1(6,9),cplSecSeVPVP1(6,6),cplSecSeVPVZ1(6,6),cplSvImcSeVPVWm1(9,6),     & 
& cplSvRecSeVPVWm1(9,6)
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_NInvSeesaw_SeToSeVP


Subroutine Amplitude_IR_VERTEX_NInvSeesaw_SeToSeVP(MAh,MCha,MChi,MFe,MFv,             & 
& Mhh,MHpm,MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,           & 
& MSe2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplAhSecSe,cplFvChacSeL,cplFvChacSeR,               & 
& cplcChaChaVPL,cplcChaChaVPR,cplChiFecSeL,cplChiFecSeR,cplcFeChiSeL,cplcFeChiSeR,       & 
& cplcFeFeVPL,cplcFeFeVPR,cplcChaFvSeL,cplcChaFvSeR,cplhhSecSe,cplHpmSvImcSe,            & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NInvSeesaw_SeToSeVP



End Module OneLoopDecay_Se_NInvSeesaw
