...
Module Wrapper_OneLoopDecay_Fv_NInvSeesaw
Use Model_Data_NInvSeesaw 
Use Kinematics 
Use OneLoopDecay_Fv_NInvSeesaw 
Use Control 
Use Settings 
...
& cplAhHpmcHpm(3,2,2),cplAhHpmcVWm(3,2),cplAhSecSe(3,6,6),cplAhSvImSvIm(3,9,9),          & 
& cplAhSvImSvRe(3,9,9),cplAhSvReSvRe(3,9,9),cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),   & 
...
& cplcChaChiVWmL(2,5),cplcChaChiVWmR(2,5),cplcChaFeSvImL(2,3,9),cplcChaFeSvImR(2,3,9),   & 
...
& cplHpmSvImcSe(2,9,6),cplHpmSvRecSe(2,9,6),cplSecSeVP(6,6),cplSecSeVZ(6,6),             & 
& cplSeSvImcHpm(6,9,2),cplSeSvImcVWm(6,9),cplSeSvRecHpm(6,9,2),cplSeSvRecVWm(6,9),       & 
& cplSvImcSeVWm(9,6),cplSvImSvReVZ(9,9),cplSvRecSeVWm(9,6),ctcplChiFvSvImL(5,9,9),       & 
& ctcplChiFvSvImR(5,9,9),ctcplChiFvSvReL(5,9,9),ctcplChiFvSvReR(5,9,9),ctcplFvChacSeL(9,2,6),& 
& ctcplFvChacSeR(9,2,6),ctcplFvFecHpmL(9,3,2),ctcplFvFecHpmR(9,3,2),ctcplFvFecVWmL(9,3), & 
& ctcplFvFecVWmR(9,3),ctcplFvFvAhL(9,9,3),ctcplFvFvAhR(9,9,3),ctcplFvFvhhL(9,9,3),       & 
& ctcplFvFvhhR(9,9,3),ctcplFvFvVZL(9,9),ctcplFvFvVZR(9,9),GcplcHpmVPVWm(2),              & 
& GcplFvFecHpmL(9,3,2),GcplFvFecHpmR(9,3,2),GcplHpmcVWmVP(2),GosZcplcHpmVPVWm(2),        & 
& GosZcplFvFecHpmL(9,3,2),GosZcplFvFecHpmR(9,3,2),GosZcplHpmcVWmVP(2),GZcplcHpmVPVWm(2), & 
& GZcplFvFecHpmL(9,3,2),GZcplFvFecHpmR(9,3,2),GZcplHpmcVWmVP(2),ZcplcChaChaVPL(2,2),     & 
& ZcplcChaChaVPR(2,2),ZcplcChaFvSeL(2,9,6),ZcplcChaFvSeR(2,9,6),ZcplcFeFeVPL(3,3),       & 
& ZcplcFeFeVPR(3,3),ZcplcFeFvHpmL(3,9,2),ZcplcFeFvHpmR(3,9,2),ZcplcFeFvVWmL(3,9),        & 
& ZcplcFeFvVWmR(3,9),ZcplChiFvSvImL(5,9,9),ZcplChiFvSvImR(5,9,9),ZcplChiFvSvReL(5,9,9),  & 
& ZcplChiFvSvReR(5,9,9),ZcplcHpmVPVWm(2),ZcplcVWmVPVWm,ZcplFvChacSeL(9,2,6),             & 
& ZcplFvChacSeR(9,2,6),ZcplFvFecHpmL(9,3,2),ZcplFvFecHpmR(9,3,2),ZcplFvFecVWmL(9,3)

Complex(dp),Intent(in) :: ZcplFvFecVWmR(9,3),ZcplFvFvAhL(9,9,3),ZcplFvFvAhR(9,9,3),ZcplFvFvhhL(9,9,3),           & 
& ZcplFvFvhhR(9,9,3),ZcplFvFvVZL(9,9),ZcplFvFvVZR(9,9),ZcplHpmcHpmVP(2,2),               & 
...
Real(dp) :: MRPFvToFvAh(9,9,3),MRGFvToFvAh(9,9,3), MRPZFvToFvAh(9,9,3),MRGZFvToFvAh(9,9,3) 
Real(dp) :: MVPFvToFvAh(9,9,3) 
Real(dp) :: RMsqTreeFvToFvAh(9,9,3),RMsqWaveFvToFvAh(9,9,3),RMsqVertexFvToFvAh(9,9,3) 
Complex(dp) :: AmpTreeFvToFvAh(2,9,9,3),AmpWaveFvToFvAh(2,9,9,3)=(0._dp,0._dp),AmpVertexFvToFvAh(2,9,9,3)& 
 & ,AmpVertexIRosFvToFvAh(2,9,9,3),AmpVertexIRdrFvToFvAh(2,9,9,3), AmpSumFvToFvAh(2,9,9,3), AmpSum2FvToFvAh(2,9,9,3) 
Complex(dp) :: AmpTreeZFvToFvAh(2,9,9,3),AmpWaveZFvToFvAh(2,9,9,3),AmpVertexZFvToFvAh(2,9,9,3) 
Real(dp) :: AmpSqFvToFvAh(9,9,3),  AmpSqTreeFvToFvAh(9,9,3) 
Real(dp) :: MRPFvToChacSe(9,2,6),MRGFvToChacSe(9,2,6), MRPZFvToChacSe(9,2,6),MRGZFvToChacSe(9,2,6) 
Real(dp) :: MVPFvToChacSe(9,2,6) 
Real(dp) :: RMsqTreeFvToChacSe(9,2,6),RMsqWaveFvToChacSe(9,2,6),RMsqVertexFvToChacSe(9,2,6) 
Complex(dp) :: AmpTreeFvToChacSe(2,9,2,6),AmpWaveFvToChacSe(2,9,2,6)=(0._dp,0._dp),AmpVertexFvToChacSe(2,9,2,6)& 
 & ,AmpVertexIRosFvToChacSe(2,9,2,6),AmpVertexIRdrFvToChacSe(2,9,2,6), AmpSumFvToChacSe(2,9,2,6), AmpSum2FvToChacSe(2,9,2,6) 
Complex(dp) :: AmpTreeZFvToChacSe(2,9,2,6),AmpWaveZFvToChacSe(2,9,2,6),AmpVertexZFvToChacSe(2,9,2,6) 
Real(dp) :: AmpSqFvToChacSe(9,2,6),  AmpSqTreeFvToChacSe(9,2,6) 
Real(dp) :: MRPFvToChiSvIm(9,5,9),MRGFvToChiSvIm(9,5,9), MRPZFvToChiSvIm(9,5,9),MRGZFvToChiSvIm(9,5,9) 
Real(dp) :: MVPFvToChiSvIm(9,5,9) 
Real(dp) :: RMsqTreeFvToChiSvIm(9,5,9),RMsqWaveFvToChiSvIm(9,5,9),RMsqVertexFvToChiSvIm(9,5,9) 
Complex(dp) :: AmpTreeFvToChiSvIm(2,9,5,9),AmpWaveFvToChiSvIm(2,9,5,9)=(0._dp,0._dp),AmpVertexFvToChiSvIm(2,9,5,9)& 
 & ,AmpVertexIRosFvToChiSvIm(2,9,5,9),AmpVertexIRdrFvToChiSvIm(2,9,5,9), AmpSumFvToChiSvIm(2,9,5,9), AmpSum2FvToChiSvIm(2,9,5,9) 
Complex(dp) :: AmpTreeZFvToChiSvIm(2,9,5,9),AmpWaveZFvToChiSvIm(2,9,5,9),AmpVertexZFvToChiSvIm(2,9,5,9) 
Real(dp) :: AmpSqFvToChiSvIm(9,5,9),  AmpSqTreeFvToChiSvIm(9,5,9) 
Real(dp) :: MRPFvToChiSvRe(9,5,9),MRGFvToChiSvRe(9,5,9), MRPZFvToChiSvRe(9,5,9),MRGZFvToChiSvRe(9,5,9) 
Real(dp) :: MVPFvToChiSvRe(9,5,9) 
Real(dp) :: RMsqTreeFvToChiSvRe(9,5,9),RMsqWaveFvToChiSvRe(9,5,9),RMsqVertexFvToChiSvRe(9,5,9) 
Complex(dp) :: AmpTreeFvToChiSvRe(2,9,5,9),AmpWaveFvToChiSvRe(2,9,5,9)=(0._dp,0._dp),AmpVertexFvToChiSvRe(2,9,5,9)& 
 & ,AmpVertexIRosFvToChiSvRe(2,9,5,9),AmpVertexIRdrFvToChiSvRe(2,9,5,9), AmpSumFvToChiSvRe(2,9,5,9), AmpSum2FvToChiSvRe(2,9,5,9) 
Complex(dp) :: AmpTreeZFvToChiSvRe(2,9,5,9),AmpWaveZFvToChiSvRe(2,9,5,9),AmpVertexZFvToChiSvRe(2,9,5,9) 
Real(dp) :: AmpSqFvToChiSvRe(9,5,9),  AmpSqTreeFvToChiSvRe(9,5,9) 
Real(dp) :: MRPFvToFecHpm(9,3,2),MRGFvToFecHpm(9,3,2), MRPZFvToFecHpm(9,3,2),MRGZFvToFecHpm(9,3,2) 
Real(dp) :: MVPFvToFecHpm(9,3,2) 
Real(dp) :: RMsqTreeFvToFecHpm(9,3,2),RMsqWaveFvToFecHpm(9,3,2),RMsqVertexFvToFecHpm(9,3,2) 
Complex(dp) :: AmpTreeFvToFecHpm(2,9,3,2),AmpWaveFvToFecHpm(2,9,3,2)=(0._dp,0._dp),AmpVertexFvToFecHpm(2,9,3,2)& 
 & ,AmpVertexIRosFvToFecHpm(2,9,3,2),AmpVertexIRdrFvToFecHpm(2,9,3,2), AmpSumFvToFecHpm(2,9,3,2), AmpSum2FvToFecHpm(2,9,3,2) 
Complex(dp) :: AmpTreeZFvToFecHpm(2,9,3,2),AmpWaveZFvToFecHpm(2,9,3,2),AmpVertexZFvToFecHpm(2,9,3,2) 
Real(dp) :: AmpSqFvToFecHpm(9,3,2),  AmpSqTreeFvToFecHpm(9,3,2) 
Real(dp) :: MRPFvToFecVWm(9,3),MRGFvToFecVWm(9,3), MRPZFvToFecVWm(9,3),MRGZFvToFecVWm(9,3) 
Real(dp) :: MVPFvToFecVWm(9,3) 
Real(dp) :: RMsqTreeFvToFecVWm(9,3),RMsqWaveFvToFecVWm(9,3),RMsqVertexFvToFecVWm(9,3) 
Complex(dp) :: AmpTreeFvToFecVWm(4,9,3),AmpWaveFvToFecVWm(4,9,3)=(0._dp,0._dp),AmpVertexFvToFecVWm(4,9,3)& 
 & ,AmpVertexIRosFvToFecVWm(4,9,3),AmpVertexIRdrFvToFecVWm(4,9,3), AmpSumFvToFecVWm(4,9,3), AmpSum2FvToFecVWm(4,9,3) 
Complex(dp) :: AmpTreeZFvToFecVWm(4,9,3),AmpWaveZFvToFecVWm(4,9,3),AmpVertexZFvToFecVWm(4,9,3) 
Real(dp) :: AmpSqFvToFecVWm(9,3),  AmpSqTreeFvToFecVWm(9,3) 
Real(dp) :: MRPFvToFvhh(9,9,3),MRGFvToFvhh(9,9,3), MRPZFvToFvhh(9,9,3),MRGZFvToFvhh(9,9,3) 
Real(dp) :: MVPFvToFvhh(9,9,3) 
Real(dp) :: RMsqTreeFvToFvhh(9,9,3),RMsqWaveFvToFvhh(9,9,3),RMsqVertexFvToFvhh(9,9,3) 
Complex(dp) :: AmpTreeFvToFvhh(2,9,9,3),AmpWaveFvToFvhh(2,9,9,3)=(0._dp,0._dp),AmpVertexFvToFvhh(2,9,9,3)& 
 & ,AmpVertexIRosFvToFvhh(2,9,9,3),AmpVertexIRdrFvToFvhh(2,9,9,3), AmpSumFvToFvhh(2,9,9,3), AmpSum2FvToFvhh(2,9,9,3) 
Complex(dp) :: AmpTreeZFvToFvhh(2,9,9,3),AmpWaveZFvToFvhh(2,9,9,3),AmpVertexZFvToFvhh(2,9,9,3) 
Real(dp) :: AmpSqFvToFvhh(9,9,3),  AmpSqTreeFvToFvhh(9,9,3) 
Real(dp) :: MRPFvToFvVZ(9,9),MRGFvToFvVZ(9,9), MRPZFvToFvVZ(9,9),MRGZFvToFvVZ(9,9) 
Real(dp) :: MVPFvToFvVZ(9,9) 
Real(dp) :: RMsqTreeFvToFvVZ(9,9),RMsqWaveFvToFvVZ(9,9),RMsqVertexFvToFvVZ(9,9) 
Complex(dp) :: AmpTreeFvToFvVZ(4,9,9),AmpWaveFvToFvVZ(4,9,9)=(0._dp,0._dp),AmpVertexFvToFvVZ(4,9,9)& 
 & ,AmpVertexIRosFvToFvVZ(4,9,9),AmpVertexIRdrFvToFvVZ(4,9,9), AmpSumFvToFvVZ(4,9,9), AmpSum2FvToFvVZ(4,9,9) 
Complex(dp) :: AmpTreeZFvToFvVZ(4,9,9),AmpWaveZFvToFvVZ(4,9,9),AmpVertexZFvToFvVZ(4,9,9) 
Real(dp) :: AmpSqFvToFvVZ(9,9),  AmpSqTreeFvToFvVZ(9,9) 
Real(dp) :: MRPFvToFvVP(9,9),MRGFvToFvVP(9,9), MRPZFvToFvVP(9,9),MRGZFvToFvVP(9,9) 
Real(dp) :: MVPFvToFvVP(9,9) 
Real(dp) :: RMsqTreeFvToFvVP(9,9),RMsqWaveFvToFvVP(9,9),RMsqVertexFvToFvVP(9,9) 
Complex(dp) :: AmpTreeFvToFvVP(4,9,9),AmpWaveFvToFvVP(4,9,9)=(0._dp,0._dp),AmpVertexFvToFvVP(4,9,9)& 
 & ,AmpVertexIRosFvToFvVP(4,9,9),AmpVertexIRdrFvToFvVP(4,9,9), AmpSumFvToFvVP(4,9,9), AmpSum2FvToFvVP(4,9,9) 
Complex(dp) :: AmpTreeZFvToFvVP(4,9,9),AmpWaveZFvToFvVP(4,9,9),AmpVertexZFvToFvVP(4,9,9) 
Real(dp) :: AmpSqFvToFvVP(9,9),  AmpSqTreeFvToFvVP(9,9) 
...
Call Amplitude_Tree_NInvSeesaw_FvToFvAh(cplFvFvAhL,cplFvFvAhR,MAh,MFv,MAh2,           & 
& MFv2,AmpTreeFvToFvAh)

  Else 
Call Amplitude_Tree_NInvSeesaw_FvToFvAh(ZcplFvFvAhL,ZcplFvFvAhR,MAh,MFv,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_FvToFvAh(MLambda,em,gs,cplFvFvAhL,cplFvFvAhR,              & 
& MAhOS,MFvOS,MRPFvToFvAh,MRGFvToFvAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_FvToFvAh(MLambda,em,gs,ZcplFvFvAhL,ZcplFvFvAhR,            & 
& MAhOS,MFvOS,MRPFvToFvAh,MRGFvToFvAh)
...
Call Amplitude_WAVE_NInvSeesaw_FvToFvAh(cplFvFvAhL,cplFvFvAhR,ctcplFvFvAhL,           & 
& ctcplFvFvAhR,MAh,MAh2,MFv,MFv2,ZfAh,ZfFV,AmpWaveFvToFvAh)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_FvToFvAh(MAh,MCha,MChi,MFe,MFv,Mhh,MHpm,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_FvToFvAh(MAh,MCha,MChi,MFe,MFv,Mhh,               & 
...
& cplcChaFvSeR,cplcFeFvVWmL,cplcFeFvVWmR,AmpVertexIRdrFvToFvAh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_FvToFvAh(MAhOS,MChaOS,MChiOS,MFeOS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_FvToChacSe(cplFvChacSeL,cplFvChacSeR,MCha,             & 
& MFv,MSe,MCha2,MFv2,MSe2,AmpTreeFvToChacSe)

  Else 
Call Amplitude_Tree_NInvSeesaw_FvToChacSe(ZcplFvChacSeL,ZcplFvChacSeR,MCha,           & 
& MFv,MSe,MCha2,MFv2,MSe2,AmpTreeFvToChacSe)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_FvToChacSe(MLambda,em,gs,cplFvChacSeL,cplFvChacSeR,        & 
& MChaOS,MFvOS,MSeOS,MRPFvToChacSe,MRGFvToChacSe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_FvToChacSe(MLambda,em,gs,ZcplFvChacSeL,ZcplFvChacSeR,      & 
& MChaOS,MFvOS,MSeOS,MRPFvToChacSe,MRGFvToChacSe)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_FvToChacSe(cplFvChacSeL,cplFvChacSeR,ctcplFvChacSeL,   & 
& ctcplFvChacSeR,MCha,MCha2,MFv,MFv2,MSe,MSe2,ZfFV,ZfLm,ZfLp,ZfSe,AmpWaveFvToChacSe)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_FvToChacSe(MAh,MCha,MChi,MFe,MFv,Mhh,MHpm,           & 
...
& cplSvImcSeVWm,cplSvRecSeVWm,AmpVertexFvToChacSe)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_FvToChacSe(MAh,MCha,MChi,MFe,MFv,Mhh,             & 
...
& cplSecSeVP,cplSecSeVZ,cplSvImcSeVWm,cplSvRecSeVWm,AmpVertexIRdrFvToChacSe)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_FvToChacSe(MAhOS,MChaOS,MChiOS,MFeOS,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_FvToChiSvIm(cplChiFvSvImL,cplChiFvSvImR,               & 
& MChi,MFv,MSvIm,MChi2,MFv2,MSvIm2,AmpTreeFvToChiSvIm)

  Else 
Call Amplitude_Tree_NInvSeesaw_FvToChiSvIm(ZcplChiFvSvImL,ZcplChiFvSvImR,             & 
& MChi,MFv,MSvIm,MChi2,MFv2,MSvIm2,AmpTreeFvToChiSvIm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_FvToChiSvIm(MLambda,em,gs,cplChiFvSvImL,cplChiFvSvImR,     & 
& MChiOS,MFvOS,MSvImOS,MRPFvToChiSvIm,MRGFvToChiSvIm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_FvToChiSvIm(MLambda,em,gs,ZcplChiFvSvImL,ZcplChiFvSvImR,   & 
& MChiOS,MFvOS,MSvImOS,MRPFvToChiSvIm,MRGFvToChiSvIm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_FvToChiSvIm(cplChiFvSvImL,cplChiFvSvImR,               & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_FvToChiSvIm(MAh,MCha,MChi,MFe,MFv,Mhh,               & 
& MHpm,MSe,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,MSe2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_FvToChiSvIm(MAh,MCha,MChi,MFe,MFv,Mhh,            & 
& MHpm,MSe,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,MSe2,              & 
& MSvIm2,MSvRe2,MVWm2,MVZ2,cplChiChiAhL,cplChiChiAhR,cplFvFvAhL,cplFvFvAhR,              & 
& cplAhSvImSvIm,cplAhSvImSvRe,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,              & 
& cplChiChacVWmR,cplFvChacSeL,cplFvChacSeR,cplcFeChaSvImL,cplcFeChaSvImR,cplChiChihhL,   & 
...
& cplSeSvImcVWm,cplSvImSvReVZ,cplSvImcSeVWm,AmpVertexIRdrFvToChiSvIm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_FvToChiSvIm(MAhOS,MChaOS,MChiOS,MFeOS,            & 
& MFvOS,MhhOS,MHpmOS,MSeOS,MSvImOS,MSvReOS,MVWmOS,MVZOS,MAh2OS,MCha2OS,MChi2OS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_FvToChiSvRe(cplChiFvSvReL,cplChiFvSvReR,               & 
& MChi,MFv,MSvRe,MChi2,MFv2,MSvRe2,AmpTreeFvToChiSvRe)

  Else 
Call Amplitude_Tree_NInvSeesaw_FvToChiSvRe(ZcplChiFvSvReL,ZcplChiFvSvReR,             & 
& MChi,MFv,MSvRe,MChi2,MFv2,MSvRe2,AmpTreeFvToChiSvRe)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_FvToChiSvRe(MLambda,em,gs,cplChiFvSvReL,cplChiFvSvReR,     & 
& MChiOS,MFvOS,MSvReOS,MRPFvToChiSvRe,MRGFvToChiSvRe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_FvToChiSvRe(MLambda,em,gs,ZcplChiFvSvReL,ZcplChiFvSvReR,   & 
& MChiOS,MFvOS,MSvReOS,MRPFvToChiSvRe,MRGFvToChiSvRe)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_FvToChiSvRe(cplChiFvSvReL,cplChiFvSvReR,               & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_FvToChiSvRe(MAh,MCha,MChi,MFe,MFv,Mhh,               & 
& MHpm,MSe,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,MSe2,              & 
& MSvIm2,MSvRe2,MVWm2,MVZ2,cplChiChiAhL,cplChiChiAhR,cplFvFvAhL,cplFvFvAhR,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_FvToChiSvRe(MAh,MCha,MChi,MFe,MFv,Mhh,            & 
& MHpm,MSe,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,MSe2,              & 
& MSvIm2,MSvRe2,MVWm2,MVZ2,cplChiChiAhL,cplChiChiAhR,cplFvFvAhL,cplFvFvAhR,              & 
& cplAhSvImSvRe,cplAhSvReSvRe,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,              & 
& cplChiChacVWmR,cplFvChacSeL,cplFvChacSeR,cplcFeChaSvReL,cplcFeChaSvReR,cplChiChihhL,   & 
...
& cplSeSvRecVWm,cplSvImSvReVZ,cplSvRecSeVWm,AmpVertexIRdrFvToChiSvRe)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_FvToChiSvRe(MAhOS,MChaOS,MChiOS,MFeOS,            & 
& MFvOS,MhhOS,MHpmOS,MSeOS,MSvImOS,MSvReOS,MVWmOS,MVZOS,MAh2OS,MCha2OS,MChi2OS,          & 
& MFe2OS,MFv2OS,Mhh2OS,MHpm2OS,MSe2OS,MSvIm2OS,MSvRe2OS,MVWm2OS,MVZ2OS,cplChiChiAhL,     & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_FvToFecHpm(cplFvFecHpmL,cplFvFecHpmR,MFe,              & 
& MFv,MHpm,MFe2,MFv2,MHpm2,AmpTreeFvToFecHpm)

  Else 
Call Amplitude_Tree_NInvSeesaw_FvToFecHpm(ZcplFvFecHpmL,ZcplFvFecHpmR,MFe,            & 
& MFv,MHpm,MFe2,MFv2,MHpm2,AmpTreeFvToFecHpm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_FvToFecHpm(MLambda,em,gs,cplFvFecHpmL,cplFvFecHpmR,        & 
& MFeOS,MFvOS,MHpmOS,MRPFvToFecHpm,MRGFvToFecHpm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_FvToFecHpm(MLambda,em,gs,ZcplFvFecHpmL,ZcplFvFecHpmR,      & 
& MFeOS,MFvOS,MHpmOS,MRPFvToFecHpm,MRGFvToFecHpm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_FvToFecHpm(cplFvFecHpmL,cplFvFecHpmR,ctcplFvFecHpmL,   & 
& ctcplFvFecHpmR,MFe,MFe2,MFv,MFv2,MHpm,MHpm2,ZfFEL,ZfFER,ZfFV,ZfHpm,AmpWaveFvToFecHpm)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_FvToFecHpm(MAh,MCha,MChi,MFe,MFv,Mhh,MHpm,           & 
& MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,MSe2,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_FvToFecHpm(MAh,MCha,MChi,MFe,MFv,Mhh,             & 
& MHpm,MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,               & 
...
& cplcHpmVPVWm,cplcHpmVWmVZ,AmpVertexIRdrFvToFecHpm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_FvToFecHpm(MAhOS,MChaOS,MChiOS,MFeOS,             & 
& MFvOS,MhhOS,MHpmOS,MSeOS,MSvImOS,MSvReOS,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,              & 
& MChi2OS,MFe2OS,MFv2OS,Mhh2OS,MHpm2OS,MSe2OS,MSvIm2OS,MSvRe2OS,MVP2,MVWm2OS,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_FvToFecVWm(cplFvFecVWmL,cplFvFecVWmR,MFe,              & 
& MFv,MVWm,MFe2,MFv2,MVWm2,AmpTreeFvToFecVWm)

  Else 
Call Amplitude_Tree_NInvSeesaw_FvToFecVWm(ZcplFvFecVWmL,ZcplFvFecVWmR,MFe,            & 
& MFv,MVWm,MFe2,MFv2,MVWm2,AmpTreeFvToFecVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_FvToFecVWm(MLambda,em,gs,cplFvFecVWmL,cplFvFecVWmR,        & 
& MFeOS,MFvOS,MVWmOS,MRPFvToFecVWm,MRGFvToFecVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_FvToFecVWm(MLambda,em,gs,ZcplFvFecVWmL,ZcplFvFecVWmR,      & 
& MFeOS,MFvOS,MVWmOS,MRPFvToFecVWm,MRGFvToFecVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_FvToFecVWm(cplFvFecVWmL,cplFvFecVWmR,ctcplFvFecVWmL,   & 
& ctcplFvFecVWmR,MFe,MFe2,MFv,MFv2,MVWm,MVWm2,ZfFEL,ZfFER,ZfFV,ZfVWm,AmpWaveFvToFecVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_FvToFecVWm(MAh,MCha,MChi,MFe,MFv,Mhh,MHpm,           & 
& MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,MSe2,               & 
& MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplFvFvAhL,cplFvFvAhR,           & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_FvToFecVWm(MAh,MCha,MChi,MFe,MFv,Mhh,             & 
& MHpm,MSe,MSvIm,MSvRe,MVP,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,               & 
& MSe2,MSvIm2,MSvRe2,MVP2,MVWm2,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplFvFvAhL,cplFvFvAhR,      & 
& cplAhHpmcVWm,cplChiChacVWmL,cplChiChacVWmR,cplFvChacSeL,cplFvChacSeR,cplChiFecSeL,     & 
& cplChiFecSeR,cplChiFvSvImL,cplChiFvSvImR,cplChiFvSvReL,cplChiFvSvReR,cplFvFecHpmL,     & 
...
& AmpVertexIRdrFvToFecVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_FvToFecVWm(MAhOS,MChaOS,MChiOS,MFeOS,             & 
& MFvOS,MhhOS,MHpmOS,MSeOS,MSvImOS,MSvReOS,MVP,MVWmOS,MVZOS,MAh2OS,MCha2OS,              & 
& MChi2OS,MFe2OS,MFv2OS,Mhh2OS,MHpm2OS,MSe2OS,MSvIm2OS,MSvRe2OS,MVP2,MVWm2OS,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_FvToFvhh(cplFvFvhhL,cplFvFvhhR,MFv,Mhh,MFv2,           & 
& Mhh2,AmpTreeFvToFvhh)

  Else 
Call Amplitude_Tree_NInvSeesaw_FvToFvhh(ZcplFvFvhhL,ZcplFvFvhhR,MFv,Mhh,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_FvToFvhh(MLambda,em,gs,cplFvFvhhL,cplFvFvhhR,              & 
& MFvOS,MhhOS,MRPFvToFvhh,MRGFvToFvhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_FvToFvhh(MLambda,em,gs,ZcplFvFvhhL,ZcplFvFvhhR,            & 
& MFvOS,MhhOS,MRPFvToFvhh,MRGFvToFvhh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_FvToFvhh(cplFvFvhhL,cplFvFvhhR,ctcplFvFvhhL,           & 
& ctcplFvFvhhR,MFv,MFv2,Mhh,Mhh2,ZfFV,Zfhh,AmpWaveFvToFvhh)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_FvToFvhh(MAh,MCha,MChi,MFe,MFv,Mhh,MHpm,             & 
& MSe,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,MSe2,MSvIm2,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_FvToFvhh(MAh,MCha,MChi,MFe,MFv,Mhh,               & 
& MHpm,MSe,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,MSe2,              & 
...
& AmpVertexIRdrFvToFvhh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_FvToFvhh(MAhOS,MChaOS,MChiOS,MFeOS,               & 
& MFvOS,MhhOS,MHpmOS,MSeOS,MSvImOS,MSvReOS,MVWmOS,MVZOS,MAh2OS,MCha2OS,MChi2OS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NInvSeesaw_FvToFvVZ(cplFvFvVZL,cplFvFvVZR,MFv,MVZ,MFv2,           & 
& MVZ2,AmpTreeFvToFvVZ)

  Else 
Call Amplitude_Tree_NInvSeesaw_FvToFvVZ(ZcplFvFvVZL,ZcplFvFvVZR,MFv,MVZ,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NInvSeesaw_FvToFvVZ(MLambda,em,gs,cplFvFvVZL,cplFvFvVZR,              & 
& MFvOS,MVZOS,MRPFvToFvVZ,MRGFvToFvVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NInvSeesaw_FvToFvVZ(MLambda,em,gs,ZcplFvFvVZL,ZcplFvFvVZR,            & 
& MFvOS,MVZOS,MRPFvToFvVZ,MRGFvToFvVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NInvSeesaw_FvToFvVZ(cplFvFvVZL,cplFvFvVZR,ctcplFvFvVZL,           & 
& ctcplFvFvVZR,MFv,MFv2,MVZ,MVZ2,ZfFV,ZfVZ,AmpWaveFvToFvVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_FvToFvVZ(MAh,MCha,MChi,MFe,MFv,Mhh,MHpm,             & 
& MSe,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,MSe2,MSvIm2,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NInvSeesaw_FvToFvVZ(MAh,MCha,MChi,MFe,MFv,Mhh,               & 
& MHpm,MSe,MSvIm,MSvRe,MVWm,MVZ,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,MSe2,              & 
...
& AmpVertexIRdrFvToFvVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NInvSeesaw_FvToFvVZ(MAhOS,MChaOS,MChiOS,MFeOS,               & 
& MFvOS,MhhOS,MHpmOS,MSeOS,MSvImOS,MSvReOS,MVWmOS,MVZOS,MAh2OS,MCha2OS,MChi2OS,          & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_NInvSeesaw_FvToFvVP(ZcplFvFvVZL,ZcplFvFvVZR,ctcplFvFvVZL,         & 
& ctcplFvFvVZR,MFvOS,MFv2OS,MVP,MVP2,MVZOS,MVZ2OS,ZfFV,ZfVP,ZfVZVP,AmpWaveFvToFvVP)

 Else 
Call Amplitude_WAVE_NInvSeesaw_FvToFvVP(cplFvFvVZL,cplFvFvVZR,ctcplFvFvVZL,           & 
& ctcplFvFvVZR,MFvOS,MFv2OS,MVP,MVP2,MVZOS,MVZ2OS,ZfFV,ZfVP,ZfVZVP,AmpWaveFvToFvVP)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_NInvSeesaw_FvToFvVP(MChaOS,MFeOS,MFvOS,MHpmOS,MSeOS,            & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NInvSeesaw_FvToFvVP(MCha,MFe,MFv,MHpm,MSe,MVP,MVWm,             & 
...
End Module Wrapper_OneLoopDecay_Fv_NInvSeesaw
