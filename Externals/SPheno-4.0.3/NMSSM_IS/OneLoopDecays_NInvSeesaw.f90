...
Module OneLoopDecays_NInvSeesaw 
Use Couplings_NInvSeesaw 
Use CouplingsCT_NInvSeesaw 
Use Model_Data_NInvSeesaw 
Use LoopCouplings_NInvSeesaw 
Use LoopMasses_NInvSeesaw 
Use RGEs_NInvSeesaw 
Use Tadpoles_NInvSeesaw 
Use Kinematics 
Use CouplingsForDecays_NInvSeesaw 
 
Use Wrapper_OneLoopDecay_hh_NInvSeesaw 
Use Wrapper_OneLoopDecay_Ah_NInvSeesaw 
Use Wrapper_OneLoopDecay_Hpm_NInvSeesaw 
Use Wrapper_OneLoopDecay_Sd_NInvSeesaw 
Use Wrapper_OneLoopDecay_Su_NInvSeesaw 
Use Wrapper_OneLoopDecay_Se_NInvSeesaw 
Use Wrapper_OneLoopDecay_SvIm_NInvSeesaw 
Use Wrapper_OneLoopDecay_SvRe_NInvSeesaw 
Use Wrapper_OneLoopDecay_Chi_NInvSeesaw 
Use Wrapper_OneLoopDecay_Cha_NInvSeesaw 
Use Wrapper_OneLoopDecay_Glu_NInvSeesaw 
Use Wrapper_OneLoopDecay_Fv_NInvSeesaw 

 
Contains 
 
Subroutine getZCouplings(lam,Tlam,kap,Tk,vd,vu,vS,ZA,g1,g2,ZH,ZP,Yd,Td,               & 
& ZD,Ye,Te,ZE,Yu,Tu,ZU,MUX,lamN,TLN,Yv,Tv,ZVI,ZVR,g3,TW,UM,UP,ZN,ZDL,ZDR,ZEL,            & 
& ZER,ZUL,ZUR,UV,pG,cplAhAhAh,cplAhAhhh,cplAhhhhh,cplAhHpmcHpm,cplAhSdcSd,               & 
& cplAhSecSe,cplAhSucSu,cplAhSvImSvIm,cplAhSvImSvRe,cplAhSvReSvRe,cplhhhhhh,             & 
...
& cplSeSvRecHpm,cplAhAhAhAh,cplAhAhAhhh,cplAhAhhhhh,cplAhAhHpmcHpm,cplAhAhSdcSd,         & 
& cplAhAhSecSe,cplAhAhSucSu,cplAhAhSvImSvIm,cplAhAhSvImSvRe,cplAhAhSvReSvRe,             & 
& cplAhhhhhhh,cplAhhhHpmcHpm,cplAhhhSdcSd,cplAhhhSecSe,cplAhhhSucSu,cplAhhhSvImSvIm,     & 
& cplAhhhSvImSvRe,cplAhhhSvReSvRe,cplAhHpmSucSd,cplAhHpmSvImcSe,cplAhHpmSvRecSe,         & 
& cplAhSdcHpmcSu,cplAhSeSvImcHpm,cplAhSeSvRecHpm,cplhhhhhhhh,cplhhhhHpmcHpm,             & 
& cplhhhhSdcSd,cplhhhhSecSe,cplhhhhSucSu,cplhhhhSvImSvIm,cplhhhhSvImSvRe,cplhhhhSvReSvRe,& 
...
& cplAhAhSdcSd(3,3,6,6),cplAhAhSecSe(3,3,6,6),cplAhAhSucSu(3,3,6,6),cplAhAhSvImSvIm(3,3,9,9),& 
& cplAhAhSvImSvRe(3,3,9,9),cplAhAhSvReSvRe(3,3,9,9),cplAhhhhhhh(3,3,3,3),cplAhhhHpmcHpm(3,3,2,2),& 
& cplAhhhSdcSd(3,3,6,6),cplAhhhSecSe(3,3,6,6),cplAhhhSucSu(3,3,6,6),cplAhhhSvImSvIm(3,3,9,9),& 
& cplAhhhSvImSvRe(3,3,9,9),cplAhhhSvReSvRe(3,3,9,9),cplAhHpmSucSd(3,2,6,6),              & 
& cplAhHpmSvImcSe(3,2,9,6),cplAhHpmSvRecSe(3,2,9,6),cplAhSdcHpmcSu(3,6,2,6),             & 
& cplAhSeSvImcHpm(3,6,9,2),cplAhSeSvRecHpm(3,6,9,2),cplhhhhhhhh(3,3,3,3),cplhhhhHpmcHpm(3,3,2,2),& 
& cplhhhhSdcSd(3,3,6,6),cplhhhhSecSe(3,3,6,6),cplhhhhSucSu(3,3,6,6),cplhhhhSvImSvIm(3,3,9,9),& 
& cplhhhhSvImSvRe(3,3,9,9),cplhhhhSvReSvRe(3,3,9,9),cplhhHpmSucSd(3,2,6,6),              & 
& cplhhHpmSvImcSe(3,2,9,6),cplhhHpmSvRecSe(3,2,9,6),cplhhSdcHpmcSu(3,6,2,6),             & 
& cplhhSeSvImcHpm(3,6,9,2),cplhhSeSvRecHpm(3,6,9,2),cplHpmHpmcHpmcHpm(2,2,2,2),          & 
& cplHpmSdcHpmcSd(2,6,2,6),cplHpmSecHpmcSe(2,6,2,6),cplHpmSucHpmcSu(2,6,2,6),            & 
& cplHpmSvImSvImcHpm(2,9,9,2),cplHpmSvImSvRecHpm(2,9,9,2),cplHpmSvReSvRecHpm(2,9,9,2),   & 
& cplSdSdcSdcSd(6,6,6,6),cplSdSecSdcSe(6,6,6,6),cplSdSucSdcSu(6,6,6,6),cplSdSvImSvImcSd(6,9,9,6),& 
& cplSdSvImcSecSu(6,9,6,6),cplSdSvReSvRecSd(6,9,9,6),cplSdSvRecSecSu(6,9,6,6),           & 
& cplSeSecSecSe(6,6,6,6),cplSeSuSvImcSd(6,6,9,6),cplSeSuSvRecSd(6,6,9,6),cplSeSucSecSu(6,6,6,6),& 
& cplSeSvImSvImcSe(6,9,9,6),cplSeSvImSvRecSe(6,9,9,6),cplSeSvReSvRecSe(6,9,9,6),         & 
& cplSuSucSucSu(6,6,6,6),cplSuSvImSvImcSu(6,9,9,6),cplSuSvImSvRecSu(6,9,9,6),            & 
& cplSuSvReSvRecSu(6,9,9,6),cplSvImSvImSvImSvIm(9,9,9,9),cplSvImSvImSvImSvRe(9,9,9,9),   & 
& cplSvImSvImSvReSvRe(9,9,9,9),cplSvImSvReSvReSvRe(9,9,9,9),cplSvReSvReSvReSvRe(9,9,9,9),& 
...
& cplSdcSucVWm(6,6),cplSeSvImcVWm(6,9),cplSeSvRecVWm(6,9),cplSecSeVP(6,6),               & 
& cplSecSeVZ(6,6),cplSucSuVG(6,6),cplSucSuVP(6,6),cplSucSdVWm(6,6),cplSucSuVZ(6,6),      & 
& cplSvImSvReVZ(9,9),cplSvImcSeVWm(9,6),cplSvRecSeVWm(9,6),cplhhcVWmVWm(3),              & 
...
& cplSdcSdVZVZ(6,6),cplSdcSucVWmVZ(6,6),cplSeSvImcVWmVP(6,9),cplSeSvImcVWmVZ(6,9),       & 
& cplSeSvRecVWmVP(6,9),cplSeSvRecVWmVZ(6,9),cplSecSeVPVP(6,6),cplSecSeVPVZ(6,6),         & 
...
& cplSvImSvImcVWmVWm(9,9),cplSvImSvImVZVZ(9,9),cplSvImcSeVPVWm(9,6),cplSvImcSeVWmVZ(9,6),& 
& cplSvReSvRecVWmVWm(9,9),cplSvReSvReVZVZ(9,9),cplSvRecSeVPVWm(9,6),cplSvRecSeVWmVZ(9,6),& 
...
& cplcFdFdVZR(3,3),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),cplFvFecVWmL(9,3),              & 
& cplFvFecVWmR(9,3),cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3), & 
...
& cplcFeFvVWmL(3,9),cplcFeFvVWmR(3,9),cplGluGluVGL,cplGluGluVGR,cplVGVGVGVG1
...
& TempcplAhSdcSd(3,6,6),TempcplAhSecSe(3,6,6),TempcplAhSucSu(3,6,6),TempcplAhSvImSvIm(3,9,9),& 
& TempcplAhSvImSvRe(3,9,9),TempcplAhSvReSvRe(3,9,9),Tempcplhhhhhh(3,3,3),TempcplhhHpmcHpm(3,2,2),& 
& TempcplhhSdcSd(3,6,6),TempcplhhSecSe(3,6,6),TempcplhhSucSu(3,6,6),TempcplhhSvImSvIm(3,9,9),& 
& TempcplhhSvImSvRe(3,9,9),TempcplhhSvReSvRe(3,9,9),TempcplHpmSucSd(2,6,6),              & 
& TempcplHpmSvImcSe(2,9,6),TempcplHpmSvRecSe(2,9,6),TempcplSdcHpmcSu(6,2,6),             & 
& TempcplSeSvImcHpm(6,9,2),TempcplSeSvRecHpm(6,9,2),TempcplAhAhAhAh(3,3,3,3),            & 
...
& TempcplAhAhSvImSvIm(3,3,9,9),TempcplAhAhSvImSvRe(3,3,9,9),TempcplAhAhSvReSvRe(3,3,9,9),& 
& TempcplAhhhhhhh(3,3,3,3),TempcplAhhhHpmcHpm(3,3,2,2),TempcplAhhhSdcSd(3,3,6,6),        & 
& TempcplAhhhSecSe(3,3,6,6),TempcplAhhhSucSu(3,3,6,6),TempcplAhhhSvImSvIm(3,3,9,9),      & 
& TempcplAhhhSvImSvRe(3,3,9,9),TempcplAhhhSvReSvRe(3,3,9,9),TempcplAhHpmSucSd(3,2,6,6),  & 
& TempcplAhHpmSvImcSe(3,2,9,6),TempcplAhHpmSvRecSe(3,2,9,6),TempcplAhSdcHpmcSu(3,6,2,6), & 
& TempcplAhSeSvImcHpm(3,6,9,2),TempcplAhSeSvRecHpm(3,6,9,2),Tempcplhhhhhhhh(3,3,3,3),    & 
& TempcplhhhhHpmcHpm(3,3,2,2),TempcplhhhhSdcSd(3,3,6,6),TempcplhhhhSecSe(3,3,6,6),       & 
& TempcplhhhhSucSu(3,3,6,6),TempcplhhhhSvImSvIm(3,3,9,9),TempcplhhhhSvImSvRe(3,3,9,9),   & 
& TempcplhhhhSvReSvRe(3,3,9,9),TempcplhhHpmSucSd(3,2,6,6),TempcplhhHpmSvImcSe(3,2,9,6),  & 
& TempcplhhHpmSvRecSe(3,2,9,6),TempcplhhSdcHpmcSu(3,6,2,6),TempcplhhSeSvImcHpm(3,6,9,2), & 
& TempcplhhSeSvRecHpm(3,6,9,2),TempcplHpmHpmcHpmcHpm(2,2,2,2),TempcplHpmSdcHpmcSd(2,6,2,6),& 
& TempcplHpmSecHpmcSe(2,6,2,6),TempcplHpmSucHpmcSu(2,6,2,6),TempcplHpmSvImSvImcHpm(2,9,9,2),& 
& TempcplHpmSvImSvRecHpm(2,9,9,2),TempcplHpmSvReSvRecHpm(2,9,9,2),TempcplSdSdcSdcSd(6,6,6,6),& 
& TempcplSdSecSdcSe(6,6,6,6),TempcplSdSucSdcSu(6,6,6,6),TempcplSdSvImSvImcSd(6,9,9,6),   & 
& TempcplSdSvImcSecSu(6,9,6,6),TempcplSdSvReSvRecSd(6,9,9,6),TempcplSdSvRecSecSu(6,9,6,6),& 
& TempcplSeSecSecSe(6,6,6,6),TempcplSeSuSvImcSd(6,6,9,6),TempcplSeSuSvRecSd(6,6,9,6),    & 
& TempcplSeSucSecSu(6,6,6,6),TempcplSeSvImSvImcSe(6,9,9,6),TempcplSeSvImSvRecSe(6,9,9,6),& 
& TempcplSeSvReSvRecSe(6,9,9,6),TempcplSuSucSucSu(6,6,6,6),TempcplSuSvImSvImcSu(6,9,9,6),& 
& TempcplSuSvImSvRecSu(6,9,9,6),TempcplSuSvReSvRecSu(6,9,9,6),TempcplSvImSvImSvImSvIm(9,9,9,9),& 
& TempcplSvImSvImSvImSvRe(9,9,9,9),TempcplSvImSvImSvReSvRe(9,9,9,9),TempcplSvImSvReSvReSvRe(9,9,9,9),& 
& TempcplSvReSvReSvReSvRe(9,9,9,9),TempcplAhhhVZ(3,3),TempcplAhHpmcVWm(3,2),             & 
...
& TempcplSdcSucVWm(6,6),TempcplSeSvImcVWm(6,9),TempcplSeSvRecVWm(6,9),TempcplSecSeVP(6,6),& 
& TempcplSecSeVZ(6,6),TempcplSucSuVG(6,6),TempcplSucSuVP(6,6),TempcplSucSdVWm(6,6),      & 
& TempcplSucSuVZ(6,6),TempcplSvImSvReVZ(9,9),TempcplSvImcSeVWm(9,6),TempcplSvRecSeVWm(9,6),& 
...
& TempcplSdcSdcVWmVWm(6,6),TempcplSdcSdVZVZ(6,6),TempcplSdcSucVWmVZ(6,6),TempcplSeSvImcVWmVP(6,9),& 
& TempcplSeSvImcVWmVZ(6,9),TempcplSeSvRecVWmVP(6,9),TempcplSeSvRecVWmVZ(6,9),            & 
...
& TempcplSucSucVWmVWm(6,6),TempcplSucSuVZVZ(6,6),TempcplSvImSvImcVWmVWm(9,9),            & 
& TempcplSvImSvImVZVZ(9,9),TempcplSvImcSeVPVWm(9,6),TempcplSvImcSeVWmVZ(9,6),            & 
& TempcplSvReSvRecVWmVWm(9,9),TempcplSvReSvReVZVZ(9,9),TempcplSvRecSeVPVWm(9,6),         & 
& TempcplSvRecSeVWmVZ(9,6),TempcplVGVGVG,TempcplcVWmVPVWm,TempcplcVWmVWmVZ,              & 
...
& TempcplcFeFeAhR(3,3,3),TempcplcFuFuAhL(3,3,3),TempcplcFuFuAhR(3,3,3),TempcplFvFvAhL(9,9,3),& 
& TempcplFvFvAhR(9,9,3),TempcplChiChacHpmL(5,2,2),TempcplChiChacHpmR(5,2,2),             & 
& TempcplChaFucSdL(2,3,6),TempcplChaFucSdR(2,3,6),TempcplFvChacSeL(9,2,6),               & 
& TempcplFvChacSeR(9,2,6),TempcplcChaChahhL(2,2,3),TempcplcChaChahhR(2,2,3),             & 
& TempcplcFdChaSuL(3,2,6),TempcplcFdChaSuR(3,2,6),TempcplcFeChaSvImL(3,2,9),             & 
& TempcplcFeChaSvImR(3,2,9),TempcplcFeChaSvReL(3,2,9),TempcplcFeChaSvReR(3,2,9),         & 
...
& TempcplChiFucSuL(5,3,6),TempcplChiFucSuR(5,3,6),TempcplChiFvSvImL(5,9,9),              & 
& TempcplChiFvSvImR(5,9,9),TempcplChiFvSvReL(5,9,9),TempcplChiFvSvReR(5,9,9),            & 
...
& TempcplcFuFdcHpmL(3,3,2),TempcplcFuFdcHpmR(3,3,2),TempcplFvFecHpmL(9,3,2),             & 
& TempcplFvFecHpmR(9,3,2),TempcplcFeFehhL(3,3,3),TempcplcFeFehhR(3,3,3),TempcplcChaFeSvImL(2,3,9),& 
& TempcplcChaFeSvImR(2,3,9),TempcplcChaFeSvReL(2,3,9),TempcplcChaFeSvReR(2,3,9),         & 
& TempcplGluFucSuL(3,6),TempcplGluFucSuR(3,6),TempcplcFuFuhhL(3,3,3),TempcplcFuFuhhR(3,3,3),& 
& TempcplcFdFuHpmL(3,3,2),TempcplcFdFuHpmR(3,3,2),TempcplFvFvhhL(9,9,3),TempcplFvFvhhR(9,9,3),& 
& TempcplcFeFvHpmL(3,9,2),TempcplcFeFvHpmR(3,9,2),TempcplcChaFvSeL(2,9,6)

Complex(dp) :: TempcplcChaFvSeR(2,9,6),TempcplcFdGluSdL(3,6),TempcplcFdGluSdR(3,6),TempcplcFuGluSuL(3,6),& 
...
& TempcplcFuFdcVWmL(3,3),TempcplcFuFdcVWmR(3,3),TempcplFvFecVWmL(9,3),TempcplFvFecVWmR(9,3),& 
...
& TempcplFvFvVZL(9,9),TempcplFvFvVZR(9,9),TempcplcFeFvVWmL(3,9),TempcplcFeFvVWmR(3,9),   & 
...
& ZcplAhSdcSd(3,6,6),ZcplAhSecSe(3,6,6),ZcplAhSucSu(3,6,6),ZcplAhSvImSvIm(3,9,9),        & 
& ZcplAhSvImSvRe(3,9,9),ZcplAhSvReSvRe(3,9,9),Zcplhhhhhh(3,3,3),ZcplhhHpmcHpm(3,2,2),    & 
& ZcplhhSdcSd(3,6,6),ZcplhhSecSe(3,6,6),ZcplhhSucSu(3,6,6),ZcplhhSvImSvIm(3,9,9),        & 
& ZcplhhSvImSvRe(3,9,9),ZcplhhSvReSvRe(3,9,9),ZcplHpmSucSd(2,6,6),ZcplHpmSvImcSe(2,9,6), & 
& ZcplHpmSvRecSe(2,9,6),ZcplSdcHpmcSu(6,2,6),ZcplSeSvImcHpm(6,9,2),ZcplSeSvRecHpm(6,9,2),& 
& ZcplAhAhAhAh(3,3,3,3),ZcplAhAhAhhh(3,3,3,3),ZcplAhAhhhhh(3,3,3,3),ZcplAhAhHpmcHpm(3,3,2,2),& 
& ZcplAhAhSdcSd(3,3,6,6),ZcplAhAhSecSe(3,3,6,6),ZcplAhAhSucSu(3,3,6,6),ZcplAhAhSvImSvIm(3,3,9,9),& 
& ZcplAhAhSvImSvRe(3,3,9,9),ZcplAhAhSvReSvRe(3,3,9,9),ZcplAhhhhhhh(3,3,3,3),             & 
& ZcplAhhhHpmcHpm(3,3,2,2),ZcplAhhhSdcSd(3,3,6,6),ZcplAhhhSecSe(3,3,6,6),ZcplAhhhSucSu(3,3,6,6),& 
& ZcplAhhhSvImSvIm(3,3,9,9),ZcplAhhhSvImSvRe(3,3,9,9),ZcplAhhhSvReSvRe(3,3,9,9),         & 
& ZcplAhHpmSucSd(3,2,6,6),ZcplAhHpmSvImcSe(3,2,9,6),ZcplAhHpmSvRecSe(3,2,9,6),           & 
& ZcplAhSdcHpmcSu(3,6,2,6),ZcplAhSeSvImcHpm(3,6,9,2),ZcplAhSeSvRecHpm(3,6,9,2),          & 
& Zcplhhhhhhhh(3,3,3,3),ZcplhhhhHpmcHpm(3,3,2,2),ZcplhhhhSdcSd(3,3,6,6),ZcplhhhhSecSe(3,3,6,6),& 
& ZcplhhhhSucSu(3,3,6,6),ZcplhhhhSvImSvIm(3,3,9,9),ZcplhhhhSvImSvRe(3,3,9,9),            & 
& ZcplhhhhSvReSvRe(3,3,9,9),ZcplhhHpmSucSd(3,2,6,6),ZcplhhHpmSvImcSe(3,2,9,6),           & 
& ZcplhhHpmSvRecSe(3,2,9,6),ZcplhhSdcHpmcSu(3,6,2,6),ZcplhhSeSvImcHpm(3,6,9,2),          & 
& ZcplhhSeSvRecHpm(3,6,9,2),ZcplHpmHpmcHpmcHpm(2,2,2,2),ZcplHpmSdcHpmcSd(2,6,2,6),       & 
& ZcplHpmSecHpmcSe(2,6,2,6),ZcplHpmSucHpmcSu(2,6,2,6),ZcplHpmSvImSvImcHpm(2,9,9,2),      & 
& ZcplHpmSvImSvRecHpm(2,9,9,2),ZcplHpmSvReSvRecHpm(2,9,9,2),ZcplSdSdcSdcSd(6,6,6,6),     & 
& ZcplSdSecSdcSe(6,6,6,6),ZcplSdSucSdcSu(6,6,6,6),ZcplSdSvImSvImcSd(6,9,9,6),            & 
& ZcplSdSvImcSecSu(6,9,6,6),ZcplSdSvReSvRecSd(6,9,9,6),ZcplSdSvRecSecSu(6,9,6,6),        & 
& ZcplSeSecSecSe(6,6,6,6),ZcplSeSuSvImcSd(6,6,9,6),ZcplSeSuSvRecSd(6,6,9,6),             & 
& ZcplSeSucSecSu(6,6,6,6),ZcplSeSvImSvImcSe(6,9,9,6),ZcplSeSvImSvRecSe(6,9,9,6),         & 
& ZcplSeSvReSvRecSe(6,9,9,6),ZcplSuSucSucSu(6,6,6,6),ZcplSuSvImSvImcSu(6,9,9,6),         & 
& ZcplSuSvImSvRecSu(6,9,9,6),ZcplSuSvReSvRecSu(6,9,9,6),ZcplSvImSvImSvImSvIm(9,9,9,9),   & 
& ZcplSvImSvImSvImSvRe(9,9,9,9),ZcplSvImSvImSvReSvRe(9,9,9,9),ZcplSvImSvReSvReSvRe(9,9,9,9),& 
& ZcplSvReSvReSvReSvRe(9,9,9,9),ZcplAhhhVZ(3,3),ZcplAhHpmcVWm(3,2),ZcplAhcHpmVWm(3,2),   & 
& ZcplhhHpmcVWm(3,2),ZcplhhcHpmVWm(3,2),ZcplHpmcHpmVP(2,2),ZcplHpmcHpmVZ(2,2),           & 
& ZcplSdcSdVG(6,6),ZcplSdcSdVP(6,6),ZcplSdcSdVZ(6,6),ZcplSdcSucVWm(6,6),ZcplSeSvImcVWm(6,9),& 
& ZcplSeSvRecVWm(6,9),ZcplSecSeVP(6,6),ZcplSecSeVZ(6,6),ZcplSucSuVG(6,6),ZcplSucSuVP(6,6),& 
& ZcplSucSdVWm(6,6),ZcplSucSuVZ(6,6),ZcplSvImSvReVZ(9,9),ZcplSvImcSeVWm(9,6),            & 
& ZcplSvRecSeVWm(9,6),ZcplhhcVWmVWm(3),ZcplhhVZVZ(3),ZcplHpmcVWmVP(2),ZcplHpmcVWmVZ(2),  & 
...
& ZcplSeSvImcVWmVP(6,9),ZcplSeSvImcVWmVZ(6,9),ZcplSeSvRecVWmVP(6,9),ZcplSeSvRecVWmVZ(6,9),& 
...
& ZcplSucSucVWmVWm(6,6),ZcplSucSuVZVZ(6,6),ZcplSvImSvImcVWmVWm(9,9),ZcplSvImSvImVZVZ(9,9),& 
& ZcplSvImcSeVPVWm(9,6),ZcplSvImcSeVWmVZ(9,6),ZcplSvReSvRecVWmVWm(9,9),ZcplSvReSvReVZVZ(9,9),& 
& ZcplSvRecSeVPVWm(9,6),ZcplSvRecSeVWmVZ(9,6),ZcplVGVGVG,ZcplcVWmVPVWm,ZcplcVWmVWmVZ,    & 
...
& ZcplcFuFuAhL(3,3,3),ZcplcFuFuAhR(3,3,3),ZcplFvFvAhL(9,9,3),ZcplFvFvAhR(9,9,3),         & 
& ZcplChiChacHpmL(5,2,2),ZcplChiChacHpmR(5,2,2),ZcplChaFucSdL(2,3,6),ZcplChaFucSdR(2,3,6),& 
& ZcplFvChacSeL(9,2,6),ZcplFvChacSeR(9,2,6),ZcplcChaChahhL(2,2,3),ZcplcChaChahhR(2,2,3), & 
& ZcplcFdChaSuL(3,2,6),ZcplcFdChaSuR(3,2,6),ZcplcFeChaSvImL(3,2,9),ZcplcFeChaSvImR(3,2,9),& 
& ZcplcFeChaSvReL(3,2,9),ZcplcFeChaSvReR(3,2,9),ZcplChiChihhL(5,5,3),ZcplChiChihhR(5,5,3),& 
& ZcplChiFdcSdL(5,3,6),ZcplChiFdcSdR(5,3,6),ZcplChiFecSeL(5,3,6),ZcplChiFecSeR(5,3,6),   & 
& ZcplChiFucSuL(5,3,6),ZcplChiFucSuR(5,3,6),ZcplChiFvSvImL(5,9,9),ZcplChiFvSvImR(5,9,9), & 
& ZcplChiFvSvReL(5,9,9),ZcplChiFvSvReR(5,9,9),ZcplcChaChiHpmL(2,5,2),ZcplcChaChiHpmR(2,5,2),& 
...
& ZcplcFuFdcHpmL(3,3,2),ZcplcFuFdcHpmR(3,3,2),ZcplFvFecHpmL(9,3,2),ZcplFvFecHpmR(9,3,2), & 
& ZcplcFeFehhL(3,3,3),ZcplcFeFehhR(3,3,3),ZcplcChaFeSvImL(2,3,9),ZcplcChaFeSvImR(2,3,9), & 
& ZcplcChaFeSvReL(2,3,9),ZcplcChaFeSvReR(2,3,9),ZcplGluFucSuL(3,6),ZcplGluFucSuR(3,6),   & 
& ZcplcFuFuhhL(3,3,3),ZcplcFuFuhhR(3,3,3),ZcplcFdFuHpmL(3,3,2),ZcplcFdFuHpmR(3,3,2),     & 
& ZcplFvFvhhL(9,9,3),ZcplFvFvhhR(9,9,3),ZcplcFeFvHpmL(3,9,2),ZcplcFeFvHpmR(3,9,2),       & 
& ZcplcChaFvSeL(2,9,6),ZcplcChaFvSeR(2,9,6),ZcplcFdGluSdL(3,6),ZcplcFdGluSdR(3,6),       & 
...
& ZcplcFuFdcVWmL(3,3),ZcplcFuFdcVWmR(3,3),ZcplFvFecVWmL(9,3),ZcplFvFecVWmR(9,3),         & 
...
& ZcplFvFvVZL(9,9),ZcplFvFvVZR(9,9),ZcplcFeFvVWmL(3,9),ZcplcFeFvVWmR(3,9),               & 
& ZcplGluGluVGL,ZcplGluGluVGR,ZcplVGVGVGVG1,ZcplVGVGVGVG2,ZcplVGVGVGVG3,ZcplcVWmVPVPVWm1,& 
& ZcplcVWmVPVPVWm2,ZcplcVWmVPVPVWm3,ZcplcVWmVPVWmVZ1,ZcplcVWmVPVWmVZ2,ZcplcVWmVPVWmVZ3,  & 
& ZcplcVWmcVWmVWmVWm1,ZcplcVWmcVWmVWmVWm2,ZcplcVWmcVWmVWmVWm3,ZcplcVWmVWmVZVZ1,          & 
& ZcplcVWmVWmVZVZ2,ZcplcVWmVWmVZVZ3,ZcplcgGgGVG,ZcplcgWmgAVWm,ZcplcgWpCgAcVWm,           & 
...
& cplcFdFuVWmR(3,3),cplcFeFvVWmL(3,9),cplcFeFvVWmR(3,9),cplcFuFdcVWmL(3,3),              & 
& cplcFuFdcVWmR(3,3),cplChiChacVWmL(5,2),cplChiChacVWmR(5,2),cplcHpmVPVWm(2),            & 
& cplcHpmVWmVZ(2),cplcVWmVPVWm,cplcVWmVWmVZ,cplFvFecVWmL(9,3),cplFvFecVWmR(9,3),         & 
& cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),cplSdcSucVWm(6,6),cplSeSvImcVWm(6,9),cplSeSvRecVWm(6,9),& 
& cplSucSdVWm(6,6),cplSvImcSeVWm(9,6),cplSvRecSeVWm(9,6),ZcplAhcHpmVWm(3,2),             & 
& ZcplcChaChiVWmL(2,5),ZcplcChaChiVWmR(2,5),ZcplcFdFuVWmL(3,3),ZcplcFdFuVWmR(3,3),       & 
& ZcplcFeFvVWmL(3,9),ZcplcFeFvVWmR(3,9),ZcplcFuFdcVWmL(3,3),ZcplcFuFdcVWmR(3,3),         & 
& ZcplChiChacVWmL(5,2),ZcplChiChacVWmR(5,2),ZcplcHpmVPVWm(2),ZcplcHpmVWmVZ(2),           & 
& ZcplcVWmVPVWm,ZcplcVWmVWmVZ,ZcplFvFecVWmL(9,3),ZcplFvFecVWmR(9,3),ZcplhhcHpmVWm(3,2),  & 
& ZcplhhcVWmVWm(3),ZcplSdcSucVWm(6,6),ZcplSeSvImcVWm(6,9),ZcplSeSvRecVWm(6,9),           & 
& ZcplSucSdVWm(6,6),ZcplSvImcSeVWm(9,6),ZcplSvRecSeVWm(9,6)

Integer :: gt1, gt2, gt3, i1, i2
Complex(dp), Intent(out) :: GcplAhHpmcHpm(3,2,2),GcplhhHpmcHpm(3,2,2),GcplHpmSucSd(2,6,6),GcplHpmSvImcSe(2,9,6),  & 
& GcplHpmSvRecSe(2,9,6),GcplSdcHpmcSu(6,2,6),GcplSeSvImcHpm(6,9,2),GcplSeSvRecHpm(6,9,2),& 
...
& GcplFvFecHpmL(9,3,2),GcplFvFecHpmR(9,3,2),GcplcFdFuHpmL(3,3,2),GcplcFdFuHpmR(3,3,2),   & 
& GcplcFeFvHpmL(3,9,2),GcplcFeFvHpmR(3,9,2)

Complex(dp), Intent(out) :: GZcplAhHpmcHpm(3,2,2),GZcplhhHpmcHpm(3,2,2),GZcplHpmSucSd(2,6,6),GZcplHpmSvImcSe(2,9,6),& 
& GZcplHpmSvRecSe(2,9,6),GZcplSdcHpmcSu(6,2,6),GZcplSeSvImcHpm(6,9,2),GZcplSeSvRecHpm(6,9,2),& 
...
& GZcplFvFecHpmL(9,3,2),GZcplFvFecHpmR(9,3,2),GZcplcFdFuHpmL(3,3,2),GZcplcFdFuHpmR(3,3,2),& 
& GZcplcFeFvHpmL(3,9,2),GZcplcFeFvHpmR(3,9,2)

Complex(dp), Intent(out) :: GosZcplAhHpmcHpm(3,2,2),GosZcplhhHpmcHpm(3,2,2),GosZcplHpmSucSd(2,6,6),               & 
& GosZcplHpmSvImcSe(2,9,6),GosZcplHpmSvRecSe(2,9,6),GosZcplSdcHpmcSu(6,2,6),             & 
& GosZcplSeSvImcHpm(6,9,2),GosZcplSeSvRecHpm(6,9,2),GosZcplAhHpmcVWm(3,2),               & 
...
& GosZcplcFuFdcHpmR(3,3,2),GosZcplFvFecHpmL(9,3,2),GosZcplFvFecHpmR(9,3,2),              & 
& GosZcplcFdFuHpmL(3,3,2),GosZcplcFdFuHpmR(3,3,2),GosZcplcFeFvHpmL(3,9,2),               & 
& GosZcplcFeFvHpmR(3,9,2)
...
& ZN,ZP,ZU,ZUL,ZUR,ZVI,ZVR,ZW,ZZ,betaH,g1,g2,g3,Yd,Ye,lam,kap,lamN,Yu,Yv,MUX,            & 
& Td,Te,Tlam,Tk,TLN,Tu,Tv,BMUX,mq2,ml2,mHd2,mHu2,md2,mu2,me2,mv2,ms2,mx2,M1,             & 
& M2,M3,vd,vu,vS,cplAhAhAh,cplAhAhhh,cplAhhhhh,cplAhHpmcHpm,cplAhSdcSd,cplAhSecSe,       & 
...
& dg1,dg2,dg3,dMUX,dBMUX,dYd,dTd,dYe,dTe,dlam,dTlam,dkap,dTk,dlamN,dTLN,dYu,             & 
& dTu,dYv,dTv,dmq2,dml2,dmHd2,dmHu2,dmd2,dmu2,dme2,dmv2,dms2,dmx2,dM1,dM2,               & 
& dM3,dvd,dvu,dvS,dpG,dZD,dZVI,dZVR,dZU,dZE,dZH,dZA,dZP,dZN,dUV,dUM,dUP,dZEL,            & 
& dZER,dZDL,dZDR,dZUL,dZUR,dSinTW,dCosTW,dTanTW,ZfVG,ZffG,ZfVP,ZfVZ,ZfVWm,               & 
& ZfSd,ZfSvIm,ZfSvRe,ZfSu,ZfSe,Zfhh,ZfAh,ZfHpm,ZfL0,ZfFV,ZfLm,ZfLp,ZfFEL,ZfFER,          & 
& ZfFDL,ZfFDR,ZfFUL,ZfFUR,ZfVPVZ,ZfVZVP,ctcplAhAhAh,ctcplAhAhhh,ctcplAhhhhh,             & 
& ctcplAhHpmcHpm,ctcplAhSdcSd,ctcplAhSecSe,ctcplAhSucSu,ctcplAhSvImSvIm,ctcplAhSvImSvRe, & 
& ctcplAhSvReSvRe,ctcplhhhhhh,ctcplhhHpmcHpm,ctcplhhSdcSd,ctcplhhSecSe,ctcplhhSucSu,     & 
& ctcplhhSvImSvIm,ctcplhhSvImSvRe,ctcplhhSvReSvRe,ctcplHpmSucSd,ctcplHpmSvImcSe,         & 
& ctcplHpmSvRecSe,ctcplSdcHpmcSu,ctcplSeSvImcHpm,ctcplSeSvRecHpm,ctcplAhhhVZ,            & 
& ctcplAhHpmcVWm,ctcplAhcHpmVWm,ctcplhhHpmcVWm,ctcplhhcHpmVWm,ctcplHpmcHpmVP,            & 
& ctcplHpmcHpmVZ,ctcplSdcSdVG,ctcplSdcSdVP,ctcplSdcSdVZ,ctcplSdcSucVWm,ctcplSeSvImcVWm,  & 
& ctcplSeSvRecVWm,ctcplSecSeVP,ctcplSecSeVZ,ctcplSucSuVG,ctcplSucSuVP,ctcplSucSdVWm,     & 
& ctcplSucSuVZ,ctcplSvImSvReVZ,ctcplSvImcSeVWm,ctcplSvRecSeVWm,ctcplhhcVWmVWm,           & 
...
& ctcplcFdFdVZL,ctcplcFdFdVZR,ctcplcFuFdcVWmL,ctcplcFuFdcVWmR,ctcplFvFecVWmL,            & 
& ctcplFvFecVWmR,ctcplcFeFeVPL,ctcplcFeFeVPR,ctcplcFeFeVZL,ctcplcFeFeVZR,ctcplcFuFuVGL,  & 
& ctcplcFuFuVGR,ctcplcFuFuVPL,ctcplcFuFuVPR,ctcplcFdFuVWmL,ctcplcFdFuVWmR,               & 
& ctcplcFuFuVZL,ctcplcFuFuVZR,ctcplFvFvVZL,ctcplFvFvVZR,ctcplcFeFvVWmL,ctcplcFeFvVWmR,   & 
...
Complex(dp) :: PiSd(6,6,6),DerPiSd(6,6,6),PiSvIm(9,9,9),DerPiSvIm(9,9,9),PiSvRe(9,9,9),              & 
& DerPiSvRe(9,9,9),PiSu(6,6,6),DerPiSu(6,6,6),PiSe(6,6,6),DerPiSe(6,6,6),Pihh(3,3,3),    & 
...
& DerSigmaSLirChi(5,5,5),DerSigmaSRirChi(5,5,5),DerSigmaRirChi(5,5,5),SigmaLFv(9,9,9),   & 
& SigmaSLFv(9,9,9),SigmaSRFv(9,9,9),SigmaRFv(9,9,9),DerSigmaLFv(9,9,9),DerSigmaSLFv(9,9,9),& 
& DerSigmaSRFv(9,9,9),DerSigmaRFv(9,9,9),DerSigmaLirFv(9,9,9),DerSigmaSLirFv(9,9,9),     & 
& DerSigmaSRirFv(9,9,9),DerSigmaRirFv(9,9,9),SigmaLCha(2,2,2),SigmaSLCha(2,2,2),         & 
...
Complex(dp) :: PiSdDR(6,6,6),DerPiSdDR(6,6,6),PiSvImDR(9,9,9),DerPiSvImDR(9,9,9),PiSvReDR(9,9,9),    & 
& DerPiSvReDR(9,9,9),PiSuDR(6,6,6),DerPiSuDR(6,6,6),PiSeDR(6,6,6),DerPiSeDR(6,6,6),      & 
...
& DerSigmaRirChiDR(5,5,5),SigmaLFvDR(9,9,9),SigmaSLFvDR(9,9,9),SigmaSRFvDR(9,9,9),       & 
& SigmaRFvDR(9,9,9),DerSigmaLFvDR(9,9,9),DerSigmaSLFvDR(9,9,9),DerSigmaSRFvDR(9,9,9),    & 
& DerSigmaRFvDR(9,9,9),DerSigmaLirFvDR(9,9,9),DerSigmaSLirFvDR(9,9,9),DerSigmaSRirFvDR(9,9,9),& 
& DerSigmaRirFvDR(9,9,9),SigmaLChaDR(2,2,2),SigmaSLChaDR(2,2,2),SigmaSRChaDR(2,2,2),     & 
...
Complex(dp) :: PiSdOS(6,6,6),DerPiSdOS(6,6,6),PiSvImOS(9,9,9),DerPiSvImOS(9,9,9),PiSvReOS(9,9,9),    & 
& DerPiSvReOS(9,9,9),PiSuOS(6,6,6),DerPiSuOS(6,6,6),PiSeOS(6,6,6),DerPiSeOS(6,6,6),      & 
...
& DerSigmaRirChiOS(5,5,5),SigmaLFvOS(9,9,9),SigmaSLFvOS(9,9,9),SigmaSRFvOS(9,9,9),       & 
& SigmaRFvOS(9,9,9),DerSigmaLFvOS(9,9,9),DerSigmaSLFvOS(9,9,9),DerSigmaSRFvOS(9,9,9),    & 
& DerSigmaRFvOS(9,9,9),DerSigmaLirFvOS(9,9,9),DerSigmaSLirFvOS(9,9,9),DerSigmaSRirFvOS(9,9,9),& 
& DerSigmaRirFvOS(9,9,9),SigmaLChaOS(2,2,2),SigmaSLChaOS(2,2,2),SigmaSRChaOS(2,2,2),     & 
...
Complex(dp),Intent(out) :: dMUX(3,3),dBMUX(3,3),dYd(3,3),dTd(3,3),dYe(3,3),dTe(3,3),dlam,dTlam,dkap,             & 
...
Complex(dp),Intent(out) :: ZfVG,ZffG,ZfVP,ZfVZ,ZfVWm,ZfSd(6,6),ZfSvIm(9,9),ZfSvRe(9,9),ZfSu(6,6),ZfSe(6,6),      & 
...
Complex(dp),Intent(in) :: GcplAhHpmcHpm(3,2,2),GcplhhHpmcHpm(3,2,2),GcplHpmSucSd(2,6,6),GcplHpmSvImcSe(2,9,6),  & 
& GcplHpmSvRecSe(2,9,6),GcplSdcHpmcSu(6,2,6),GcplSeSvImcHpm(6,9,2),GcplSeSvRecHpm(6,9,2),& 
& GcplAhHpmcVWm(3,2),GcplAhcHpmVWm(3,2),GcplhhHpmcVWm(3,2),GcplhhcHpmVWm(3,2),           & 
& GcplHpmcHpmVP(2,2),GcplHpmcHpmVZ(2,2),GcplHpmcVWmVP(2),GcplHpmcVWmVZ(2),               & 
& GcplcHpmVPVWm(2),GcplcHpmVWmVZ(2),GcplChiChacHpmL(5,2,2),GcplChiChacHpmR(5,2,2),       & 
...
Call ParametersToG365(g1,g2,g3,Yd,Ye,lam,kap,lamN,Yu,Yv,MUX,Td,Te,Tlam,               & 
& Tk,TLN,Tu,Tv,BMUX,mq2,ml2,mHd2,mHu2,md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,vd,               & 
& vu,vS,g1D)

TwoLoopRGEsave=TwoLoopRGE 
TwoLoopRGE=.False. 
Call rge365(365,0._dp,g1D,g1D) 
TwoLoopRGE=TwoLoopRGEsave 
Call GToParameters365(g1D,dg1,dg2,dg3,dYd,dYe,dlam,dkap,dlamN,dYu,dYv,dMUX,           & 
& dTd,dTe,dTlam,dTk,dTLN,dTu,dTv,dBMUX,dmq2,dml2,dmHd2,dmHu2,dmd2,dmu2,dme2,             & 
& dmv2,dms2,dmx2,dM1,dM2,dM3,dvd,dvu,dvS)
...
dMUX = 0.5_dp*divergence*dMUX 
dBMUX = 0.5_dp*divergence*dBMUX 
...
& ZD,Ye,Te,ZE,Yu,Tu,ZU,MUX,lamN,TLN,Yv,Tv,ZVI,ZVR,TW,g3,UM,UP,ZN,ZDL,ZDR,ZEL,            & 
& ZER,ZUL,ZUR,UV,pG,dlam,dTlam,dkap,dTk,dvd,dvu,dvS,dZA,dg1,dg2,dZH,dZP,dYd,             & 
& dTd,dZD,dYe,dTe,dZE,dYu,dTu,dZU,dMUX,dlamN,dTLN,dYv,dTv,dZVI,dZVR,dSinTW,              & 
...
Subroutine CalculateOneLoopDecays(gP1Lhh,gP1LAh,gP1LHpm,gP1LSd,gP1LSu,gP1LSe,         & 
& gP1LSvIm,gP1LSvRe,gP1LChi,gP1LCha,gP1LGlu,gP1LFv,MSdOS,MSd2OS,MSvImOS,MSvIm2OS,        & 
& MSvReOS,MSvRe2OS,MSuOS,MSu2OS,MSeOS,MSe2OS,MhhOS,Mhh2OS,MAhOS,MAh2OS,MHpmOS,           & 
& MHpm2OS,MChiOS,MChi2OS,MFvOS,MFv2OS,MChaOS,MCha2OS,MFeOS,MFe2OS,MFdOS,MFd2OS,          & 
& MFuOS,MFu2OS,MGluOS,MGlu2OS,MVZOS,MVZ2OS,MVWmOS,MVWm2OS,ZDOS,ZVIOS,ZVROS,              & 
& ZUOS,ZEOS,ZHOS,ZAOS,ZPOS,ZNOS,UVOS,UMOS,UPOS,ZELOS,ZEROS,ZDLOS,ZDROS,ZULOS,            & 
& ZUROS,vd,vu,vS,g1,g2,g3,Yd,Ye,lam,kap,lamN,Yu,Yv,MUX,Td,Te,Tlam,Tk,TLN,Tu,             & 
& Tv,BMUX,mq2,ml2,mHd2,mHu2,md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,epsI,deltaM,kont)
...
Complex(dp) :: dMUX(3,3),dBMUX(3,3),dYd(3,3),dTd(3,3),dYe(3,3),dTe(3,3),dlam,dTlam,dkap,             & 
& dTk,dlamN(3,3),dTLN(3,3),dYu(3,3),dTu(3,3),dYv(3,3),dTv(3,3),dmq2(3,3),dml2(3,3),      & 
& dmd2(3,3),dmu2(3,3),dme2(3,3),dmv2(3,3),dmx2(3,3),dM1,dM2,dM3,dpG,dZD(6,6),            & 
& dZVI(9,9),dZVR(9,9),dZU(6,6),dZE(6,6),dZN(5,5),dUV(9,9),dUM(2,2),dUP(2,2),             & 
& dZEL(3,3),dZER(3,3),dZDL(3,3),dZDR(3,3),dZUL(3,3),dZUR(3,3)

Complex(dp) :: ZfVG,ZffG,ZfVP,ZfVZ,ZfVWm,ZfSd(6,6),ZfSvIm(9,9),ZfSvRe(9,9),ZfSu(6,6),ZfSe(6,6),      & 
& Zfhh(3,3),ZfAh(3,3),ZfHpm(2,2),ZfL0(5,5),ZfFV(9,9),ZfLm(2,2),ZfLp(2,2),ZfFEL(3,3),     & 
& ZfFER(3,3),ZfFDL(3,3),ZfFDR(3,3),ZfFUL(3,3),ZfFUR(3,3),ZfVPVZ,ZfVZVP
...
& cplAhAhSdcSdaa(3,3,6,6),cplAhAhSecSe1(3,3,6,6),cplAhAhSucSuaa(3,3,6,6),cplAhAhSvImSvIm1(3,3,9,9),& 
& cplAhAhSvImSvRe1(3,3,9,9),cplAhAhSvReSvRe1(3,3,9,9),cplAhhhhhhh1(3,3,3,3),             & 
...
& cplAhhhSvReSvRe1(3,3,9,9),cplAhHpmSucSdaa(3,2,6,6),cplAhHpmSvImcSe1(3,2,9,6),          & 
& cplAhHpmSvRecSe1(3,2,9,6),cplAhSdcHpmcSuaa(3,6,2,6),cplAhSeSvImcHpm1(3,6,9,2),         & 
& cplAhSeSvRecHpm1(3,6,9,2),cplhhhhhhhh1(3,3,3,3),cplhhhhHpmcHpm1(3,3,2,2),              & 
& cplhhhhSdcSdaa(3,3,6,6),cplhhhhSecSe1(3,3,6,6),cplhhhhSucSuaa(3,3,6,6),cplhhhhSvImSvIm1(3,3,9,9),& 
& cplhhhhSvImSvRe1(3,3,9,9),cplhhhhSvReSvRe1(3,3,9,9),cplhhHpmSucSdaa(3,2,6,6),          & 
& cplhhHpmSvImcSe1(3,2,9,6),cplhhHpmSvRecSe1(3,2,9,6),cplhhSdcHpmcSuaa(3,6,2,6),         & 
& cplhhSeSvImcHpm1(3,6,9,2),cplhhSeSvRecHpm1(3,6,9,2),cplHpmHpmcHpmcHpm1(2,2,2,2),       & 
...
& cplSdSucSdcSuabba(6,6,6,6),cplSdSucSdcSuabab(6,6,6,6),cplSdSvImSvImcSdaa(6,9,9,6),     & 
& cplSdSvImcSecSuaa(6,9,6,6),cplSdSvReSvRecSdaa(6,9,9,6),cplSdSvRecSecSuaa(6,9,6,6),     & 
& cplSeSecSecSe1(6,6,6,6),cplSeSuSvImcSdaa(6,6,9,6),cplSeSuSvRecSdaa(6,6,9,6),           & 
& cplSeSucSecSuaa(6,6,6,6),cplSeSvImSvImcSe1(6,9,9,6),cplSeSvImSvRecSe1(6,9,9,6),        & 
& cplSeSvReSvRecSe1(6,9,9,6),cplSuSucSucSuabba(6,6,6,6),cplSuSucSucSuabab(6,6,6,6),      & 
& cplSuSvImSvImcSuaa(6,9,9,6),cplSuSvImSvRecSuaa(6,9,9,6),cplSuSvReSvRecSuaa(6,9,9,6),   & 
& cplSvImSvImSvImSvIm1(9,9,9,9),cplSvImSvImSvImSvRe1(9,9,9,9),cplSvImSvImSvReSvRe1(9,9,9,9),& 
& cplSvImSvReSvReSvRe1(9,9,9,9),cplSvReSvReSvReSvRe1(9,9,9,9),cplAhAhcVWmVWm1(3,3),      & 
...
& cplSdcSucVWmVZaa(6,6),cplSeSvImcVWmVP1(6,9),cplSeSvImcVWmVZ1(6,9),cplSeSvRecVWmVP1(6,9),& 
& cplSeSvRecVWmVZ1(6,9),cplSecSeVPVP1(6,6),cplSecSeVPVZ1(6,6),cplSecSecVWmVWm1(6,6),     & 
...
& cplSucSucVWmVWmaa(6,6),cplSucSuVZVZaa(6,6),cplSvImSvImcVWmVWm1(9,9),cplSvImSvImVZVZ1(9,9),& 
& cplSvImcSeVPVWm1(9,6),cplSvImcSeVWmVZ1(9,6),cplSvReSvRecVWmVWm1(9,9),cplSvReSvReVZVZ1(9,9)

Complex(dp) :: cplSvRecSeVPVWm1(9,6),cplSvRecSeVWmVZ1(9,6),cplVGVGVGVG1Q,cplVGVGVGVG2Q,               & 
...
Complex(dp) :: ZRUZD(6,6),ZRUZVI(9,9),ZRUZVR(9,9),ZRUZU(6,6),ZRUZE(6,6),ZRUZH(3,3),ZRUZA(3,3),       & 
& ZRUZP(2,2),ZRUZN(5,5),ZRUUV(9,9),ZRUUM(2,2),ZRUUP(2,2),ZRUZEL(3,3),ZRUZER(3,3),        & 
& ZRUZDL(3,3),ZRUZDR(3,3),ZRUZUL(3,3),ZRUZUR(3,3)
...
Complex(dp) :: GcplAhHpmcHpm(3,2,2),GcplhhHpmcHpm(3,2,2),GcplHpmSucSd(2,6,6),GcplHpmSvImcSe(2,9,6),  & 
& GcplHpmSvRecSe(2,9,6),GcplSdcHpmcSu(6,2,6),GcplSeSvImcHpm(6,9,2),GcplSeSvRecHpm(6,9,2),& 
& GcplAhHpmcVWm(3,2),GcplAhcHpmVWm(3,2),GcplhhHpmcVWm(3,2),GcplhhcHpmVWm(3,2),           & 
& GcplHpmcHpmVP(2,2),GcplHpmcHpmVZ(2,2),GcplHpmcVWmVP(2),GcplHpmcVWmVZ(2),               & 
& GcplcHpmVPVWm(2),GcplcHpmVWmVZ(2),GcplChiChacHpmL(5,2,2),GcplChiChacHpmR(5,2,2),       & 
...
Complex(dp) :: GZcplAhHpmcHpm(3,2,2),GZcplhhHpmcHpm(3,2,2),GZcplHpmSucSd(2,6,6),GZcplHpmSvImcSe(2,9,6),& 
& GZcplHpmSvRecSe(2,9,6),GZcplSdcHpmcSu(6,2,6),GZcplSeSvImcHpm(6,9,2),GZcplSeSvRecHpm(6,9,2),& 
& GZcplAhHpmcVWm(3,2),GZcplAhcHpmVWm(3,2),GZcplhhHpmcVWm(3,2),GZcplhhcHpmVWm(3,2),       & 
& GZcplHpmcHpmVP(2,2),GZcplHpmcHpmVZ(2,2),GZcplHpmcVWmVP(2),GZcplHpmcVWmVZ(2),           & 
& GZcplcHpmVPVWm(2),GZcplcHpmVWmVZ(2),GZcplChiChacHpmL(5,2,2),GZcplChiChacHpmR(5,2,2),   & 
...
Real(dp), Intent(out) :: gP1LAh(3,405) 
Real(dp), Intent(out) :: gP1LHpm(2,204) 
...
Real(dp), Intent(out) :: gP1LChi(5,256) 
Real(dp), Intent(out) :: gP1LCha(2,168) 
Real(dp), Intent(out) :: gP1LGlu(1,49) 
Real(dp), Intent(out) :: gP1LFv(9,171) 
Iname = Iname + 1 
...
& Te,ZE,Yu,Tu,ZU,MUX,lamN,TLN,Yv,Tv,ZVI,ZVR,g3,TW,UM,UP,ZN,ZDL,ZDR,ZEL,ZER,              & 
...
& MHpm,MHpm2,MSd,MSd2,MSe,MSe2,MSu,MSu2,MSvIm,MSvIm2,MSvRe,MSvRe2,MVWm,MVWm2,            & 
& MVZ,MVZ2,pG,TW,UM,UP,UV,v,ZA,ZD,ZDL,ZDR,ZE,ZEL,ZER,ZH,ZN,ZP,ZU,ZUL,ZUR,ZVI,            & 
& ZVR,ZW,ZZ,betaH,g1,g2,g3,Yd,Ye,lam,kap,lamN,Yu,Yv,MUX,Td,Te,Tlam,Tk,TLN,               & 
& Tu,Tv,BMUX,mq2,ml2,mHd2,mHu2,md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,vd,vu,vS,dg1,            & 
& dg2,dg3,dMUX,dBMUX,dYd,dTd,dYe,dTe,dlam,dTlam,dkap,dTk,dlamN,dTLN,dYu,dTu,             & 
& dYv,dTv,dmq2,dml2,dmHd2,dmHu2,dmd2,dmu2,dme2,dmv2,dms2,dmx2,dM1,dM2,dM3,               & 
& dvd,dvu,dvS,dpG,dZD,dZVI,dZVR,dZU,dZE,dZH,dZA,dZP,dZN,dUV,dUM,dUP,dZEL,dZER,           & 
& dZDL,dZDR,dZUL,dZUR,dSinTW,dCosTW,dTanTW,ZfVG,ZffG,ZfVP,ZfVZ,ZfVWm,ZfSd,               & 
& ZfSvIm,ZfSvRe,ZfSu,ZfSe,Zfhh,ZfAh,ZfHpm,ZfL0,ZfFV,ZfLm,ZfLp,ZfFEL,ZfFER,               & 
...
& cplAhhhSdcSdaa,cplAhhhSecSe1,cplAhhhSucSuaa,cplAhhhSvImSvIm1,cplAhhhSvImSvRe1,         & 
& cplAhhhSvReSvRe1,cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,cplAhHpmcVWmVP1,cplAhHpmcVWmVZ1,  & 
& cplAhHpmSucSdaa,cplAhHpmSvImcSe1,cplAhHpmSvRecSe1,cplAhSdcHpmcSuaa,cplAhSdcSd,         & 
...
& cplChiFvSvReR,cplcHpmVPVWm,cplcHpmVWmVZ,cplcVWmVPVPVWm1Q,cplcVWmVPVPVWm2Q,             & 
& cplcVWmVPVPVWm3Q,cplcVWmVPVWm,cplcVWmVPVWmVZ1Q,cplcVWmVPVWmVZ2Q,cplcVWmVPVWmVZ3Q,      & 
& cplcVWmVWmVZ,cplcVWmVWmVZVZ1Q,cplcVWmVWmVZVZ2Q,cplcVWmVWmVZVZ3Q,cplFvChacSeL,          & 
...
& dZDL,dZDR,dZUL,dZUR,dSinTW,dCosTW,dTanTW,ZfVG,ZffG,ZfVP,ZfVZ,ZfVWm,ZfSd,               & 
& ZfSvIm,ZfSvRe,ZfSu,ZfSe,Zfhh,ZfAh,ZfHpm,ZfL0,ZfFV,ZfLm,ZfLp,ZfFEL,ZfFER,               & 
& ZfFDL,ZfFDR,ZfFUL,ZfFUR,ZfVPVZ,ZfVZVP,cplAhAhAh,cplAhAhhh,cplAhAhSucSuaa,              & 
& cplAhcHpmVWm,cplAhhhhh,cplAhhhSucSuaa,cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,             & 
& cplAhHpmSucSdaa,cplAhSdcHpmcSuaa,cplAhSdcSd,cplAhSecSe,cplAhSucSu,cplAhSvImSvIm,       & 
...
& cplhhSdcHpmcSuaa,cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvImSvIm,cplhhSvImSvRe,         & 
...
& cplSdcSucVWmVPaa,cplSdcSucVWmVZaa,cplSdSucSdcSuabab,cplSdSucSdcSuabba,cplSdSvImcSecSuaa,& 
& cplSdSvRecSecSuaa,cplSeSucSecSuaa,cplSeSvImcHpm,cplSeSvRecHpm,cplSucSdVGVWmLamct3ct2ct1,& 
...
& ZRUZVI,ZRUZVR,ZRUZU,ZRUZE,ZRUZH,ZRUZA,ZRUZP,ZRUZN,ZRUUV,ZRUUM,ZRUUP,ZRUZEL,            & 
& ZRUZER,ZRUZDL,ZRUZDR,ZRUZUL,ZRUZUR,MLambda,em,gs,deltaM,kont,gP1LSu)
...
& ZfSvIm,ZfSvRe,ZfSu,ZfSe,Zfhh,ZfAh,ZfHpm,ZfL0,ZfFV,ZfLm,ZfLp,ZfFEL,ZfFER,               & 
& ZfFDL,ZfFDR,ZfFUL,ZfFUR,ZfVPVZ,ZfVZVP,cplAhAhAh,cplAhAhhh,cplAhcHpmVWm,cplAhhhhh,      & 
& cplAhhhVZ,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSecSe,cplAhSvImSvIm,cplAhSvImSvRe,            & 
...
& cplhhSvReSvRe,cplhhVZVZ,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcVWmVP,cplHpmcVWmVZ,           & 
& cplHpmSvImcSe,cplHpmSvRecSe,cplSecSeVP,cplSecSeVZ,cplSeSvImcHpm,cplSeSvImcVWm,         & 
& cplSeSvRecHpm,cplSeSvRecVWm,cplSvImcSeVWm,cplSvImSvReVZ,cplSvRecSeVWm,ctcplChiFvSvImL, & 
...
End Module OneLoopDecays_NInvSeesaw 
