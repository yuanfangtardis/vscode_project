...
Module CouplingsForDecays_NInvSeesaw
...
& Ydinput,Yeinput,laminput,kapinput,lamNinput,Yuinput,Yvinput,MUXinput,Tdinput,          & 
& Teinput,Tlaminput,Tkinput,TLNinput,Tuinput,Tvinput,BMUXinput,mq2input,ml2input,        & 
& mHd2input,mHu2input,md2input,mu2input,me2input,mv2input,ms2input,mx2input,             & 
...
& Yvinput(3,3),MUXinput(3,3),Tdinput(3,3),Teinput(3,3),Tlaminput,Tkinput,TLNinput(3,3),  & 
& Tuinput(3,3),Tvinput(3,3),BMUXinput(3,3),mq2input(3,3),ml2input(3,3),md2input(3,3),    & 
& mu2input(3,3),me2input(3,3),mv2input(3,3),mx2input(3,3),M1input,M2input,M3input
...
& MFvinput(9),MFv2input(9),MGluinput,MGlu2input,Mhhinput(3),Mhh2input(3),MHpminput(2),   & 
& MHpm2input(2),MSdinput(6),MSd2input(6),MSeinput(6),MSe2input(6),MSuinput(6),           & 
& MSu2input(6),MSvIminput(9),MSvIm2input(9),MSvReinput(9),MSvRe2input(9),MVWminput,      & 
& MVWm2input,MVZinput,MVZ2input,TWinput,vinput,ZAinput(3,3),ZHinput(3,3),ZPinput(2,2),   & 
& ZZinput(2,2),betaHinput

Complex(dp),Intent(in) :: pGinput,UMinput(2,2),UPinput(2,2),UVinput(9,9),ZDinput(6,6),ZDLinput(3,3),            & 
& ZDRinput(3,3),ZEinput(6,6),ZELinput(3,3),ZERinput(3,3),ZNinput(5,5),ZUinput(6,6),      & 
& ZULinput(3,3),ZURinput(3,3),ZVIinput(9,9),ZVRinput(9,9),ZWinput(2,2)
...
Do gt1 = 1, 3
 Do gt2 = 1, 9
  Do gt3 = 1, 9
Call CouplinghhSvImSvImT(gt1,gt2,gt3,g1,g2,MUX,lam,kap,lamN,TLN,Yv,Tv,vd,             & 
& vu,vS,ZVI,ZH,cplhhSvImSvIm(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 9
  Do gt3 = 1, 9
Call CouplinghhSvImSvReT(gt1,gt2,gt3,MUX,lam,kap,lamN,TLN,Yv,Tv,vd,vu,vS,             & 
& ZVI,ZVR,ZH,cplhhSvImSvRe(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 9
  Do gt3 = 1, 9
Call CouplinghhSvReSvReT(gt1,gt2,gt3,g1,g2,MUX,lam,kap,lamN,TLN,Yv,Tv,vd,             & 
& vu,vS,ZVR,ZH,cplhhSvReSvRe(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 9
  Do gt3 = 1, 9
Call CouplingAhSvImSvImT(gt1,gt2,gt3,MUX,lam,kap,lamN,TLN,Yv,Tv,vd,vu,vS,             & 
& ZVI,ZA,cplAhSvImSvIm(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 9
  Do gt3 = 1, 9
Call CouplingAhSvImSvReT(gt1,gt2,gt3,MUX,lam,kap,lamN,TLN,Yv,Tv,vd,vu,vS,             & 
& ZVI,ZVR,ZA,cplAhSvImSvRe(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 9
  Do gt3 = 1, 9
Call CouplingAhSvReSvReT(gt1,gt2,gt3,MUX,lam,kap,lamN,TLN,Yv,Tv,vd,vu,vS,             & 
& ZVR,ZA,cplAhSvReSvRe(gt1,gt2,gt3))
...
& Teinput,Tlaminput,Tkinput,TLNinput,Tuinput,Tvinput,BMUXinput,mq2input,ml2input,        & 
& mHd2input,mHu2input,md2input,mu2input,me2input,mv2input,ms2input,mx2input,             & 
& M1input,M2input,M3input,vdinput,vuinput,vSinput,cplAhSdcSd,cplChaFucSdL,               & 
...
& Teinput,Tlaminput,Tkinput,TLNinput,Tuinput,Tvinput,BMUXinput,mq2input,ml2input,        & 
& mHd2input,mHu2input,md2input,mu2input,me2input,mv2input,ms2input,mx2input,             & 
& M1input,M2input,M3input,vdinput,vuinput,vSinput,cplAhSucSu,cplChiFucSuL,               & 
...
& Teinput,Tlaminput,Tkinput,TLNinput,Tuinput,Tvinput,BMUXinput,mq2input,ml2input,        & 
& mHd2input,mHu2input,md2input,mu2input,me2input,mv2input,ms2input,mx2input,             & 
& M1input,M2input,M3input,vdinput,vuinput,vSinput,cplAhSecSe,cplFvChacSeL,               & 
...
Complex(dp),Intent(out) :: cplAhSecSe(3,6,6),cplFvChacSeL(9,2,6),cplFvChacSeR(9,2,6),cplChiFecSeL(5,3,6),        & 
...
& Teinput,Tlaminput,Tkinput,TLNinput,Tuinput,Tvinput,BMUXinput,mq2input,ml2input,        & 
& mHd2input,mHu2input,md2input,mu2input,me2input,mv2input,ms2input,mx2input,             & 
& M1input,M2input,M3input,vdinput,vuinput,vSinput,cplAhSvImSvIm,cplAhSvImSvRe,           & 
...
Complex(dp),Intent(out) :: cplAhSvImSvIm(3,9,9),cplAhSvImSvRe(3,9,9),cplcFeChaSvImL(3,2,9),cplcFeChaSvImR(3,2,9),& 
...
& Teinput,Tlaminput,Tkinput,TLNinput,Tuinput,Tvinput,BMUXinput,mq2input,ml2input,        & 
& mHd2input,mHu2input,md2input,mu2input,me2input,mv2input,ms2input,mx2input,             & 
& M1input,M2input,M3input,vdinput,vuinput,vSinput,cplAhSvImSvRe,cplAhSvReSvRe,           & 
...
Complex(dp),Intent(out) :: cplAhSvImSvRe(3,9,9),cplAhSvReSvRe(3,9,9),cplcFeChaSvReL(3,2,9),cplcFeChaSvReR(3,2,9),& 
...
& Teinput,Tlaminput,Tkinput,TLNinput,Tuinput,Tvinput,BMUXinput,mq2input,ml2input,        & 
& mHd2input,mHu2input,md2input,mu2input,me2input,mv2input,ms2input,mx2input,             & 
& M1input,M2input,M3input,vdinput,vuinput,vSinput,cplGluFdcSdL,cplGluFdcSdR,             & 
...
& Teinput,Tlaminput,Tkinput,TLNinput,Tuinput,Tvinput,BMUXinput,mq2input,ml2input,        & 
& mHd2input,mHu2input,md2input,mu2input,me2input,mv2input,ms2input,mx2input,             & 
& M1input,M2input,M3input,vdinput,vuinput,vSinput,cplFvFvAhL,cplFvFvAhR,cplFvChacSeL,    & 
...
Complex(dp),Intent(out) :: cplFvFvAhL(9,9,3),cplFvFvAhR(9,9,3),cplFvChacSeL(9,2,6),cplFvChacSeR(9,2,6),          & 
& cplChiFvSvImL(5,9,9),cplChiFvSvImR(5,9,9),cplChiFvSvReL(5,9,9),cplChiFvSvReR(5,9,9),   & 
...
& Teinput,Tlaminput,Tkinput,TLNinput,Tuinput,Tvinput,BMUXinput,mq2input,ml2input,        & 
& mHd2input,mHu2input,md2input,mu2input,me2input,mv2input,ms2input,mx2input,             & 
& M1input,M2input,M3input,vdinput,vuinput,vSinput,cplAhAhhh,cplAhhhhh,cplAhhhVZ,         & 
...
& cplhhSvImSvRe(3,9,9),cplhhSvReSvRe(3,9,9)
...
& Teinput,Tlaminput,Tkinput,TLNinput,Tuinput,Tvinput,BMUXinput,mq2input,ml2input,        & 
& mHd2input,mHu2input,md2input,mu2input,me2input,mv2input,ms2input,mx2input,             & 
& M1input,M2input,M3input,vdinput,vuinput,vSinput,cplAhAhAh,cplAhAhhh,cplAhcHpmVWm,      & 
& cplAhhhhh,cplAhhhVZ,cplAhHpmcHpm,cplAhSdcSd,cplAhSecSe,cplAhSucSu,cplAhSvImSvIm,       & 
& cplAhSvImSvRe,cplAhSvReSvRe,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,   & 
& cplcChaChaVZL,cplcChaChaVZR,cplcFdChaSuL,cplcFdChaSuR,cplcFdFdAhL,cplcFdFdAhR,         & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFeChaSvImL,cplcFeChaSvImR,         & 
...
& Teinput,Tlaminput,Tkinput,TLNinput,Tuinput,Tvinput,BMUXinput,mq2input,ml2input,        & 
& mHd2input,mHu2input,md2input,mu2input,me2input,mv2input,ms2input,mx2input,             & 
& M1input,M2input,M3input,vdinput,vuinput,vSinput,cplAhcHpmVWm,cplAhHpmcHpm,             & 
...
& cplcFdFuHpmL,cplcFdFuHpmR,cplcFdGluSdL,cplcFdGluSdR,cplcFeChaSvImL,cplcFeChaSvImR,     & 
...
& cplGluFdcSdR,cplGluFucSuL,cplGluFucSuR,cplhhcHpmVWm,cplhhHpmcHpm,cplHpmcHpmVZ,         & 
& cplSdcHpmcSu,cplSeSvImcHpm,cplSeSvRecHpm,deltaM)
...
& Teinput,Tlaminput,Tkinput,TLNinput,Tuinput,Tvinput,BMUXinput,mq2input,ml2input,        & 
& mHd2input,mHu2input,md2input,mu2input,me2input,mv2input,ms2input,mx2input,             & 
& M1input,M2input,M3input,vdinput,vuinput,vSinput,cplAhSdcSd,cplcChacFuSdL,              & 
...
& Teinput,Tlaminput,Tkinput,TLNinput,Tuinput,Tvinput,BMUXinput,mq2input,ml2input,        & 
& mHd2input,mHu2input,md2input,mu2input,me2input,mv2input,ms2input,mx2input,             & 
& M1input,M2input,M3input,vdinput,vuinput,vSinput,cplAhSucSu,cplcChacFuSdL,              & 
& cplcChacFuSdR,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,   & 
...
& cplcFeFvHpmR(3,9,2),cplcFeFvVWmL(3,9),cplcFeFvVWmR(3,9),cplcFuChiSuL(3,5,6),           & 
...
& cplChiFecSeR(5,3,6),cplChiFucSuL(5,3,6),cplChiFucSuR(5,3,6),cplChiFvSvImL(5,9,9),      & 
& cplChiFvSvImR(5,9,9),cplChiFvSvReL(5,9,9),cplChiFvSvReR(5,9,9),cplFvChacSeL(9,2,6),    & 
& cplFvChacSeR(9,2,6),cplFvFvAhL(9,9,3),cplFvFvAhR(9,9,3),cplFvFvhhL(9,9,3),             & 
& cplFvFvhhR(9,9,3),cplFvFvVZL(9,9),cplFvFvVZR(9,9),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6), & 
...
& Teinput,Tlaminput,Tkinput,TLNinput,Tuinput,Tvinput,BMUXinput,mq2input,ml2input,        & 
& mHd2input,mHu2input,md2input,mu2input,me2input,mv2input,ms2input,mx2input,             & 
& M1input,M2input,M3input,vdinput,vuinput,vSinput,cplAhSecSe,cplcChacFuSdL,              & 
& cplcChacFuSdR,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,   & 
& cplcChaChaVZR,cplcChaChiHpmL,cplcChaChiHpmR,cplcChaFdcSuL,cplcChaFdcSuR,               & 
& cplcChaFeSvImL,cplcChaFeSvImR,cplcChaFeSvReL,cplcChaFeSvReR,cplcChaFvSeL,              & 
...
Complex(dp),Intent(out) :: cplAhSvImSvIm(3,9,9),cplAhSvImSvRe(3,9,9),cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),  & 
& cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),       & 
& cplcChaFeSvImL(2,3,9),cplcChaFeSvImR(2,3,9),cplcChaFeSvReL(2,3,9),cplcChaFeSvReR(2,3,9),& 
& cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6),cplcFdFdAhL(3,3,3),cplcFdFdAhR(3,3,3),         & 
& cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),               & 
...
Complex(dp),Intent(out) :: cplAhSvImSvRe(3,9,9),cplAhSvReSvRe(3,9,9),cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),  & 
& cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),       & 
& cplcChaFeSvImL(2,3,9),cplcChaFeSvImR(2,3,9),cplcChaFeSvReL(2,3,9),cplcChaFeSvReR(2,3,9),& 
& cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6),cplcFdFdAhL(3,3,3),cplcFdFdAhR(3,3,3),         & 
& cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),               & 
...
& Teinput,Tlaminput,Tkinput,TLNinput,Tuinput,Tvinput,BMUXinput,mq2input,ml2input,        & 
& mHd2input,mHu2input,md2input,mu2input,me2input,mv2input,ms2input,mx2input,             & 
& M1input,M2input,M3input,vdinput,vuinput,vSinput,cplcChacFuSdL,cplcChacFuSdR,           & 
& cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,cplcChaChaVZR,   & 
& cplcChaChiHpmL,cplcChaChiHpmR,cplcChaChiVWmL,cplcChaChiVWmR,cplcChaFdcSuL,             & 
& cplcChaFdcSuR,cplcChaFeSvImL,cplcChaFeSvImR,cplcChaFeSvReL,cplcChaFeSvReR,             & 
& cplcChaFvSeL,cplcChaFvSeR,cplcFdChaSuL,cplcFdChaSuR,cplcFdFdAhL,cplcFdFdAhR,           & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFeChaSvImL,cplcFeChaSvImR,         & 
& cplcFeChaSvReL,cplcFeChaSvReR,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,         & 
...
& cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,cplChiChiAhL,              & 
& cplChiChiAhR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,cplChiFdcSdL,         & 
& cplChiFdcSdR,cplChiFecSeL,cplChiFecSeR,cplChiFvSvImL,cplChiFvSvImR,cplChiFvSvReL,      & 
& cplChiFvSvReR,cplFvChacSeL,cplFvChacSeR,cplFvFecHpmL,cplFvFecHpmR,cplFvFecVWmL,        & 
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVZL,cplFvFvVZR,        & 
& cplGluFdcSdL,cplGluFdcSdR,deltaM)
...
& cplcFdFdAhL(3,3,3),cplcFdFdAhR(3,3,3),cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),           & 
& cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFdFuHpmL(3,3,2),cplcFdFuHpmR(3,3,2),             & 
& cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),cplcFeChaSvImL(3,2,9),cplcFeChaSvImR(3,2,9),       & 
& cplcFeChaSvReL(3,2,9),cplcFeChaSvReR(3,2,9),cplcFeChiSeL(3,5,6),cplcFeChiSeR(3,5,6),   & 
& cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3),           & 
& cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFvHpmL(3,9,2),cplcFeFvHpmR(3,9,2),             & 
& cplcFeFvVWmL(3,9),cplcFeFvVWmR(3,9),cplcFuFuAhL(3,3,3),cplcFuFuAhR(3,3,3),             & 
& cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),               & 
& cplChiChacHpmL(5,2,2),cplChiChacHpmR(5,2,2),cplChiChacVWmL(5,2),cplChiChacVWmR(5,2),   & 
& cplChiChiAhL(5,5,3),cplChiChiAhR(5,5,3),cplChiChihhL(5,5,3),cplChiChihhR(5,5,3),       & 
...
End Module CouplingsForDecays_NInvSeesaw
