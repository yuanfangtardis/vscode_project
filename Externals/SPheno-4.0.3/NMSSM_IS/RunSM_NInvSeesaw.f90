...
& vu,vS,CKMout,sinW2_out,Alpha_out,AlphaS_out,realCKM)
...
Real(dp) :: scale_save, Qin, tz, dt, g1D(365), g62_SM(62) 
 
 
! Run SUSY RGEs from M_SUSY to Qin 
Qin=sqrt(getRenormalizationScale()) 
scale_save = Qin 
Call ParametersToG365(g1input,g2input,g3input,Ydinput,Yeinput,laminput,               & 
...
& md2input,mu2input,me2input,mv2input,ms2input,mx2input,M1input,M2input,M3input,         & 
& vdinput,vuinput,vSinput,g1D)

Call GToParameters365(g1D,g1,g2,g3,Yd,Ye,lam,kap,lamN,Yu,Yv,MUX,Td,Te,Tlam,           & 
