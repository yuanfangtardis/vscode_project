...
Module TreeLevelMasses_NInvSeesaw 
...
& md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,GenerationMixing,kont)
...
Complex(dp),Intent(out) :: pG,UM(2,2),UP(2,2),UV(9,9),ZD(6,6),ZDL(3,3),ZDR(3,3),ZE(6,6),ZEL(3,3),ZER(3,3),       & 
...
Complex(dp) :: MGluC 
Iname = Iname + 1 
NameOfUnit(Iname) = 'TreeMassesinverse-Seesaw-NMSSM'
...
Call CalculateMSvIm(g1,g2,MUX,BMUX,lam,kap,lamN,TLN,Yv,Tv,ml2,mv2,mx2,vd,             & 
& vu,vS,ZVI,MSvIm,MSvIm2,kont)

Call CalculateMSvRe(g1,g2,MUX,BMUX,lam,kap,lamN,TLN,Yv,Tv,ml2,mv2,mx2,vd,             & 
...
MChi2 = MChi**2 
Call CalculateMFv(MUX,lamN,Yv,vu,vS,UV,MFv,kont)
...
& vd,vu,vS,g1,g2,g3,Yd,Ye,lam,kap,lamN,Yu,Yv,MUX,Td,Te,Tlam,Tk,TLN,Tu,Tv,BMUX,           & 
& mq2,ml2,mHd2,mHu2,md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,kont)
...
& mHd2,mHu2,md2,mu2,me2,mv2,ms2,mx2,M1,M2,M3,GenerationMixing,kont)
...
Call CalculateMSvImEffPot(g1,g2,MUX,BMUX,lam,kap,lamN,TLN,Yv,Tv,ml2,mv2,              & 
& mx2,vd,vu,vS,ZVI,MSvIm,MSvIm2,kont)

Call CalculateMSvReEffPot(g1,g2,MUX,BMUX,lam,kap,lamN,TLN,Yv,Tv,ml2,mv2,              & 
& mx2,vd,vu,vS,ZVR,MSvRe,MSvRe2,kont)
...
MChi2 = MChi**2 
Call CalculateMFvEffPot(MUX,lamN,Yv,vu,vS,UV,MFv,kont)
...
Subroutine CalculateMSvIm(g1,g2,MUX,BMUX,lam,kap,lamN,TLN,Yv,Tv,ml2,mv2,              & 
& mx2,vd,vu,vS,ZVI,MSvIm,MSvIm2,kont)
...
Integer :: i1,i2,i3,i4, ierr 
Integer :: j1,j2,j3,j4, pos 
Real(dp), Intent(out) :: MSvIm(9), MSvIm2(9) 
Complex(dp), Intent(out) :: ZVI(9,9) 
...
mat(1,7) = 0._dp 
Do j1 = 1,3
mat(1,7) = mat(1,7)+(vS*vu*Conjg(lamN(j1,1))*Yv(j1,1))/4._dp
End Do 
Do j1 = 1,3
mat(1,7) = mat(1,7)+(vS*vu*Conjg(Yv(j1,1))*lamN(j1,1))/4._dp
End Do 
mat(1,8) = 0._dp 
Do j1 = 1,3
mat(1,8) = mat(1,8)+(vS*vu*Conjg(lamN(j1,2))*Yv(j1,1))/4._dp
End Do 
Do j1 = 1,3
mat(1,8) = mat(1,8)+(vS*vu*Conjg(Yv(j1,1))*lamN(j1,2))/4._dp
End Do 
mat(1,9) = 0._dp 
Do j1 = 1,3
mat(1,9) = mat(1,9)+(vS*vu*Conjg(lamN(j1,3))*Yv(j1,1))/4._dp
End Do 
Do j1 = 1,3
mat(1,9) = mat(1,9)+(vS*vu*Conjg(Yv(j1,1))*lamN(j1,3))/4._dp
End Do 
mat(2,2) = 0._dp 
...
mat(2,7) = 0._dp 
Do j1 = 1,3
mat(2,7) = mat(2,7)+(vS*vu*Conjg(lamN(j1,1))*Yv(j1,2))/4._dp
End Do 
Do j1 = 1,3
mat(2,7) = mat(2,7)+(vS*vu*Conjg(Yv(j1,2))*lamN(j1,1))/4._dp
End Do 
mat(2,8) = 0._dp 
Do j1 = 1,3
mat(2,8) = mat(2,8)+(vS*vu*Conjg(lamN(j1,2))*Yv(j1,2))/4._dp
End Do 
Do j1 = 1,3
mat(2,8) = mat(2,8)+(vS*vu*Conjg(Yv(j1,2))*lamN(j1,2))/4._dp
End Do 
mat(2,9) = 0._dp 
Do j1 = 1,3
mat(2,9) = mat(2,9)+(vS*vu*Conjg(lamN(j1,3))*Yv(j1,2))/4._dp
End Do 
Do j1 = 1,3
mat(2,9) = mat(2,9)+(vS*vu*Conjg(Yv(j1,2))*lamN(j1,3))/4._dp
End Do 
mat(3,3) = 0._dp 
...
mat(3,7) = 0._dp 
Do j1 = 1,3
mat(3,7) = mat(3,7)+(vS*vu*Conjg(lamN(j1,1))*Yv(j1,3))/4._dp
End Do 
Do j1 = 1,3
mat(3,7) = mat(3,7)+(vS*vu*Conjg(Yv(j1,3))*lamN(j1,1))/4._dp
End Do 
mat(3,8) = 0._dp 
Do j1 = 1,3
mat(3,8) = mat(3,8)+(vS*vu*Conjg(lamN(j1,2))*Yv(j1,3))/4._dp
End Do 
Do j1 = 1,3
mat(3,8) = mat(3,8)+(vS*vu*Conjg(Yv(j1,3))*lamN(j1,2))/4._dp
End Do 
mat(3,9) = 0._dp 
Do j1 = 1,3
mat(3,9) = mat(3,9)+(vS*vu*Conjg(lamN(j1,3))*Yv(j1,3))/4._dp
End Do 
Do j1 = 1,3
mat(3,9) = mat(3,9)+(vS*vu*Conjg(Yv(j1,3))*lamN(j1,3))/4._dp
End Do 
mat(4,4) = 0._dp 
...
End Do 
mat(4,7) = 0._dp 
mat(4,7) = mat(4,7)+(vS**2*kap*Conjg(lamN(1,1)))/4._dp
mat(4,7) = mat(4,7)-(vd*vu*lam*Conjg(lamN(1,1)))/4._dp
mat(4,7) = mat(4,7)+(vS*Conjg(TLN(1,1)))/(2._dp*sqrt(2._dp))
Do j1 = 1,3
mat(4,7) = mat(4,7)-(vS*Conjg(lamN(1,j1))*MUX(1,j1))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(4,7) = mat(4,7)-(vS*Conjg(lamN(1,j1))*MUX(j1,1))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(4,7) = mat(4,7)-(vS*Conjg(MUX(1,j1))*lamN(1,j1))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(4,7) = mat(4,7)-(vS*Conjg(MUX(j1,1))*lamN(1,j1))/(4._dp*sqrt(2._dp))
End Do 
mat(4,7) = mat(4,7)+(vS**2*Conjg(kap)*lamN(1,1))/4._dp
mat(4,7) = mat(4,7)-(vd*vu*Conjg(lam)*lamN(1,1))/4._dp
mat(4,7) = mat(4,7)+(vS*TLN(1,1))/(2._dp*sqrt(2._dp))
mat(4,8) = 0._dp 
mat(4,8) = mat(4,8)+(vS**2*kap*Conjg(lamN(1,2)))/4._dp
mat(4,8) = mat(4,8)-(vd*vu*lam*Conjg(lamN(1,2)))/4._dp
mat(4,8) = mat(4,8)+(vS*Conjg(TLN(1,2)))/(2._dp*sqrt(2._dp))
Do j1 = 1,3
mat(4,8) = mat(4,8)-(vS*Conjg(lamN(1,j1))*MUX(2,j1))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(4,8) = mat(4,8)-(vS*Conjg(lamN(1,j1))*MUX(j1,2))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(4,8) = mat(4,8)-(vS*Conjg(MUX(2,j1))*lamN(1,j1))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(4,8) = mat(4,8)-(vS*Conjg(MUX(j1,2))*lamN(1,j1))/(4._dp*sqrt(2._dp))
End Do 
mat(4,8) = mat(4,8)+(vS**2*Conjg(kap)*lamN(1,2))/4._dp
mat(4,8) = mat(4,8)-(vd*vu*Conjg(lam)*lamN(1,2))/4._dp
mat(4,8) = mat(4,8)+(vS*TLN(1,2))/(2._dp*sqrt(2._dp))
mat(4,9) = 0._dp 
mat(4,9) = mat(4,9)+(vS**2*kap*Conjg(lamN(1,3)))/4._dp
mat(4,9) = mat(4,9)-(vd*vu*lam*Conjg(lamN(1,3)))/4._dp
mat(4,9) = mat(4,9)+(vS*Conjg(TLN(1,3)))/(2._dp*sqrt(2._dp))
Do j1 = 1,3
mat(4,9) = mat(4,9)-(vS*Conjg(lamN(1,j1))*MUX(3,j1))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(4,9) = mat(4,9)-(vS*Conjg(lamN(1,j1))*MUX(j1,3))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(4,9) = mat(4,9)-(vS*Conjg(MUX(3,j1))*lamN(1,j1))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(4,9) = mat(4,9)-(vS*Conjg(MUX(j1,3))*lamN(1,j1))/(4._dp*sqrt(2._dp))
End Do 
mat(4,9) = mat(4,9)+(vS**2*Conjg(kap)*lamN(1,3))/4._dp
mat(4,9) = mat(4,9)-(vd*vu*Conjg(lam)*lamN(1,3))/4._dp
mat(4,9) = mat(4,9)+(vS*TLN(1,3))/(2._dp*sqrt(2._dp))
mat(5,5) = 0._dp 
...
End Do 
mat(5,7) = 0._dp 
mat(5,7) = mat(5,7)+(vS**2*kap*Conjg(lamN(2,1)))/4._dp
mat(5,7) = mat(5,7)-(vd*vu*lam*Conjg(lamN(2,1)))/4._dp
mat(5,7) = mat(5,7)+(vS*Conjg(TLN(2,1)))/(2._dp*sqrt(2._dp))
Do j1 = 1,3
mat(5,7) = mat(5,7)-(vS*Conjg(lamN(2,j1))*MUX(1,j1))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(5,7) = mat(5,7)-(vS*Conjg(lamN(2,j1))*MUX(j1,1))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(5,7) = mat(5,7)-(vS*Conjg(MUX(1,j1))*lamN(2,j1))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(5,7) = mat(5,7)-(vS*Conjg(MUX(j1,1))*lamN(2,j1))/(4._dp*sqrt(2._dp))
End Do 
mat(5,7) = mat(5,7)+(vS**2*Conjg(kap)*lamN(2,1))/4._dp
mat(5,7) = mat(5,7)-(vd*vu*Conjg(lam)*lamN(2,1))/4._dp
mat(5,7) = mat(5,7)+(vS*TLN(2,1))/(2._dp*sqrt(2._dp))
mat(5,8) = 0._dp 
mat(5,8) = mat(5,8)+(vS**2*kap*Conjg(lamN(2,2)))/4._dp
mat(5,8) = mat(5,8)-(vd*vu*lam*Conjg(lamN(2,2)))/4._dp
mat(5,8) = mat(5,8)+(vS*Conjg(TLN(2,2)))/(2._dp*sqrt(2._dp))
Do j1 = 1,3
mat(5,8) = mat(5,8)-(vS*Conjg(lamN(2,j1))*MUX(2,j1))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(5,8) = mat(5,8)-(vS*Conjg(lamN(2,j1))*MUX(j1,2))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(5,8) = mat(5,8)-(vS*Conjg(MUX(2,j1))*lamN(2,j1))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(5,8) = mat(5,8)-(vS*Conjg(MUX(j1,2))*lamN(2,j1))/(4._dp*sqrt(2._dp))
End Do 
mat(5,8) = mat(5,8)+(vS**2*Conjg(kap)*lamN(2,2))/4._dp
mat(5,8) = mat(5,8)-(vd*vu*Conjg(lam)*lamN(2,2))/4._dp
mat(5,8) = mat(5,8)+(vS*TLN(2,2))/(2._dp*sqrt(2._dp))
mat(5,9) = 0._dp 
mat(5,9) = mat(5,9)+(vS**2*kap*Conjg(lamN(2,3)))/4._dp
mat(5,9) = mat(5,9)-(vd*vu*lam*Conjg(lamN(2,3)))/4._dp
mat(5,9) = mat(5,9)+(vS*Conjg(TLN(2,3)))/(2._dp*sqrt(2._dp))
Do j1 = 1,3
mat(5,9) = mat(5,9)-(vS*Conjg(lamN(2,j1))*MUX(3,j1))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(5,9) = mat(5,9)-(vS*Conjg(lamN(2,j1))*MUX(j1,3))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(5,9) = mat(5,9)-(vS*Conjg(MUX(3,j1))*lamN(2,j1))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(5,9) = mat(5,9)-(vS*Conjg(MUX(j1,3))*lamN(2,j1))/(4._dp*sqrt(2._dp))
End Do 
mat(5,9) = mat(5,9)+(vS**2*Conjg(kap)*lamN(2,3))/4._dp
mat(5,9) = mat(5,9)-(vd*vu*Conjg(lam)*lamN(2,3))/4._dp
mat(5,9) = mat(5,9)+(vS*TLN(2,3))/(2._dp*sqrt(2._dp))
mat(6,6) = 0._dp 
...
End Do 
mat(6,7) = 0._dp 
mat(6,7) = mat(6,7)+(vS**2*kap*Conjg(lamN(3,1)))/4._dp
mat(6,7) = mat(6,7)-(vd*vu*lam*Conjg(lamN(3,1)))/4._dp
mat(6,7) = mat(6,7)+(vS*Conjg(TLN(3,1)))/(2._dp*sqrt(2._dp))
Do j1 = 1,3
mat(6,7) = mat(6,7)-(vS*Conjg(lamN(3,j1))*MUX(1,j1))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(6,7) = mat(6,7)-(vS*Conjg(lamN(3,j1))*MUX(j1,1))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(6,7) = mat(6,7)-(vS*Conjg(MUX(1,j1))*lamN(3,j1))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(6,7) = mat(6,7)-(vS*Conjg(MUX(j1,1))*lamN(3,j1))/(4._dp*sqrt(2._dp))
End Do 
mat(6,7) = mat(6,7)+(vS**2*Conjg(kap)*lamN(3,1))/4._dp
mat(6,7) = mat(6,7)-(vd*vu*Conjg(lam)*lamN(3,1))/4._dp
mat(6,7) = mat(6,7)+(vS*TLN(3,1))/(2._dp*sqrt(2._dp))
mat(6,8) = 0._dp 
mat(6,8) = mat(6,8)+(vS**2*kap*Conjg(lamN(3,2)))/4._dp
mat(6,8) = mat(6,8)-(vd*vu*lam*Conjg(lamN(3,2)))/4._dp
mat(6,8) = mat(6,8)+(vS*Conjg(TLN(3,2)))/(2._dp*sqrt(2._dp))
Do j1 = 1,3
mat(6,8) = mat(6,8)-(vS*Conjg(lamN(3,j1))*MUX(2,j1))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(6,8) = mat(6,8)-(vS*Conjg(lamN(3,j1))*MUX(j1,2))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(6,8) = mat(6,8)-(vS*Conjg(MUX(2,j1))*lamN(3,j1))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(6,8) = mat(6,8)-(vS*Conjg(MUX(j1,2))*lamN(3,j1))/(4._dp*sqrt(2._dp))
End Do 
mat(6,8) = mat(6,8)+(vS**2*Conjg(kap)*lamN(3,2))/4._dp
mat(6,8) = mat(6,8)-(vd*vu*Conjg(lam)*lamN(3,2))/4._dp
mat(6,8) = mat(6,8)+(vS*TLN(3,2))/(2._dp*sqrt(2._dp))
mat(6,9) = 0._dp 
mat(6,9) = mat(6,9)+(vS**2*kap*Conjg(lamN(3,3)))/4._dp
mat(6,9) = mat(6,9)-(vd*vu*lam*Conjg(lamN(3,3)))/4._dp
mat(6,9) = mat(6,9)+(vS*Conjg(TLN(3,3)))/(2._dp*sqrt(2._dp))
Do j1 = 1,3
mat(6,9) = mat(6,9)-(vS*Conjg(lamN(3,j1))*MUX(3,j1))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(6,9) = mat(6,9)-(vS*Conjg(lamN(3,j1))*MUX(j1,3))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(6,9) = mat(6,9)-(vS*Conjg(MUX(3,j1))*lamN(3,j1))/(4._dp*sqrt(2._dp))
End Do 
Do j1 = 1,3
mat(6,9) = mat(6,9)-(vS*Conjg(MUX(j1,3))*lamN(3,j1))/(4._dp*sqrt(2._dp))
End Do 
mat(6,9) = mat(6,9)+(vS**2*Conjg(kap)*lamN(3,3))/4._dp
mat(6,9) = mat(6,9)-(vd*vu*Conjg(lam)*lamN(3,3))/4._dp
mat(6,9) = mat(6,9)+(vS*TLN(3,3))/(2._dp*sqrt(2._dp))
mat(7,7) = 0._dp 
mat(7,7) = mat(7,7)-Conjg(BMUX(1,1))/2._dp
mat(7,7) = mat(7,7)+mx2(1,1)
Do j1 = 1,3
mat(7,7) = mat(7,7)+(Conjg(MUX(1,j1))*MUX(1,j1))/4._dp
End Do 
Do j1 = 1,3
mat(7,7) = mat(7,7)+(Conjg(MUX(j1,1))*MUX(1,j1))/4._dp
End Do 
Do j1 = 1,3
mat(7,7) = mat(7,7)+(Conjg(MUX(1,j1))*MUX(j1,1))/4._dp
End Do 
Do j1 = 1,3
mat(7,7) = mat(7,7)+(Conjg(MUX(j1,1))*MUX(j1,1))/4._dp
End Do 
Do j1 = 1,3
mat(7,7) = mat(7,7)+(vS**2*Conjg(lamN(j1,1))*lamN(j1,1))/2._dp
End Do 
mat(7,7) = mat(7,7)-BMUX(1,1)/2._dp
mat(7,8) = 0._dp 
mat(7,8) = mat(7,8)-Conjg(BMUX(1,2))/4._dp
mat(7,8) = mat(7,8)-Conjg(BMUX(2,1))/4._dp
mat(7,8) = mat(7,8)+mx2(1,2)/2._dp
mat(7,8) = mat(7,8)+mx2(2,1)/2._dp
Do j1 = 1,3
mat(7,8) = mat(7,8)+(Conjg(MUX(2,j1))*MUX(1,j1))/8._dp
End Do 
Do j1 = 1,3
mat(7,8) = mat(7,8)+(Conjg(MUX(j1,2))*MUX(1,j1))/8._dp
End Do 
Do j1 = 1,3
mat(7,8) = mat(7,8)+(Conjg(MUX(1,j1))*MUX(2,j1))/8._dp
End Do 
Do j1 = 1,3
mat(7,8) = mat(7,8)+(Conjg(MUX(j1,1))*MUX(2,j1))/8._dp
End Do 
Do j1 = 1,3
mat(7,8) = mat(7,8)+(Conjg(MUX(2,j1))*MUX(j1,1))/8._dp
End Do 
Do j1 = 1,3
mat(7,8) = mat(7,8)+(Conjg(MUX(j1,2))*MUX(j1,1))/8._dp
End Do 
Do j1 = 1,3
mat(7,8) = mat(7,8)+(Conjg(MUX(1,j1))*MUX(j1,2))/8._dp
End Do 
Do j1 = 1,3
mat(7,8) = mat(7,8)+(Conjg(MUX(j1,1))*MUX(j1,2))/8._dp
End Do 
Do j1 = 1,3
mat(7,8) = mat(7,8)+(vS**2*Conjg(lamN(j1,2))*lamN(j1,1))/4._dp
End Do 
Do j1 = 1,3
mat(7,8) = mat(7,8)+(vS**2*Conjg(lamN(j1,1))*lamN(j1,2))/4._dp
End Do 
mat(7,8) = mat(7,8)-BMUX(1,2)/4._dp
mat(7,8) = mat(7,8)-BMUX(2,1)/4._dp
mat(7,9) = 0._dp 
mat(7,9) = mat(7,9)-Conjg(BMUX(1,3))/4._dp
mat(7,9) = mat(7,9)-Conjg(BMUX(3,1))/4._dp
mat(7,9) = mat(7,9)+mx2(1,3)/2._dp
mat(7,9) = mat(7,9)+mx2(3,1)/2._dp
Do j1 = 1,3
mat(7,9) = mat(7,9)+(Conjg(MUX(3,j1))*MUX(1,j1))/8._dp
End Do 
Do j1 = 1,3
mat(7,9) = mat(7,9)+(Conjg(MUX(j1,3))*MUX(1,j1))/8._dp
End Do 
Do j1 = 1,3
mat(7,9) = mat(7,9)+(Conjg(MUX(1,j1))*MUX(3,j1))/8._dp
End Do 
Do j1 = 1,3
mat(7,9) = mat(7,9)+(Conjg(MUX(j1,1))*MUX(3,j1))/8._dp
End Do 
Do j1 = 1,3
mat(7,9) = mat(7,9)+(Conjg(MUX(3,j1))*MUX(j1,1))/8._dp
End Do 
Do j1 = 1,3
mat(7,9) = mat(7,9)+(Conjg(MUX(j1,3))*MUX(j1,1))/8._dp
End Do 
Do j1 = 1,3
mat(7,9) = mat(7,9)+(Conjg(MUX(1,j1))*MUX(j1,3))/8._dp
End Do 
Do j1 = 1,3
mat(7,9) = mat(7,9)+(Conjg(MUX(j1,1))*MUX(j1,3))/8._dp
End Do 
Do j1 = 1,3
mat(7,9) = mat(7,9)+(vS**2*Conjg(lamN(j1,3))*lamN(j1,1))/4._dp
End Do 
Do j1 = 1,3
mat(7,9) = mat(7,9)+(vS**2*Conjg(lamN(j1,1))*lamN(j1,3))/4._dp
End Do 
mat(7,9) = mat(7,9)-BMUX(1,3)/4._dp
mat(7,9) = mat(7,9)-BMUX(3,1)/4._dp
mat(8,8) = 0._dp 
mat(8,8) = mat(8,8)-Conjg(BMUX(2,2))/2._dp
mat(8,8) = mat(8,8)+mx2(2,2)
Do j1 = 1,3
mat(8,8) = mat(8,8)+(Conjg(MUX(2,j1))*MUX(2,j1))/4._dp
End Do 
Do j1 = 1,3
mat(8,8) = mat(8,8)+(Conjg(MUX(j1,2))*MUX(2,j1))/4._dp
End Do 
Do j1 = 1,3
mat(8,8) = mat(8,8)+(Conjg(MUX(2,j1))*MUX(j1,2))/4._dp
End Do 
Do j1 = 1,3
mat(8,8) = mat(8,8)+(Conjg(MUX(j1,2))*MUX(j1,2))/4._dp
End Do 
Do j1 = 1,3
mat(8,8) = mat(8,8)+(vS**2*Conjg(lamN(j1,2))*lamN(j1,2))/2._dp
End Do 
mat(8,8) = mat(8,8)-BMUX(2,2)/2._dp
mat(8,9) = 0._dp 
mat(8,9) = mat(8,9)-Conjg(BMUX(2,3))/4._dp
mat(8,9) = mat(8,9)-Conjg(BMUX(3,2))/4._dp
mat(8,9) = mat(8,9)+mx2(2,3)/2._dp
mat(8,9) = mat(8,9)+mx2(3,2)/2._dp
Do j1 = 1,3
mat(8,9) = mat(8,9)+(Conjg(MUX(3,j1))*MUX(2,j1))/8._dp
End Do 
Do j1 = 1,3
mat(8,9) = mat(8,9)+(Conjg(MUX(j1,3))*MUX(2,j1))/8._dp
End Do 
Do j1 = 1,3
mat(8,9) = mat(8,9)+(Conjg(MUX(2,j1))*MUX(3,j1))/8._dp
End Do 
Do j1 = 1,3
mat(8,9) = mat(8,9)+(Conjg(MUX(j1,2))*MUX(3,j1))/8._dp
End Do 
Do j1 = 1,3
mat(8,9) = mat(8,9)+(Conjg(MUX(3,j1))*MUX(j1,2))/8._dp
End Do 
Do j1 = 1,3
mat(8,9) = mat(8,9)+(Conjg(MUX(j1,3))*MUX(j1,2))/8._dp
End Do 
Do j1 = 1,3
mat(8,9) = mat(8,9)+(Conjg(MUX(2,j1))*MUX(j1,3))/8._dp
End Do 
Do j1 = 1,3
mat(8,9) = mat(8,9)+(Conjg(MUX(j1,2))*MUX(j1,3))/8._dp
End Do 
Do j1 = 1,3
mat(8,9) = mat(8,9)+(vS**2*Conjg(lamN(j1,3))*lamN(j1,2))/4._dp
End Do 
Do j1 = 1,3
mat(8,9) = mat(8,9)+(vS**2*Conjg(lamN(j1,2))*lamN(j1,3))/4._dp
End Do 
mat(8,9) = mat(8,9)-BMUX(2,3)/4._dp
mat(8,9) = mat(8,9)-BMUX(3,2)/4._dp
mat(9,9) = 0._dp 
mat(9,9) = mat(9,9)-Conjg(BMUX(3,3))/2._dp
mat(9,9) = mat(9,9)+mx2(3,3)
Do j1 = 1,3
mat(9,9) = mat(9,9)+(Conjg(MUX(3,j1))*MUX(3,j1))/4._dp
End Do 
Do j1 = 1,3
mat(9,9) = mat(9,9)+(Conjg(MUX(j1,3))*MUX(3,j1))/4._dp
End Do 
Do j1 = 1,3
mat(9,9) = mat(9,9)+(Conjg(MUX(3,j1))*MUX(j1,3))/4._dp
End Do 
Do j1 = 1,3
mat(9,9) = mat(9,9)+(Conjg(MUX(j1,3))*MUX(j1,3))/4._dp
End Do 
Do j1 = 1,3
mat(9,9) = mat(9,9)+(vS**2*Conjg(lamN(j1,3))*lamN(j1,3))/2._dp
End Do 
mat(9,9) = mat(9,9)-BMUX(3,3)/2._dp
...
Subroutine CalculateMSvRe(g1,g2,MUX,BMUX,lam,kap,lamN,TLN,Yv,Tv,ml2,mv2,              & 
& mx2,vd,vu,vS,ZVR,MSvRe,MSvRe2,kont)
...
Integer :: i1,i2,i3,i4, ierr 
Integer :: j1,j2,j3,j4, pos 
Real(dp), Intent(out) :: MSvRe(9), MSvRe2(9) 
Complex(dp), Intent(out) :: ZVR(9,9) 
...
Subroutine CalculateMFv(MUX,lamN,Yv,vu,vS,UV,MFv,kont)
...
mat(4,6) = 0._dp 
mat(4,7) = 0._dp 
mat(4,7) = mat(4,7)+(vS*lamN(1,1))/sqrt(2._dp)
mat(4,8) = 0._dp 
mat(4,8) = mat(4,8)+(vS*lamN(1,2))/sqrt(2._dp)
mat(4,9) = 0._dp 
mat(4,9) = mat(4,9)+(vS*lamN(1,3))/sqrt(2._dp)
mat(5,5) = 0._dp 
mat(5,6) = 0._dp 
mat(5,7) = 0._dp 
mat(5,7) = mat(5,7)+(vS*lamN(2,1))/sqrt(2._dp)
mat(5,8) = 0._dp 
mat(5,8) = mat(5,8)+(vS*lamN(2,2))/sqrt(2._dp)
mat(5,9) = 0._dp 
mat(5,9) = mat(5,9)+(vS*lamN(2,3))/sqrt(2._dp)
mat(6,6) = 0._dp 
mat(6,7) = 0._dp 
mat(6,7) = mat(6,7)+(vS*lamN(3,1))/sqrt(2._dp)
mat(6,8) = 0._dp 
mat(6,8) = mat(6,8)+(vS*lamN(3,2))/sqrt(2._dp)
mat(6,9) = 0._dp 
mat(6,9) = mat(6,9)+(vS*lamN(3,3))/sqrt(2._dp)
mat(7,7) = 0._dp 
...
Subroutine CalculateMSvImEffPot(g1,g2,MUX,BMUX,lam,kap,lamN,TLN,Yv,Tv,ml2,            & 
& mv2,mx2,vd,vu,vS,ZVI,MSvIm,MSvIm2,kont)
...
Real(dp) :: MSvIm2temp(9), Q2 
Complex(dp) :: ZVItemp(9,9), ZVItemp2(9,9) 
...
Subroutine CalculateMSvReEffPot(g1,g2,MUX,BMUX,lam,kap,lamN,TLN,Yv,Tv,ml2,            & 
& mv2,mx2,vd,vu,vS,ZVR,MSvRe,MSvRe2,kont)
...
Real(dp) :: MSvRe2temp(9), Q2 
Complex(dp) :: ZVRtemp(9,9), ZVRtemp2(9,9) 
...
Subroutine CalculateMFvEffPot(MUX,lamN,Yv,vu,vS,UV,MFv,kont)
...
& me2,mv2,ms2,mx2,M1,M2,M3,GenerationMixing,kont)
...
Real(dp),Intent(out) :: MFd(3),MFd2(3),MFe(3),MFe2(3),MFu(3),MFu2(3),MFv(9),MFv2(9),MVWm,MVWm2,               & 
& MVZ,MVZ2,TW,ZZ(2,2)

Complex(dp),Intent(out) :: UV(9,9),ZDL(3,3),ZDR(3,3),ZEL(3,3),ZER(3,3),ZUL(3,3),ZUR(3,3),ZW(2,2)
...
End Module TreeLevelMasses_NInvSeesaw 
