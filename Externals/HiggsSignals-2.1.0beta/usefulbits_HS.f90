...
!--------------------------------------------------------------------
 ...
 character(LEN=9),parameter :: HSvers='2.1.0beta'
...
! Values can be changes with specific user subroutines.
 ...
 logical :: normalize_rates_to_reference_position = .True.
...
!---
  ...
  double precision, dimension(5,5) :: CS13covSM = 0.0D0
  double precision, dimension(5,5) :: CS13cov = 0.0D0
