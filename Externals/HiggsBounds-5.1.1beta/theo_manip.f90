...
! Higgs-fermion coupling here (nobody has ever calculated this!).
    ...
    & XS_ZHcoeff_CPodd(Mhi,'TEV  ',1,.True.) *( effC(jj)%hjtt_p(i)**2 )+ &
    & XS_ZHcoeff(Mhi,'TEV  ',2,.True.,.True.)*( effC(jj)%hjbb_s(i)**2 )+ &
    & XS_ZHcoeff_CPodd(Mhi,'TEV  ',2,.True.) *( effC(jj)%hjbb_p(i)**2 )+ &
    ...
    & XS_ZHcoeff_CPodd(Mhi,'TEV  ',6,.True.)*( effC(jj)%hjtt_p(i) * effC(jj)%hjbb_p(i)) &
...
! Higgs-fermion coupling here (nobody has ever calculated this!).
    ...
    & XS_ZHcoeff_CPodd(Mhi,'LHC7 ',1,.True.) *( effC(jj)%hjtt_p(i)**2 )+ &
    & XS_ZHcoeff(Mhi,'LHC7 ',2,.True.,.True.)*( effC(jj)%hjbb_s(i)**2 )+ &
    & XS_ZHcoeff_CPodd(Mhi,'LHC7 ',2,.True.) *( effC(jj)%hjbb_p(i)**2 )+ &
    ...
    & XS_ZHcoeff_CPodd(Mhi,'LHC7 ',6,.True.)*(effC(jj)%hjtt_p(i) * effC(jj)%hjbb_p(i)) &
...
! Higgs-fermion coupling here (nobody has ever calculated this!).
    ...
    & XS_ZHcoeff_CPodd(Mhi,'LHC8 ',1,.True.) *( effC(jj)%hjtt_p(i)**2 )+ &
    & XS_ZHcoeff(Mhi,'LHC8 ',2,.True.,.True.)*( effC(jj)%hjbb_s(i)**2 )+ &
    & XS_ZHcoeff_CPodd(Mhi,'LHC8 ',2,.True.) *( effC(jj)%hjbb_p(i)**2 )+ &
    ...
    & XS_ZHcoeff_CPodd(Mhi,'LHC8 ',6,.True.)*(effC(jj)%hjtt_p(i) * effC(jj)%hjbb_p(i)) &
...
! Higgs-fermion coupling here (nobody has ever calculated this!).
    ...
    & XS_ZHcoeff_CPodd(Mhi,'LHC13',1,.True.) *( effC(jj)%hjtt_p(i)**2 )+ &
    & XS_ZHcoeff(Mhi,'LHC13',2,.True.,.True.)*( effC(jj)%hjbb_s(i)**2 )+ &
    & XS_ZHcoeff_CPodd(Mhi,'LHC13',2,.True.) *( effC(jj)%hjbb_p(i)**2 )+ &
    ...
    & XS_ZHcoeff_CPodd(Mhi,'LHC13',6,.True.)*(effC(jj)%hjtt_p(i) * effC(jj)%hjbb_p(i)) &
...
!    write(*,*) 'DEBUG - 13 TeV ZH approximation:'
!    do kk=1,7
!     write(*,*) "XS_ZHcoeff, XS_ZHcoeff_CPodd, kk = ",XS_ZHcoeff(Mhi,'LHC13',kk,.True.,.True.),XS_ZHcoeff_CPodd(Mhi,'LHC13',kk,.True.),kk
!    enddo
!    write(*,*) "theo(jj)%lhc13%XS_hjZ_ratio(i) = ", theo(jj)%lhc13%XS_hjZ_ratio(i)
   else
