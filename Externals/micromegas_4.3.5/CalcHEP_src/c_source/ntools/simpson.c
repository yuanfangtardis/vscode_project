...
double simpson( double (*func)(double),double a,double b, double  eps)
{
  ...
  // time: 2017.10.06.11:00
  // xiaofei,yuanfang debug begin
  // To avoid the erros:
  ///    simpson:recursion terminated after 34 steps
  eps*=10;
  // xiaofei,yuanfang debug end
...
double simpson_arg( double (*func)(double,void*),void*par,double a,double b, double  eps)
{
  ...
  // eps*=10; //xiaofei, yuanfang debug,2017.10.06
  if(a==b) return 0;
