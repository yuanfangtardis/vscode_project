...
static void C16(REAL*C)
{
  REAL* V=va_ext;
REAL S[23];                                                           
C[114]=+8*V[4134]*V[4132]*V[948]*V[874];
C[113]=+8*V[4134]*V[4130]*V[948]*V[800];
C[112]=+8*V[4132]*V[4130]*V[874]*V[800];
C[111]=+8*V[4134]*V[4128]*V[948]*V[726];
C[110]=+8*V[4132]*V[4128]*V[874]*V[726];
C[109]=+8*V[4130]*V[4128]*V[800]*V[726];
C[108]=+8*V[4134]*V[4126]*V[948]*V[652];
C[107]=+8*V[4132]*V[4126]*V[874]*V[652];
C[106]=+8*V[4130]*V[4126]*V[800]*V[652];
C[105]=+8*V[4128]*V[4126]*V[726]*V[652];
C[104]=+8*V[4134]*V[4124]*V[948]*V[578];
C[103]=+8*V[4132]*V[4124]*V[874]*V[578];
C[102]=+8*V[4130]*V[4124]*V[800]*V[578];
C[101]=+8*V[4128]*V[4124]*V[726]*V[578];
C[100]=+8*V[4126]*V[4124]*V[652]*V[578];
S[0]=V[27]*V[27];
S[1]=V[3]*V[3];
C[99]=+S[1]*(S[0]-S[1]);
C[98]=+2*S[1];
...
C[97]=+4*S[2]*S[3];
C[96]=+S[2]*S[3];
C[95]=+4*V[4134]*V[4132]*V[948]*V[874];
S[4]=V[4132]*V[4132];
S[5]=V[874]*V[874];
C[94]=+4*S[4]*S[5];
C[93]=+2*V[4134]*V[4132]*V[948]*V[874];
C[92]=+S[4]*S[5];
C[91]=+4*V[4134]*V[4130]*V[948]*V[800];
C[90]=+4*V[4132]*V[4130]*V[874]*V[800];
S[6]=V[4130]*V[4130];
S[7]=V[800]*V[800];
C[89]=+4*S[6]*S[7];
C[88]=+2*V[4134]*V[4130]*V[948]*V[800];
C[87]=+2*V[4132]*V[4130]*V[874]*V[800];
C[86]=+S[6]*S[7];
C[85]=+4*V[4134]*V[4128]*V[948]*V[726];
C[84]=+4*V[4132]*V[4128]*V[874]*V[726];
C[83]=+4*V[4130]*V[4128]*V[800]*V[726];
S[8]=V[4128]*V[4128];
S[9]=V[726]*V[726];
C[82]=+4*S[8]*S[9];
C[81]=+2*V[4134]*V[4128]*V[948]*V[726];
C[80]=+2*V[4132]*V[4128]*V[874]*V[726];
C[79]=+2*V[4130]*V[4128]*V[800]*V[726];
C[78]=+S[8]*S[9];
C[77]=+4*V[4134]*V[4126]*V[948]*V[652];
C[76]=+4*V[4132]*V[4126]*V[874]*V[652];
C[75]=+4*V[4130]*V[4126]*V[800]*V[652];
C[74]=+4*V[4128]*V[4126]*V[726]*V[652];
S[10]=V[4126]*V[4126];
S[11]=V[652]*V[652];
C[73]=+4*S[10]*S[11];
C[72]=+2*V[4134]*V[4126]*V[948]*V[652];
C[71]=+2*V[4132]*V[4126]*V[874]*V[652];
C[70]=+2*V[4130]*V[4126]*V[800]*V[652];
C[69]=+2*V[4128]*V[4126]*V[726]*V[652];
C[68]=+S[10]*S[11];
C[67]=+4*V[4134]*V[4124]*V[948]*V[578];
C[66]=+4*V[4132]*V[4124]*V[874]*V[578];
C[65]=+4*V[4130]*V[4124]*V[800]*V[578];
C[64]=+4*V[4128]*V[4124]*V[726]*V[578];
C[63]=+4*V[4126]*V[4124]*V[652]*V[578];
S[12]=V[24]*V[24];
C[62]=+S[1]*(S[0]-S[12]);
C[61]=+S[0]+S[12];
C[60]=+S[0]-S[12]-2*S[1];
...
S[14]=V[578]*V[578];
C[59]=+4*S[13]*S[14];
C[58]=+2*V[4134]*V[4124]*V[948]*V[578];
C[57]=+2*V[4132]*V[4124]*V[874]*V[578];
C[56]=+2*V[4130]*V[4124]*V[800]*V[578];
C[55]=+2*V[4128]*V[4124]*V[726]*V[578];
C[54]=+2*V[4126]*V[4124]*V[652]*V[578];
S[15]=V[24]*V[24]*V[24]*V[24];
C[53]=+S[0]*(S[0]-2*S[12]-4*S[1])+S[15];
C[52]=+4*(S[0]-S[12]);
C[51]=+S[13]*S[14];
C[50]=+4*V[4134]*V[4103]*V[2954]*V[948];
C[49]=+4*V[4132]*V[4103]*V[2954]*V[874];
C[48]=+4*V[4130]*V[4103]*V[2954]*V[800];
C[47]=+4*V[4128]*V[4103]*V[2954]*V[726];
C[46]=+4*V[4126]*V[4103]*V[2954]*V[652];
C[45]=+4*V[4124]*V[4103]*V[2954]*V[578];
C[44]=+2*V[4134]*V[4103]*V[2954]*V[948];
C[43]=+2*V[4132]*V[4103]*V[2954]*V[874];
C[42]=+2*V[4130]*V[4103]*V[2954]*V[800];
C[41]=+2*V[4128]*V[4103]*V[2954]*V[726];
C[40]=+2*V[4126]*V[4103]*V[2954]*V[652];
C[39]=+2*V[4124]*V[4103]*V[2954]*V[578];
S[16]=V[4103]*V[4103];
S[17]=V[2954]*V[2954];
C[38]=+S[16]*S[17];
C[37]=+4*V[4134]*V[4102]*V[2306]*V[948];
C[36]=+4*V[4132]*V[4102]*V[2306]*V[874];
C[35]=+4*V[4130]*V[4102]*V[2306]*V[800];
C[34]=+4*V[4128]*V[4102]*V[2306]*V[726];
C[33]=+4*V[4126]*V[4102]*V[2306]*V[652];
C[32]=+4*V[4124]*V[4102]*V[2306]*V[578];
C[31]=+2*V[4134]*V[4102]*V[2306]*V[948];
C[30]=+2*V[4132]*V[4102]*V[2306]*V[874];
C[29]=+2*V[4130]*V[4102]*V[2306]*V[800];
C[28]=+2*V[4128]*V[4102]*V[2306]*V[726];
C[27]=+2*V[4126]*V[4102]*V[2306]*V[652];
C[26]=+2*V[4124]*V[4102]*V[2306]*V[578];
C[25]=+2*V[4103]*V[4102]*V[2954]*V[2306];
S[18]=V[4102]*V[4102];
S[19]=V[2306]*V[2306];
C[24]=+S[18]*S[19];
C[23]=+4*V[4134]*V[4101]*V[1658]*V[948];
C[22]=+4*V[4132]*V[4101]*V[1658]*V[874];
C[21]=+4*V[4130]*V[4101]*V[1658]*V[800];
C[20]=+4*V[4128]*V[4101]*V[1658]*V[726];
C[19]=+4*V[4126]*V[4101]*V[1658]*V[652];
C[18]=+S[1]*(S[0]+S[12]-2*S[1]);
C[17]=+S[0]+S[12]-4*S[1];
C[16]=+S[0]-S[12]+2*S[1];
C[15]=+4*V[4124]*V[4101]*V[1658]*V[578];
C[14]=+2*V[4134]*V[4101]*V[1658]*V[948];
C[13]=+2*V[4132]*V[4101]*V[1658]*V[874];
C[12]=+2*V[4130]*V[4101]*V[1658]*V[800];
C[11]=+2*V[4128]*V[4101]*V[1658]*V[726];
C[10]=+2*V[4126]*V[4101]*V[1658]*V[652];
C[9]=+S[12]*(2*(-S[0]-S[1])+S[12])+S[0]*(S[0]-2*S[1]);
C[8]=+2*(S[0]+S[12]);
C[7]=+2*(S[0]-S[12])+4*S[1];
C[6]=+2*V[4124]*V[4101]*V[1658]*V[578];
C[5]=+2*V[4103]*V[4101]*V[2954]*V[1658];
C[4]=+2*V[4102]*V[4101]*V[2306]*V[1658];
